...
/**
 * TimeLimitDataApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class TimeLimitDataApi
{
    ...
    /**
     * Operation timeLimitDataGetByTimeLimitTitleId
     *
     * /api/v2/TimeLimitTitles/{id}/TimeLimitData
     *
     * @param  string $id TimeLimitTitle Id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitDataGetByTimeLimitTitleId'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\TimeLimitData[]
     */
    public function timeLimitDataGetByTimeLimitTitleId($id, string $contentType = self::contentTypes['timeLimitDataGetByTimeLimitTitleId'][0])
    {
        list($response) = $this->timeLimitDataGetByTimeLimitTitleIdWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation timeLimitDataGetByTimeLimitTitleIdWithHttpInfo
     *
     * /api/v2/TimeLimitTitles/{id}/TimeLimitData
     *
     * @param  string $id TimeLimitTitle Id (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\TimeLimitData[], HTTP status code, HTTP response headers (array of strings)
     */
    public function timeLimitDataGetByTimeLimitTitleIdWithHttpInfo($id, string $contentType = self::contentTypes['timeLimitDataGetByTimeLimitTitleId'][0])
    {
        $request = $this->timeLimitDataGetByTimeLimitTitleIdRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\TimeLimitData[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\TimeLimitData[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\TimeLimitData[]', []),
            ...
            $returnType = '\OpenAPI\Client\Model\TimeLimitData[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\TimeLimitData[]',
    ...
    /**
     * Operation timeLimitDataGetByTimeLimitTitleIdAsync
     *
     * /api/v2/TimeLimitTitles/{id}/TimeLimitData
     *
     * @param  string $id TimeLimitTitle Id (required)
     ...
     */
    public function timeLimitDataGetByTimeLimitTitleIdAsync($id, string $contentType = self::contentTypes['timeLimitDataGetByTimeLimitTitleId'][0])
    {
        return $this->timeLimitDataGetByTimeLimitTitleIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation timeLimitDataGetByTimeLimitTitleIdAsyncWithHttpInfo
     *
     * /api/v2/TimeLimitTitles/{id}/TimeLimitData
     *
     * @param  string $id TimeLimitTitle Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeLimitDataGetByTimeLimitTitleIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['timeLimitDataGetByTimeLimitTitleId'][0])
    {
        $returnType = '\OpenAPI\Client\Model\TimeLimitData[]';
        $request = $this->timeLimitDataGetByTimeLimitTitleIdRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'timeLimitDataGetByTimeLimitTitleId'
     *
     * @param  string $id TimeLimitTitle Id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitDataGetByTimeLimitTitleId'] to see the possible values for this operation
     *
     ...
     */
    public function timeLimitDataGetByTimeLimitTitleIdRequest($id, string $contentType = self::contentTypes['timeLimitDataGetByTimeLimitTitleId'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling timeLimitDataGetByTimeLimitTitleId'
            );
        }


        $resourcePath = '/api/v2/TimeLimitTitles/{id}/TimeLimitData';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
