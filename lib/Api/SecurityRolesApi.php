...
/**
 * SecurityRolesApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class SecurityRolesApi
{
    ...
    /**
     * Operation securityRolesCanDelete
     *
     * /api/v2/SecurityRoles/{id}/CanDelete
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityRolesCanDelete'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CanDeleteSecurityRole
     */
    public function securityRolesCanDelete($id, string $contentType = self::contentTypes['securityRolesCanDelete'][0])
    {
        list($response) = $this->securityRolesCanDeleteWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation securityRolesCanDeleteWithHttpInfo
     *
     * /api/v2/SecurityRoles/{id}/CanDelete
     *
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CanDeleteSecurityRole, HTTP status code, HTTP response headers (array of strings)
     */
    public function securityRolesCanDeleteWithHttpInfo($id, string $contentType = self::contentTypes['securityRolesCanDelete'][0])
    {
        $request = $this->securityRolesCanDeleteRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CanDeleteSecurityRole' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CanDeleteSecurityRole' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CanDeleteSecurityRole', []),
            ...
            $returnType = '\OpenAPI\Client\Model\CanDeleteSecurityRole';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CanDeleteSecurityRole',
    ...
    /**
     * Operation securityRolesCanDeleteAsync
     *
     * /api/v2/SecurityRoles/{id}/CanDelete
     *
     * @param  string $id (required)
     ...
     */
    public function securityRolesCanDeleteAsync($id, string $contentType = self::contentTypes['securityRolesCanDelete'][0])
    {
        return $this->securityRolesCanDeleteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation securityRolesCanDeleteAsyncWithHttpInfo
     *
     * /api/v2/SecurityRoles/{id}/CanDelete
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityRolesCanDeleteAsyncWithHttpInfo($id, string $contentType = self::contentTypes['securityRolesCanDelete'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CanDeleteSecurityRole';
        $request = $this->securityRolesCanDeleteRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'securityRolesCanDelete'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityRolesCanDelete'] to see the possible values for this operation
     *
     ...
     */
    public function securityRolesCanDeleteRequest($id, string $contentType = self::contentTypes['securityRolesCanDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling securityRolesCanDelete'
            );
        }


        $resourcePath = '/api/v2/SecurityRoles/{id}/CanDelete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation securityRolesDelete
     *
     * /api/v2/SecurityRoles/{id}
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityRolesDelete'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function securityRolesDelete($id, string $contentType = self::contentTypes['securityRolesDelete'][0])
    {
        $this->securityRolesDeleteWithHttpInfo($id, $contentType);
    }

    /**
     * Operation securityRolesDeleteWithHttpInfo
     *
     * /api/v2/SecurityRoles/{id}
     *
     * @param  string $id (required)
     ...
     */
    public function securityRolesDeleteWithHttpInfo($id, string $contentType = self::contentTypes['securityRolesDelete'][0])
    {
        $request = $this->securityRolesDeleteRequest($id, $contentType);
    ...
    /**
     * Operation securityRolesDeleteAsync
     *
     * /api/v2/SecurityRoles/{id}
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityRolesDeleteAsync($id, string $contentType = self::contentTypes['securityRolesDelete'][0])
    {
        return $this->securityRolesDeleteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation securityRolesDeleteAsyncWithHttpInfo
     *
     * /api/v2/SecurityRoles/{id}
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityRolesDeleteAsyncWithHttpInfo($id, string $contentType = self::contentTypes['securityRolesDelete'][0])
    {
        $returnType = '';
        $request = $this->securityRolesDeleteRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'securityRolesDelete'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityRolesDelete'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function securityRolesDeleteRequest($id, string $contentType = self::contentTypes['securityRolesDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling securityRolesDelete'
            );
        }


        $resourcePath = '/api/v2/SecurityRoles/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation securityRolesGetAll
     *
     * /api/v2/SecurityRoles
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityRolesGetAll'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SecurityRole[]
     */
    public function securityRolesGetAll(string $contentType = self::contentTypes['securityRolesGetAll'][0])
    {
        list($response) = $this->securityRolesGetAllWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation securityRolesGetAllWithHttpInfo
     *
     * /api/v2/SecurityRoles
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityRolesGetAll'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\SecurityRole[], HTTP status code, HTTP response headers (array of strings)
     */
    public function securityRolesGetAllWithHttpInfo(string $contentType = self::contentTypes['securityRolesGetAll'][0])
    {
        $request = $this->securityRolesGetAllRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\SecurityRole[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\SecurityRole[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\SecurityRole[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\SecurityRole[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation securityRolesGetAllAsync
     *
     * /api/v2/SecurityRoles
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityRolesGetAll'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityRolesGetAllAsync(string $contentType = self::contentTypes['securityRolesGetAll'][0])
    {
        return $this->securityRolesGetAllAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation securityRolesGetAllAsyncWithHttpInfo
     *
     * /api/v2/SecurityRoles
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityRolesGetAll'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityRolesGetAllAsyncWithHttpInfo(string $contentType = self::contentTypes['securityRolesGetAll'][0])
    {
        $returnType = '\OpenAPI\Client\Model\SecurityRole[]';
        $request = $this->securityRolesGetAllRequest($contentType);
    ...
    /**
     * Create request for operation 'securityRolesGetAll'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityRolesGetAll'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function securityRolesGetAllRequest(string $contentType = self::contentTypes['securityRolesGetAll'][0])
    {


        $resourcePath = '/api/v2/SecurityRoles';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation securityRolesGetById
     *
     * /api/v2/SecurityRoles/{id}
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityRolesGetById'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SecurityRole
     */
    public function securityRolesGetById($id, string $contentType = self::contentTypes['securityRolesGetById'][0])
    {
        list($response) = $this->securityRolesGetByIdWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation securityRolesGetByIdWithHttpInfo
     *
     * /api/v2/SecurityRoles/{id}
     *
     * @param  string $id (required)
     ...
     * @return array of \OpenAPI\Client\Model\SecurityRole, HTTP status code, HTTP response headers (array of strings)
     */
    public function securityRolesGetByIdWithHttpInfo($id, string $contentType = self::contentTypes['securityRolesGetById'][0])
    {
        $request = $this->securityRolesGetByIdRequest($id, $contentType);
    ...
    /**
     * Operation securityRolesGetByIdAsync
     *
     * /api/v2/SecurityRoles/{id}
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityRolesGetByIdAsync($id, string $contentType = self::contentTypes['securityRolesGetById'][0])
    {
        return $this->securityRolesGetByIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation securityRolesGetByIdAsyncWithHttpInfo
     *
     * /api/v2/SecurityRoles/{id}
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityRolesGetByIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['securityRolesGetById'][0])
    {
        $returnType = '\OpenAPI\Client\Model\SecurityRole';
        $request = $this->securityRolesGetByIdRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'securityRolesGetById'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityRolesGetById'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function securityRolesGetByIdRequest($id, string $contentType = self::contentTypes['securityRolesGetById'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling securityRolesGetById'
            );
        }
    ...
    /**
     * Operation securityRolesInsert
     *
     * /api/v2/SecurityRoles
     *
     * @param  \OpenAPI\Client\Model\SecurityRole $security_role security_role (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityRolesInsert'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SecurityRole
     */
    public function securityRolesInsert($security_role, string $contentType = self::contentTypes['securityRolesInsert'][0])
    {
        list($response) = $this->securityRolesInsertWithHttpInfo($security_role, $contentType);
        return $response;
    }

    /**
     * Operation securityRolesInsertWithHttpInfo
     *
     * /api/v2/SecurityRoles
     *
     * @param  \OpenAPI\Client\Model\SecurityRole $security_role (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityRolesInsert'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\SecurityRole, HTTP status code, HTTP response headers (array of strings)
     */
    public function securityRolesInsertWithHttpInfo($security_role, string $contentType = self::contentTypes['securityRolesInsert'][0])
    {
        $request = $this->securityRolesInsertRequest($security_role, $contentType);
    ...
    /**
     * Operation securityRolesInsertAsync
     *
     * /api/v2/SecurityRoles
     *
     * @param  \OpenAPI\Client\Model\SecurityRole $security_role (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityRolesInsertAsync($security_role, string $contentType = self::contentTypes['securityRolesInsert'][0])
    {
        return $this->securityRolesInsertAsyncWithHttpInfo($security_role, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation securityRolesInsertAsyncWithHttpInfo
     *
     * /api/v2/SecurityRoles
     *
     * @param  \OpenAPI\Client\Model\SecurityRole $security_role (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityRolesInsertAsyncWithHttpInfo($security_role, string $contentType = self::contentTypes['securityRolesInsert'][0])
    {
        $returnType = '\OpenAPI\Client\Model\SecurityRole';
        $request = $this->securityRolesInsertRequest($security_role, $contentType);
    ...
    /**
     * Create request for operation 'securityRolesInsert'
     *
     * @param  \OpenAPI\Client\Model\SecurityRole $security_role (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityRolesInsert'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function securityRolesInsertRequest($security_role, string $contentType = self::contentTypes['securityRolesInsert'][0])
    {

        // verify the required parameter 'security_role' is set
        if ($security_role === null || (is_array($security_role) && count($security_role) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $security_role when calling securityRolesInsert'
            );
        }
        ...
        // for model (json/xml)
        if (isset($security_role)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($security_role));
            } else {
                $httpBody = $security_role;
            }
    ...
    /**
     * Operation securityRolesUpdate
     *
     * /api/v2/SecurityRoles
     *
     * @param  \OpenAPI\Client\Model\SecurityRole $security_role security_role (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityRolesUpdate'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function securityRolesUpdate($security_role, string $contentType = self::contentTypes['securityRolesUpdate'][0])
    {
        $this->securityRolesUpdateWithHttpInfo($security_role, $contentType);
    }

    /**
     * Operation securityRolesUpdateWithHttpInfo
     *
     * /api/v2/SecurityRoles
     *
     * @param  \OpenAPI\Client\Model\SecurityRole $security_role (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function securityRolesUpdateWithHttpInfo($security_role, string $contentType = self::contentTypes['securityRolesUpdate'][0])
    {
        $request = $this->securityRolesUpdateRequest($security_role, $contentType);
    ...
    /**
     * Operation securityRolesUpdateAsync
     *
     * /api/v2/SecurityRoles
     *
     * @param  \OpenAPI\Client\Model\SecurityRole $security_role (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityRolesUpdateAsync($security_role, string $contentType = self::contentTypes['securityRolesUpdate'][0])
    {
        return $this->securityRolesUpdateAsyncWithHttpInfo($security_role, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation securityRolesUpdateAsyncWithHttpInfo
     *
     * /api/v2/SecurityRoles
     *
     * @param  \OpenAPI\Client\Model\SecurityRole $security_role (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityRolesUpdateAsyncWithHttpInfo($security_role, string $contentType = self::contentTypes['securityRolesUpdate'][0])
    {
        $returnType = '';
        $request = $this->securityRolesUpdateRequest($security_role, $contentType);
    ...
    /**
     * Create request for operation 'securityRolesUpdate'
     *
     * @param  \OpenAPI\Client\Model\SecurityRole $security_role (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityRolesUpdate'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function securityRolesUpdateRequest($security_role, string $contentType = self::contentTypes['securityRolesUpdate'][0])
    {

        // verify the required parameter 'security_role' is set
        if ($security_role === null || (is_array($security_role) && count($security_role) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $security_role when calling securityRolesUpdate'
            );
        }
