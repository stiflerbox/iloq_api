...
/**
 * NetworkModulesApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class NetworkModulesApi
{
    ...
    /**
     * Operation networkModulesGetAll
     *
     * /api/v2/NetworkModules
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['networkModulesGetAll'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\NetworkModule[]
     */
    public function networkModulesGetAll(string $contentType = self::contentTypes['networkModulesGetAll'][0])
    {
        list($response) = $this->networkModulesGetAllWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation networkModulesGetAllWithHttpInfo
     *
     * /api/v2/NetworkModules
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['networkModulesGetAll'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\NetworkModule[], HTTP status code, HTTP response headers (array of strings)
     */
    public function networkModulesGetAllWithHttpInfo(string $contentType = self::contentTypes['networkModulesGetAll'][0])
    {
        $request = $this->networkModulesGetAllRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\NetworkModule[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\NetworkModule[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\NetworkModule[]', []),
            ...
            $returnType = '\OpenAPI\Client\Model\NetworkModule[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\NetworkModule[]',
    ...
    /**
     * Operation networkModulesGetAllAsync
     *
     * /api/v2/NetworkModules
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['networkModulesGetAll'] to see the possible values for this operation
     ...
     */
    public function networkModulesGetAllAsync(string $contentType = self::contentTypes['networkModulesGetAll'][0])
    {
        return $this->networkModulesGetAllAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation networkModulesGetAllAsyncWithHttpInfo
     *
     * /api/v2/NetworkModules
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['networkModulesGetAll'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function networkModulesGetAllAsyncWithHttpInfo(string $contentType = self::contentTypes['networkModulesGetAll'][0])
    {
        $returnType = '\OpenAPI\Client\Model\NetworkModule[]';
        $request = $this->networkModulesGetAllRequest($contentType);
    ...
    /**
     * Create request for operation 'networkModulesGetAll'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['networkModulesGetAll'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function networkModulesGetAllRequest(string $contentType = self::contentTypes['networkModulesGetAll'][0])
    {


        $resourcePath = '/api/v2/NetworkModules';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation networkModulesGetById
     *
     * /api/v2/NetworkModules/{id}
     *
     * @param  string $id Network module id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['networkModulesGetById'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\NetworkModule
     */
    public function networkModulesGetById($id, string $contentType = self::contentTypes['networkModulesGetById'][0])
    {
        list($response) = $this->networkModulesGetByIdWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation networkModulesGetByIdWithHttpInfo
     *
     * /api/v2/NetworkModules/{id}
     *
     * @param  string $id Network module id (required)
     ...
     * @return array of \OpenAPI\Client\Model\NetworkModule, HTTP status code, HTTP response headers (array of strings)
     */
    public function networkModulesGetByIdWithHttpInfo($id, string $contentType = self::contentTypes['networkModulesGetById'][0])
    {
        $request = $this->networkModulesGetByIdRequest($id, $contentType);
    ...
    /**
     * Operation networkModulesGetByIdAsync
     *
     * /api/v2/NetworkModules/{id}
     *
     * @param  string $id Network module id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function networkModulesGetByIdAsync($id, string $contentType = self::contentTypes['networkModulesGetById'][0])
    {
        return $this->networkModulesGetByIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation networkModulesGetByIdAsyncWithHttpInfo
     *
     * /api/v2/NetworkModules/{id}
     *
     * @param  string $id Network module id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function networkModulesGetByIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['networkModulesGetById'][0])
    {
        $returnType = '\OpenAPI\Client\Model\NetworkModule';
        $request = $this->networkModulesGetByIdRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'networkModulesGetById'
     *
     * @param  string $id Network module id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['networkModulesGetById'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function networkModulesGetByIdRequest($id, string $contentType = self::contentTypes['networkModulesGetById'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling networkModulesGetById'
            );
        }


        $resourcePath = '/api/v2/NetworkModules/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
