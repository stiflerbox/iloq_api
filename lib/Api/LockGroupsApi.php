...
/**
 * LockGroupsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class LockGroupsApi
{
    ...
    /**
     * Operation lockGroupsGenerateAccessToken
     *
     * /api/v2/LockGroups/GenerateAccessToken
     *
     * @param  \OpenAPI\Client\Model\GenerateAccessTokenParam $generate_access_token_param Access token generation parameter (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockGroupsGenerateAccessToken'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GenerateAccessTokenResult
     */
    public function lockGroupsGenerateAccessToken($generate_access_token_param, string $contentType = self::contentTypes['lockGroupsGenerateAccessToken'][0])
    {
        list($response) = $this->lockGroupsGenerateAccessTokenWithHttpInfo($generate_access_token_param, $contentType);
        return $response;
    }

    /**
     * Operation lockGroupsGenerateAccessTokenWithHttpInfo
     *
     * /api/v2/LockGroups/GenerateAccessToken
     *
     * @param  \OpenAPI\Client\Model\GenerateAccessTokenParam $generate_access_token_param Access token generation parameter (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GenerateAccessTokenResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function lockGroupsGenerateAccessTokenWithHttpInfo($generate_access_token_param, string $contentType = self::contentTypes['lockGroupsGenerateAccessToken'][0])
    {
        $request = $this->lockGroupsGenerateAccessTokenRequest($generate_access_token_param, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GenerateAccessTokenResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GenerateAccessTokenResult' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GenerateAccessTokenResult', []),
            ...
            $returnType = '\OpenAPI\Client\Model\GenerateAccessTokenResult';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GenerateAccessTokenResult',
    ...
    /**
     * Operation lockGroupsGenerateAccessTokenAsync
     *
     * /api/v2/LockGroups/GenerateAccessToken
     *
     * @param  \OpenAPI\Client\Model\GenerateAccessTokenParam $generate_access_token_param Access token generation parameter (required)
     ...
     */
    public function lockGroupsGenerateAccessTokenAsync($generate_access_token_param, string $contentType = self::contentTypes['lockGroupsGenerateAccessToken'][0])
    {
        return $this->lockGroupsGenerateAccessTokenAsyncWithHttpInfo($generate_access_token_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation lockGroupsGenerateAccessTokenAsyncWithHttpInfo
     *
     * /api/v2/LockGroups/GenerateAccessToken
     *
     * @param  \OpenAPI\Client\Model\GenerateAccessTokenParam $generate_access_token_param Access token generation parameter (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lockGroupsGenerateAccessTokenAsyncWithHttpInfo($generate_access_token_param, string $contentType = self::contentTypes['lockGroupsGenerateAccessToken'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GenerateAccessTokenResult';
        $request = $this->lockGroupsGenerateAccessTokenRequest($generate_access_token_param, $contentType);
    ...
    /**
     * Create request for operation 'lockGroupsGenerateAccessToken'
     *
     * @param  \OpenAPI\Client\Model\GenerateAccessTokenParam $generate_access_token_param Access token generation parameter (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockGroupsGenerateAccessToken'] to see the possible values for this operation
     *
     ...
     */
    public function lockGroupsGenerateAccessTokenRequest($generate_access_token_param, string $contentType = self::contentTypes['lockGroupsGenerateAccessToken'][0])
    {

        // verify the required parameter 'generate_access_token_param' is set
        if ($generate_access_token_param === null || (is_array($generate_access_token_param) && count($generate_access_token_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $generate_access_token_param when calling lockGroupsGenerateAccessToken'
            );
        }


        $resourcePath = '/api/v2/LockGroups/GenerateAccessToken';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($generate_access_token_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($generate_access_token_param));
            } else {
                $httpBody = $generate_access_token_param;
            }
    ...
    /**
     * Operation lockGroupsGetAllLockGroups
     *
     * /api/v2/LockGroups
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockGroupsGetAllLockGroups'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\LockGroup[]
     */
    public function lockGroupsGetAllLockGroups(string $contentType = self::contentTypes['lockGroupsGetAllLockGroups'][0])
    {
        list($response) = $this->lockGroupsGetAllLockGroupsWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation lockGroupsGetAllLockGroupsWithHttpInfo
     *
     * /api/v2/LockGroups
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockGroupsGetAllLockGroups'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\LockGroup[], HTTP status code, HTTP response headers (array of strings)
     */
    public function lockGroupsGetAllLockGroupsWithHttpInfo(string $contentType = self::contentTypes['lockGroupsGetAllLockGroups'][0])
    {
        $request = $this->lockGroupsGetAllLockGroupsRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\LockGroup[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\LockGroup[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\LockGroup[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\LockGroup[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\LockGroup[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation lockGroupsGetAllLockGroupsAsync
     *
     * /api/v2/LockGroups
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockGroupsGetAllLockGroups'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lockGroupsGetAllLockGroupsAsync(string $contentType = self::contentTypes['lockGroupsGetAllLockGroups'][0])
    {
        return $this->lockGroupsGetAllLockGroupsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation lockGroupsGetAllLockGroupsAsyncWithHttpInfo
     *
     * /api/v2/LockGroups
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockGroupsGetAllLockGroups'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lockGroupsGetAllLockGroupsAsyncWithHttpInfo(string $contentType = self::contentTypes['lockGroupsGetAllLockGroups'][0])
    {
        $returnType = '\OpenAPI\Client\Model\LockGroup[]';
        $request = $this->lockGroupsGetAllLockGroupsRequest($contentType);
    ...
    /**
     * Create request for operation 'lockGroupsGetAllLockGroups'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockGroupsGetAllLockGroups'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function lockGroupsGetAllLockGroupsRequest(string $contentType = self::contentTypes['lockGroupsGetAllLockGroups'][0])
    {


        $resourcePath = '/api/v2/LockGroups';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation lockGroupsGetConnectionSettings
     *
     * /api/v2/LockGroups/ConnectionSettings
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockGroupsGetConnectionSettings'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetConnectionSettingsResult
     */
    public function lockGroupsGetConnectionSettings(string $contentType = self::contentTypes['lockGroupsGetConnectionSettings'][0])
    {
        list($response) = $this->lockGroupsGetConnectionSettingsWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation lockGroupsGetConnectionSettingsWithHttpInfo
     *
     * /api/v2/LockGroups/ConnectionSettings
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockGroupsGetConnectionSettings'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GetConnectionSettingsResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function lockGroupsGetConnectionSettingsWithHttpInfo(string $contentType = self::contentTypes['lockGroupsGetConnectionSettings'][0])
    {
        $request = $this->lockGroupsGetConnectionSettingsRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetConnectionSettingsResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GetConnectionSettingsResult' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetConnectionSettingsResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\GetConnectionSettingsResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetConnectionSettingsResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation lockGroupsGetConnectionSettingsAsync
     *
     * /api/v2/LockGroups/ConnectionSettings
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockGroupsGetConnectionSettings'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lockGroupsGetConnectionSettingsAsync(string $contentType = self::contentTypes['lockGroupsGetConnectionSettings'][0])
    {
        return $this->lockGroupsGetConnectionSettingsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation lockGroupsGetConnectionSettingsAsyncWithHttpInfo
     *
     * /api/v2/LockGroups/ConnectionSettings
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockGroupsGetConnectionSettings'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lockGroupsGetConnectionSettingsAsyncWithHttpInfo(string $contentType = self::contentTypes['lockGroupsGetConnectionSettings'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetConnectionSettingsResult';
        $request = $this->lockGroupsGetConnectionSettingsRequest($contentType);
    ...
    /**
     * Create request for operation 'lockGroupsGetConnectionSettings'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockGroupsGetConnectionSettings'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function lockGroupsGetConnectionSettingsRequest(string $contentType = self::contentTypes['lockGroupsGetConnectionSettings'][0])
    {


        $resourcePath = '/api/v2/LockGroups/ConnectionSettings';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
