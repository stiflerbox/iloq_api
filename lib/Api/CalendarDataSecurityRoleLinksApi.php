<?php
/**
 * CalendarDataSecurityRoleLinksApi
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CalendarDataSecurityRoleLinksApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CalendarDataSecurityRoleLinksApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation calendarDataSecurityRoleLinksDeleteLinks
     *
     * /api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks/Delete
     *
     * @param  string $id Calendar data Id (required)
     * @param  \OpenAPI\Client\Model\CalendarDataSecurityRoleLinksDeleteLinksParam $calendar_data_security_role_links_delete_links_param Parameter containing links which are deleted (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataSecurityRoleLinksDeleteLinks'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function calendarDataSecurityRoleLinksDeleteLinks($id, $calendar_data_security_role_links_delete_links_param, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksDeleteLinks'][0])
    {
        $this->calendarDataSecurityRoleLinksDeleteLinksWithHttpInfo($id, $calendar_data_security_role_links_delete_links_param, $contentType);
    }

    /**
     * Operation calendarDataSecurityRoleLinksDeleteLinksWithHttpInfo
     *
     * /api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks/Delete
     *
     * @param  string $id Calendar data Id (required)
     ...
     */
    public function calendarDataSecurityRoleLinksDeleteLinksWithHttpInfo($id, $calendar_data_security_role_links_delete_links_param, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksDeleteLinks'][0])
    {
        $request = $this->calendarDataSecurityRoleLinksDeleteLinksRequest($id, $calendar_data_security_role_links_delete_links_param, $contentType);
    ...
    /**
     * Operation calendarDataSecurityRoleLinksDeleteLinksAsync
     *
     * /api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks/Delete
     *
     * @param  string $id Calendar data Id (required)
     ...
     */
    public function calendarDataSecurityRoleLinksDeleteLinksAsync($id, $calendar_data_security_role_links_delete_links_param, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksDeleteLinks'][0])
    {
        return $this->calendarDataSecurityRoleLinksDeleteLinksAsyncWithHttpInfo($id, $calendar_data_security_role_links_delete_links_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarDataSecurityRoleLinksDeleteLinksAsyncWithHttpInfo
     *
     * /api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks/Delete
     *
     * @param  string $id Calendar data Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataSecurityRoleLinksDeleteLinksAsyncWithHttpInfo($id, $calendar_data_security_role_links_delete_links_param, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksDeleteLinks'][0])
    {
        $returnType = '';
        $request = $this->calendarDataSecurityRoleLinksDeleteLinksRequest($id, $calendar_data_security_role_links_delete_links_param, $contentType);
    ...
    /**
     * Create request for operation 'calendarDataSecurityRoleLinksDeleteLinks'
     *
     * @param  string $id Calendar data Id (required)
     * @param  \OpenAPI\Client\Model\CalendarDataSecurityRoleLinksDeleteLinksParam $calendar_data_security_role_links_delete_links_param Parameter containing links which are deleted (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataSecurityRoleLinksDeleteLinks'] to see the possible values for this operation
     ...
     */
    public function calendarDataSecurityRoleLinksDeleteLinksRequest($id, $calendar_data_security_role_links_delete_links_param, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksDeleteLinks'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling calendarDataSecurityRoleLinksDeleteLinks'
            );
        }

        // verify the required parameter 'calendar_data_security_role_links_delete_links_param' is set
        if ($calendar_data_security_role_links_delete_links_param === null || (is_array($calendar_data_security_role_links_delete_links_param) && count($calendar_data_security_role_links_delete_links_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $calendar_data_security_role_links_delete_links_param when calling calendarDataSecurityRoleLinksDeleteLinks'
            );
        }


        $resourcePath = '/api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks/Delete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($calendar_data_security_role_links_delete_links_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($calendar_data_security_role_links_delete_links_param));
            } else {
                $httpBody = $calendar_data_security_role_links_delete_links_param;
            }
    ...
    /**
     * Operation calendarDataSecurityRoleLinksGetLinksByCalendarDataId
     *
     * /api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks
     *
     * @param  string $id Calendar data id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataSecurityRoleLinksGetLinksByCalendarDataId'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CalendarDataSecurityRoleLink[]
     */
    public function calendarDataSecurityRoleLinksGetLinksByCalendarDataId($id, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksGetLinksByCalendarDataId'][0])
    {
        list($response) = $this->calendarDataSecurityRoleLinksGetLinksByCalendarDataIdWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation calendarDataSecurityRoleLinksGetLinksByCalendarDataIdWithHttpInfo
     *
     * /api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks
     *
     * @param  string $id Calendar data id (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CalendarDataSecurityRoleLink[], HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarDataSecurityRoleLinksGetLinksByCalendarDataIdWithHttpInfo($id, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksGetLinksByCalendarDataId'][0])
    {
        $request = $this->calendarDataSecurityRoleLinksGetLinksByCalendarDataIdRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CalendarDataSecurityRoleLink[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CalendarDataSecurityRoleLink[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CalendarDataSecurityRoleLink[]', []),
            ...
            $returnType = '\OpenAPI\Client\Model\CalendarDataSecurityRoleLink[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CalendarDataSecurityRoleLink[]',
    ...
    /**
     * Operation calendarDataSecurityRoleLinksGetLinksByCalendarDataIdAsync
     *
     * /api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks
     *
     * @param  string $id Calendar data id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataSecurityRoleLinksGetLinksByCalendarDataIdAsync($id, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksGetLinksByCalendarDataId'][0])
    {
        return $this->calendarDataSecurityRoleLinksGetLinksByCalendarDataIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarDataSecurityRoleLinksGetLinksByCalendarDataIdAsyncWithHttpInfo
     *
     * /api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks
     *
     * @param  string $id Calendar data id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataSecurityRoleLinksGetLinksByCalendarDataIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksGetLinksByCalendarDataId'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CalendarDataSecurityRoleLink[]';
        $request = $this->calendarDataSecurityRoleLinksGetLinksByCalendarDataIdRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'calendarDataSecurityRoleLinksGetLinksByCalendarDataId'
     *
     * @param  string $id Calendar data id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataSecurityRoleLinksGetLinksByCalendarDataId'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarDataSecurityRoleLinksGetLinksByCalendarDataIdRequest($id, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksGetLinksByCalendarDataId'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling calendarDataSecurityRoleLinksGetLinksByCalendarDataId'
            );
        }


        $resourcePath = '/api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation calendarDataSecurityRoleLinksGetLinksBySecurityRoleId
     *
     * /api/v2/SecurityRoles/{id}/CalendarDataSecurityRoleLinks
     *
     * @param  string $id Code access group id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataSecurityRoleLinksGetLinksBySecurityRoleId'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CalendarDataSecurityRoleLink[]
     */
    public function calendarDataSecurityRoleLinksGetLinksBySecurityRoleId($id, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksGetLinksBySecurityRoleId'][0])
    {
        list($response) = $this->calendarDataSecurityRoleLinksGetLinksBySecurityRoleIdWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation calendarDataSecurityRoleLinksGetLinksBySecurityRoleIdWithHttpInfo
     *
     * /api/v2/SecurityRoles/{id}/CalendarDataSecurityRoleLinks
     *
     * @param  string $id Code access group id (required)
     ...
     * @return array of \OpenAPI\Client\Model\CalendarDataSecurityRoleLink[], HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarDataSecurityRoleLinksGetLinksBySecurityRoleIdWithHttpInfo($id, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksGetLinksBySecurityRoleId'][0])
    {
        $request = $this->calendarDataSecurityRoleLinksGetLinksBySecurityRoleIdRequest($id, $contentType);
    ...
    /**
     * Operation calendarDataSecurityRoleLinksGetLinksBySecurityRoleIdAsync
     *
     * /api/v2/SecurityRoles/{id}/CalendarDataSecurityRoleLinks
     *
     * @param  string $id Code access group id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataSecurityRoleLinksGetLinksBySecurityRoleIdAsync($id, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksGetLinksBySecurityRoleId'][0])
    {
        return $this->calendarDataSecurityRoleLinksGetLinksBySecurityRoleIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarDataSecurityRoleLinksGetLinksBySecurityRoleIdAsyncWithHttpInfo
     *
     * /api/v2/SecurityRoles/{id}/CalendarDataSecurityRoleLinks
     *
     * @param  string $id Code access group id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataSecurityRoleLinksGetLinksBySecurityRoleIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksGetLinksBySecurityRoleId'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CalendarDataSecurityRoleLink[]';
        $request = $this->calendarDataSecurityRoleLinksGetLinksBySecurityRoleIdRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'calendarDataSecurityRoleLinksGetLinksBySecurityRoleId'
     *
     * @param  string $id Code access group id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataSecurityRoleLinksGetLinksBySecurityRoleId'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarDataSecurityRoleLinksGetLinksBySecurityRoleIdRequest($id, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksGetLinksBySecurityRoleId'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling calendarDataSecurityRoleLinksGetLinksBySecurityRoleId'
            );
        }


        $resourcePath = '/api/v2/SecurityRoles/{id}/CalendarDataSecurityRoleLinks';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation calendarDataSecurityRoleLinksInsertLinks
     *
     * /api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks
     *
     * @param  string $id Calendar data Id (required)
     * @param  \OpenAPI\Client\Model\CalendarDataSecurityRoleLinksInsertLinksParam $calendar_data_security_role_links_insert_links_param Parameter containing links which are added (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataSecurityRoleLinksInsertLinks'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function calendarDataSecurityRoleLinksInsertLinks($id, $calendar_data_security_role_links_insert_links_param, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksInsertLinks'][0])
    {
        $this->calendarDataSecurityRoleLinksInsertLinksWithHttpInfo($id, $calendar_data_security_role_links_insert_links_param, $contentType);
    }

    /**
     * Operation calendarDataSecurityRoleLinksInsertLinksWithHttpInfo
     *
     * /api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks
     *
     * @param  string $id Calendar data Id (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarDataSecurityRoleLinksInsertLinksWithHttpInfo($id, $calendar_data_security_role_links_insert_links_param, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksInsertLinks'][0])
    {
        $request = $this->calendarDataSecurityRoleLinksInsertLinksRequest($id, $calendar_data_security_role_links_insert_links_param, $contentType);
    ...
    /**
     * Operation calendarDataSecurityRoleLinksInsertLinksAsync
     *
     * /api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks
     *
     * @param  string $id Calendar data Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataSecurityRoleLinksInsertLinksAsync($id, $calendar_data_security_role_links_insert_links_param, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksInsertLinks'][0])
    {
        return $this->calendarDataSecurityRoleLinksInsertLinksAsyncWithHttpInfo($id, $calendar_data_security_role_links_insert_links_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarDataSecurityRoleLinksInsertLinksAsyncWithHttpInfo
     *
     * /api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks
     *
     * @param  string $id Calendar data Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataSecurityRoleLinksInsertLinksAsyncWithHttpInfo($id, $calendar_data_security_role_links_insert_links_param, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksInsertLinks'][0])
    {
        $returnType = '';
        $request = $this->calendarDataSecurityRoleLinksInsertLinksRequest($id, $calendar_data_security_role_links_insert_links_param, $contentType);
    ...
    /**
     * Create request for operation 'calendarDataSecurityRoleLinksInsertLinks'
     *
     * @param  string $id Calendar data Id (required)
     * @param  \OpenAPI\Client\Model\CalendarDataSecurityRoleLinksInsertLinksParam $calendar_data_security_role_links_insert_links_param Parameter containing links which are added (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataSecurityRoleLinksInsertLinks'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarDataSecurityRoleLinksInsertLinksRequest($id, $calendar_data_security_role_links_insert_links_param, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksInsertLinks'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling calendarDataSecurityRoleLinksInsertLinks'
            );
        }

        // verify the required parameter 'calendar_data_security_role_links_insert_links_param' is set
        if ($calendar_data_security_role_links_insert_links_param === null || (is_array($calendar_data_security_role_links_insert_links_param) && count($calendar_data_security_role_links_insert_links_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $calendar_data_security_role_links_insert_links_param when calling calendarDataSecurityRoleLinksInsertLinks'
            );
        }
        ...
        // for model (json/xml)
        if (isset($calendar_data_security_role_links_insert_links_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($calendar_data_security_role_links_insert_links_param));
            } else {
                $httpBody = $calendar_data_security_role_links_insert_links_param;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation calendarDataSecurityRoleLinksSetLinks
     *
     * /api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks
     *
     * @param  string $id Calendar data Id (required)
     * @param  \OpenAPI\Client\Model\CalendarDataSecurityRoleLinksSetLinksParam $calendar_data_security_role_links_set_links_param Parameter containing links (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataSecurityRoleLinksSetLinks'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function calendarDataSecurityRoleLinksSetLinks($id, $calendar_data_security_role_links_set_links_param, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksSetLinks'][0])
    {
        $this->calendarDataSecurityRoleLinksSetLinksWithHttpInfo($id, $calendar_data_security_role_links_set_links_param, $contentType);
    }

    /**
     * Operation calendarDataSecurityRoleLinksSetLinksWithHttpInfo
     *
     * /api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks
     *
     * @param  string $id Calendar data Id (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarDataSecurityRoleLinksSetLinksWithHttpInfo($id, $calendar_data_security_role_links_set_links_param, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksSetLinks'][0])
    {
        $request = $this->calendarDataSecurityRoleLinksSetLinksRequest($id, $calendar_data_security_role_links_set_links_param, $contentType);
    ...
    /**
     * Operation calendarDataSecurityRoleLinksSetLinksAsync
     *
     * /api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks
     *
     * @param  string $id Calendar data Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataSecurityRoleLinksSetLinksAsync($id, $calendar_data_security_role_links_set_links_param, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksSetLinks'][0])
    {
        return $this->calendarDataSecurityRoleLinksSetLinksAsyncWithHttpInfo($id, $calendar_data_security_role_links_set_links_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarDataSecurityRoleLinksSetLinksAsyncWithHttpInfo
     *
     * /api/v2/CalendarDatas/{id}/CalendarDataSecurityRoleLinks
     *
     * @param  string $id Calendar data Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataSecurityRoleLinksSetLinksAsyncWithHttpInfo($id, $calendar_data_security_role_links_set_links_param, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksSetLinks'][0])
    {
        $returnType = '';
        $request = $this->calendarDataSecurityRoleLinksSetLinksRequest($id, $calendar_data_security_role_links_set_links_param, $contentType);
    ...
    /**
     * Create request for operation 'calendarDataSecurityRoleLinksSetLinks'
     *
     * @param  string $id Calendar data Id (required)
     * @param  \OpenAPI\Client\Model\CalendarDataSecurityRoleLinksSetLinksParam $calendar_data_security_role_links_set_links_param Parameter containing links (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataSecurityRoleLinksSetLinks'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarDataSecurityRoleLinksSetLinksRequest($id, $calendar_data_security_role_links_set_links_param, string $contentType = self::contentTypes['calendarDataSecurityRoleLinksSetLinks'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling calendarDataSecurityRoleLinksSetLinks'
            );
        }

        // verify the required parameter 'calendar_data_security_role_links_set_links_param' is set
        if ($calendar_data_security_role_links_set_links_param === null || (is_array($calendar_data_security_role_links_set_links_param) && count($calendar_data_security_role_links_set_links_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $calendar_data_security_role_links_set_links_param when calling calendarDataSecurityRoleLinksSetLinks'
            );
        }
        ...
        // for model (json/xml)
        if (isset($calendar_data_security_role_links_set_links_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($calendar_data_security_role_links_set_links_param));
            } else {
                $httpBody = $calendar_data_security_role_links_set_links_param;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
