...
/**
 * NetworkModuleDeviceRelaysApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class NetworkModuleDeviceRelaysApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation networkModuleDeviceRelaysGetById
     *
     * /api/v2/NetworkModuleDeviceRelays/{id}
     *
     * @param  string $id network module device relay id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['networkModuleDeviceRelaysGetById'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\NetworkModuleDeviceRelay
     */
    public function networkModuleDeviceRelaysGetById($id, string $contentType = self::contentTypes['networkModuleDeviceRelaysGetById'][0])
    {
        list($response) = $this->networkModuleDeviceRelaysGetByIdWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation networkModuleDeviceRelaysGetByIdWithHttpInfo
     *
     * /api/v2/NetworkModuleDeviceRelays/{id}
     *
     * @param  string $id network module device relay id (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\NetworkModuleDeviceRelay, HTTP status code, HTTP response headers (array of strings)
     */
    public function networkModuleDeviceRelaysGetByIdWithHttpInfo($id, string $contentType = self::contentTypes['networkModuleDeviceRelaysGetById'][0])
    {
        $request = $this->networkModuleDeviceRelaysGetByIdRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\NetworkModuleDeviceRelay' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\NetworkModuleDeviceRelay' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\NetworkModuleDeviceRelay', []),
            ...
            $returnType = '\OpenAPI\Client\Model\NetworkModuleDeviceRelay';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\NetworkModuleDeviceRelay',
    ...
    /**
     * Operation networkModuleDeviceRelaysGetByIdAsync
     *
     * /api/v2/NetworkModuleDeviceRelays/{id}
     *
     * @param  string $id network module device relay id (required)
     ...
     */
    public function networkModuleDeviceRelaysGetByIdAsync($id, string $contentType = self::contentTypes['networkModuleDeviceRelaysGetById'][0])
    {
        return $this->networkModuleDeviceRelaysGetByIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation networkModuleDeviceRelaysGetByIdAsyncWithHttpInfo
     *
     * /api/v2/NetworkModuleDeviceRelays/{id}
     *
     * @param  string $id network module device relay id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function networkModuleDeviceRelaysGetByIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['networkModuleDeviceRelaysGetById'][0])
    {
        $returnType = '\OpenAPI\Client\Model\NetworkModuleDeviceRelay';
        $request = $this->networkModuleDeviceRelaysGetByIdRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'networkModuleDeviceRelaysGetById'
     *
     * @param  string $id network module device relay id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['networkModuleDeviceRelaysGetById'] to see the possible values for this operation
     *
     ...
     */
    public function networkModuleDeviceRelaysGetByIdRequest($id, string $contentType = self::contentTypes['networkModuleDeviceRelaysGetById'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling networkModuleDeviceRelaysGetById'
            );
        }


        $resourcePath = '/api/v2/NetworkModuleDeviceRelays/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation networkModuleDeviceRelaysGetByNetworkModuleDeviceId
     *
     * /api/v2/NetworkModuleDevices/{id}/NetworkModuleDeviceRelays
     *
     * @param  string $id Network module device id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['networkModuleDeviceRelaysGetByNetworkModuleDeviceId'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\NetworkModuleDeviceRelay[]
     */
    public function networkModuleDeviceRelaysGetByNetworkModuleDeviceId($id, string $contentType = self::contentTypes['networkModuleDeviceRelaysGetByNetworkModuleDeviceId'][0])
    {
        list($response) = $this->networkModuleDeviceRelaysGetByNetworkModuleDeviceIdWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation networkModuleDeviceRelaysGetByNetworkModuleDeviceIdWithHttpInfo
     *
     * /api/v2/NetworkModuleDevices/{id}/NetworkModuleDeviceRelays
     *
     * @param  string $id Network module device id (required)
     ...
     * @return array of \OpenAPI\Client\Model\NetworkModuleDeviceRelay[], HTTP status code, HTTP response headers (array of strings)
     */
    public function networkModuleDeviceRelaysGetByNetworkModuleDeviceIdWithHttpInfo($id, string $contentType = self::contentTypes['networkModuleDeviceRelaysGetByNetworkModuleDeviceId'][0])
    {
        $request = $this->networkModuleDeviceRelaysGetByNetworkModuleDeviceIdRequest($id, $contentType);
    ...
    /**
     * Operation networkModuleDeviceRelaysGetByNetworkModuleDeviceIdAsync
     *
     * /api/v2/NetworkModuleDevices/{id}/NetworkModuleDeviceRelays
     *
     * @param  string $id Network module device id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function networkModuleDeviceRelaysGetByNetworkModuleDeviceIdAsync($id, string $contentType = self::contentTypes['networkModuleDeviceRelaysGetByNetworkModuleDeviceId'][0])
    {
        return $this->networkModuleDeviceRelaysGetByNetworkModuleDeviceIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation networkModuleDeviceRelaysGetByNetworkModuleDeviceIdAsyncWithHttpInfo
     *
     * /api/v2/NetworkModuleDevices/{id}/NetworkModuleDeviceRelays
     *
     * @param  string $id Network module device id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function networkModuleDeviceRelaysGetByNetworkModuleDeviceIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['networkModuleDeviceRelaysGetByNetworkModuleDeviceId'][0])
    {
        $returnType = '\OpenAPI\Client\Model\NetworkModuleDeviceRelay[]';
        $request = $this->networkModuleDeviceRelaysGetByNetworkModuleDeviceIdRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'networkModuleDeviceRelaysGetByNetworkModuleDeviceId'
     *
     * @param  string $id Network module device id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['networkModuleDeviceRelaysGetByNetworkModuleDeviceId'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function networkModuleDeviceRelaysGetByNetworkModuleDeviceIdRequest($id, string $contentType = self::contentTypes['networkModuleDeviceRelaysGetByNetworkModuleDeviceId'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling networkModuleDeviceRelaysGetByNetworkModuleDeviceId'
            );
        }


        $resourcePath = '/api/v2/NetworkModuleDevices/{id}/NetworkModuleDeviceRelays';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation networkModuleDeviceRelaysGetByNetworkModuleId
     *
     * /api/v2/NetworkModules/{id}/NetworkModuleDeviceRelays
     *
     * @param  string $id Network module id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['networkModuleDeviceRelaysGetByNetworkModuleId'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\NetworkModuleDeviceRelay[]
     */
    public function networkModuleDeviceRelaysGetByNetworkModuleId($id, string $contentType = self::contentTypes['networkModuleDeviceRelaysGetByNetworkModuleId'][0])
    {
        list($response) = $this->networkModuleDeviceRelaysGetByNetworkModuleIdWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation networkModuleDeviceRelaysGetByNetworkModuleIdWithHttpInfo
     *
     * /api/v2/NetworkModules/{id}/NetworkModuleDeviceRelays
     *
     * @param  string $id Network module id (required)
     ...
     * @return array of \OpenAPI\Client\Model\NetworkModuleDeviceRelay[], HTTP status code, HTTP response headers (array of strings)
     */
    public function networkModuleDeviceRelaysGetByNetworkModuleIdWithHttpInfo($id, string $contentType = self::contentTypes['networkModuleDeviceRelaysGetByNetworkModuleId'][0])
    {
        $request = $this->networkModuleDeviceRelaysGetByNetworkModuleIdRequest($id, $contentType);
    ...
    /**
     * Operation networkModuleDeviceRelaysGetByNetworkModuleIdAsync
     *
     * /api/v2/NetworkModules/{id}/NetworkModuleDeviceRelays
     *
     * @param  string $id Network module id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function networkModuleDeviceRelaysGetByNetworkModuleIdAsync($id, string $contentType = self::contentTypes['networkModuleDeviceRelaysGetByNetworkModuleId'][0])
    {
        return $this->networkModuleDeviceRelaysGetByNetworkModuleIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation networkModuleDeviceRelaysGetByNetworkModuleIdAsyncWithHttpInfo
     *
     * /api/v2/NetworkModules/{id}/NetworkModuleDeviceRelays
     *
     * @param  string $id Network module id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function networkModuleDeviceRelaysGetByNetworkModuleIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['networkModuleDeviceRelaysGetByNetworkModuleId'][0])
    {
        $returnType = '\OpenAPI\Client\Model\NetworkModuleDeviceRelay[]';
        $request = $this->networkModuleDeviceRelaysGetByNetworkModuleIdRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'networkModuleDeviceRelaysGetByNetworkModuleId'
     *
     * @param  string $id Network module id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['networkModuleDeviceRelaysGetByNetworkModuleId'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function networkModuleDeviceRelaysGetByNetworkModuleIdRequest($id, string $contentType = self::contentTypes['networkModuleDeviceRelaysGetByNetworkModuleId'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling networkModuleDeviceRelaysGetByNetworkModuleId'
            );
        }


        $resourcePath = '/api/v2/NetworkModules/{id}/NetworkModuleDeviceRelays';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
