...
/**
 * CalendarDataTitlesApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class CalendarDataTitlesApi
{
    ...
    /**
     * Operation calendarDataTitlesDelete
     *
     * /api/v2/CalendarDataTitles/{id}
     *
     * @param  string $id Calendar id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataTitlesDelete'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function calendarDataTitlesDelete($id, string $contentType = self::contentTypes['calendarDataTitlesDelete'][0])
    {
        $this->calendarDataTitlesDeleteWithHttpInfo($id, $contentType);
    }

    /**
     * Operation calendarDataTitlesDeleteWithHttpInfo
     *
     * /api/v2/CalendarDataTitles/{id}
     *
     * @param  string $id Calendar id (required)
     ...
     */
    public function calendarDataTitlesDeleteWithHttpInfo($id, string $contentType = self::contentTypes['calendarDataTitlesDelete'][0])
    {
        $request = $this->calendarDataTitlesDeleteRequest($id, $contentType);
    ...
    /**
     * Operation calendarDataTitlesDeleteAsync
     *
     * /api/v2/CalendarDataTitles/{id}
     *
     * @param  string $id Calendar id (required)
     ...
     */
    public function calendarDataTitlesDeleteAsync($id, string $contentType = self::contentTypes['calendarDataTitlesDelete'][0])
    {
        return $this->calendarDataTitlesDeleteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarDataTitlesDeleteAsyncWithHttpInfo
     *
     * /api/v2/CalendarDataTitles/{id}
     *
     * @param  string $id Calendar id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataTitlesDeleteAsyncWithHttpInfo($id, string $contentType = self::contentTypes['calendarDataTitlesDelete'][0])
    {
        $returnType = '';
        $request = $this->calendarDataTitlesDeleteRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'calendarDataTitlesDelete'
     *
     * @param  string $id Calendar id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataTitlesDelete'] to see the possible values for this operation
     *
     ...
     */
    public function calendarDataTitlesDeleteRequest($id, string $contentType = self::contentTypes['calendarDataTitlesDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling calendarDataTitlesDelete'
            );
        }


        $resourcePath = '/api/v2/CalendarDataTitles/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation calendarDataTitlesGetAll
     *
     * /api/v2/CalendarDataTitles
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataTitlesGetAll'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CalendarDataTitle[]
     */
    public function calendarDataTitlesGetAll(string $contentType = self::contentTypes['calendarDataTitlesGetAll'][0])
    {
        list($response) = $this->calendarDataTitlesGetAllWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation calendarDataTitlesGetAllWithHttpInfo
     *
     * /api/v2/CalendarDataTitles
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataTitlesGetAll'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CalendarDataTitle[], HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarDataTitlesGetAllWithHttpInfo(string $contentType = self::contentTypes['calendarDataTitlesGetAll'][0])
    {
        $request = $this->calendarDataTitlesGetAllRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CalendarDataTitle[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CalendarDataTitle[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CalendarDataTitle[]', []),
            ...
            $returnType = '\OpenAPI\Client\Model\CalendarDataTitle[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CalendarDataTitle[]',
    ...
    /**
     * Operation calendarDataTitlesGetAllAsync
     *
     * /api/v2/CalendarDataTitles
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataTitlesGetAll'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataTitlesGetAllAsync(string $contentType = self::contentTypes['calendarDataTitlesGetAll'][0])
    {
        return $this->calendarDataTitlesGetAllAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarDataTitlesGetAllAsyncWithHttpInfo
     *
     * /api/v2/CalendarDataTitles
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataTitlesGetAll'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataTitlesGetAllAsyncWithHttpInfo(string $contentType = self::contentTypes['calendarDataTitlesGetAll'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CalendarDataTitle[]';
        $request = $this->calendarDataTitlesGetAllRequest($contentType);
    ...
    /**
     * Create request for operation 'calendarDataTitlesGetAll'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataTitlesGetAll'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarDataTitlesGetAllRequest(string $contentType = self::contentTypes['calendarDataTitlesGetAll'][0])
    {


        $resourcePath = '/api/v2/CalendarDataTitles';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation calendarDataTitlesGetById
     *
     * /api/v2/CalendarDataTitles/{id}
     *
     * @param  string $id Calendar data title id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataTitlesGetById'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CalendarDataTitle
     */
    public function calendarDataTitlesGetById($id, string $contentType = self::contentTypes['calendarDataTitlesGetById'][0])
    {
        list($response) = $this->calendarDataTitlesGetByIdWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation calendarDataTitlesGetByIdWithHttpInfo
     *
     * /api/v2/CalendarDataTitles/{id}
     *
     * @param  string $id Calendar data title id (required)
     ...
     * @return array of \OpenAPI\Client\Model\CalendarDataTitle, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarDataTitlesGetByIdWithHttpInfo($id, string $contentType = self::contentTypes['calendarDataTitlesGetById'][0])
    {
        $request = $this->calendarDataTitlesGetByIdRequest($id, $contentType);
    ...
    /**
     * Operation calendarDataTitlesGetByIdAsync
     *
     * /api/v2/CalendarDataTitles/{id}
     *
     * @param  string $id Calendar data title id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataTitlesGetByIdAsync($id, string $contentType = self::contentTypes['calendarDataTitlesGetById'][0])
    {
        return $this->calendarDataTitlesGetByIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarDataTitlesGetByIdAsyncWithHttpInfo
     *
     * /api/v2/CalendarDataTitles/{id}
     *
     * @param  string $id Calendar data title id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataTitlesGetByIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['calendarDataTitlesGetById'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CalendarDataTitle';
        $request = $this->calendarDataTitlesGetByIdRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'calendarDataTitlesGetById'
     *
     * @param  string $id Calendar data title id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataTitlesGetById'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarDataTitlesGetByIdRequest($id, string $contentType = self::contentTypes['calendarDataTitlesGetById'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling calendarDataTitlesGetById'
            );
        }
    ...
    /**
     * Operation calendarDataTitlesInsert
     *
     * /api/v2/CalendarDataTitles
     *
     * @param  \OpenAPI\Client\Model\CalendarDataTitleInsert $calendar_data_title_insert Calendar to insert (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataTitlesInsert'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function calendarDataTitlesInsert($calendar_data_title_insert, string $contentType = self::contentTypes['calendarDataTitlesInsert'][0])
    {
        $this->calendarDataTitlesInsertWithHttpInfo($calendar_data_title_insert, $contentType);
    }

    /**
     * Operation calendarDataTitlesInsertWithHttpInfo
     *
     * /api/v2/CalendarDataTitles
     *
     * @param  \OpenAPI\Client\Model\CalendarDataTitleInsert $calendar_data_title_insert Calendar to insert (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarDataTitlesInsertWithHttpInfo($calendar_data_title_insert, string $contentType = self::contentTypes['calendarDataTitlesInsert'][0])
    {
        $request = $this->calendarDataTitlesInsertRequest($calendar_data_title_insert, $contentType);
    ...
    /**
     * Operation calendarDataTitlesInsertAsync
     *
     * /api/v2/CalendarDataTitles
     *
     * @param  \OpenAPI\Client\Model\CalendarDataTitleInsert $calendar_data_title_insert Calendar to insert (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataTitlesInsertAsync($calendar_data_title_insert, string $contentType = self::contentTypes['calendarDataTitlesInsert'][0])
    {
        return $this->calendarDataTitlesInsertAsyncWithHttpInfo($calendar_data_title_insert, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarDataTitlesInsertAsyncWithHttpInfo
     *
     * /api/v2/CalendarDataTitles
     *
     * @param  \OpenAPI\Client\Model\CalendarDataTitleInsert $calendar_data_title_insert Calendar to insert (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataTitlesInsertAsyncWithHttpInfo($calendar_data_title_insert, string $contentType = self::contentTypes['calendarDataTitlesInsert'][0])
    {
        $returnType = '';
        $request = $this->calendarDataTitlesInsertRequest($calendar_data_title_insert, $contentType);
    ...
    /**
     * Create request for operation 'calendarDataTitlesInsert'
     *
     * @param  \OpenAPI\Client\Model\CalendarDataTitleInsert $calendar_data_title_insert Calendar to insert (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataTitlesInsert'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarDataTitlesInsertRequest($calendar_data_title_insert, string $contentType = self::contentTypes['calendarDataTitlesInsert'][0])
    {

        // verify the required parameter 'calendar_data_title_insert' is set
        if ($calendar_data_title_insert === null || (is_array($calendar_data_title_insert) && count($calendar_data_title_insert) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $calendar_data_title_insert when calling calendarDataTitlesInsert'
            );
        }
        ...
        // for model (json/xml)
        if (isset($calendar_data_title_insert)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($calendar_data_title_insert));
            } else {
                $httpBody = $calendar_data_title_insert;
            }
    ...
    /**
     * Operation calendarDataTitlesUpdate
     *
     * /api/v2/CalendarDataTitles
     *
     * @param  \OpenAPI\Client\Model\CalendarDataTitleUpdate $calendar_data_title_update Calendar to update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataTitlesUpdate'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function calendarDataTitlesUpdate($calendar_data_title_update, string $contentType = self::contentTypes['calendarDataTitlesUpdate'][0])
    {
        $this->calendarDataTitlesUpdateWithHttpInfo($calendar_data_title_update, $contentType);
    }

    /**
     * Operation calendarDataTitlesUpdateWithHttpInfo
     *
     * /api/v2/CalendarDataTitles
     *
     * @param  \OpenAPI\Client\Model\CalendarDataTitleUpdate $calendar_data_title_update Calendar to update (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarDataTitlesUpdateWithHttpInfo($calendar_data_title_update, string $contentType = self::contentTypes['calendarDataTitlesUpdate'][0])
    {
        $request = $this->calendarDataTitlesUpdateRequest($calendar_data_title_update, $contentType);
    ...
    /**
     * Operation calendarDataTitlesUpdateAsync
     *
     * /api/v2/CalendarDataTitles
     *
     * @param  \OpenAPI\Client\Model\CalendarDataTitleUpdate $calendar_data_title_update Calendar to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataTitlesUpdateAsync($calendar_data_title_update, string $contentType = self::contentTypes['calendarDataTitlesUpdate'][0])
    {
        return $this->calendarDataTitlesUpdateAsyncWithHttpInfo($calendar_data_title_update, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarDataTitlesUpdateAsyncWithHttpInfo
     *
     * /api/v2/CalendarDataTitles
     *
     * @param  \OpenAPI\Client\Model\CalendarDataTitleUpdate $calendar_data_title_update Calendar to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDataTitlesUpdateAsyncWithHttpInfo($calendar_data_title_update, string $contentType = self::contentTypes['calendarDataTitlesUpdate'][0])
    {
        $returnType = '';
        $request = $this->calendarDataTitlesUpdateRequest($calendar_data_title_update, $contentType);
    ...
    /**
     * Create request for operation 'calendarDataTitlesUpdate'
     *
     * @param  \OpenAPI\Client\Model\CalendarDataTitleUpdate $calendar_data_title_update Calendar to update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDataTitlesUpdate'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarDataTitlesUpdateRequest($calendar_data_title_update, string $contentType = self::contentTypes['calendarDataTitlesUpdate'][0])
    {

        // verify the required parameter 'calendar_data_title_update' is set
        if ($calendar_data_title_update === null || (is_array($calendar_data_title_update) && count($calendar_data_title_update) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $calendar_data_title_update when calling calendarDataTitlesUpdate'
            );
        }
        ...
        // for model (json/xml)
        if (isset($calendar_data_title_update)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($calendar_data_title_update));
            } else {
                $httpBody = $calendar_data_title_update;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
