<?php
/**
 * CalendarNetworkModuleRelayLinksApi
 * PHP version 7.4
 *
 * @category Class
...
/**
 * CalendarNetworkModuleRelayLinksApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class CalendarNetworkModuleRelayLinksApi
{
    /**
     * @var ClientInterface
     */
    ...
    /**
     * Operation calendarNetworkModuleRelayLinksGetLinksByCalendarId
     *
     * /api/v2/CalendarDataTitles/{id}/CalendarNetworkModuleDeviceRelayLinks
     *
     * @param  string $id Calendar id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarNetworkModuleRelayLinksGetLinksByCalendarId'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CalendarNetworkModuleRelayLink[]
     */
    public function calendarNetworkModuleRelayLinksGetLinksByCalendarId($id, string $contentType = self::contentTypes['calendarNetworkModuleRelayLinksGetLinksByCalendarId'][0])
    {
        list($response) = $this->calendarNetworkModuleRelayLinksGetLinksByCalendarIdWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation calendarNetworkModuleRelayLinksGetLinksByCalendarIdWithHttpInfo
     *
     * /api/v2/CalendarDataTitles/{id}/CalendarNetworkModuleDeviceRelayLinks
     *
     * @param  string $id Calendar id (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CalendarNetworkModuleRelayLink[], HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarNetworkModuleRelayLinksGetLinksByCalendarIdWithHttpInfo($id, string $contentType = self::contentTypes['calendarNetworkModuleRelayLinksGetLinksByCalendarId'][0])
    {
        $request = $this->calendarNetworkModuleRelayLinksGetLinksByCalendarIdRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CalendarNetworkModuleRelayLink[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CalendarNetworkModuleRelayLink[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CalendarNetworkModuleRelayLink[]', []),
            ...
            $returnType = '\OpenAPI\Client\Model\CalendarNetworkModuleRelayLink[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CalendarNetworkModuleRelayLink[]',
    ...
    /**
     * Operation calendarNetworkModuleRelayLinksGetLinksByCalendarIdAsync
     *
     * /api/v2/CalendarDataTitles/{id}/CalendarNetworkModuleDeviceRelayLinks
     *
     * @param  string $id Calendar id (required)
     ...
     */
    public function calendarNetworkModuleRelayLinksGetLinksByCalendarIdAsync($id, string $contentType = self::contentTypes['calendarNetworkModuleRelayLinksGetLinksByCalendarId'][0])
    {
        return $this->calendarNetworkModuleRelayLinksGetLinksByCalendarIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarNetworkModuleRelayLinksGetLinksByCalendarIdAsyncWithHttpInfo
     *
     * /api/v2/CalendarDataTitles/{id}/CalendarNetworkModuleDeviceRelayLinks
     *
     * @param  string $id Calendar id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarNetworkModuleRelayLinksGetLinksByCalendarIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['calendarNetworkModuleRelayLinksGetLinksByCalendarId'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CalendarNetworkModuleRelayLink[]';
        $request = $this->calendarNetworkModuleRelayLinksGetLinksByCalendarIdRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'calendarNetworkModuleRelayLinksGetLinksByCalendarId'
     *
     * @param  string $id Calendar id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarNetworkModuleRelayLinksGetLinksByCalendarId'] to see the possible values for this operation
     *
     ...
     */
    public function calendarNetworkModuleRelayLinksGetLinksByCalendarIdRequest($id, string $contentType = self::contentTypes['calendarNetworkModuleRelayLinksGetLinksByCalendarId'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling calendarNetworkModuleRelayLinksGetLinksByCalendarId'
            );
        }


        $resourcePath = '/api/v2/CalendarDataTitles/{id}/CalendarNetworkModuleDeviceRelayLinks';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayId
     *
     * /api/v2/NetworkModuleDeviceRelays/{id}/CalendarNetworkModuleDeviceRelayLinks
     *
     * @param  string $id Network module device relay id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayId'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CalendarNetworkModuleRelayLink[]
     */
    public function calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayId($id, string $contentType = self::contentTypes['calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayId'][0])
    {
        list($response) = $this->calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayIdWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayIdWithHttpInfo
     *
     * /api/v2/NetworkModuleDeviceRelays/{id}/CalendarNetworkModuleDeviceRelayLinks
     *
     * @param  string $id Network module device relay id (required)
     ...
     * @return array of \OpenAPI\Client\Model\CalendarNetworkModuleRelayLink[], HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayIdWithHttpInfo($id, string $contentType = self::contentTypes['calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayId'][0])
    {
        $request = $this->calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayIdRequest($id, $contentType);
    ...
    /**
     * Operation calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayIdAsync
     *
     * /api/v2/NetworkModuleDeviceRelays/{id}/CalendarNetworkModuleDeviceRelayLinks
     *
     * @param  string $id Network module device relay id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayIdAsync($id, string $contentType = self::contentTypes['calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayId'][0])
    {
        return $this->calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayIdAsyncWithHttpInfo
     *
     * /api/v2/NetworkModuleDeviceRelays/{id}/CalendarNetworkModuleDeviceRelayLinks
     *
     * @param  string $id Network module device relay id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayId'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CalendarNetworkModuleRelayLink[]';
        $request = $this->calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayIdRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayId'
     *
     * @param  string $id Network module device relay id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayId'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayIdRequest($id, string $contentType = self::contentTypes['calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayId'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling calendarNetworkModuleRelayLinksGetLinksByNetworkModuleRelayId'
            );
        }


        $resourcePath = '/api/v2/NetworkModuleDeviceRelays/{id}/CalendarNetworkModuleDeviceRelayLinks';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation calendarNetworkModuleRelayLinksSetLinks
     *
     * /api/v2/CalendarDataTitles/{id}/CalendarNetworkModuleDeviceRelayLinks
     *
     * @param  string $id id (required)
     * @param  \OpenAPI\Client\Model\CalendarNetworkModuleDeviceRelayLinksSetLinksParam $calendar_network_module_device_relay_links_set_links_param Parameter containing links (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarNetworkModuleRelayLinksSetLinks'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function calendarNetworkModuleRelayLinksSetLinks($id, $calendar_network_module_device_relay_links_set_links_param, string $contentType = self::contentTypes['calendarNetworkModuleRelayLinksSetLinks'][0])
    {
        $this->calendarNetworkModuleRelayLinksSetLinksWithHttpInfo($id, $calendar_network_module_device_relay_links_set_links_param, $contentType);
    }

    /**
     * Operation calendarNetworkModuleRelayLinksSetLinksWithHttpInfo
     *
     * /api/v2/CalendarDataTitles/{id}/CalendarNetworkModuleDeviceRelayLinks
     *
     ...
     */
    public function calendarNetworkModuleRelayLinksSetLinksWithHttpInfo($id, $calendar_network_module_device_relay_links_set_links_param, string $contentType = self::contentTypes['calendarNetworkModuleRelayLinksSetLinks'][0])
    {
        $request = $this->calendarNetworkModuleRelayLinksSetLinksRequest($id, $calendar_network_module_device_relay_links_set_links_param, $contentType);
    ...
    /**
     * Operation calendarNetworkModuleRelayLinksSetLinksAsync
     *
     * /api/v2/CalendarDataTitles/{id}/CalendarNetworkModuleDeviceRelayLinks
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarNetworkModuleRelayLinksSetLinksAsync($id, $calendar_network_module_device_relay_links_set_links_param, string $contentType = self::contentTypes['calendarNetworkModuleRelayLinksSetLinks'][0])
    {
        return $this->calendarNetworkModuleRelayLinksSetLinksAsyncWithHttpInfo($id, $calendar_network_module_device_relay_links_set_links_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarNetworkModuleRelayLinksSetLinksAsyncWithHttpInfo
     *
     * /api/v2/CalendarDataTitles/{id}/CalendarNetworkModuleDeviceRelayLinks
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarNetworkModuleRelayLinksSetLinksAsyncWithHttpInfo($id, $calendar_network_module_device_relay_links_set_links_param, string $contentType = self::contentTypes['calendarNetworkModuleRelayLinksSetLinks'][0])
    {
        $returnType = '';
        $request = $this->calendarNetworkModuleRelayLinksSetLinksRequest($id, $calendar_network_module_device_relay_links_set_links_param, $contentType);
    ...
    /**
     * Create request for operation 'calendarNetworkModuleRelayLinksSetLinks'
     *
     * @param  string $id (required)
     * @param  \OpenAPI\Client\Model\CalendarNetworkModuleDeviceRelayLinksSetLinksParam $calendar_network_module_device_relay_links_set_links_param Parameter containing links (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarNetworkModuleRelayLinksSetLinks'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarNetworkModuleRelayLinksSetLinksRequest($id, $calendar_network_module_device_relay_links_set_links_param, string $contentType = self::contentTypes['calendarNetworkModuleRelayLinksSetLinks'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling calendarNetworkModuleRelayLinksSetLinks'
            );
        }

        // verify the required parameter 'calendar_network_module_device_relay_links_set_links_param' is set
        if ($calendar_network_module_device_relay_links_set_links_param === null || (is_array($calendar_network_module_device_relay_links_set_links_param) && count($calendar_network_module_device_relay_links_set_links_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $calendar_network_module_device_relay_links_set_links_param when calling calendarNetworkModuleRelayLinksSetLinks'
            );
        }
        ...
        // for model (json/xml)
        if (isset($calendar_network_module_device_relay_links_set_links_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($calendar_network_module_device_relay_links_set_links_param));
            } else {
                $httpBody = $calendar_network_module_device_relay_links_set_links_param;
            }
