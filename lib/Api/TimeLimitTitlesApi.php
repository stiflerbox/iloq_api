...
/**
 * TimeLimitTitlesApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class TimeLimitTitlesApi
{
    ...
    /**
     * Operation timeLimitTitlesCanDelete
     *
     * /api/v2/TimeLimitTitles/{id}/CanDelete
     *
     * @param  string $id TimeLimitTitle Id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitTitlesCanDelete'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CanDeleteTimeLimitTitleResult
     */
    public function timeLimitTitlesCanDelete($id, string $contentType = self::contentTypes['timeLimitTitlesCanDelete'][0])
    {
        list($response) = $this->timeLimitTitlesCanDeleteWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation timeLimitTitlesCanDeleteWithHttpInfo
     *
     * /api/v2/TimeLimitTitles/{id}/CanDelete
     *
     * @param  string $id TimeLimitTitle Id (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CanDeleteTimeLimitTitleResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function timeLimitTitlesCanDeleteWithHttpInfo($id, string $contentType = self::contentTypes['timeLimitTitlesCanDelete'][0])
    {
        $request = $this->timeLimitTitlesCanDeleteRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CanDeleteTimeLimitTitleResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CanDeleteTimeLimitTitleResult' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CanDeleteTimeLimitTitleResult', []),
            ...
            $returnType = '\OpenAPI\Client\Model\CanDeleteTimeLimitTitleResult';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CanDeleteTimeLimitTitleResult',
    ...
    /**
     * Operation timeLimitTitlesCanDeleteAsync
     *
     * /api/v2/TimeLimitTitles/{id}/CanDelete
     *
     * @param  string $id TimeLimitTitle Id (required)
     ...
     */
    public function timeLimitTitlesCanDeleteAsync($id, string $contentType = self::contentTypes['timeLimitTitlesCanDelete'][0])
    {
        return $this->timeLimitTitlesCanDeleteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation timeLimitTitlesCanDeleteAsyncWithHttpInfo
     *
     * /api/v2/TimeLimitTitles/{id}/CanDelete
     *
     * @param  string $id TimeLimitTitle Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeLimitTitlesCanDeleteAsyncWithHttpInfo($id, string $contentType = self::contentTypes['timeLimitTitlesCanDelete'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CanDeleteTimeLimitTitleResult';
        $request = $this->timeLimitTitlesCanDeleteRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'timeLimitTitlesCanDelete'
     *
     * @param  string $id TimeLimitTitle Id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitTitlesCanDelete'] to see the possible values for this operation
     *
     ...
     */
    public function timeLimitTitlesCanDeleteRequest($id, string $contentType = self::contentTypes['timeLimitTitlesCanDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling timeLimitTitlesCanDelete'
            );
        }


        $resourcePath = '/api/v2/TimeLimitTitles/{id}/CanDelete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation timeLimitTitlesDelete
     *
     * /api/v2/TimeLimitTitles/{id}
     *
     * @param  string $id Time limit title id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitTitlesDelete'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function timeLimitTitlesDelete($id, string $contentType = self::contentTypes['timeLimitTitlesDelete'][0])
    {
        $this->timeLimitTitlesDeleteWithHttpInfo($id, $contentType);
    }

    /**
     * Operation timeLimitTitlesDeleteWithHttpInfo
     *
     * /api/v2/TimeLimitTitles/{id}
     *
     * @param  string $id Time limit title id (required)
     ...
     */
    public function timeLimitTitlesDeleteWithHttpInfo($id, string $contentType = self::contentTypes['timeLimitTitlesDelete'][0])
    {
        $request = $this->timeLimitTitlesDeleteRequest($id, $contentType);
    ...
    /**
     * Operation timeLimitTitlesDeleteAsync
     *
     * /api/v2/TimeLimitTitles/{id}
     *
     * @param  string $id Time limit title id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeLimitTitlesDeleteAsync($id, string $contentType = self::contentTypes['timeLimitTitlesDelete'][0])
    {
        return $this->timeLimitTitlesDeleteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation timeLimitTitlesDeleteAsyncWithHttpInfo
     *
     * /api/v2/TimeLimitTitles/{id}
     *
     * @param  string $id Time limit title id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeLimitTitlesDeleteAsyncWithHttpInfo($id, string $contentType = self::contentTypes['timeLimitTitlesDelete'][0])
    {
        $returnType = '';
        $request = $this->timeLimitTitlesDeleteRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'timeLimitTitlesDelete'
     *
     * @param  string $id Time limit title id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitTitlesDelete'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function timeLimitTitlesDeleteRequest($id, string $contentType = self::contentTypes['timeLimitTitlesDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling timeLimitTitlesDelete'
            );
        }


        $resourcePath = '/api/v2/TimeLimitTitles/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation timeLimitTitlesGetAll
     *
     * /api/v2/TimeLimitTitles
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitTitlesGetAll'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\TimeLimitTitle[]
     */
    public function timeLimitTitlesGetAll(string $contentType = self::contentTypes['timeLimitTitlesGetAll'][0])
    {
        list($response) = $this->timeLimitTitlesGetAllWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation timeLimitTitlesGetAllWithHttpInfo
     *
     * /api/v2/TimeLimitTitles
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitTitlesGetAll'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\TimeLimitTitle[], HTTP status code, HTTP response headers (array of strings)
     */
    public function timeLimitTitlesGetAllWithHttpInfo(string $contentType = self::contentTypes['timeLimitTitlesGetAll'][0])
    {
        $request = $this->timeLimitTitlesGetAllRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\TimeLimitTitle[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\TimeLimitTitle[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\TimeLimitTitle[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\TimeLimitTitle[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\TimeLimitTitle[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation timeLimitTitlesGetAllAsync
     *
     * /api/v2/TimeLimitTitles
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitTitlesGetAll'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeLimitTitlesGetAllAsync(string $contentType = self::contentTypes['timeLimitTitlesGetAll'][0])
    {
        return $this->timeLimitTitlesGetAllAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation timeLimitTitlesGetAllAsyncWithHttpInfo
     *
     * /api/v2/TimeLimitTitles
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitTitlesGetAll'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeLimitTitlesGetAllAsyncWithHttpInfo(string $contentType = self::contentTypes['timeLimitTitlesGetAll'][0])
    {
        $returnType = '\OpenAPI\Client\Model\TimeLimitTitle[]';
        $request = $this->timeLimitTitlesGetAllRequest($contentType);
    ...
    /**
     * Create request for operation 'timeLimitTitlesGetAll'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitTitlesGetAll'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function timeLimitTitlesGetAllRequest(string $contentType = self::contentTypes['timeLimitTitlesGetAll'][0])
    {


        $resourcePath = '/api/v2/TimeLimitTitles';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation timeLimitTitlesGetById
     *
     * /api/v2/TimeLimitTitles/{id}
     *
     * @param  string $id Time limit title id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitTitlesGetById'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\TimeLimitTitle
     */
    public function timeLimitTitlesGetById($id, string $contentType = self::contentTypes['timeLimitTitlesGetById'][0])
    {
        list($response) = $this->timeLimitTitlesGetByIdWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation timeLimitTitlesGetByIdWithHttpInfo
     *
     * /api/v2/TimeLimitTitles/{id}
     *
     * @param  string $id Time limit title id (required)
     ...
     * @return array of \OpenAPI\Client\Model\TimeLimitTitle, HTTP status code, HTTP response headers (array of strings)
     */
    public function timeLimitTitlesGetByIdWithHttpInfo($id, string $contentType = self::contentTypes['timeLimitTitlesGetById'][0])
    {
        $request = $this->timeLimitTitlesGetByIdRequest($id, $contentType);
    ...
    /**
     * Operation timeLimitTitlesGetByIdAsync
     *
     * /api/v2/TimeLimitTitles/{id}
     *
     * @param  string $id Time limit title id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeLimitTitlesGetByIdAsync($id, string $contentType = self::contentTypes['timeLimitTitlesGetById'][0])
    {
        return $this->timeLimitTitlesGetByIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation timeLimitTitlesGetByIdAsyncWithHttpInfo
     *
     * /api/v2/TimeLimitTitles/{id}
     *
     * @param  string $id Time limit title id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeLimitTitlesGetByIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['timeLimitTitlesGetById'][0])
    {
        $returnType = '\OpenAPI\Client\Model\TimeLimitTitle';
        $request = $this->timeLimitTitlesGetByIdRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'timeLimitTitlesGetById'
     *
     * @param  string $id Time limit title id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitTitlesGetById'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function timeLimitTitlesGetByIdRequest($id, string $contentType = self::contentTypes['timeLimitTitlesGetById'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling timeLimitTitlesGetById'
            );
        }
    ...
    /**
     * Operation timeLimitTitlesInsert
     *
     * /api/v2/TimeLimitTitles
     *
     * @param  \OpenAPI\Client\Model\InsertTimeLimitTitlesParam $insert_time_limit_titles_param Time limit title and data to insert (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitTitlesInsert'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function timeLimitTitlesInsert($insert_time_limit_titles_param, string $contentType = self::contentTypes['timeLimitTitlesInsert'][0])
    {
        $this->timeLimitTitlesInsertWithHttpInfo($insert_time_limit_titles_param, $contentType);
    }

    /**
     * Operation timeLimitTitlesInsertWithHttpInfo
     *
     * /api/v2/TimeLimitTitles
     *
     * @param  \OpenAPI\Client\Model\InsertTimeLimitTitlesParam $insert_time_limit_titles_param Time limit title and data to insert (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function timeLimitTitlesInsertWithHttpInfo($insert_time_limit_titles_param, string $contentType = self::contentTypes['timeLimitTitlesInsert'][0])
    {
        $request = $this->timeLimitTitlesInsertRequest($insert_time_limit_titles_param, $contentType);
    ...
    /**
     * Operation timeLimitTitlesInsertAsync
     *
     * /api/v2/TimeLimitTitles
     *
     * @param  \OpenAPI\Client\Model\InsertTimeLimitTitlesParam $insert_time_limit_titles_param Time limit title and data to insert (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeLimitTitlesInsertAsync($insert_time_limit_titles_param, string $contentType = self::contentTypes['timeLimitTitlesInsert'][0])
    {
        return $this->timeLimitTitlesInsertAsyncWithHttpInfo($insert_time_limit_titles_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation timeLimitTitlesInsertAsyncWithHttpInfo
     *
     * /api/v2/TimeLimitTitles
     *
     * @param  \OpenAPI\Client\Model\InsertTimeLimitTitlesParam $insert_time_limit_titles_param Time limit title and data to insert (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeLimitTitlesInsertAsyncWithHttpInfo($insert_time_limit_titles_param, string $contentType = self::contentTypes['timeLimitTitlesInsert'][0])
    {
        $returnType = '';
        $request = $this->timeLimitTitlesInsertRequest($insert_time_limit_titles_param, $contentType);
    ...
    /**
     * Create request for operation 'timeLimitTitlesInsert'
     *
     * @param  \OpenAPI\Client\Model\InsertTimeLimitTitlesParam $insert_time_limit_titles_param Time limit title and data to insert (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitTitlesInsert'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function timeLimitTitlesInsertRequest($insert_time_limit_titles_param, string $contentType = self::contentTypes['timeLimitTitlesInsert'][0])
    {

        // verify the required parameter 'insert_time_limit_titles_param' is set
        if ($insert_time_limit_titles_param === null || (is_array($insert_time_limit_titles_param) && count($insert_time_limit_titles_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $insert_time_limit_titles_param when calling timeLimitTitlesInsert'
            );
        }
        ...
        // for model (json/xml)
        if (isset($insert_time_limit_titles_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($insert_time_limit_titles_param));
            } else {
                $httpBody = $insert_time_limit_titles_param;
            }
    ...
    /**
     * Operation timeLimitTitlesUpdate
     *
     * /api/v2/TimeLimitTitles
     *
     * @param  \OpenAPI\Client\Model\UpdateTimeLimitTitlesParam $update_time_limit_titles_param Time limit title to update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitTitlesUpdate'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function timeLimitTitlesUpdate($update_time_limit_titles_param, string $contentType = self::contentTypes['timeLimitTitlesUpdate'][0])
    {
        $this->timeLimitTitlesUpdateWithHttpInfo($update_time_limit_titles_param, $contentType);
    }

    /**
     * Operation timeLimitTitlesUpdateWithHttpInfo
     *
     * /api/v2/TimeLimitTitles
     *
     * @param  \OpenAPI\Client\Model\UpdateTimeLimitTitlesParam $update_time_limit_titles_param Time limit title to update (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function timeLimitTitlesUpdateWithHttpInfo($update_time_limit_titles_param, string $contentType = self::contentTypes['timeLimitTitlesUpdate'][0])
    {
        $request = $this->timeLimitTitlesUpdateRequest($update_time_limit_titles_param, $contentType);
    ...
    /**
     * Operation timeLimitTitlesUpdateAsync
     *
     * /api/v2/TimeLimitTitles
     *
     * @param  \OpenAPI\Client\Model\UpdateTimeLimitTitlesParam $update_time_limit_titles_param Time limit title to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeLimitTitlesUpdateAsync($update_time_limit_titles_param, string $contentType = self::contentTypes['timeLimitTitlesUpdate'][0])
    {
        return $this->timeLimitTitlesUpdateAsyncWithHttpInfo($update_time_limit_titles_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation timeLimitTitlesUpdateAsyncWithHttpInfo
     *
     * /api/v2/TimeLimitTitles
     *
     * @param  \OpenAPI\Client\Model\UpdateTimeLimitTitlesParam $update_time_limit_titles_param Time limit title to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function timeLimitTitlesUpdateAsyncWithHttpInfo($update_time_limit_titles_param, string $contentType = self::contentTypes['timeLimitTitlesUpdate'][0])
    {
        $returnType = '';
        $request = $this->timeLimitTitlesUpdateRequest($update_time_limit_titles_param, $contentType);
    ...
    /**
     * Create request for operation 'timeLimitTitlesUpdate'
     *
     * @param  \OpenAPI\Client\Model\UpdateTimeLimitTitlesParam $update_time_limit_titles_param Time limit title to update (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['timeLimitTitlesUpdate'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function timeLimitTitlesUpdateRequest($update_time_limit_titles_param, string $contentType = self::contentTypes['timeLimitTitlesUpdate'][0])
    {

        // verify the required parameter 'update_time_limit_titles_param' is set
        if ($update_time_limit_titles_param === null || (is_array($update_time_limit_titles_param) && count($update_time_limit_titles_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_time_limit_titles_param when calling timeLimitTitlesUpdate'
            );
        }
        ...
        // for model (json/xml)
        if (isset($update_time_limit_titles_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_time_limit_titles_param));
            } else {
                $httpBody = $update_time_limit_titles_param;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
