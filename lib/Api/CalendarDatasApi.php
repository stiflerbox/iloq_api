...
/**
 * CalendarDatasApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class CalendarDatasApi
{
    ...
    /**
     * Operation calendarDatasDelete
     *
     * /api/v2/CalendarDatas/{id}
     *
     * @param  string $id Calendar data id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDatasDelete'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function calendarDatasDelete($id, string $contentType = self::contentTypes['calendarDatasDelete'][0])
    {
        $this->calendarDatasDeleteWithHttpInfo($id, $contentType);
    }

    /**
     * Operation calendarDatasDeleteWithHttpInfo
     *
     * /api/v2/CalendarDatas/{id}
     *
     * @param  string $id Calendar data id (required)
     ...
     */
    public function calendarDatasDeleteWithHttpInfo($id, string $contentType = self::contentTypes['calendarDatasDelete'][0])
    {
        $request = $this->calendarDatasDeleteRequest($id, $contentType);
    ...
    /**
     * Operation calendarDatasDeleteAsync
     *
     * /api/v2/CalendarDatas/{id}
     *
     * @param  string $id Calendar data id (required)
     ...
     */
    public function calendarDatasDeleteAsync($id, string $contentType = self::contentTypes['calendarDatasDelete'][0])
    {
        return $this->calendarDatasDeleteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarDatasDeleteAsyncWithHttpInfo
     *
     * /api/v2/CalendarDatas/{id}
     *
     * @param  string $id Calendar data id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDatasDeleteAsyncWithHttpInfo($id, string $contentType = self::contentTypes['calendarDatasDelete'][0])
    {
        $returnType = '';
        $request = $this->calendarDatasDeleteRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'calendarDatasDelete'
     *
     * @param  string $id Calendar data id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDatasDelete'] to see the possible values for this operation
     *
     ...
     */
    public function calendarDatasDeleteRequest($id, string $contentType = self::contentTypes['calendarDatasDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling calendarDatasDelete'
            );
        }


        $resourcePath = '/api/v2/CalendarDatas/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation calendarDatasGetByCalendarDataId
     *
     * /api/v2/CalendarDatas/{id}
     *
     * @param  string $id Calendar data id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDatasGetByCalendarDataId'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResult
     */
    public function calendarDatasGetByCalendarDataId($id, string $contentType = self::contentTypes['calendarDatasGetByCalendarDataId'][0])
    {
        list($response) = $this->calendarDatasGetByCalendarDataIdWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation calendarDatasGetByCalendarDataIdWithHttpInfo
     *
     * /api/v2/CalendarDatas/{id}
     *
     * @param  string $id Calendar data id (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarDatasGetByCalendarDataIdWithHttpInfo($id, string $contentType = self::contentTypes['calendarDatasGetByCalendarDataId'][0])
    {
        $request = $this->calendarDatasGetByCalendarDataIdRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResult' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResult', []),
            ...
            $returnType = '\OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResult';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResult',
    ...
    /**
     * Operation calendarDatasGetByCalendarDataIdAsync
     *
     * /api/v2/CalendarDatas/{id}
     *
     * @param  string $id Calendar data id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDatasGetByCalendarDataIdAsync($id, string $contentType = self::contentTypes['calendarDatasGetByCalendarDataId'][0])
    {
        return $this->calendarDatasGetByCalendarDataIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarDatasGetByCalendarDataIdAsyncWithHttpInfo
     *
     * /api/v2/CalendarDatas/{id}
     *
     * @param  string $id Calendar data id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDatasGetByCalendarDataIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['calendarDatasGetByCalendarDataId'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResult';
        $request = $this->calendarDatasGetByCalendarDataIdRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'calendarDatasGetByCalendarDataId'
     *
     * @param  string $id Calendar data id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDatasGetByCalendarDataId'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarDatasGetByCalendarDataIdRequest($id, string $contentType = self::contentTypes['calendarDatasGetByCalendarDataId'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling calendarDatasGetByCalendarDataId'
            );
        }
    ...
    /**
     * Operation calendarDatasGetByCalendarId
     *
     * /api/v2/CalendarDataTitles/{id}/CalendarDatas
     *
     * @param  string $id Calendar id (required)
     * @param  \DateTime $start_date Start date to filter result set (optional)
     * @param  \DateTime $end_date End date to filter result set (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDatasGetByCalendarId'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CalendarDataGetByCalendarIdResult
     */
    public function calendarDatasGetByCalendarId($id, $start_date = null, $end_date = null, string $contentType = self::contentTypes['calendarDatasGetByCalendarId'][0])
    {
        list($response) = $this->calendarDatasGetByCalendarIdWithHttpInfo($id, $start_date, $end_date, $contentType);
        return $response;
    }

    /**
     * Operation calendarDatasGetByCalendarIdWithHttpInfo
     *
     * /api/v2/CalendarDataTitles/{id}/CalendarDatas
     *
     * @param  string $id Calendar id (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CalendarDataGetByCalendarIdResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarDatasGetByCalendarIdWithHttpInfo($id, $start_date = null, $end_date = null, string $contentType = self::contentTypes['calendarDatasGetByCalendarId'][0])
    {
        $request = $this->calendarDatasGetByCalendarIdRequest($id, $start_date, $end_date, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CalendarDataGetByCalendarIdResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CalendarDataGetByCalendarIdResult' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CalendarDataGetByCalendarIdResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\CalendarDataGetByCalendarIdResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CalendarDataGetByCalendarIdResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation calendarDatasGetByCalendarIdAsync
     *
     * /api/v2/CalendarDataTitles/{id}/CalendarDatas
     *
     * @param  string $id Calendar id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDatasGetByCalendarIdAsync($id, $start_date = null, $end_date = null, string $contentType = self::contentTypes['calendarDatasGetByCalendarId'][0])
    {
        return $this->calendarDatasGetByCalendarIdAsyncWithHttpInfo($id, $start_date, $end_date, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarDatasGetByCalendarIdAsyncWithHttpInfo
     *
     * /api/v2/CalendarDataTitles/{id}/CalendarDatas
     *
     * @param  string $id Calendar id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDatasGetByCalendarIdAsyncWithHttpInfo($id, $start_date = null, $end_date = null, string $contentType = self::contentTypes['calendarDatasGetByCalendarId'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CalendarDataGetByCalendarIdResult';
        $request = $this->calendarDatasGetByCalendarIdRequest($id, $start_date, $end_date, $contentType);
    ...
    /**
     * Create request for operation 'calendarDatasGetByCalendarId'
     *
     * @param  string $id Calendar id (required)
     * @param  \DateTime $start_date Start date to filter result set (optional)
     * @param  \DateTime $end_date End date to filter result set (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarDatasGetByCalendarIdRequest($id, $start_date = null, $end_date = null, string $contentType = self::contentTypes['calendarDatasGetByCalendarId'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling calendarDatasGetByCalendarId'
            );
        }
        ...
        $resourcePath = '/api/v2/CalendarDataTitles/{id}/CalendarDatas';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation calendarDatasInsert
     *
     * /api/v2/CalendarDatas
     *
     * @param  \OpenAPI\Client\Model\CalendarDataInsertParam $calendar_data_insert_param Insert data (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDatasInsert'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function calendarDatasInsert($calendar_data_insert_param, string $contentType = self::contentTypes['calendarDatasInsert'][0])
    {
        $this->calendarDatasInsertWithHttpInfo($calendar_data_insert_param, $contentType);
    }

    /**
     * Operation calendarDatasInsertWithHttpInfo
     *
     * /api/v2/CalendarDatas
     *
     * @param  \OpenAPI\Client\Model\CalendarDataInsertParam $calendar_data_insert_param Insert data (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarDatasInsertWithHttpInfo($calendar_data_insert_param, string $contentType = self::contentTypes['calendarDatasInsert'][0])
    {
        $request = $this->calendarDatasInsertRequest($calendar_data_insert_param, $contentType);
    ...
    /**
     * Operation calendarDatasInsertAsync
     *
     * /api/v2/CalendarDatas
     *
     * @param  \OpenAPI\Client\Model\CalendarDataInsertParam $calendar_data_insert_param Insert data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDatasInsertAsync($calendar_data_insert_param, string $contentType = self::contentTypes['calendarDatasInsert'][0])
    {
        return $this->calendarDatasInsertAsyncWithHttpInfo($calendar_data_insert_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarDatasInsertAsyncWithHttpInfo
     *
     * /api/v2/CalendarDatas
     *
     * @param  \OpenAPI\Client\Model\CalendarDataInsertParam $calendar_data_insert_param Insert data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDatasInsertAsyncWithHttpInfo($calendar_data_insert_param, string $contentType = self::contentTypes['calendarDatasInsert'][0])
    {
        $returnType = '';
        $request = $this->calendarDatasInsertRequest($calendar_data_insert_param, $contentType);
    ...
    /**
     * Create request for operation 'calendarDatasInsert'
     *
     * @param  \OpenAPI\Client\Model\CalendarDataInsertParam $calendar_data_insert_param Insert data (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDatasInsert'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarDatasInsertRequest($calendar_data_insert_param, string $contentType = self::contentTypes['calendarDatasInsert'][0])
    {

        // verify the required parameter 'calendar_data_insert_param' is set
        if ($calendar_data_insert_param === null || (is_array($calendar_data_insert_param) && count($calendar_data_insert_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $calendar_data_insert_param when calling calendarDatasInsert'
            );
        }


        $resourcePath = '/api/v2/CalendarDatas';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($calendar_data_insert_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($calendar_data_insert_param));
            } else {
                $httpBody = $calendar_data_insert_param;
            }
    ...
    /**
     * Operation calendarDatasUpdate
     *
     * /api/v2/CalendarDatas
     *
     * @param  \OpenAPI\Client\Model\CalendarDataUpdateParam $calendar_data_update_param Update data (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDatasUpdate'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function calendarDatasUpdate($calendar_data_update_param, string $contentType = self::contentTypes['calendarDatasUpdate'][0])
    {
        $this->calendarDatasUpdateWithHttpInfo($calendar_data_update_param, $contentType);
    }

    /**
     * Operation calendarDatasUpdateWithHttpInfo
     *
     * /api/v2/CalendarDatas
     *
     * @param  \OpenAPI\Client\Model\CalendarDataUpdateParam $calendar_data_update_param Update data (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function calendarDatasUpdateWithHttpInfo($calendar_data_update_param, string $contentType = self::contentTypes['calendarDatasUpdate'][0])
    {
        $request = $this->calendarDatasUpdateRequest($calendar_data_update_param, $contentType);
    ...
    /**
     * Operation calendarDatasUpdateAsync
     *
     * /api/v2/CalendarDatas
     *
     * @param  \OpenAPI\Client\Model\CalendarDataUpdateParam $calendar_data_update_param Update data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDatasUpdateAsync($calendar_data_update_param, string $contentType = self::contentTypes['calendarDatasUpdate'][0])
    {
        return $this->calendarDatasUpdateAsyncWithHttpInfo($calendar_data_update_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation calendarDatasUpdateAsyncWithHttpInfo
     *
     * /api/v2/CalendarDatas
     *
     * @param  \OpenAPI\Client\Model\CalendarDataUpdateParam $calendar_data_update_param Update data (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function calendarDatasUpdateAsyncWithHttpInfo($calendar_data_update_param, string $contentType = self::contentTypes['calendarDatasUpdate'][0])
    {
        $returnType = '';
        $request = $this->calendarDatasUpdateRequest($calendar_data_update_param, $contentType);
    ...
    /**
     * Create request for operation 'calendarDatasUpdate'
     *
     * @param  \OpenAPI\Client\Model\CalendarDataUpdateParam $calendar_data_update_param Update data (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['calendarDatasUpdate'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function calendarDatasUpdateRequest($calendar_data_update_param, string $contentType = self::contentTypes['calendarDatasUpdate'][0])
    {

        // verify the required parameter 'calendar_data_update_param' is set
        if ($calendar_data_update_param === null || (is_array($calendar_data_update_param) && count($calendar_data_update_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $calendar_data_update_param when calling calendarDatasUpdate'
            );
        }
        ...
        // for model (json/xml)
        if (isset($calendar_data_update_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($calendar_data_update_param));
            } else {
                $httpBody = $calendar_data_update_param;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
