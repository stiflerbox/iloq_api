...
class LockLogsApi
{
    ...
    /**
     * Operation lockLogsGetLockLogDataByGoingDates
     *
     * /api/v2/LockLogs/GetLockLogDataByGoingDates
     *
     * @param  \OpenAPI\Client\Model\GetLockLogDataParam $get_lock_log_data_param Parameter containing start and end dates (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockLogsGetLockLogDataByGoingDates'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetLockLogDataResult
     */
    public function lockLogsGetLockLogDataByGoingDates($get_lock_log_data_param, string $contentType = self::contentTypes['lockLogsGetLockLogDataByGoingDates'][0])
    {
        list($response) = $this->lockLogsGetLockLogDataByGoingDatesWithHttpInfo($get_lock_log_data_param, $contentType);
        return $response;
    }

    /**
     * Operation lockLogsGetLockLogDataByGoingDatesWithHttpInfo
     *
     * /api/v2/LockLogs/GetLockLogDataByGoingDates
     *
     * @param  \OpenAPI\Client\Model\GetLockLogDataParam $get_lock_log_data_param Parameter containing start and end dates (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GetLockLogDataResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function lockLogsGetLockLogDataByGoingDatesWithHttpInfo($get_lock_log_data_param, string $contentType = self::contentTypes['lockLogsGetLockLogDataByGoingDates'][0])
    {
        $request = $this->lockLogsGetLockLogDataByGoingDatesRequest($get_lock_log_data_param, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetLockLogDataResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GetLockLogDataResult' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetLockLogDataResult', []),
            ...
            $returnType = '\OpenAPI\Client\Model\GetLockLogDataResult';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetLockLogDataResult',
    ...
    /**
     * Operation lockLogsGetLockLogDataByGoingDatesAsync
     *
     * /api/v2/LockLogs/GetLockLogDataByGoingDates
     *
     * @param  \OpenAPI\Client\Model\GetLockLogDataParam $get_lock_log_data_param Parameter containing start and end dates (required)
     ...
     */
    public function lockLogsGetLockLogDataByGoingDatesAsync($get_lock_log_data_param, string $contentType = self::contentTypes['lockLogsGetLockLogDataByGoingDates'][0])
    {
        return $this->lockLogsGetLockLogDataByGoingDatesAsyncWithHttpInfo($get_lock_log_data_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation lockLogsGetLockLogDataByGoingDatesAsyncWithHttpInfo
     *
     * /api/v2/LockLogs/GetLockLogDataByGoingDates
     *
     * @param  \OpenAPI\Client\Model\GetLockLogDataParam $get_lock_log_data_param Parameter containing start and end dates (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lockLogsGetLockLogDataByGoingDatesAsyncWithHttpInfo($get_lock_log_data_param, string $contentType = self::contentTypes['lockLogsGetLockLogDataByGoingDates'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetLockLogDataResult';
        $request = $this->lockLogsGetLockLogDataByGoingDatesRequest($get_lock_log_data_param, $contentType);
    ...
    /**
     * Create request for operation 'lockLogsGetLockLogDataByGoingDates'
     *
     * @param  \OpenAPI\Client\Model\GetLockLogDataParam $get_lock_log_data_param Parameter containing start and end dates (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockLogsGetLockLogDataByGoingDates'] to see the possible values for this operation
     *
     ...
     */
    public function lockLogsGetLockLogDataByGoingDatesRequest($get_lock_log_data_param, string $contentType = self::contentTypes['lockLogsGetLockLogDataByGoingDates'][0])
    {

        // verify the required parameter 'get_lock_log_data_param' is set
        if ($get_lock_log_data_param === null || (is_array($get_lock_log_data_param) && count($get_lock_log_data_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $get_lock_log_data_param when calling lockLogsGetLockLogDataByGoingDates'
            );
        }


        $resourcePath = '/api/v2/LockLogs/GetLockLogDataByGoingDates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($get_lock_log_data_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($get_lock_log_data_param));
            } else {
                $httpBody = $get_lock_log_data_param;
            }
    ...
    /**
     * Operation lockLogsGetLockLogDataByTimestamp
     *
     * /api/v2/LockLogs/GetLockLogDataByTimestamp
     *
     * @param  \OpenAPI\Client\Model\GetLockLogDataParam $get_lock_log_data_param Parameter containing start and end dates (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockLogsGetLockLogDataByTimestamp'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetLockLogDataResult
     */
    public function lockLogsGetLockLogDataByTimestamp($get_lock_log_data_param, string $contentType = self::contentTypes['lockLogsGetLockLogDataByTimestamp'][0])
    {
        list($response) = $this->lockLogsGetLockLogDataByTimestampWithHttpInfo($get_lock_log_data_param, $contentType);
        return $response;
    }

    /**
     * Operation lockLogsGetLockLogDataByTimestampWithHttpInfo
     *
     * /api/v2/LockLogs/GetLockLogDataByTimestamp
     *
     * @param  \OpenAPI\Client\Model\GetLockLogDataParam $get_lock_log_data_param Parameter containing start and end dates (required)
     ...
     * @return array of \OpenAPI\Client\Model\GetLockLogDataResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function lockLogsGetLockLogDataByTimestampWithHttpInfo($get_lock_log_data_param, string $contentType = self::contentTypes['lockLogsGetLockLogDataByTimestamp'][0])
    {
        $request = $this->lockLogsGetLockLogDataByTimestampRequest($get_lock_log_data_param, $contentType);
    ...
    /**
     * Operation lockLogsGetLockLogDataByTimestampAsync
     *
     * /api/v2/LockLogs/GetLockLogDataByTimestamp
     *
     * @param  \OpenAPI\Client\Model\GetLockLogDataParam $get_lock_log_data_param Parameter containing start and end dates (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lockLogsGetLockLogDataByTimestampAsync($get_lock_log_data_param, string $contentType = self::contentTypes['lockLogsGetLockLogDataByTimestamp'][0])
    {
        return $this->lockLogsGetLockLogDataByTimestampAsyncWithHttpInfo($get_lock_log_data_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation lockLogsGetLockLogDataByTimestampAsyncWithHttpInfo
     *
     * /api/v2/LockLogs/GetLockLogDataByTimestamp
     *
     * @param  \OpenAPI\Client\Model\GetLockLogDataParam $get_lock_log_data_param Parameter containing start and end dates (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lockLogsGetLockLogDataByTimestampAsyncWithHttpInfo($get_lock_log_data_param, string $contentType = self::contentTypes['lockLogsGetLockLogDataByTimestamp'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetLockLogDataResult';
        $request = $this->lockLogsGetLockLogDataByTimestampRequest($get_lock_log_data_param, $contentType);
    ...
    /**
     * Create request for operation 'lockLogsGetLockLogDataByTimestamp'
     *
     * @param  \OpenAPI\Client\Model\GetLockLogDataParam $get_lock_log_data_param Parameter containing start and end dates (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockLogsGetLockLogDataByTimestamp'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function lockLogsGetLockLogDataByTimestampRequest($get_lock_log_data_param, string $contentType = self::contentTypes['lockLogsGetLockLogDataByTimestamp'][0])
    {

        // verify the required parameter 'get_lock_log_data_param' is set
        if ($get_lock_log_data_param === null || (is_array($get_lock_log_data_param) && count($get_lock_log_data_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $get_lock_log_data_param when calling lockLogsGetLockLogDataByTimestamp'
            );
        }


        $resourcePath = '/api/v2/LockLogs/GetLockLogDataByTimestamp';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation lockLogsGetLockLogs
     *
     * /api/v2/LockLogs
     *
     * @param  \OpenAPI\Client\Model\GetLockLogsParam $get_lock_logs_param get_lock_logs_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockLogsGetLockLogs'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetLockLogsResult
     */
    public function lockLogsGetLockLogs($get_lock_logs_param, string $contentType = self::contentTypes['lockLogsGetLockLogs'][0])
    {
        list($response) = $this->lockLogsGetLockLogsWithHttpInfo($get_lock_logs_param, $contentType);
        return $response;
    }

    /**
     * Operation lockLogsGetLockLogsWithHttpInfo
     *
     * /api/v2/LockLogs
     *
     * @param  \OpenAPI\Client\Model\GetLockLogsParam $get_lock_logs_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockLogsGetLockLogs'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GetLockLogsResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function lockLogsGetLockLogsWithHttpInfo($get_lock_logs_param, string $contentType = self::contentTypes['lockLogsGetLockLogs'][0])
    {
        $request = $this->lockLogsGetLockLogsRequest($get_lock_logs_param, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetLockLogsResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GetLockLogsResult' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetLockLogsResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\GetLockLogsResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetLockLogsResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation lockLogsGetLockLogsAsync
     *
     * /api/v2/LockLogs
     *
     * @param  \OpenAPI\Client\Model\GetLockLogsParam $get_lock_logs_param (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lockLogsGetLockLogsAsync($get_lock_logs_param, string $contentType = self::contentTypes['lockLogsGetLockLogs'][0])
    {
        return $this->lockLogsGetLockLogsAsyncWithHttpInfo($get_lock_logs_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation lockLogsGetLockLogsAsyncWithHttpInfo
     *
     * /api/v2/LockLogs
     *
     * @param  \OpenAPI\Client\Model\GetLockLogsParam $get_lock_logs_param (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function lockLogsGetLockLogsAsyncWithHttpInfo($get_lock_logs_param, string $contentType = self::contentTypes['lockLogsGetLockLogs'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetLockLogsResult';
        $request = $this->lockLogsGetLockLogsRequest($get_lock_logs_param, $contentType);
    ...
    /**
     * Create request for operation 'lockLogsGetLockLogs'
     *
     * @param  \OpenAPI\Client\Model\GetLockLogsParam $get_lock_logs_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['lockLogsGetLockLogs'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function lockLogsGetLockLogsRequest($get_lock_logs_param, string $contentType = self::contentTypes['lockLogsGetLockLogs'][0])
    {

        // verify the required parameter 'get_lock_logs_param' is set
        if ($get_lock_logs_param === null || (is_array($get_lock_logs_param) && count($get_lock_logs_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $get_lock_logs_param when calling lockLogsGetLockLogs'
            );
        }


        $resourcePath = '/api/v2/LockLogs';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($get_lock_logs_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($get_lock_logs_param));
            } else {
                $httpBody = $get_lock_logs_param;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
