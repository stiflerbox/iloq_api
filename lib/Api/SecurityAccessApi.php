...
/**
 * SecurityAccessApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class SecurityAccessApi
{
    ...
    /**
     * Operation securityAccessDelete
     *
     * /api/v2/SecurityAccesses/{id}
     *
     * @param  string $id Security access ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityAccessDelete'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function securityAccessDelete($id, string $contentType = self::contentTypes['securityAccessDelete'][0])
    {
        $this->securityAccessDeleteWithHttpInfo($id, $contentType);
    }

    /**
     * Operation securityAccessDeleteWithHttpInfo
     *
     * /api/v2/SecurityAccesses/{id}
     *
     * @param  string $id Security access ID (required)
     ...
     */
    public function securityAccessDeleteWithHttpInfo($id, string $contentType = self::contentTypes['securityAccessDelete'][0])
    {
        $request = $this->securityAccessDeleteRequest($id, $contentType);
    ...
    /**
     * Operation securityAccessDeleteAsync
     *
     * /api/v2/SecurityAccesses/{id}
     *
     * @param  string $id Security access ID (required)
     ...
     */
    public function securityAccessDeleteAsync($id, string $contentType = self::contentTypes['securityAccessDelete'][0])
    {
        return $this->securityAccessDeleteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation securityAccessDeleteAsyncWithHttpInfo
     *
     * /api/v2/SecurityAccesses/{id}
     *
     * @param  string $id Security access ID (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityAccessDeleteAsyncWithHttpInfo($id, string $contentType = self::contentTypes['securityAccessDelete'][0])
    {
        $returnType = '';
        $request = $this->securityAccessDeleteRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'securityAccessDelete'
     *
     * @param  string $id Security access ID (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityAccessDelete'] to see the possible values for this operation
     *
     ...
     */
    public function securityAccessDeleteRequest($id, string $contentType = self::contentTypes['securityAccessDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling securityAccessDelete'
            );
        }


        $resourcePath = '/api/v2/SecurityAccesses/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation securityAccessGetAllSecurityAccesses
     *
     * /api/v2/SecurityAccesses
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityAccessGetAllSecurityAccesses'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SecurityAccess[]
     */
    public function securityAccessGetAllSecurityAccesses(string $contentType = self::contentTypes['securityAccessGetAllSecurityAccesses'][0])
    {
        list($response) = $this->securityAccessGetAllSecurityAccessesWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation securityAccessGetAllSecurityAccessesWithHttpInfo
     *
     * /api/v2/SecurityAccesses
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityAccessGetAllSecurityAccesses'] to see the possible values for this operation
     ...
     */
    public function securityAccessGetAllSecurityAccessesWithHttpInfo(string $contentType = self::contentTypes['securityAccessGetAllSecurityAccesses'][0])
    {
        $request = $this->securityAccessGetAllSecurityAccessesRequest($contentType);
    ...
    /**
     * Operation securityAccessGetAllSecurityAccessesAsync
     *
     * /api/v2/SecurityAccesses
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityAccessGetAllSecurityAccesses'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityAccessGetAllSecurityAccessesAsync(string $contentType = self::contentTypes['securityAccessGetAllSecurityAccesses'][0])
    {
        return $this->securityAccessGetAllSecurityAccessesAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation securityAccessGetAllSecurityAccessesAsyncWithHttpInfo
     *
     * /api/v2/SecurityAccesses
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityAccessGetAllSecurityAccesses'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityAccessGetAllSecurityAccessesAsyncWithHttpInfo(string $contentType = self::contentTypes['securityAccessGetAllSecurityAccesses'][0])
    {
        $returnType = '\OpenAPI\Client\Model\SecurityAccess[]';
        $request = $this->securityAccessGetAllSecurityAccessesRequest($contentType);
    ...
    /**
     * Create request for operation 'securityAccessGetAllSecurityAccesses'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityAccessGetAllSecurityAccesses'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function securityAccessGetAllSecurityAccessesRequest(string $contentType = self::contentTypes['securityAccessGetAllSecurityAccesses'][0])
    {


        $resourcePath = '/api/v2/SecurityAccesses';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation securityAccessInsert
     *
     * /api/v2/SecurityAccesses
     *
     * @param  \OpenAPI\Client\Model\InsertSecurityAccessParam $insert_security_access_param Parameter (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityAccessInsert'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InsertSecurityAccessResult
     */
    public function securityAccessInsert($insert_security_access_param, string $contentType = self::contentTypes['securityAccessInsert'][0])
    {
        list($response) = $this->securityAccessInsertWithHttpInfo($insert_security_access_param, $contentType);
        return $response;
    }

    /**
     * Operation securityAccessInsertWithHttpInfo
     *
     * /api/v2/SecurityAccesses
     *
     * @param  \OpenAPI\Client\Model\InsertSecurityAccessParam $insert_security_access_param Parameter (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\InsertSecurityAccessResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function securityAccessInsertWithHttpInfo($insert_security_access_param, string $contentType = self::contentTypes['securityAccessInsert'][0])
    {
        $request = $this->securityAccessInsertRequest($insert_security_access_param, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\InsertSecurityAccessResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InsertSecurityAccessResult' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\InsertSecurityAccessResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\InsertSecurityAccessResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\InsertSecurityAccessResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation securityAccessInsertAsync
     *
     * /api/v2/SecurityAccesses
     *
     * @param  \OpenAPI\Client\Model\InsertSecurityAccessParam $insert_security_access_param Parameter (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityAccessInsertAsync($insert_security_access_param, string $contentType = self::contentTypes['securityAccessInsert'][0])
    {
        return $this->securityAccessInsertAsyncWithHttpInfo($insert_security_access_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation securityAccessInsertAsyncWithHttpInfo
     *
     * /api/v2/SecurityAccesses
     *
     * @param  \OpenAPI\Client\Model\InsertSecurityAccessParam $insert_security_access_param Parameter (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityAccessInsertAsyncWithHttpInfo($insert_security_access_param, string $contentType = self::contentTypes['securityAccessInsert'][0])
    {
        $returnType = '\OpenAPI\Client\Model\InsertSecurityAccessResult';
        $request = $this->securityAccessInsertRequest($insert_security_access_param, $contentType);
    ...
    /**
     * Create request for operation 'securityAccessInsert'
     *
     * @param  \OpenAPI\Client\Model\InsertSecurityAccessParam $insert_security_access_param Parameter (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityAccessInsert'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function securityAccessInsertRequest($insert_security_access_param, string $contentType = self::contentTypes['securityAccessInsert'][0])
    {

        // verify the required parameter 'insert_security_access_param' is set
        if ($insert_security_access_param === null || (is_array($insert_security_access_param) && count($insert_security_access_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $insert_security_access_param when calling securityAccessInsert'
            );
        }
        ...
        // for model (json/xml)
        if (isset($insert_security_access_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($insert_security_access_param));
            } else {
                $httpBody = $insert_security_access_param;
            }
    ...
    /**
     * Operation securityAccessUpdate
     *
     * /api/v2/SecurityAccesses
     *
     * @param  \OpenAPI\Client\Model\UpdateSecurityAccessParam $update_security_access_param Parameter (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityAccessUpdate'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function securityAccessUpdate($update_security_access_param, string $contentType = self::contentTypes['securityAccessUpdate'][0])
    {
        $this->securityAccessUpdateWithHttpInfo($update_security_access_param, $contentType);
    }

    /**
     * Operation securityAccessUpdateWithHttpInfo
     *
     * /api/v2/SecurityAccesses
     *
     * @param  \OpenAPI\Client\Model\UpdateSecurityAccessParam $update_security_access_param Parameter (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function securityAccessUpdateWithHttpInfo($update_security_access_param, string $contentType = self::contentTypes['securityAccessUpdate'][0])
    {
        $request = $this->securityAccessUpdateRequest($update_security_access_param, $contentType);
    ...
    /**
     * Operation securityAccessUpdateAsync
     *
     * /api/v2/SecurityAccesses
     *
     * @param  \OpenAPI\Client\Model\UpdateSecurityAccessParam $update_security_access_param Parameter (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityAccessUpdateAsync($update_security_access_param, string $contentType = self::contentTypes['securityAccessUpdate'][0])
    {
        return $this->securityAccessUpdateAsyncWithHttpInfo($update_security_access_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation securityAccessUpdateAsyncWithHttpInfo
     *
     * /api/v2/SecurityAccesses
     *
     * @param  \OpenAPI\Client\Model\UpdateSecurityAccessParam $update_security_access_param Parameter (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function securityAccessUpdateAsyncWithHttpInfo($update_security_access_param, string $contentType = self::contentTypes['securityAccessUpdate'][0])
    {
        $returnType = '';
        $request = $this->securityAccessUpdateRequest($update_security_access_param, $contentType);
    ...
    /**
     * Create request for operation 'securityAccessUpdate'
     *
     * @param  \OpenAPI\Client\Model\UpdateSecurityAccessParam $update_security_access_param Parameter (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['securityAccessUpdate'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function securityAccessUpdateRequest($update_security_access_param, string $contentType = self::contentTypes['securityAccessUpdate'][0])
    {

        // verify the required parameter 'update_security_access_param' is set
        if ($update_security_access_param === null || (is_array($update_security_access_param) && count($update_security_access_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_security_access_param when calling securityAccessUpdate'
            );
        }
        ...
        // for model (json/xml)
        if (isset($update_security_access_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_security_access_param));
            } else {
                $httpBody = $update_security_access_param;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
