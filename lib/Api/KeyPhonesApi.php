...
/**
 * KeyPhonesApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class KeyPhonesApi
{
    ...
    /**
     * Operation keyPhonesGetByKeyId
     *
     * /api/v2/Keys/{id}/KeyPhone
     *
     * @param  string $id Key Id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyPhonesGetByKeyId'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\KeyPhone
     */
    public function keyPhonesGetByKeyId($id, string $contentType = self::contentTypes['keyPhonesGetByKeyId'][0])
    {
        list($response) = $this->keyPhonesGetByKeyIdWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation keyPhonesGetByKeyIdWithHttpInfo
     *
     * /api/v2/Keys/{id}/KeyPhone
     *
     * @param  string $id Key Id (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\KeyPhone, HTTP status code, HTTP response headers (array of strings)
     */
    public function keyPhonesGetByKeyIdWithHttpInfo($id, string $contentType = self::contentTypes['keyPhonesGetByKeyId'][0])
    {
        $request = $this->keyPhonesGetByKeyIdRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\KeyPhone' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\KeyPhone' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\KeyPhone', []),
            ...
            $returnType = '\OpenAPI\Client\Model\KeyPhone';
    ...
    /**
     * Operation keyPhonesGetByKeyIdAsync
     *
     * /api/v2/Keys/{id}/KeyPhone
     *
     * @param  string $id Key Id (required)
     ...
     */
    public function keyPhonesGetByKeyIdAsync($id, string $contentType = self::contentTypes['keyPhonesGetByKeyId'][0])
    {
        return $this->keyPhonesGetByKeyIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation keyPhonesGetByKeyIdAsyncWithHttpInfo
     *
     * /api/v2/Keys/{id}/KeyPhone
     *
     * @param  string $id Key Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyPhonesGetByKeyIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['keyPhonesGetByKeyId'][0])
    {
        $returnType = '\OpenAPI\Client\Model\KeyPhone';
        $request = $this->keyPhonesGetByKeyIdRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'keyPhonesGetByKeyId'
     *
     * @param  string $id Key Id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyPhonesGetByKeyId'] to see the possible values for this operation
     *
     ...
     */
    public function keyPhonesGetByKeyIdRequest($id, string $contentType = self::contentTypes['keyPhonesGetByKeyId'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling keyPhonesGetByKeyId'
            );
        }


        $resourcePath = '/api/v2/Keys/{id}/KeyPhone';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation keyPhonesSendPhoneRegistration
     *
     * /api/v2/KeyPhones/{id}/ReRegister
     *
     * @param  string $id Key Id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyPhonesSendPhoneRegistration'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function keyPhonesSendPhoneRegistration($id, string $contentType = self::contentTypes['keyPhonesSendPhoneRegistration'][0])
    {
        $this->keyPhonesSendPhoneRegistrationWithHttpInfo($id, $contentType);
    }

    /**
     * Operation keyPhonesSendPhoneRegistrationWithHttpInfo
     *
     * /api/v2/KeyPhones/{id}/ReRegister
     *
     * @param  string $id Key Id (required)
     ...
     */
    public function keyPhonesSendPhoneRegistrationWithHttpInfo($id, string $contentType = self::contentTypes['keyPhonesSendPhoneRegistration'][0])
    {
        $request = $this->keyPhonesSendPhoneRegistrationRequest($id, $contentType);
    ...
    /**
     * Operation keyPhonesSendPhoneRegistrationAsync
     *
     * /api/v2/KeyPhones/{id}/ReRegister
     *
     * @param  string $id Key Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyPhonesSendPhoneRegistrationAsync($id, string $contentType = self::contentTypes['keyPhonesSendPhoneRegistration'][0])
    {
        return $this->keyPhonesSendPhoneRegistrationAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation keyPhonesSendPhoneRegistrationAsyncWithHttpInfo
     *
     * /api/v2/KeyPhones/{id}/ReRegister
     *
     * @param  string $id Key Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyPhonesSendPhoneRegistrationAsyncWithHttpInfo($id, string $contentType = self::contentTypes['keyPhonesSendPhoneRegistration'][0])
    {
        $returnType = '';
        $request = $this->keyPhonesSendPhoneRegistrationRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'keyPhonesSendPhoneRegistration'
     *
     * @param  string $id Key Id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyPhonesSendPhoneRegistration'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function keyPhonesSendPhoneRegistrationRequest($id, string $contentType = self::contentTypes['keyPhonesSendPhoneRegistration'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling keyPhonesSendPhoneRegistration'
            );
        }


        $resourcePath = '/api/v2/KeyPhones/{id}/ReRegister';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation keyPhonesUpdate
     *
     * /api/v2/KeyPhones
     *
     * @param  \OpenAPI\Client\Model\UpdateKeyPhoneParam $update_key_phone_param Parameter containing phone information and key id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyPhonesUpdate'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function keyPhonesUpdate($update_key_phone_param, string $contentType = self::contentTypes['keyPhonesUpdate'][0])
    {
        $this->keyPhonesUpdateWithHttpInfo($update_key_phone_param, $contentType);
    }

    /**
     * Operation keyPhonesUpdateWithHttpInfo
     *
     * /api/v2/KeyPhones
     *
     * @param  \OpenAPI\Client\Model\UpdateKeyPhoneParam $update_key_phone_param Parameter containing phone information and key id (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function keyPhonesUpdateWithHttpInfo($update_key_phone_param, string $contentType = self::contentTypes['keyPhonesUpdate'][0])
    {
        $request = $this->keyPhonesUpdateRequest($update_key_phone_param, $contentType);
    ...
    /**
     * Operation keyPhonesUpdateAsync
     *
     * /api/v2/KeyPhones
     *
     * @param  \OpenAPI\Client\Model\UpdateKeyPhoneParam $update_key_phone_param Parameter containing phone information and key id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyPhonesUpdateAsync($update_key_phone_param, string $contentType = self::contentTypes['keyPhonesUpdate'][0])
    {
        return $this->keyPhonesUpdateAsyncWithHttpInfo($update_key_phone_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation keyPhonesUpdateAsyncWithHttpInfo
     *
     * /api/v2/KeyPhones
     *
     * @param  \OpenAPI\Client\Model\UpdateKeyPhoneParam $update_key_phone_param Parameter containing phone information and key id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyPhonesUpdateAsyncWithHttpInfo($update_key_phone_param, string $contentType = self::contentTypes['keyPhonesUpdate'][0])
    {
        $returnType = '';
        $request = $this->keyPhonesUpdateRequest($update_key_phone_param, $contentType);
    ...
    /**
     * Create request for operation 'keyPhonesUpdate'
     *
     * @param  \OpenAPI\Client\Model\UpdateKeyPhoneParam $update_key_phone_param Parameter containing phone information and key id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyPhonesUpdate'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function keyPhonesUpdateRequest($update_key_phone_param, string $contentType = self::contentTypes['keyPhonesUpdate'][0])
    {

        // verify the required parameter 'update_key_phone_param' is set
        if ($update_key_phone_param === null || (is_array($update_key_phone_param) && count($update_key_phone_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_key_phone_param when calling keyPhonesUpdate'
            );
        }


        $resourcePath = '/api/v2/KeyPhones';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($update_key_phone_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_key_phone_param));
            } else {
                $httpBody = $update_key_phone_param;
            }
