...
class ZonesApi
{
    ...
    /**
     * Operation zonesGetAllZones
     *
     * /api/v2/Zones
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['zonesGetAllZones'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Zone[]
     */
    public function zonesGetAllZones(string $contentType = self::contentTypes['zonesGetAllZones'][0])
    {
        list($response) = $this->zonesGetAllZonesWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation zonesGetAllZonesWithHttpInfo
     *
     * /api/v2/Zones
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['zonesGetAllZones'] to see the possible values for this operation
     ...
     */
    public function zonesGetAllZonesWithHttpInfo(string $contentType = self::contentTypes['zonesGetAllZones'][0])
    {
        $request = $this->zonesGetAllZonesRequest($contentType);
    ...
    /**
     * Operation zonesGetAllZonesAsync
     *
     * /api/v2/Zones
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['zonesGetAllZones'] to see the possible values for this operation
     ...
     */
    public function zonesGetAllZonesAsync(string $contentType = self::contentTypes['zonesGetAllZones'][0])
    {
        return $this->zonesGetAllZonesAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation zonesGetAllZonesAsyncWithHttpInfo
     *
     * /api/v2/Zones
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['zonesGetAllZones'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function zonesGetAllZonesAsyncWithHttpInfo(string $contentType = self::contentTypes['zonesGetAllZones'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Zone[]';
        $request = $this->zonesGetAllZonesRequest($contentType);
    ...
    /**
     * Create request for operation 'zonesGetAllZones'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['zonesGetAllZones'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function zonesGetAllZonesRequest(string $contentType = self::contentTypes['zonesGetAllZones'][0])
    {


        $resourcePath = '/api/v2/Zones';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
