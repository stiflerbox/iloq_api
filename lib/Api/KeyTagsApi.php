...
class KeyTagsApi
{
    ...
    /**
     * Operation keyTagsDelete
     *
     * /api/v2/KeyTags/{id}
     *
     * @param  string $id Key tag id to delete (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyTagsDelete'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function keyTagsDelete($id, string $contentType = self::contentTypes['keyTagsDelete'][0])
    {
        $this->keyTagsDeleteWithHttpInfo($id, $contentType);
    }

    /**
     * Operation keyTagsDeleteWithHttpInfo
     *
     * /api/v2/KeyTags/{id}
     *
     * @param  string $id Key tag id to delete (required)
     ...
     */
    public function keyTagsDeleteWithHttpInfo($id, string $contentType = self::contentTypes['keyTagsDelete'][0])
    {
        $request = $this->keyTagsDeleteRequest($id, $contentType);
     ...
     */
    public function keyTagsDeleteAsync($id, string $contentType = self::contentTypes['keyTagsDelete'][0])
    {
        return $this->keyTagsDeleteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation keyTagsDeleteAsyncWithHttpInfo
     *
     * /api/v2/KeyTags/{id}
     *
     * @param  string $id Key tag id to delete (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyTagsDeleteAsyncWithHttpInfo($id, string $contentType = self::contentTypes['keyTagsDelete'][0])
    {
        $returnType = '';
        $request = $this->keyTagsDeleteRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'keyTagsDelete'
     *
     * @param  string $id Key tag id to delete (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyTagsDelete'] to see the possible values for this operation
     *
     ...
     */
    public function keyTagsDeleteRequest($id, string $contentType = self::contentTypes['keyTagsDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling keyTagsDelete'
            );
        }


        $resourcePath = '/api/v2/KeyTags/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation keyTagsGetAll
     *
     * /api/v2/KeyTags
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyTagsGetAll'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\FNKeyTag[]
     */
    public function keyTagsGetAll(string $contentType = self::contentTypes['keyTagsGetAll'][0])
    {
        list($response) = $this->keyTagsGetAllWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation keyTagsGetAllWithHttpInfo
     *
     * /api/v2/KeyTags
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyTagsGetAll'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\FNKeyTag[], HTTP status code, HTTP response headers (array of strings)
     */
    public function keyTagsGetAllWithHttpInfo(string $contentType = self::contentTypes['keyTagsGetAll'][0])
    {
        $request = $this->keyTagsGetAllRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\FNKeyTag[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\FNKeyTag[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\FNKeyTag[]', []),
            ...
            $returnType = '\OpenAPI\Client\Model\FNKeyTag[]';
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyTagsGetAllAsync(string $contentType = self::contentTypes['keyTagsGetAll'][0])
    {
        return $this->keyTagsGetAllAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation keyTagsGetAllAsyncWithHttpInfo
     *
     * /api/v2/KeyTags
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyTagsGetAll'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyTagsGetAllAsyncWithHttpInfo(string $contentType = self::contentTypes['keyTagsGetAll'][0])
    {
        $returnType = '\OpenAPI\Client\Model\FNKeyTag[]';
        $request = $this->keyTagsGetAllRequest($contentType);
    ...
    /**
     * Create request for operation 'keyTagsGetAll'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyTagsGetAll'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function keyTagsGetAllRequest(string $contentType = self::contentTypes['keyTagsGetAll'][0])
    {


        $resourcePath = '/api/v2/KeyTags';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation keyTagsGetById
     *
     * /api/v2/KeyTags/{id}
     *
     * @param  string $id Tag id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyTagsGetById'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\FNKeyTag
     */
    public function keyTagsGetById($id, string $contentType = self::contentTypes['keyTagsGetById'][0])
    {
        list($response) = $this->keyTagsGetByIdWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation keyTagsGetByIdWithHttpInfo
     *
     * /api/v2/KeyTags/{id}
     *
     * @param  string $id Tag id (required)
     ...
     * @return array of \OpenAPI\Client\Model\FNKeyTag, HTTP status code, HTTP response headers (array of strings)
     */
    public function keyTagsGetByIdWithHttpInfo($id, string $contentType = self::contentTypes['keyTagsGetById'][0])
    {
        $request = $this->keyTagsGetByIdRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyTagsGetByIdAsync($id, string $contentType = self::contentTypes['keyTagsGetById'][0])
    {
        return $this->keyTagsGetByIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation keyTagsGetByIdAsyncWithHttpInfo
     *
     * /api/v2/KeyTags/{id}
     *
     * @param  string $id Tag id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyTagsGetByIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['keyTagsGetById'][0])
    {
        $returnType = '\OpenAPI\Client\Model\FNKeyTag';
        $request = $this->keyTagsGetByIdRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'keyTagsGetById'
     *
     * @param  string $id Tag id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyTagsGetById'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function keyTagsGetByIdRequest($id, string $contentType = self::contentTypes['keyTagsGetById'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling keyTagsGetById'
            );
        }
    ...
    /**
     * Operation keyTagsGetTagsByFNKey
     *
     * /api/v2/Keys/{id}/KeyTags
     *
     * @param  string $id Key id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyTagsGetTagsByFNKey'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\FNKeyTag[]
     */
    public function keyTagsGetTagsByFNKey($id, string $contentType = self::contentTypes['keyTagsGetTagsByFNKey'][0])
    {
        list($response) = $this->keyTagsGetTagsByFNKeyWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation keyTagsGetTagsByFNKeyWithHttpInfo
     *
     * /api/v2/Keys/{id}/KeyTags
     *
     * @param  string $id Key id (required)
     ...
     * @return array of \OpenAPI\Client\Model\FNKeyTag[], HTTP status code, HTTP response headers (array of strings)
     */
    public function keyTagsGetTagsByFNKeyWithHttpInfo($id, string $contentType = self::contentTypes['keyTagsGetTagsByFNKey'][0])
    {
        $request = $this->keyTagsGetTagsByFNKeyRequest($id, $contentType);
    ...
    /**
     * Operation keyTagsGetTagsByFNKeyAsync
     *
     * /api/v2/Keys/{id}/KeyTags
     *
     * @param  string $id Key id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyTagsGetTagsByFNKeyAsync($id, string $contentType = self::contentTypes['keyTagsGetTagsByFNKey'][0])
    {
        return $this->keyTagsGetTagsByFNKeyAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation keyTagsGetTagsByFNKeyAsyncWithHttpInfo
     *
     * /api/v2/Keys/{id}/KeyTags
     *
     * @param  string $id Key id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyTagsGetTagsByFNKeyAsyncWithHttpInfo($id, string $contentType = self::contentTypes['keyTagsGetTagsByFNKey'][0])
    {
        $returnType = '\OpenAPI\Client\Model\FNKeyTag[]';
        $request = $this->keyTagsGetTagsByFNKeyRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'keyTagsGetTagsByFNKey'
     *
     * @param  string $id Key id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyTagsGetTagsByFNKey'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function keyTagsGetTagsByFNKeyRequest($id, string $contentType = self::contentTypes['keyTagsGetTagsByFNKey'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling keyTagsGetTagsByFNKey'
            );
        }


        $resourcePath = '/api/v2/Keys/{id}/KeyTags';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation keyTagsInsert
     *
     * /api/v2/KeyTags
     *
     * @param  \OpenAPI\Client\Model\FNKeyTag $fn_key_tag Parameter (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyTagsInsert'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function keyTagsInsert($fn_key_tag, string $contentType = self::contentTypes['keyTagsInsert'][0])
    {
        $this->keyTagsInsertWithHttpInfo($fn_key_tag, $contentType);
    }

    /**
     * Operation keyTagsInsertWithHttpInfo
     *
     * /api/v2/KeyTags
     *
     * @param  \OpenAPI\Client\Model\FNKeyTag $fn_key_tag Parameter (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function keyTagsInsertWithHttpInfo($fn_key_tag, string $contentType = self::contentTypes['keyTagsInsert'][0])
    {
        $request = $this->keyTagsInsertRequest($fn_key_tag, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyTagsInsertAsync($fn_key_tag, string $contentType = self::contentTypes['keyTagsInsert'][0])
    {
        return $this->keyTagsInsertAsyncWithHttpInfo($fn_key_tag, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation keyTagsInsertAsyncWithHttpInfo
     *
     * /api/v2/KeyTags
     *
     * @param  \OpenAPI\Client\Model\FNKeyTag $fn_key_tag Parameter (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyTagsInsertAsyncWithHttpInfo($fn_key_tag, string $contentType = self::contentTypes['keyTagsInsert'][0])
    {
        $returnType = '';
        $request = $this->keyTagsInsertRequest($fn_key_tag, $contentType);
    ...
    /**
     * Create request for operation 'keyTagsInsert'
     *
     * @param  \OpenAPI\Client\Model\FNKeyTag $fn_key_tag Parameter (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyTagsInsert'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function keyTagsInsertRequest($fn_key_tag, string $contentType = self::contentTypes['keyTagsInsert'][0])
    {

        // verify the required parameter 'fn_key_tag' is set
        if ($fn_key_tag === null || (is_array($fn_key_tag) && count($fn_key_tag) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fn_key_tag when calling keyTagsInsert'
            );
        }
        ...
        if (isset($fn_key_tag)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                ...
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($fn_key_tag));
            } else {
                $httpBody = $fn_key_tag;
            }
    ...
    /**
     * Operation keyTagsUpdate
     *
     * /api/v2/KeyTags
     *
     * @param  \OpenAPI\Client\Model\FNKeyTag $fn_key_tag Parameter (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyTagsUpdate'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function keyTagsUpdate($fn_key_tag, string $contentType = self::contentTypes['keyTagsUpdate'][0])
    {
        $this->keyTagsUpdateWithHttpInfo($fn_key_tag, $contentType);
    }

    /**
     * Operation keyTagsUpdateWithHttpInfo
     *
     * /api/v2/KeyTags
     *
     * @param  \OpenAPI\Client\Model\FNKeyTag $fn_key_tag Parameter (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function keyTagsUpdateWithHttpInfo($fn_key_tag, string $contentType = self::contentTypes['keyTagsUpdate'][0])
    {
        $request = $this->keyTagsUpdateRequest($fn_key_tag, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyTagsUpdateAsync($fn_key_tag, string $contentType = self::contentTypes['keyTagsUpdate'][0])
    {
        return $this->keyTagsUpdateAsyncWithHttpInfo($fn_key_tag, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation keyTagsUpdateAsyncWithHttpInfo
     *
     * /api/v2/KeyTags
     *
     * @param  \OpenAPI\Client\Model\FNKeyTag $fn_key_tag Parameter (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function keyTagsUpdateAsyncWithHttpInfo($fn_key_tag, string $contentType = self::contentTypes['keyTagsUpdate'][0])
    {
        $returnType = '';
        $request = $this->keyTagsUpdateRequest($fn_key_tag, $contentType);
    ...
    /**
     * Create request for operation 'keyTagsUpdate'
     *
     * @param  \OpenAPI\Client\Model\FNKeyTag $fn_key_tag Parameter (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['keyTagsUpdate'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function keyTagsUpdateRequest($fn_key_tag, string $contentType = self::contentTypes['keyTagsUpdate'][0])
    {

        // verify the required parameter 'fn_key_tag' is set
        if ($fn_key_tag === null || (is_array($fn_key_tag) && count($fn_key_tag) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fn_key_tag when calling keyTagsUpdate'
            );
        }
