...
class BlacklistsApi
{
    ...
    /**
     * Operation blacklistsAddKey
     *
     * /api/v2/Blacklists/AddKey/{fnkeyId}
     *
     * @param  string $fnkey_id Key which is added to blocklist (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsAddKey'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function blacklistsAddKey($fnkey_id, string $contentType = self::contentTypes['blacklistsAddKey'][0])
    {
        $this->blacklistsAddKeyWithHttpInfo($fnkey_id, $contentType);
    }

    /**
     * Operation blacklistsAddKeyWithHttpInfo
     *
     * /api/v2/Blacklists/AddKey/{fnkeyId}
     *
     * @param  string $fnkey_id Key which is added to blocklist (required)
     ...
     */
    public function blacklistsAddKeyWithHttpInfo($fnkey_id, string $contentType = self::contentTypes['blacklistsAddKey'][0])
    {
        $request = $this->blacklistsAddKeyRequest($fnkey_id, $contentType);
    ...
    /**
     * Operation blacklistsAddKeyAsync
     *
     * /api/v2/Blacklists/AddKey/{fnkeyId}
     *
     * @param  string $fnkey_id Key which is added to blocklist (required)
     ...
     */
    public function blacklistsAddKeyAsync($fnkey_id, string $contentType = self::contentTypes['blacklistsAddKey'][0])
    {
        return $this->blacklistsAddKeyAsyncWithHttpInfo($fnkey_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation blacklistsAddKeyAsyncWithHttpInfo
     *
     * /api/v2/Blacklists/AddKey/{fnkeyId}
     *
     * @param  string $fnkey_id Key which is added to blocklist (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blacklistsAddKeyAsyncWithHttpInfo($fnkey_id, string $contentType = self::contentTypes['blacklistsAddKey'][0])
    {
        $returnType = '';
        $request = $this->blacklistsAddKeyRequest($fnkey_id, $contentType);
    ...
    /**
     * Create request for operation 'blacklistsAddKey'
     *
     * @param  string $fnkey_id Key which is added to blocklist (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsAddKey'] to see the possible values for this operation
     *
     ...
     */
    public function blacklistsAddKeyRequest($fnkey_id, string $contentType = self::contentTypes['blacklistsAddKey'][0])
    {

        // verify the required parameter 'fnkey_id' is set
        if ($fnkey_id === null || (is_array($fnkey_id) && count($fnkey_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fnkey_id when calling blacklistsAddKey'
            );
        }


        $resourcePath = '/api/v2/Blacklists/AddKey/{fnkeyId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($fnkey_id !== null) {
            $resourcePath = str_replace(
                '{' . 'fnkeyId' . '}',
                ObjectSerializer::toPathValue($fnkey_id),
                $resourcePath
            );
        }
    ...
    /**
     * Operation blacklistsCanAddKey
     *
     * /api/v2/Blacklists/CanAddKey/{fnkeyId}
     *
     * @param  string $fnkey_id Key which would be added to blocklist (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsCanAddKey'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return bool
     */
    public function blacklistsCanAddKey($fnkey_id, string $contentType = self::contentTypes['blacklistsCanAddKey'][0])
    {
        list($response) = $this->blacklistsCanAddKeyWithHttpInfo($fnkey_id, $contentType);
        return $response;
    }

    /**
     * Operation blacklistsCanAddKeyWithHttpInfo
     *
     * /api/v2/Blacklists/CanAddKey/{fnkeyId}
     *
     * @param  string $fnkey_id Key which would be added to blocklist (required)
     ...
     */
    public function blacklistsCanAddKeyWithHttpInfo($fnkey_id, string $contentType = self::contentTypes['blacklistsCanAddKey'][0])
    {
        $request = $this->blacklistsCanAddKeyRequest($fnkey_id, $contentType);
    ...
    /**
     * Operation blacklistsCanAddKeyAsync
     *
     * /api/v2/Blacklists/CanAddKey/{fnkeyId}
     *
     * @param  string $fnkey_id Key which would be added to blocklist (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blacklistsCanAddKeyAsync($fnkey_id, string $contentType = self::contentTypes['blacklistsCanAddKey'][0])
    {
        return $this->blacklistsCanAddKeyAsyncWithHttpInfo($fnkey_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation blacklistsCanAddKeyAsyncWithHttpInfo
     *
     * /api/v2/Blacklists/CanAddKey/{fnkeyId}
     *
     * @param  string $fnkey_id Key which would be added to blocklist (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blacklistsCanAddKeyAsyncWithHttpInfo($fnkey_id, string $contentType = self::contentTypes['blacklistsCanAddKey'][0])
    {
        $returnType = 'bool';
        $request = $this->blacklistsCanAddKeyRequest($fnkey_id, $contentType);
    ...
    /**
     * Create request for operation 'blacklistsCanAddKey'
     *
     * @param  string $fnkey_id Key which would be added to blocklist (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsCanAddKey'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function blacklistsCanAddKeyRequest($fnkey_id, string $contentType = self::contentTypes['blacklistsCanAddKey'][0])
    {

        // verify the required parameter 'fnkey_id' is set
        if ($fnkey_id === null || (is_array($fnkey_id) && count($fnkey_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fnkey_id when calling blacklistsCanAddKey'
            );
        }


        $resourcePath = '/api/v2/Blacklists/CanAddKey/{fnkeyId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation blacklistsCanOrderS40Blacklist
     *
     * /api/v2/Blacklists/CanOrderS40Blacklist
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsCanOrderS40Blacklist'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CanOrderS40BlacklistResult
     */
    public function blacklistsCanOrderS40Blacklist(string $contentType = self::contentTypes['blacklistsCanOrderS40Blacklist'][0])
    {
        list($response) = $this->blacklistsCanOrderS40BlacklistWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation blacklistsCanOrderS40BlacklistWithHttpInfo
     *
     * /api/v2/Blacklists/CanOrderS40Blacklist
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsCanOrderS40Blacklist'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CanOrderS40BlacklistResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function blacklistsCanOrderS40BlacklistWithHttpInfo(string $contentType = self::contentTypes['blacklistsCanOrderS40Blacklist'][0])
    {
        $request = $this->blacklistsCanOrderS40BlacklistRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CanOrderS40BlacklistResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CanOrderS40BlacklistResult' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CanOrderS40BlacklistResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\CanOrderS40BlacklistResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CanOrderS40BlacklistResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation blacklistsCanOrderS40BlacklistAsync
     *
     * /api/v2/Blacklists/CanOrderS40Blacklist
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsCanOrderS40Blacklist'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blacklistsCanOrderS40BlacklistAsync(string $contentType = self::contentTypes['blacklistsCanOrderS40Blacklist'][0])
    {
        return $this->blacklistsCanOrderS40BlacklistAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation blacklistsCanOrderS40BlacklistAsyncWithHttpInfo
     *
     * /api/v2/Blacklists/CanOrderS40Blacklist
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsCanOrderS40Blacklist'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blacklistsCanOrderS40BlacklistAsyncWithHttpInfo(string $contentType = self::contentTypes['blacklistsCanOrderS40Blacklist'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CanOrderS40BlacklistResult';
        $request = $this->blacklistsCanOrderS40BlacklistRequest($contentType);
    ...
    /**
     * Create request for operation 'blacklistsCanOrderS40Blacklist'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsCanOrderS40Blacklist'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function blacklistsCanOrderS40BlacklistRequest(string $contentType = self::contentTypes['blacklistsCanOrderS40Blacklist'][0])
    {


        $resourcePath = '/api/v2/Blacklists/CanOrderS40Blacklist';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation blacklistsCanRemoveKey
     *
     * /api/v2/Blacklists/CanRemoveKey/{fnkeyId}
     *
     * @param  string $fnkey_id Key which would be removed from blocklist (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsCanRemoveKey'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return bool
     */
    public function blacklistsCanRemoveKey($fnkey_id, string $contentType = self::contentTypes['blacklistsCanRemoveKey'][0])
    {
        list($response) = $this->blacklistsCanRemoveKeyWithHttpInfo($fnkey_id, $contentType);
        return $response;
    }

    /**
     * Operation blacklistsCanRemoveKeyWithHttpInfo
     *
     * /api/v2/Blacklists/CanRemoveKey/{fnkeyId}
     *
     * @param  string $fnkey_id Key which would be removed from blocklist (required)
     ...
     * @return array of bool, HTTP status code, HTTP response headers (array of strings)
     */
    public function blacklistsCanRemoveKeyWithHttpInfo($fnkey_id, string $contentType = self::contentTypes['blacklistsCanRemoveKey'][0])
    {
        $request = $this->blacklistsCanRemoveKeyRequest($fnkey_id, $contentType);
    ...
    /**
     * Operation blacklistsCanRemoveKeyAsync
     *
     * /api/v2/Blacklists/CanRemoveKey/{fnkeyId}
     *
     * @param  string $fnkey_id Key which would be removed from blocklist (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blacklistsCanRemoveKeyAsync($fnkey_id, string $contentType = self::contentTypes['blacklistsCanRemoveKey'][0])
    {
        return $this->blacklistsCanRemoveKeyAsyncWithHttpInfo($fnkey_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation blacklistsCanRemoveKeyAsyncWithHttpInfo
     *
     * /api/v2/Blacklists/CanRemoveKey/{fnkeyId}
     *
     * @param  string $fnkey_id Key which would be removed from blocklist (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blacklistsCanRemoveKeyAsyncWithHttpInfo($fnkey_id, string $contentType = self::contentTypes['blacklistsCanRemoveKey'][0])
    {
        $returnType = 'bool';
        $request = $this->blacklistsCanRemoveKeyRequest($fnkey_id, $contentType);
    ...
    /**
     * Create request for operation 'blacklistsCanRemoveKey'
     *
     * @param  string $fnkey_id Key which would be removed from blocklist (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsCanRemoveKey'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function blacklistsCanRemoveKeyRequest($fnkey_id, string $contentType = self::contentTypes['blacklistsCanRemoveKey'][0])
    {

        // verify the required parameter 'fnkey_id' is set
        if ($fnkey_id === null || (is_array($fnkey_id) && count($fnkey_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fnkey_id when calling blacklistsCanRemoveKey'
            );
        }


        $resourcePath = '/api/v2/Blacklists/CanRemoveKey/{fnkeyId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation blacklistsGetAll
     *
     * /api/v2/Blacklists
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsGetAll'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetS40BlacklistResult
     */
    public function blacklistsGetAll(string $contentType = self::contentTypes['blacklistsGetAll'][0])
    {
        list($response) = $this->blacklistsGetAllWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation blacklistsGetAllWithHttpInfo
     *
     * /api/v2/Blacklists
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsGetAll'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GetS40BlacklistResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function blacklistsGetAllWithHttpInfo(string $contentType = self::contentTypes['blacklistsGetAll'][0])
    {
        $request = $this->blacklistsGetAllRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetS40BlacklistResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GetS40BlacklistResult' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetS40BlacklistResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\GetS40BlacklistResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetS40BlacklistResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation blacklistsGetAllAsync
     *
     * /api/v2/Blacklists
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsGetAll'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blacklistsGetAllAsync(string $contentType = self::contentTypes['blacklistsGetAll'][0])
    {
        return $this->blacklistsGetAllAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation blacklistsGetAllAsyncWithHttpInfo
     *
     * /api/v2/Blacklists
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsGetAll'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blacklistsGetAllAsyncWithHttpInfo(string $contentType = self::contentTypes['blacklistsGetAll'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetS40BlacklistResult';
        $request = $this->blacklistsGetAllRequest($contentType);
    ...
    /**
     * Create request for operation 'blacklistsGetAll'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsGetAll'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function blacklistsGetAllRequest(string $contentType = self::contentTypes['blacklistsGetAll'][0])
    {


        $resourcePath = '/api/v2/Blacklists';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation blacklistsOrderS40Blacklist
     *
     * /api/v2/Blacklists/OrderS40Blacklist
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsOrderS40Blacklist'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function blacklistsOrderS40Blacklist(string $contentType = self::contentTypes['blacklistsOrderS40Blacklist'][0])
    {
        $this->blacklistsOrderS40BlacklistWithHttpInfo($contentType);
    }

    /**
     * Operation blacklistsOrderS40BlacklistWithHttpInfo
     *
     * /api/v2/Blacklists/OrderS40Blacklist
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsOrderS40Blacklist'] to see the possible values for this operation
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function blacklistsOrderS40BlacklistWithHttpInfo(string $contentType = self::contentTypes['blacklistsOrderS40Blacklist'][0])
    {
        $request = $this->blacklistsOrderS40BlacklistRequest($contentType);
    ...
    /**
     * Operation blacklistsOrderS40BlacklistAsync
     *
     * /api/v2/Blacklists/OrderS40Blacklist
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsOrderS40Blacklist'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blacklistsOrderS40BlacklistAsync(string $contentType = self::contentTypes['blacklistsOrderS40Blacklist'][0])
    {
        return $this->blacklistsOrderS40BlacklistAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation blacklistsOrderS40BlacklistAsyncWithHttpInfo
     *
     * /api/v2/Blacklists/OrderS40Blacklist
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsOrderS40Blacklist'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blacklistsOrderS40BlacklistAsyncWithHttpInfo(string $contentType = self::contentTypes['blacklistsOrderS40Blacklist'][0])
    {
        $returnType = '';
        $request = $this->blacklistsOrderS40BlacklistRequest($contentType);
    ...
    /**
     * Create request for operation 'blacklistsOrderS40Blacklist'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsOrderS40Blacklist'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function blacklistsOrderS40BlacklistRequest(string $contentType = self::contentTypes['blacklistsOrderS40Blacklist'][0])
    {


        $resourcePath = '/api/v2/Blacklists/OrderS40Blacklist';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation blacklistsRemoveKey
     *
     * /api/v2/Blacklists/RemoveKey/{fnkeyId}
     *
     * @param  string $fnkey_id Key which is removed from blocklist (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsRemoveKey'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function blacklistsRemoveKey($fnkey_id, string $contentType = self::contentTypes['blacklistsRemoveKey'][0])
    {
        $this->blacklistsRemoveKeyWithHttpInfo($fnkey_id, $contentType);
    }

    /**
     * Operation blacklistsRemoveKeyWithHttpInfo
     *
     * /api/v2/Blacklists/RemoveKey/{fnkeyId}
     *
     * @param  string $fnkey_id Key which is removed from blocklist (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function blacklistsRemoveKeyWithHttpInfo($fnkey_id, string $contentType = self::contentTypes['blacklistsRemoveKey'][0])
    {
        $request = $this->blacklistsRemoveKeyRequest($fnkey_id, $contentType);
    ...
    /**
     * Operation blacklistsRemoveKeyAsync
     *
     * /api/v2/Blacklists/RemoveKey/{fnkeyId}
     *
     * @param  string $fnkey_id Key which is removed from blocklist (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blacklistsRemoveKeyAsync($fnkey_id, string $contentType = self::contentTypes['blacklistsRemoveKey'][0])
    {
        return $this->blacklistsRemoveKeyAsyncWithHttpInfo($fnkey_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation blacklistsRemoveKeyAsyncWithHttpInfo
     *
     * /api/v2/Blacklists/RemoveKey/{fnkeyId}
     *
     * @param  string $fnkey_id Key which is removed from blocklist (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function blacklistsRemoveKeyAsyncWithHttpInfo($fnkey_id, string $contentType = self::contentTypes['blacklistsRemoveKey'][0])
    {
        $returnType = '';
        $request = $this->blacklistsRemoveKeyRequest($fnkey_id, $contentType);
    ...
    /**
     * Create request for operation 'blacklistsRemoveKey'
     *
     * @param  string $fnkey_id Key which is removed from blocklist (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['blacklistsRemoveKey'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function blacklistsRemoveKeyRequest($fnkey_id, string $contentType = self::contentTypes['blacklistsRemoveKey'][0])
    {

        // verify the required parameter 'fnkey_id' is set
        if ($fnkey_id === null || (is_array($fnkey_id) && count($fnkey_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $fnkey_id when calling blacklistsRemoveKey'
            );
        }


        $resourcePath = '/api/v2/Blacklists/RemoveKey/{fnkeyId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
