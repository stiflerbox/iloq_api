...
class WebhooksApi
{
    ...
    /**
     * Operation webhooksAddSubscription
     *
     * /api/v2/Webhooks/Subscriptions
     *
     * @param  \OpenAPI\Client\Model\AddSubscriptionParam $add_subscription_param add_subscription_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksAddSubscription'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhooksAddSubscription($add_subscription_param, string $contentType = self::contentTypes['webhooksAddSubscription'][0])
    {
        $this->webhooksAddSubscriptionWithHttpInfo($add_subscription_param, $contentType);
    }

    /**
     * Operation webhooksAddSubscriptionWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions
     *
     * @param  \OpenAPI\Client\Model\AddSubscriptionParam $add_subscription_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksAddSubscription'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function webhooksAddSubscriptionWithHttpInfo($add_subscription_param, string $contentType = self::contentTypes['webhooksAddSubscription'][0])
    {
        $request = $this->webhooksAddSubscriptionRequest($add_subscription_param, $contentType);
    ...
    /**
     * Operation webhooksAddSubscriptionAsync
     *
     * /api/v2/Webhooks/Subscriptions
     *
     * @param  \OpenAPI\Client\Model\AddSubscriptionParam $add_subscription_param (required)
     ...
     */
    public function webhooksAddSubscriptionAsync($add_subscription_param, string $contentType = self::contentTypes['webhooksAddSubscription'][0])
    {
        return $this->webhooksAddSubscriptionAsyncWithHttpInfo($add_subscription_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksAddSubscriptionAsyncWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions
     *
     * @param  \OpenAPI\Client\Model\AddSubscriptionParam $add_subscription_param (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksAddSubscriptionAsyncWithHttpInfo($add_subscription_param, string $contentType = self::contentTypes['webhooksAddSubscription'][0])
    {
        $returnType = '';
        $request = $this->webhooksAddSubscriptionRequest($add_subscription_param, $contentType);
    ...
    /**
     * Create request for operation 'webhooksAddSubscription'
     *
     * @param  \OpenAPI\Client\Model\AddSubscriptionParam $add_subscription_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksAddSubscription'] to see the possible values for this operation
     *
     ...
     */
    public function webhooksAddSubscriptionRequest($add_subscription_param, string $contentType = self::contentTypes['webhooksAddSubscription'][0])
    {

        // verify the required parameter 'add_subscription_param' is set
        if ($add_subscription_param === null || (is_array($add_subscription_param) && count($add_subscription_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $add_subscription_param when calling webhooksAddSubscription'
            );
        }


        $resourcePath = '/api/v2/Webhooks/Subscriptions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($add_subscription_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($add_subscription_param));
            } else {
                $httpBody = $add_subscription_param;
            }
    ...
    /**
     * Operation webhooksDeleteSubscription
     *
     * /api/v2/Webhooks/Subscriptions/{id}
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksDeleteSubscription'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhooksDeleteSubscription($id, string $contentType = self::contentTypes['webhooksDeleteSubscription'][0])
    {
        $this->webhooksDeleteSubscriptionWithHttpInfo($id, $contentType);
    }

    /**
     * Operation webhooksDeleteSubscriptionWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions/{id}
     *
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhooksDeleteSubscriptionWithHttpInfo($id, string $contentType = self::contentTypes['webhooksDeleteSubscription'][0])
    {
        $request = $this->webhooksDeleteSubscriptionRequest($id, $contentType);
    ...
    /**
     * Operation webhooksDeleteSubscriptionAsync
     *
     * /api/v2/Webhooks/Subscriptions/{id}
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksDeleteSubscriptionAsync($id, string $contentType = self::contentTypes['webhooksDeleteSubscription'][0])
    {
        return $this->webhooksDeleteSubscriptionAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksDeleteSubscriptionAsyncWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions/{id}
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksDeleteSubscriptionAsyncWithHttpInfo($id, string $contentType = self::contentTypes['webhooksDeleteSubscription'][0])
    {
        $returnType = '';
        $request = $this->webhooksDeleteSubscriptionRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'webhooksDeleteSubscription'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksDeleteSubscription'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhooksDeleteSubscriptionRequest($id, string $contentType = self::contentTypes['webhooksDeleteSubscription'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling webhooksDeleteSubscription'
            );
        }


        $resourcePath = '/api/v2/Webhooks/Subscriptions/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation webhooksGetEvents
     *
     * /api/v2/Webhooks/Events
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetEvents'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\WebhookEvent[]
     */
    public function webhooksGetEvents(string $contentType = self::contentTypes['webhooksGetEvents'][0])
    {
        list($response) = $this->webhooksGetEventsWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation webhooksGetEventsWithHttpInfo
     *
     * /api/v2/Webhooks/Events
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetEvents'] to see the possible values for this operation
     ...
     */
    public function webhooksGetEventsWithHttpInfo(string $contentType = self::contentTypes['webhooksGetEvents'][0])
    {
        $request = $this->webhooksGetEventsRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\WebhookEvent[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\WebhookEvent[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\WebhookEvent[]', []),
    ...
    /**
     * Operation webhooksGetEventsAsync
     *
     * /api/v2/Webhooks/Events
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetEvents'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksGetEventsAsync(string $contentType = self::contentTypes['webhooksGetEvents'][0])
    {
        return $this->webhooksGetEventsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksGetEventsAsyncWithHttpInfo
     *
     * /api/v2/Webhooks/Events
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetEvents'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksGetEventsAsyncWithHttpInfo(string $contentType = self::contentTypes['webhooksGetEvents'][0])
    {
        $returnType = '\OpenAPI\Client\Model\WebhookEvent[]';
        $request = $this->webhooksGetEventsRequest($contentType);
    ...
    /**
     * Create request for operation 'webhooksGetEvents'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetEvents'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhooksGetEventsRequest(string $contentType = self::contentTypes['webhooksGetEvents'][0])
    {


        $resourcePath = '/api/v2/Webhooks/Events';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation webhooksGetPayloadsForSubscription
     *
     * /api/v2/Webhooks/Subscriptions/{id}/Payloads
     *
     * @param  string $id id (required)
     * @param  \OpenAPI\Client\Model\EventState $state state (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetPayloadsForSubscription'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Payload[]
     */
    public function webhooksGetPayloadsForSubscription($id, $state, string $contentType = self::contentTypes['webhooksGetPayloadsForSubscription'][0])
    {
        list($response) = $this->webhooksGetPayloadsForSubscriptionWithHttpInfo($id, $state, $contentType);
        return $response;
    }

    /**
     * Operation webhooksGetPayloadsForSubscriptionWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions/{id}/Payloads
     *
     * @param  string $id (required)
     * @param  \OpenAPI\Client\Model\EventState $state (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetPayloadsForSubscription'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Payload[], HTTP status code, HTTP response headers (array of strings)
     */
    public function webhooksGetPayloadsForSubscriptionWithHttpInfo($id, $state, string $contentType = self::contentTypes['webhooksGetPayloadsForSubscription'][0])
    {
        $request = $this->webhooksGetPayloadsForSubscriptionRequest($id, $state, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\Payload[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\Payload[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\Payload[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\Payload[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    /**
     * Operation webhooksGetPayloadsForSubscriptionAsync
     *
     * /api/v2/Webhooks/Subscriptions/{id}/Payloads
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksGetPayloadsForSubscriptionAsync($id, $state, string $contentType = self::contentTypes['webhooksGetPayloadsForSubscription'][0])
    {
        return $this->webhooksGetPayloadsForSubscriptionAsyncWithHttpInfo($id, $state, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksGetPayloadsForSubscriptionAsyncWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions/{id}/Payloads
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksGetPayloadsForSubscriptionAsyncWithHttpInfo($id, $state, string $contentType = self::contentTypes['webhooksGetPayloadsForSubscription'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Payload[]';
        $request = $this->webhooksGetPayloadsForSubscriptionRequest($id, $state, $contentType);
    ...
    /**
     * Create request for operation 'webhooksGetPayloadsForSubscription'
     *
     * @param  string $id (required)
     * @param  \OpenAPI\Client\Model\EventState $state (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetPayloadsForSubscription'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhooksGetPayloadsForSubscriptionRequest($id, $state, string $contentType = self::contentTypes['webhooksGetPayloadsForSubscription'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling webhooksGetPayloadsForSubscription'
            );
        }
        ...
        if ($state === null || (is_array($state) && count($state) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $state when calling webhooksGetPayloadsForSubscription'
            );
        }


        $resourcePath = '/api/v2/Webhooks/Subscriptions/{id}/Payloads';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation webhooksGetPendingEventsForSubscription
     *
     * /api/v2/Webhooks/Subscriptions/{id}/PendingEvents
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetPendingEventsForSubscription'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Payload[]
     * @deprecated
     */
    public function webhooksGetPendingEventsForSubscription($id, string $contentType = self::contentTypes['webhooksGetPendingEventsForSubscription'][0])
    {
        list($response) = $this->webhooksGetPendingEventsForSubscriptionWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation webhooksGetPendingEventsForSubscriptionWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions/{id}/PendingEvents
     *
     * @param  string $id (required)
     ...
     * @deprecated
     */
    public function webhooksGetPendingEventsForSubscriptionWithHttpInfo($id, string $contentType = self::contentTypes['webhooksGetPendingEventsForSubscription'][0])
    {
        $request = $this->webhooksGetPendingEventsForSubscriptionRequest($id, $contentType);
    ...
    /**
     * Operation webhooksGetPendingEventsForSubscriptionAsync
     *
     * /api/v2/Webhooks/Subscriptions/{id}/PendingEvents
     *
     * @param  string $id (required)
     ...
     * @deprecated
     */
    public function webhooksGetPendingEventsForSubscriptionAsync($id, string $contentType = self::contentTypes['webhooksGetPendingEventsForSubscription'][0])
    {
        return $this->webhooksGetPendingEventsForSubscriptionAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksGetPendingEventsForSubscriptionAsyncWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions/{id}/PendingEvents
     *
     * @param  string $id (required)
     ...
     * @deprecated
     */
    public function webhooksGetPendingEventsForSubscriptionAsyncWithHttpInfo($id, string $contentType = self::contentTypes['webhooksGetPendingEventsForSubscription'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Payload[]';
        $request = $this->webhooksGetPendingEventsForSubscriptionRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'webhooksGetPendingEventsForSubscription'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetPendingEventsForSubscription'] to see the possible values for this operation
     *
     ...
     * @deprecated
     */
    public function webhooksGetPendingEventsForSubscriptionRequest($id, string $contentType = self::contentTypes['webhooksGetPendingEventsForSubscription'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling webhooksGetPendingEventsForSubscription'
            );
        }


        $resourcePath = '/api/v2/Webhooks/Subscriptions/{id}/PendingEvents';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation webhooksGetSubscription
     *
     * /api/v2/Webhooks/Subscriptions/{id}
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscription'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Subscription
     */
    public function webhooksGetSubscription($id, string $contentType = self::contentTypes['webhooksGetSubscription'][0])
    {
        list($response) = $this->webhooksGetSubscriptionWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation webhooksGetSubscriptionWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions/{id}
     *
     * @param  string $id (required)
     ...
     */
    public function webhooksGetSubscriptionWithHttpInfo($id, string $contentType = self::contentTypes['webhooksGetSubscription'][0])
    {
        $request = $this->webhooksGetSubscriptionRequest($id, $contentType);
    ...
    /**
     * Operation webhooksGetSubscriptionAsync
     *
     * /api/v2/Webhooks/Subscriptions/{id}
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksGetSubscriptionAsync($id, string $contentType = self::contentTypes['webhooksGetSubscription'][0])
    {
        return $this->webhooksGetSubscriptionAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksGetSubscriptionAsyncWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions/{id}
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksGetSubscriptionAsyncWithHttpInfo($id, string $contentType = self::contentTypes['webhooksGetSubscription'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Subscription';
        $request = $this->webhooksGetSubscriptionRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'webhooksGetSubscription'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscription'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhooksGetSubscriptionRequest($id, string $contentType = self::contentTypes['webhooksGetSubscription'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling webhooksGetSubscription'
            );
        }
    ...
    /**
     * Operation webhooksGetSubscriptions
     *
     * /api/v2/Webhooks/Subscriptions
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscriptions'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Subscription[]
     */
    public function webhooksGetSubscriptions(string $contentType = self::contentTypes['webhooksGetSubscriptions'][0])
    {
        list($response) = $this->webhooksGetSubscriptionsWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation webhooksGetSubscriptionsWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscriptions'] to see the possible values for this operation
     ...
     * @return array of \OpenAPI\Client\Model\Subscription[], HTTP status code, HTTP response headers (array of strings)
     */
    public function webhooksGetSubscriptionsWithHttpInfo(string $contentType = self::contentTypes['webhooksGetSubscriptions'][0])
    {
        $request = $this->webhooksGetSubscriptionsRequest($contentType);
    ...
    /**
     * Operation webhooksGetSubscriptionsAsync
     *
     * /api/v2/Webhooks/Subscriptions
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscriptions'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksGetSubscriptionsAsync(string $contentType = self::contentTypes['webhooksGetSubscriptions'][0])
    {
        return $this->webhooksGetSubscriptionsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksGetSubscriptionsAsyncWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscriptions'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksGetSubscriptionsAsyncWithHttpInfo(string $contentType = self::contentTypes['webhooksGetSubscriptions'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Subscription[]';
        $request = $this->webhooksGetSubscriptionsRequest($contentType);
    ...
    /**
     * Create request for operation 'webhooksGetSubscriptions'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscriptions'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhooksGetSubscriptionsRequest(string $contentType = self::contentTypes['webhooksGetSubscriptions'][0])
    {
    ...
    /**
     * Operation webhooksGetSubscriptionsWithPendingEvents
     *
     * /api/v2/Webhooks/Subscriptions/PendingEvents
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscriptionsWithPendingEvents'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetSubscriptionsWithPendingPayloadsResult
     * @deprecated
     */
    public function webhooksGetSubscriptionsWithPendingEvents(string $contentType = self::contentTypes['webhooksGetSubscriptionsWithPendingEvents'][0])
    {
        list($response) = $this->webhooksGetSubscriptionsWithPendingEventsWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation webhooksGetSubscriptionsWithPendingEventsWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions/PendingEvents
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscriptionsWithPendingEvents'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GetSubscriptionsWithPendingPayloadsResult, HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function webhooksGetSubscriptionsWithPendingEventsWithHttpInfo(string $contentType = self::contentTypes['webhooksGetSubscriptionsWithPendingEvents'][0])
    {
        $request = $this->webhooksGetSubscriptionsWithPendingEventsRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetSubscriptionsWithPendingPayloadsResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GetSubscriptionsWithPendingPayloadsResult' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetSubscriptionsWithPendingPayloadsResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\GetSubscriptionsWithPendingPayloadsResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetSubscriptionsWithPendingPayloadsResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation webhooksGetSubscriptionsWithPendingEventsAsync
     *
     * /api/v2/Webhooks/Subscriptions/PendingEvents
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscriptionsWithPendingEvents'] to see the possible values for this operation
     ...
     * @deprecated
     */
    public function webhooksGetSubscriptionsWithPendingEventsAsync(string $contentType = self::contentTypes['webhooksGetSubscriptionsWithPendingEvents'][0])
    {
        return $this->webhooksGetSubscriptionsWithPendingEventsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksGetSubscriptionsWithPendingEventsAsyncWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions/PendingEvents
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscriptionsWithPendingEvents'] to see the possible values for this operation
     ...
     * @deprecated
     */
    public function webhooksGetSubscriptionsWithPendingEventsAsyncWithHttpInfo(string $contentType = self::contentTypes['webhooksGetSubscriptionsWithPendingEvents'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetSubscriptionsWithPendingPayloadsResult';
        $request = $this->webhooksGetSubscriptionsWithPendingEventsRequest($contentType);
    ...
    /**
     * Create request for operation 'webhooksGetSubscriptionsWithPendingEvents'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscriptionsWithPendingEvents'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     * @deprecated
     */
    public function webhooksGetSubscriptionsWithPendingEventsRequest(string $contentType = self::contentTypes['webhooksGetSubscriptionsWithPendingEvents'][0])
    {


        $resourcePath = '/api/v2/Webhooks/Subscriptions/PendingEvents';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation webhooksGetSubscriptionsWithPendingPayloads
     *
     * /api/v2/Webhooks/Subscriptions/PendingPayloads
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscriptionsWithPendingPayloads'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetSubscriptionsWithPendingPayloadsResult
     */
    public function webhooksGetSubscriptionsWithPendingPayloads(string $contentType = self::contentTypes['webhooksGetSubscriptionsWithPendingPayloads'][0])
    {
        list($response) = $this->webhooksGetSubscriptionsWithPendingPayloadsWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation webhooksGetSubscriptionsWithPendingPayloadsWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions/PendingPayloads
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscriptionsWithPendingPayloads'] to see the possible values for this operation
     ...
     * @return array of \OpenAPI\Client\Model\GetSubscriptionsWithPendingPayloadsResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhooksGetSubscriptionsWithPendingPayloadsWithHttpInfo(string $contentType = self::contentTypes['webhooksGetSubscriptionsWithPendingPayloads'][0])
    {
        $request = $this->webhooksGetSubscriptionsWithPendingPayloadsRequest($contentType);
    ...
    /**
     * Operation webhooksGetSubscriptionsWithPendingPayloadsAsync
     *
     * /api/v2/Webhooks/Subscriptions/PendingPayloads
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscriptionsWithPendingPayloads'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksGetSubscriptionsWithPendingPayloadsAsync(string $contentType = self::contentTypes['webhooksGetSubscriptionsWithPendingPayloads'][0])
    {
        return $this->webhooksGetSubscriptionsWithPendingPayloadsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksGetSubscriptionsWithPendingPayloadsAsyncWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions/PendingPayloads
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscriptionsWithPendingPayloads'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksGetSubscriptionsWithPendingPayloadsAsyncWithHttpInfo(string $contentType = self::contentTypes['webhooksGetSubscriptionsWithPendingPayloads'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetSubscriptionsWithPendingPayloadsResult';
        $request = $this->webhooksGetSubscriptionsWithPendingPayloadsRequest($contentType);
    ...
    /**
     * Create request for operation 'webhooksGetSubscriptionsWithPendingPayloads'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksGetSubscriptionsWithPendingPayloads'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhooksGetSubscriptionsWithPendingPayloadsRequest(string $contentType = self::contentTypes['webhooksGetSubscriptionsWithPendingPayloads'][0])
    {


        $resourcePath = '/api/v2/Webhooks/Subscriptions/PendingPayloads';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation webhooksUpdateSubscription
     *
     * /api/v2/Webhooks/Subscriptions
     *
     * @param  \OpenAPI\Client\Model\AddSubscriptionParam $add_subscription_param add_subscription_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksUpdateSubscription'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function webhooksUpdateSubscription($add_subscription_param, string $contentType = self::contentTypes['webhooksUpdateSubscription'][0])
    {
        $this->webhooksUpdateSubscriptionWithHttpInfo($add_subscription_param, $contentType);
    }

    /**
     * Operation webhooksUpdateSubscriptionWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions
     *
     * @param  \OpenAPI\Client\Model\AddSubscriptionParam $add_subscription_param (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function webhooksUpdateSubscriptionWithHttpInfo($add_subscription_param, string $contentType = self::contentTypes['webhooksUpdateSubscription'][0])
    {
        $request = $this->webhooksUpdateSubscriptionRequest($add_subscription_param, $contentType);
    ...
    /**
     * Operation webhooksUpdateSubscriptionAsync
     *
     * /api/v2/Webhooks/Subscriptions
     *
     * @param  \OpenAPI\Client\Model\AddSubscriptionParam $add_subscription_param (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksUpdateSubscriptionAsync($add_subscription_param, string $contentType = self::contentTypes['webhooksUpdateSubscription'][0])
    {
        return $this->webhooksUpdateSubscriptionAsyncWithHttpInfo($add_subscription_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation webhooksUpdateSubscriptionAsyncWithHttpInfo
     *
     * /api/v2/Webhooks/Subscriptions
     *
     * @param  \OpenAPI\Client\Model\AddSubscriptionParam $add_subscription_param (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function webhooksUpdateSubscriptionAsyncWithHttpInfo($add_subscription_param, string $contentType = self::contentTypes['webhooksUpdateSubscription'][0])
    {
        $returnType = '';
        $request = $this->webhooksUpdateSubscriptionRequest($add_subscription_param, $contentType);
    ...
    /**
     * Create request for operation 'webhooksUpdateSubscription'
     *
     * @param  \OpenAPI\Client\Model\AddSubscriptionParam $add_subscription_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['webhooksUpdateSubscription'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function webhooksUpdateSubscriptionRequest($add_subscription_param, string $contentType = self::contentTypes['webhooksUpdateSubscription'][0])
    {

        // verify the required parameter 'add_subscription_param' is set
        if ($add_subscription_param === null || (is_array($add_subscription_param) && count($add_subscription_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $add_subscription_param when calling webhooksUpdateSubscription'
            );
        }
