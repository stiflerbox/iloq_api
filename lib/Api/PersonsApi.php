...
class PersonsApi
{
    ...
    /**
     * Operation personsCanDelete
     *
     * /api/v2/Persons/{id}/CanDelete
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsCanDelete'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\PniPersonCanDeleteErrorType
     */
    public function personsCanDelete($id, string $contentType = self::contentTypes['personsCanDelete'][0])
    {
        list($response) = $this->personsCanDeleteWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation personsCanDeleteWithHttpInfo
     *
     * /api/v2/Persons/{id}/CanDelete
     *
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\PniPersonCanDeleteErrorType, HTTP status code, HTTP response headers (array of strings)
     */
    public function personsCanDeleteWithHttpInfo($id, string $contentType = self::contentTypes['personsCanDelete'][0])
    {
        $request = $this->personsCanDeleteRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\PniPersonCanDeleteErrorType' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\PniPersonCanDeleteErrorType' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\PniPersonCanDeleteErrorType', []),
            ...
            $returnType = '\OpenAPI\Client\Model\PniPersonCanDeleteErrorType';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\PniPersonCanDeleteErrorType',
    ...
    /**
     * Operation personsCanDeleteAsync
     *
     * /api/v2/Persons/{id}/CanDelete
     *
     * @param  string $id (required)
     ...
     */
    public function personsCanDeleteAsync($id, string $contentType = self::contentTypes['personsCanDelete'][0])
    {
        return $this->personsCanDeleteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation personsCanDeleteAsyncWithHttpInfo
     *
     * /api/v2/Persons/{id}/CanDelete
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsCanDeleteAsyncWithHttpInfo($id, string $contentType = self::contentTypes['personsCanDelete'][0])
    {
        $returnType = '\OpenAPI\Client\Model\PniPersonCanDeleteErrorType';
        $request = $this->personsCanDeleteRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'personsCanDelete'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsCanDelete'] to see the possible values for this operation
     *
     ...
     */
    public function personsCanDeleteRequest($id, string $contentType = self::contentTypes['personsCanDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling personsCanDelete'
            );
        }


        $resourcePath = '/api/v2/Persons/{id}/CanDelete';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsDelete'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \SplFileObject
     */
    public function personsDelete($id, string $contentType = self::contentTypes['personsDelete'][0])
    {
        list($response) = $this->personsDeleteWithHttpInfo($id, $contentType);
        return $response;
    }
     ...
     */
    public function personsDeleteWithHttpInfo($id, string $contentType = self::contentTypes['personsDelete'][0])
    {
        $request = $this->personsDeleteRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsDeleteAsync($id, string $contentType = self::contentTypes['personsDelete'][0])
    {
        return $this->personsDeleteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsDeleteAsyncWithHttpInfo($id, string $contentType = self::contentTypes['personsDelete'][0])
    {
        $returnType = '\SplFileObject';
        $request = $this->personsDeleteRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function personsDeleteRequest($id, string $contentType = self::contentTypes['personsDelete'][0])
    {
        ...
        $resourcePath = '/api/v2/Persons/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation personsGetAllPersons
     *
     * /api/v2/Persons
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsGetAllPersons'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Person[]
     */
    public function personsGetAllPersons(string $contentType = self::contentTypes['personsGetAllPersons'][0])
    {
        list($response) = $this->personsGetAllPersonsWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation personsGetAllPersonsWithHttpInfo
     *
     * /api/v2/Persons
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsGetAllPersons'] to see the possible values for this operation
     ...
     */
    public function personsGetAllPersonsWithHttpInfo(string $contentType = self::contentTypes['personsGetAllPersons'][0])
    {
        $request = $this->personsGetAllPersonsRequest($contentType);
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\Person[]' === '\SplFileObject') {
                        ...
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\Person[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
    ...
    /**
     * Operation personsGetAllPersonsAsync
     *
     * /api/v2/Persons
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsGetAllPersons'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsGetAllPersonsAsync(string $contentType = self::contentTypes['personsGetAllPersons'][0])
    {
        return $this->personsGetAllPersonsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation personsGetAllPersonsAsyncWithHttpInfo
     *
     * /api/v2/Persons
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsGetAllPersons'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsGetAllPersonsAsyncWithHttpInfo(string $contentType = self::contentTypes['personsGetAllPersons'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Person[]';
        $request = $this->personsGetAllPersonsRequest($contentType);
    ...
    /**
     * Create request for operation 'personsGetAllPersons'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsGetAllPersons'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function personsGetAllPersonsRequest(string $contentType = self::contentTypes['personsGetAllPersons'][0])
    {


        $resourcePath = '/api/v2/Persons';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation personsGetNortecCode
     *
     * /api/v2/Persons/{id}/NortecActivationCode
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsGetNortecCode'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return string
     */
    public function personsGetNortecCode($id, string $contentType = self::contentTypes['personsGetNortecCode'][0])
    {
        list($response) = $this->personsGetNortecCodeWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation personsGetNortecCodeWithHttpInfo
     *
     * /api/v2/Persons/{id}/NortecActivationCode
     *
     * @param  string $id (required)
     ...
     */
    public function personsGetNortecCodeWithHttpInfo($id, string $contentType = self::contentTypes['personsGetNortecCode'][0])
    {
        $request = $this->personsGetNortecCodeRequest($id, $contentType);
    ...
    /**
     * Operation personsGetNortecCodeAsync
     *
     * /api/v2/Persons/{id}/NortecActivationCode
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsGetNortecCodeAsync($id, string $contentType = self::contentTypes['personsGetNortecCode'][0])
    {
        return $this->personsGetNortecCodeAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation personsGetNortecCodeAsyncWithHttpInfo
     *
     * /api/v2/Persons/{id}/NortecActivationCode
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsGetNortecCodeAsyncWithHttpInfo($id, string $contentType = self::contentTypes['personsGetNortecCode'][0])
    {
        $returnType = 'string';
        $request = $this->personsGetNortecCodeRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'personsGetNortecCode'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsGetNortecCode'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function personsGetNortecCodeRequest($id, string $contentType = self::contentTypes['personsGetNortecCode'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling personsGetNortecCode'
            );
        }


        $resourcePath = '/api/v2/Persons/{id}/NortecActivationCode';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation personsGetPerson
     *
     * /api/v2/Persons/{id}
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsGetPerson'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Person
     */
    public function personsGetPerson($id, string $contentType = self::contentTypes['personsGetPerson'][0])
    {
        list($response) = $this->personsGetPersonWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation personsGetPersonWithHttpInfo
     *
     * /api/v2/Persons/{id}
     *
     * @param  string $id (required)
     ...
     * @return array of \OpenAPI\Client\Model\Person, HTTP status code, HTTP response headers (array of strings)
     */
    public function personsGetPersonWithHttpInfo($id, string $contentType = self::contentTypes['personsGetPerson'][0])
    {
        $request = $this->personsGetPersonRequest($id, $contentType);
    ...
    /**
     * Operation personsGetPersonAsync
     *
     * /api/v2/Persons/{id}
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsGetPersonAsync($id, string $contentType = self::contentTypes['personsGetPerson'][0])
    {
        return $this->personsGetPersonAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation personsGetPersonAsyncWithHttpInfo
     *
     * /api/v2/Persons/{id}
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsGetPersonAsyncWithHttpInfo($id, string $contentType = self::contentTypes['personsGetPerson'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Person';
        $request = $this->personsGetPersonRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'personsGetPerson'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsGetPerson'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function personsGetPersonRequest($id, string $contentType = self::contentTypes['personsGetPerson'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling personsGetPerson'
            );
        }
    ...
    /**
     * Operation personsGetPersonsByExternalPersonIds
     *
     * /api/v2/Persons/GetByExternalPersonIds
     *
     * @param  string[] $external_person_ids external_person_ids (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsGetPersonsByExternalPersonIds'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Person[]
     */
    public function personsGetPersonsByExternalPersonIds($external_person_ids = null, string $contentType = self::contentTypes['personsGetPersonsByExternalPersonIds'][0])
    {
        list($response) = $this->personsGetPersonsByExternalPersonIdsWithHttpInfo($external_person_ids, $contentType);
        return $response;
    }

    /**
     * Operation personsGetPersonsByExternalPersonIdsWithHttpInfo
     *
     * /api/v2/Persons/GetByExternalPersonIds
     *
     * @param  string[] $external_person_ids (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsGetPersonsByExternalPersonIds'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Person[], HTTP status code, HTTP response headers (array of strings)
     */
    public function personsGetPersonsByExternalPersonIdsWithHttpInfo($external_person_ids = null, string $contentType = self::contentTypes['personsGetPersonsByExternalPersonIds'][0])
    {
        $request = $this->personsGetPersonsByExternalPersonIdsRequest($external_person_ids, $contentType);
    ...
    /**
     * Operation personsGetPersonsByExternalPersonIdsAsync
     *
     * /api/v2/Persons/GetByExternalPersonIds
     *
     * @param  string[] $external_person_ids (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsGetPersonsByExternalPersonIdsAsync($external_person_ids = null, string $contentType = self::contentTypes['personsGetPersonsByExternalPersonIds'][0])
    {
        return $this->personsGetPersonsByExternalPersonIdsAsyncWithHttpInfo($external_person_ids, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation personsGetPersonsByExternalPersonIdsAsyncWithHttpInfo
     *
     * /api/v2/Persons/GetByExternalPersonIds
     *
     * @param  string[] $external_person_ids (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsGetPersonsByExternalPersonIdsAsyncWithHttpInfo($external_person_ids = null, string $contentType = self::contentTypes['personsGetPersonsByExternalPersonIds'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Person[]';
        $request = $this->personsGetPersonsByExternalPersonIdsRequest($external_person_ids, $contentType);
    ...
    /**
     * Create request for operation 'personsGetPersonsByExternalPersonIds'
     *
     * @param  string[] $external_person_ids (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsGetPersonsByExternalPersonIds'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function personsGetPersonsByExternalPersonIdsRequest($external_person_ids = null, string $contentType = self::contentTypes['personsGetPersonsByExternalPersonIds'][0])
    {



        $resourcePath = '/api/v2/Persons/GetByExternalPersonIds';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $external_person_ids,
            'externalPersonIds', // param base name
            'array', // openApiType
            'form', // style
            true, // explode
            false // required
    ...
    /**
     * Operation personsInsert
     *
     * /api/v2/Persons
     *
     * @param  \OpenAPI\Client\Model\InsertPersonParam $insert_person_param insert_person_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsInsert'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\InsertResult
     */
    public function personsInsert($insert_person_param, string $contentType = self::contentTypes['personsInsert'][0])
    {
        list($response) = $this->personsInsertWithHttpInfo($insert_person_param, $contentType);
        return $response;
    }

    /**
     * Operation personsInsertWithHttpInfo
     *
     * /api/v2/Persons
     *
     * @param  \OpenAPI\Client\Model\InsertPersonParam $insert_person_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsInsert'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\InsertResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function personsInsertWithHttpInfo($insert_person_param, string $contentType = self::contentTypes['personsInsert'][0])
    {
        $request = $this->personsInsertRequest($insert_person_param, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\InsertResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\InsertResult' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\InsertResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\InsertResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\InsertResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsInsertAsync($insert_person_param, string $contentType = self::contentTypes['personsInsert'][0])
    {
        return $this->personsInsertAsyncWithHttpInfo($insert_person_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation personsInsertAsyncWithHttpInfo
     *
     * /api/v2/Persons
     *
     * @param  \OpenAPI\Client\Model\InsertPersonParam $insert_person_param (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsInsertAsyncWithHttpInfo($insert_person_param, string $contentType = self::contentTypes['personsInsert'][0])
    {
        $returnType = '\OpenAPI\Client\Model\InsertResult';
        $request = $this->personsInsertRequest($insert_person_param, $contentType);
    ...
    /**
     * Create request for operation 'personsInsert'
     *
     * @param  \OpenAPI\Client\Model\InsertPersonParam $insert_person_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsInsert'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function personsInsertRequest($insert_person_param, string $contentType = self::contentTypes['personsInsert'][0])
    {

        // verify the required parameter 'insert_person_param' is set
        if ($insert_person_param === null || (is_array($insert_person_param) && count($insert_person_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $insert_person_param when calling personsInsert'
            );
        }
        ...
        // for model (json/xml)
        if (isset($insert_person_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($insert_person_param));
            } else {
                $httpBody = $insert_person_param;
            }
    ...
    /**
     * Operation personsUpdate
     *
     * /api/v2/Persons
     *
     * @param  \OpenAPI\Client\Model\UpdatePersonParam $update_person_param update_person_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsUpdate'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function personsUpdate($update_person_param, string $contentType = self::contentTypes['personsUpdate'][0])
    {
        $this->personsUpdateWithHttpInfo($update_person_param, $contentType);
    }

    /**
     * Operation personsUpdateWithHttpInfo
     *
     * /api/v2/Persons
     *
     * @param  \OpenAPI\Client\Model\UpdatePersonParam $update_person_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsUpdate'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function personsUpdateWithHttpInfo($update_person_param, string $contentType = self::contentTypes['personsUpdate'][0])
    {
        $request = $this->personsUpdateRequest($update_person_param, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsUpdateAsync($update_person_param, string $contentType = self::contentTypes['personsUpdate'][0])
    {
        return $this->personsUpdateAsyncWithHttpInfo($update_person_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation personsUpdateAsyncWithHttpInfo
     *
     * /api/v2/Persons
     *
     * @param  \OpenAPI\Client\Model\UpdatePersonParam $update_person_param (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function personsUpdateAsyncWithHttpInfo($update_person_param, string $contentType = self::contentTypes['personsUpdate'][0])
    {
        $returnType = '';
        $request = $this->personsUpdateRequest($update_person_param, $contentType);
    ...
    /**
     * Create request for operation 'personsUpdate'
     *
     * @param  \OpenAPI\Client\Model\UpdatePersonParam $update_person_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['personsUpdate'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function personsUpdateRequest($update_person_param, string $contentType = self::contentTypes['personsUpdate'][0])
    {

        // verify the required parameter 'update_person_param' is set
        if ($update_person_param === null || (is_array($update_person_param) && count($update_person_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_person_param when calling personsUpdate'
            );
        }
        ...
        // for model (json/xml)
        if (isset($update_person_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_person_param));
            } else {
                $httpBody = $update_person_param;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
