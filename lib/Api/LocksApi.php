...
class LocksApi
{
    ...
    /**
     * Operation locksCanOrderLock
     *
     * /api/v2/Locks/{id}/CanOrder
     *
     * @param  string $id Lock Id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksCanOrderLock'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\CanOrderLockResultType
     */
    public function locksCanOrderLock($id, string $contentType = self::contentTypes['locksCanOrderLock'][0])
    {
        list($response) = $this->locksCanOrderLockWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation locksCanOrderLockWithHttpInfo
     *
     * /api/v2/Locks/{id}/CanOrder
     *
     * @param  string $id Lock Id (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CanOrderLockResultType, HTTP status code, HTTP response headers (array of strings)
     */
    public function locksCanOrderLockWithHttpInfo($id, string $contentType = self::contentTypes['locksCanOrderLock'][0])
    {
        $request = $this->locksCanOrderLockRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CanOrderLockResultType' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CanOrderLockResultType' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CanOrderLockResultType', []),
            ...
            $returnType = '\OpenAPI\Client\Model\CanOrderLockResultType';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CanOrderLockResultType',
    ...
    /**
     * Operation locksCanOrderLockAsync
     *
     * /api/v2/Locks/{id}/CanOrder
     *
     * @param  string $id Lock Id (required)
     ...
     */
    public function locksCanOrderLockAsync($id, string $contentType = self::contentTypes['locksCanOrderLock'][0])
    {
        return $this->locksCanOrderLockAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation locksCanOrderLockAsyncWithHttpInfo
     *
     * /api/v2/Locks/{id}/CanOrder
     *
     * @param  string $id Lock Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksCanOrderLockAsyncWithHttpInfo($id, string $contentType = self::contentTypes['locksCanOrderLock'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CanOrderLockResultType';
        $request = $this->locksCanOrderLockRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'locksCanOrderLock'
     *
     * @param  string $id Lock Id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksCanOrderLock'] to see the possible values for this operation
     *
     ...
     */
    public function locksCanOrderLockRequest($id, string $contentType = self::contentTypes['locksCanOrderLock'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling locksCanOrderLock'
            );
        }


        $resourcePath = '/api/v2/Locks/{id}/CanOrder';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation locksDelete
     *
     * /api/v2/Locks/{id}
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksDelete'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function locksDelete($id, string $contentType = self::contentTypes['locksDelete'][0])
    {
        $this->locksDeleteWithHttpInfo($id, $contentType);
    }

    /**
     * Operation locksDeleteWithHttpInfo
     *
     * /api/v2/Locks/{id}
     *
     ...
     */
    public function locksDeleteWithHttpInfo($id, string $contentType = self::contentTypes['locksDelete'][0])
    {
        $request = $this->locksDeleteRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksDeleteAsync($id, string $contentType = self::contentTypes['locksDelete'][0])
    {
        return $this->locksDeleteAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation locksDeleteAsyncWithHttpInfo
     *
     * /api/v2/Locks/{id}
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksDeleteAsyncWithHttpInfo($id, string $contentType = self::contentTypes['locksDelete'][0])
    {
        $returnType = '';
        $request = $this->locksDeleteRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'locksDelete'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksDelete'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function locksDeleteRequest($id, string $contentType = self::contentTypes['locksDelete'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling locksDelete'
            );
        }


        $resourcePath = '/api/v2/Locks/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation locksGetAllLocks
     *
     * /api/v2/Locks
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksGetAllLocks'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Lock[]
     */
    public function locksGetAllLocks(string $contentType = self::contentTypes['locksGetAllLocks'][0])
    {
        list($response) = $this->locksGetAllLocksWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation locksGetAllLocksWithHttpInfo
     *
     * /api/v2/Locks
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksGetAllLocks'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Lock[], HTTP status code, HTTP response headers (array of strings)
     */
    public function locksGetAllLocksWithHttpInfo(string $contentType = self::contentTypes['locksGetAllLocks'][0])
    {
        $request = $this->locksGetAllLocksRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\Lock[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\Lock[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\Lock[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\Lock[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
    ...
    /**
     * Operation locksGetAllLocksAsync
     *
     * /api/v2/Locks
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksGetAllLocks'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksGetAllLocksAsync(string $contentType = self::contentTypes['locksGetAllLocks'][0])
    {
        return $this->locksGetAllLocksAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation locksGetAllLocksAsyncWithHttpInfo
     *
     * /api/v2/Locks
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksGetAllLocks'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksGetAllLocksAsyncWithHttpInfo(string $contentType = self::contentTypes['locksGetAllLocks'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Lock[]';
        $request = $this->locksGetAllLocksRequest($contentType);
    ...
    /**
     * Create request for operation 'locksGetAllLocks'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksGetAllLocks'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function locksGetAllLocksRequest(string $contentType = self::contentTypes['locksGetAllLocks'][0])
    {


        $resourcePath = '/api/v2/Locks';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation locksGetLockById
     *
     * /api/v2/Locks/{id}
     *
     * @param  string $id id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksGetLockById'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Lock
     */
    public function locksGetLockById($id, string $contentType = self::contentTypes['locksGetLockById'][0])
    {
        list($response) = $this->locksGetLockByIdWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation locksGetLockByIdWithHttpInfo
     *
     * /api/v2/Locks/{id}
     *
     * @param  string $id (required)
     ...
     * @return array of \OpenAPI\Client\Model\Lock, HTTP status code, HTTP response headers (array of strings)
     */
    public function locksGetLockByIdWithHttpInfo($id, string $contentType = self::contentTypes['locksGetLockById'][0])
    {
        $request = $this->locksGetLockByIdRequest($id, $contentType);
    ...
    /**
     * Operation locksGetLockByIdAsync
     *
     * /api/v2/Locks/{id}
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksGetLockByIdAsync($id, string $contentType = self::contentTypes['locksGetLockById'][0])
    {
        return $this->locksGetLockByIdAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation locksGetLockByIdAsyncWithHttpInfo
     *
     * /api/v2/Locks/{id}
     *
     * @param  string $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksGetLockByIdAsyncWithHttpInfo($id, string $contentType = self::contentTypes['locksGetLockById'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Lock';
        $request = $this->locksGetLockByIdRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'locksGetLockById'
     *
     * @param  string $id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksGetLockById'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function locksGetLockByIdRequest($id, string $contentType = self::contentTypes['locksGetLockById'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling locksGetLockById'
            );
        }
    ...
    /**
     * Operation locksGetLockOptions
     *
     * /api/v2/Locks/{id}/Options
     *
     * @param  string $id Lock Id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksGetLockOptions'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\LLockOptionMaskParam
     */
    public function locksGetLockOptions($id, string $contentType = self::contentTypes['locksGetLockOptions'][0])
    {
        list($response) = $this->locksGetLockOptionsWithHttpInfo($id, $contentType);
        return $response;
    }

    /**
     * Operation locksGetLockOptionsWithHttpInfo
     *
     * /api/v2/Locks/{id}/Options
     *
     * @param  string $id Lock Id (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\LLockOptionMaskParam, HTTP status code, HTTP response headers (array of strings)
     */
    public function locksGetLockOptionsWithHttpInfo($id, string $contentType = self::contentTypes['locksGetLockOptions'][0])
    {
        $request = $this->locksGetLockOptionsRequest($id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\LLockOptionMaskParam' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\LLockOptionMaskParam' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\LLockOptionMaskParam', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\LLockOptionMaskParam';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\LLockOptionMaskParam',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation locksGetLockOptionsAsync
     *
     * /api/v2/Locks/{id}/Options
     *
     * @param  string $id Lock Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksGetLockOptionsAsync($id, string $contentType = self::contentTypes['locksGetLockOptions'][0])
    {
        return $this->locksGetLockOptionsAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation locksGetLockOptionsAsyncWithHttpInfo
     *
     * /api/v2/Locks/{id}/Options
     *
     * @param  string $id Lock Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksGetLockOptionsAsyncWithHttpInfo($id, string $contentType = self::contentTypes['locksGetLockOptions'][0])
    {
        $returnType = '\OpenAPI\Client\Model\LLockOptionMaskParam';
        $request = $this->locksGetLockOptionsRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'locksGetLockOptions'
     *
     * @param  string $id Lock Id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksGetLockOptions'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function locksGetLockOptionsRequest($id, string $contentType = self::contentTypes['locksGetLockOptions'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling locksGetLockOptions'
            );
        }


        $resourcePath = '/api/v2/Locks/{id}/Options';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation locksGetSecurityAccesses
     *
     * /api/v2/Locks/{id}/SecurityAccesses
     *
     * @param  string $id Lock id (required)
     * @param  \OpenAPI\Client\Model\GetSecurityAccessesView $mode mode (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksGetSecurityAccesses'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetLockSecurityAccessesResult
     */
    public function locksGetSecurityAccesses($id, $mode, string $contentType = self::contentTypes['locksGetSecurityAccesses'][0])
    {
        list($response) = $this->locksGetSecurityAccessesWithHttpInfo($id, $mode, $contentType);
        return $response;
    }

    /**
     * Operation locksGetSecurityAccessesWithHttpInfo
     *
     * /api/v2/Locks/{id}/SecurityAccesses
     *
     * @param  string $id Lock id (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GetLockSecurityAccessesResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function locksGetSecurityAccessesWithHttpInfo($id, $mode, string $contentType = self::contentTypes['locksGetSecurityAccesses'][0])
    {
        $request = $this->locksGetSecurityAccessesRequest($id, $mode, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetLockSecurityAccessesResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GetLockSecurityAccessesResult' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetLockSecurityAccessesResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\GetLockSecurityAccessesResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetLockSecurityAccessesResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation locksGetSecurityAccessesAsync
     *
     * /api/v2/Locks/{id}/SecurityAccesses
     *
     * @param  string $id Lock id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksGetSecurityAccessesAsync($id, $mode, string $contentType = self::contentTypes['locksGetSecurityAccesses'][0])
    {
        return $this->locksGetSecurityAccessesAsyncWithHttpInfo($id, $mode, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation locksGetSecurityAccessesAsyncWithHttpInfo
     *
     * /api/v2/Locks/{id}/SecurityAccesses
     *
     * @param  string $id Lock id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksGetSecurityAccessesAsyncWithHttpInfo($id, $mode, string $contentType = self::contentTypes['locksGetSecurityAccesses'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetLockSecurityAccessesResult';
        $request = $this->locksGetSecurityAccessesRequest($id, $mode, $contentType);
    ...
    /**
     * Create request for operation 'locksGetSecurityAccesses'
     *
     * @param  string $id Lock id (required)
     * @param  \OpenAPI\Client\Model\GetSecurityAccessesView $mode (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksGetSecurityAccesses'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function locksGetSecurityAccessesRequest($id, $mode, string $contentType = self::contentTypes['locksGetSecurityAccesses'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling locksGetSecurityAccesses'
            );
        }
        ...
        if ($mode === null || (is_array($mode) && count($mode) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $mode when calling locksGetSecurityAccesses'
            );
        }


        $resourcePath = '/api/v2/Locks/{id}/SecurityAccesses';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation locksGetTimeLimits
     *
     * /api/v2/Locks/{id}/TimeLimitTitles
     *
     * @param  string $id Lock Id (required)
     * @param  \OpenAPI\Client\Model\GetTimeLimitsView $mode mode (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksGetTimeLimits'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\GetLockTimeLimitsResult
     */
    public function locksGetTimeLimits($id, $mode, string $contentType = self::contentTypes['locksGetTimeLimits'][0])
    {
        list($response) = $this->locksGetTimeLimitsWithHttpInfo($id, $mode, $contentType);
        return $response;
    }

    /**
     * Operation locksGetTimeLimitsWithHttpInfo
     *
     * /api/v2/Locks/{id}/TimeLimitTitles
     *
     * @param  string $id Lock Id (required)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\GetLockTimeLimitsResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function locksGetTimeLimitsWithHttpInfo($id, $mode, string $contentType = self::contentTypes['locksGetTimeLimits'][0])
    {
        $request = $this->locksGetTimeLimitsRequest($id, $mode, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetLockTimeLimitsResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GetLockTimeLimitsResult' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetLockTimeLimitsResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\GetLockTimeLimitsResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\GetLockTimeLimitsResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation locksGetTimeLimitsAsync
     *
     * /api/v2/Locks/{id}/TimeLimitTitles
     *
     * @param  string $id Lock Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksGetTimeLimitsAsync($id, $mode, string $contentType = self::contentTypes['locksGetTimeLimits'][0])
    {
        return $this->locksGetTimeLimitsAsyncWithHttpInfo($id, $mode, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation locksGetTimeLimitsAsyncWithHttpInfo
     *
     * /api/v2/Locks/{id}/TimeLimitTitles
     *
     * @param  string $id Lock Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksGetTimeLimitsAsyncWithHttpInfo($id, $mode, string $contentType = self::contentTypes['locksGetTimeLimits'][0])
    {
        $returnType = '\OpenAPI\Client\Model\GetLockTimeLimitsResult';
        $request = $this->locksGetTimeLimitsRequest($id, $mode, $contentType);
    ...
    /**
     * Create request for operation 'locksGetTimeLimits'
     *
     * @param  string $id Lock Id (required)
     * @param  \OpenAPI\Client\Model\GetTimeLimitsView $mode (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksGetTimeLimits'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function locksGetTimeLimitsRequest($id, $mode, string $contentType = self::contentTypes['locksGetTimeLimits'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling locksGetTimeLimits'
            );
        }
        ...
        if ($mode === null || (is_array($mode) && count($mode) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $mode when calling locksGetTimeLimits'
            );
        }


        $resourcePath = '/api/v2/Locks/{id}/TimeLimitTitles';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation locksInsert
     *
     * /api/v2/Locks
     *
     * @param  \OpenAPI\Client\Model\InsertLockParam $insert_lock_param insert_lock_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksInsert'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\Lock2
     */
    public function locksInsert($insert_lock_param, string $contentType = self::contentTypes['locksInsert'][0])
    {
        list($response) = $this->locksInsertWithHttpInfo($insert_lock_param, $contentType);
        return $response;
    }

    /**
     * Operation locksInsertWithHttpInfo
     *
     * /api/v2/Locks
     *
     * @param  \OpenAPI\Client\Model\InsertLockParam $insert_lock_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksInsert'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\Lock2, HTTP status code, HTTP response headers (array of strings)
     */
    public function locksInsertWithHttpInfo($insert_lock_param, string $contentType = self::contentTypes['locksInsert'][0])
    {
        $request = $this->locksInsertRequest($insert_lock_param, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\Lock2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\Lock2' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\Lock2', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\Lock2';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksInsertAsync($insert_lock_param, string $contentType = self::contentTypes['locksInsert'][0])
    {
        return $this->locksInsertAsyncWithHttpInfo($insert_lock_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation locksInsertAsyncWithHttpInfo
     *
     * /api/v2/Locks
     *
     * @param  \OpenAPI\Client\Model\InsertLockParam $insert_lock_param (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksInsertAsyncWithHttpInfo($insert_lock_param, string $contentType = self::contentTypes['locksInsert'][0])
    {
        $returnType = '\OpenAPI\Client\Model\Lock2';
        $request = $this->locksInsertRequest($insert_lock_param, $contentType);
    ...
    /**
     * Create request for operation 'locksInsert'
     *
     * @param  \OpenAPI\Client\Model\InsertLockParam $insert_lock_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksInsert'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function locksInsertRequest($insert_lock_param, string $contentType = self::contentTypes['locksInsert'][0])
    {

        // verify the required parameter 'insert_lock_param' is set
        if ($insert_lock_param === null || (is_array($insert_lock_param) && count($insert_lock_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $insert_lock_param when calling locksInsert'
            );
        }
        ...
        // for model (json/xml)
        if (isset($insert_lock_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($insert_lock_param));
            } else {
                $httpBody = $insert_lock_param;
            }
    ...
    /**
     * Operation locksOrderLock
     *
     * /api/v2/Locks/{id}/Order
     *
     * @param  string $id Lock Id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksOrderLock'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function locksOrderLock($id, string $contentType = self::contentTypes['locksOrderLock'][0])
    {
        $this->locksOrderLockWithHttpInfo($id, $contentType);
    }

    /**
     * Operation locksOrderLockWithHttpInfo
     *
     * /api/v2/Locks/{id}/Order
     *
     * @param  string $id Lock Id (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function locksOrderLockWithHttpInfo($id, string $contentType = self::contentTypes['locksOrderLock'][0])
    {
        $request = $this->locksOrderLockRequest($id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksOrderLockAsync($id, string $contentType = self::contentTypes['locksOrderLock'][0])
    {
        return $this->locksOrderLockAsyncWithHttpInfo($id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation locksOrderLockAsyncWithHttpInfo
     *
     * /api/v2/Locks/{id}/Order
     *
     * @param  string $id Lock Id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksOrderLockAsyncWithHttpInfo($id, string $contentType = self::contentTypes['locksOrderLock'][0])
    {
        $returnType = '';
        $request = $this->locksOrderLockRequest($id, $contentType);
    ...
    /**
     * Create request for operation 'locksOrderLock'
     *
     * @param  string $id Lock Id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksOrderLock'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function locksOrderLockRequest($id, string $contentType = self::contentTypes['locksOrderLock'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling locksOrderLock'
            );
        }


        $resourcePath = '/api/v2/Locks/{id}/Order';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation locksUpdate
     *
     * /api/v2/Locks
     *
     * @param  \OpenAPI\Client\Model\UpdateLockParam $update_lock_param update_lock_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksUpdate'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function locksUpdate($update_lock_param, string $contentType = self::contentTypes['locksUpdate'][0])
    {
        $this->locksUpdateWithHttpInfo($update_lock_param, $contentType);
    }

    /**
     * Operation locksUpdateWithHttpInfo
     *
     * /api/v2/Locks
     *
     * @param  \OpenAPI\Client\Model\UpdateLockParam $update_lock_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksUpdate'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function locksUpdateWithHttpInfo($update_lock_param, string $contentType = self::contentTypes['locksUpdate'][0])
    {
        $request = $this->locksUpdateRequest($update_lock_param, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksUpdateAsync($update_lock_param, string $contentType = self::contentTypes['locksUpdate'][0])
    {
        return $this->locksUpdateAsyncWithHttpInfo($update_lock_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation locksUpdateAsyncWithHttpInfo
     *
     * /api/v2/Locks
     *
     * @param  \OpenAPI\Client\Model\UpdateLockParam $update_lock_param (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksUpdateAsyncWithHttpInfo($update_lock_param, string $contentType = self::contentTypes['locksUpdate'][0])
    {
        $returnType = '';
        $request = $this->locksUpdateRequest($update_lock_param, $contentType);
    ...
    /**
     * Create request for operation 'locksUpdate'
     *
     * @param  \OpenAPI\Client\Model\UpdateLockParam $update_lock_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksUpdate'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function locksUpdateRequest($update_lock_param, string $contentType = self::contentTypes['locksUpdate'][0])
    {

        // verify the required parameter 'update_lock_param' is set
        if ($update_lock_param === null || (is_array($update_lock_param) && count($update_lock_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_lock_param when calling locksUpdate'
            );
        }
        ...
        // for model (json/xml)
        if (isset($update_lock_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_lock_param));
            } else {
                $httpBody = $update_lock_param;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation locksUpdateSecurityAccesses
     *
     * /api/v2/Locks/{id}/SecurityAccesses
     *
     * @param  string $id Lock id (required)
     * @param  \OpenAPI\Client\Model\UpdateLockSecurityAccessesParam $update_lock_security_accesses_param Parameter (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksUpdateSecurityAccesses'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return void
     */
    public function locksUpdateSecurityAccesses($id, $update_lock_security_accesses_param, string $contentType = self::contentTypes['locksUpdateSecurityAccesses'][0])
    {
        $this->locksUpdateSecurityAccessesWithHttpInfo($id, $update_lock_security_accesses_param, $contentType);
    }

    /**
     * Operation locksUpdateSecurityAccessesWithHttpInfo
     *
     * /api/v2/Locks/{id}/SecurityAccesses
     *
     * @param  string $id Lock id (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function locksUpdateSecurityAccessesWithHttpInfo($id, $update_lock_security_accesses_param, string $contentType = self::contentTypes['locksUpdateSecurityAccesses'][0])
    {
        $request = $this->locksUpdateSecurityAccessesRequest($id, $update_lock_security_accesses_param, $contentType);
    ...
    /**
     * Operation locksUpdateSecurityAccessesAsync
     *
     * /api/v2/Locks/{id}/SecurityAccesses
     *
     * @param  string $id Lock id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksUpdateSecurityAccessesAsync($id, $update_lock_security_accesses_param, string $contentType = self::contentTypes['locksUpdateSecurityAccesses'][0])
    {
        return $this->locksUpdateSecurityAccessesAsyncWithHttpInfo($id, $update_lock_security_accesses_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation locksUpdateSecurityAccessesAsyncWithHttpInfo
     *
     * /api/v2/Locks/{id}/SecurityAccesses
     *
     * @param  string $id Lock id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function locksUpdateSecurityAccessesAsyncWithHttpInfo($id, $update_lock_security_accesses_param, string $contentType = self::contentTypes['locksUpdateSecurityAccesses'][0])
    {
        $returnType = '';
        $request = $this->locksUpdateSecurityAccessesRequest($id, $update_lock_security_accesses_param, $contentType);
    ...
    /**
     * Create request for operation 'locksUpdateSecurityAccesses'
     *
     * @param  string $id Lock id (required)
     * @param  \OpenAPI\Client\Model\UpdateLockSecurityAccessesParam $update_lock_security_accesses_param Parameter (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['locksUpdateSecurityAccesses'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function locksUpdateSecurityAccessesRequest($id, $update_lock_security_accesses_param, string $contentType = self::contentTypes['locksUpdateSecurityAccesses'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling locksUpdateSecurityAccesses'
            );
        }

        // verify the required parameter 'update_lock_security_accesses_param' is set
        if ($update_lock_security_accesses_param === null || (is_array($update_lock_security_accesses_param) && count($update_lock_security_accesses_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_lock_security_accesses_param when calling locksUpdateSecurityAccesses'
            );
        }
        ...
        // for model (json/xml)
        if (isset($update_lock_security_accesses_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($update_lock_security_accesses_param));
            } else {
                $httpBody = $update_lock_security_accesses_param;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
