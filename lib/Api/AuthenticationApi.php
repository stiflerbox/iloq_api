...
class AuthenticationApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\CreateSessionParam $create_session_param create_session_param (required)
     ...
     * @return \OpenAPI\Client\Model\CreateSessionResult
     */
    public function authenticationCreateSession($create_session_param, string $contentType = self::contentTypes['authenticationCreateSession'][0])
    {
        list($response) = $this->authenticationCreateSessionWithHttpInfo($create_session_param, $contentType);
        return $response;
    }
     ...
     * /api/v2/CreateSession
     *
     * @param  \OpenAPI\Client\Model\CreateSessionParam $create_session_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationCreateSession'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\CreateSessionResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function authenticationCreateSessionWithHttpInfo($create_session_param, string $contentType = self::contentTypes['authenticationCreateSession'][0])
    {
        $request = $this->authenticationCreateSessionRequest($create_session_param, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\CreateSessionResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\CreateSessionResult' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\CreateSessionResult', []),
            ...
            $returnType = '\OpenAPI\Client\Model\CreateSessionResult';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\CreateSessionResult',
     ...
     */
    public function authenticationCreateSessionAsync($create_session_param, string $contentType = self::contentTypes['authenticationCreateSession'][0])
    {
        return $this->authenticationCreateSessionAsyncWithHttpInfo($create_session_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function authenticationCreateSessionAsyncWithHttpInfo($create_session_param, string $contentType = self::contentTypes['authenticationCreateSession'][0])
    {
        $returnType = '\OpenAPI\Client\Model\CreateSessionResult';
        $request = $this->authenticationCreateSessionRequest($create_session_param, $contentType);
     ...
     */
    public function authenticationCreateSessionRequest($create_session_param, string $contentType = self::contentTypes['authenticationCreateSession'][0])
    {

        // verify the required parameter 'create_session_param' is set
        if ($create_session_param === null || (is_array($create_session_param) && count($create_session_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_session_param when calling authenticationCreateSession'
            );
        }


        $resourcePath = '/api/v2/CreateSession';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($create_session_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($create_session_param));
            } else {
                $httpBody = $create_session_param;
            }
    ...
    /**
     * Operation authenticationKillSession
     *
     * /api/v2/KillSession
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationKillSession'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \SplFileObject
     */
    public function authenticationKillSession(string $contentType = self::contentTypes['authenticationKillSession'][0])
    {
        list($response) = $this->authenticationKillSessionWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation authenticationKillSessionWithHttpInfo
     *
     * /api/v2/KillSession
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationKillSession'] to see the possible values for this operation
     ...
     */
    public function authenticationKillSessionWithHttpInfo(string $contentType = self::contentTypes['authenticationKillSession'][0])
    {
        $request = $this->authenticationKillSessionRequest($contentType);
    ...
    /**
     * Operation authenticationKillSessionAsync
     *
     * /api/v2/KillSession
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationKillSession'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function authenticationKillSessionAsync(string $contentType = self::contentTypes['authenticationKillSession'][0])
    {
        return $this->authenticationKillSessionAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation authenticationKillSessionAsyncWithHttpInfo
     *
     * /api/v2/KillSession
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationKillSession'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function authenticationKillSessionAsyncWithHttpInfo(string $contentType = self::contentTypes['authenticationKillSession'][0])
    {
        $returnType = '\SplFileObject';
        $request = $this->authenticationKillSessionRequest($contentType);
    ...
    /**
     * Create request for operation 'authenticationKillSession'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationKillSession'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function authenticationKillSessionRequest(string $contentType = self::contentTypes['authenticationKillSession'][0])
    {


        $resourcePath = '/api/v2/KillSession';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation authenticationSetLockgroup
     *
     * /api/v2/SetLockgroup
     *
     * @param  \OpenAPI\Client\Model\SetLockgroupParam $set_lockgroup_param set_lockgroup_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationSetLockgroup'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SetLockgroupResult
     */
    public function authenticationSetLockgroup($set_lockgroup_param, string $contentType = self::contentTypes['authenticationSetLockgroup'][0])
    {
        list($response) = $this->authenticationSetLockgroupWithHttpInfo($set_lockgroup_param, $contentType);
        return $response;
    }

    /**
     * Operation authenticationSetLockgroupWithHttpInfo
     *
     * /api/v2/SetLockgroup
     *
     * @param  \OpenAPI\Client\Model\SetLockgroupParam $set_lockgroup_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationSetLockgroup'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\SetLockgroupResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function authenticationSetLockgroupWithHttpInfo($set_lockgroup_param, string $contentType = self::contentTypes['authenticationSetLockgroup'][0])
    {
        $request = $this->authenticationSetLockgroupRequest($set_lockgroup_param, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\SetLockgroupResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\SetLockgroupResult' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\SetLockgroupResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            $returnType = '\OpenAPI\Client\Model\SetLockgroupResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\SetLockgroupResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation authenticationSetLockgroupAsync
     *
     * /api/v2/SetLockgroup
     *
     * @param  \OpenAPI\Client\Model\SetLockgroupParam $set_lockgroup_param (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function authenticationSetLockgroupAsync($set_lockgroup_param, string $contentType = self::contentTypes['authenticationSetLockgroup'][0])
    {
        return $this->authenticationSetLockgroupAsyncWithHttpInfo($set_lockgroup_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation authenticationSetLockgroupAsyncWithHttpInfo
     *
     * /api/v2/SetLockgroup
     *
     * @param  \OpenAPI\Client\Model\SetLockgroupParam $set_lockgroup_param (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function authenticationSetLockgroupAsyncWithHttpInfo($set_lockgroup_param, string $contentType = self::contentTypes['authenticationSetLockgroup'][0])
    {
        $returnType = '\OpenAPI\Client\Model\SetLockgroupResult';
        $request = $this->authenticationSetLockgroupRequest($set_lockgroup_param, $contentType);
    ...
    /**
     * Create request for operation 'authenticationSetLockgroup'
     *
     * @param  \OpenAPI\Client\Model\SetLockgroupParam $set_lockgroup_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationSetLockgroup'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function authenticationSetLockgroupRequest($set_lockgroup_param, string $contentType = self::contentTypes['authenticationSetLockgroup'][0])
    {

        // verify the required parameter 'set_lockgroup_param' is set
        if ($set_lockgroup_param === null || (is_array($set_lockgroup_param) && count($set_lockgroup_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $set_lockgroup_param when calling authenticationSetLockgroup'
            );
        }


        $resourcePath = '/api/v2/SetLockgroup';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($set_lockgroup_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($set_lockgroup_param));
            } else {
                $httpBody = $set_lockgroup_param;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * /api/v2/Test
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationTest'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return string
     */
    public function authenticationTest(string $contentType = self::contentTypes['authenticationTest'][0])
    {
        list($response) = $this->authenticationTestWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation authenticationTestWithHttpInfo
     *
     * /api/v2/Test
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationTest'] to see the possible values for this operation
     ...
     */
    public function authenticationTestWithHttpInfo(string $contentType = self::contentTypes['authenticationTest'][0])
    {
        $request = $this->authenticationTestRequest($contentType);
    ...
    /**
     * Operation authenticationTestAsync
     *
     * /api/v2/Test
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationTest'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function authenticationTestAsync(string $contentType = self::contentTypes['authenticationTest'][0])
    {
        return $this->authenticationTestAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation authenticationTestAsyncWithHttpInfo
     *
     * /api/v2/Test
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationTest'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function authenticationTestAsyncWithHttpInfo(string $contentType = self::contentTypes['authenticationTest'][0])
    {
        $returnType = 'string';
        $request = $this->authenticationTestRequest($contentType);
    ...
    /**
     * Create request for operation 'authenticationTest'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationTest'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function authenticationTestRequest(string $contentType = self::contentTypes['authenticationTest'][0])
    {
    ...
    /**
     * Operation authenticationVersion
     *
     * /api/v2/Version
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationVersion'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return string
     */
    public function authenticationVersion(string $contentType = self::contentTypes['authenticationVersion'][0])
    {
        list($response) = $this->authenticationVersionWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation authenticationVersionWithHttpInfo
     *
     * /api/v2/Version
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationVersion'] to see the possible values for this operation
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function authenticationVersionWithHttpInfo(string $contentType = self::contentTypes['authenticationVersion'][0])
    {
        $request = $this->authenticationVersionRequest($contentType);
    ...
    /**
     * Operation authenticationVersionAsync
     *
     * /api/v2/Version
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationVersion'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function authenticationVersionAsync(string $contentType = self::contentTypes['authenticationVersion'][0])
    {
        return $this->authenticationVersionAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation authenticationVersionAsyncWithHttpInfo
     *
     * /api/v2/Version
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationVersion'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function authenticationVersionAsyncWithHttpInfo(string $contentType = self::contentTypes['authenticationVersion'][0])
    {
        $returnType = 'string';
        $request = $this->authenticationVersionRequest($contentType);
    ...
    /**
     * Create request for operation 'authenticationVersion'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['authenticationVersion'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function authenticationVersionRequest(string $contentType = self::contentTypes['authenticationVersion'][0])
    {
