...
class UrlApi
{
     ...
     * /api/v2/Url/GetUrl
     *
     * @param  \OpenAPI\Client\Model\PublicApiGetUrlParam $public_api_get_url_param public_api_get_url_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['urlGetUrl'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return string
     */
    public function urlGetUrl($public_api_get_url_param, string $contentType = self::contentTypes['urlGetUrl'][0])
    {
        list($response) = $this->urlGetUrlWithHttpInfo($public_api_get_url_param, $contentType);
        return $response;
    }

    /**
     * Operation urlGetUrlWithHttpInfo
     *
     * /api/v2/Url/GetUrl
     *
     * @param  \OpenAPI\Client\Model\PublicApiGetUrlParam $public_api_get_url_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['urlGetUrl'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     ...
     */
    public function urlGetUrlWithHttpInfo($public_api_get_url_param, string $contentType = self::contentTypes['urlGetUrl'][0])
    {
        $request = $this->urlGetUrlRequest($public_api_get_url_param, $contentType);
     ...
     */
    public function urlGetUrlAsync($public_api_get_url_param, string $contentType = self::contentTypes['urlGetUrl'][0])
    {
        return $this->urlGetUrlAsyncWithHttpInfo($public_api_get_url_param, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation urlGetUrlAsyncWithHttpInfo
     *
     * /api/v2/Url/GetUrl
     *
     * @param  \OpenAPI\Client\Model\PublicApiGetUrlParam $public_api_get_url_param (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function urlGetUrlAsyncWithHttpInfo($public_api_get_url_param, string $contentType = self::contentTypes['urlGetUrl'][0])
    {
        $returnType = 'string';
        $request = $this->urlGetUrlRequest($public_api_get_url_param, $contentType);
    ...
    /**
     * Create request for operation 'urlGetUrl'
     *
     * @param  \OpenAPI\Client\Model\PublicApiGetUrlParam $public_api_get_url_param (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['urlGetUrl'] to see the possible values for this operation
     *
     ...
     */
    public function urlGetUrlRequest($public_api_get_url_param, string $contentType = self::contentTypes['urlGetUrl'][0])
    {

        // verify the required parameter 'public_api_get_url_param' is set
        if ($public_api_get_url_param === null || (is_array($public_api_get_url_param) && count($public_api_get_url_param) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $public_api_get_url_param when calling urlGetUrl'
            );
        }


        $resourcePath = '/api/v2/Url/GetUrl';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($public_api_get_url_param)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($public_api_get_url_param));
            } else {
                $httpBody = $public_api_get_url_param;
            }
