...
/**
 * RealEstatesApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class RealEstatesApi
{
    ...
    /**
     * Operation realEstatesGetValues
     *
     * /api/v2/RealEstates
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['realEstatesGetValues'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\RealEstate[]
     */
    public function realEstatesGetValues(string $contentType = self::contentTypes['realEstatesGetValues'][0])
    {
        list($response) = $this->realEstatesGetValuesWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation realEstatesGetValuesWithHttpInfo
     *
     * /api/v2/RealEstates
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['realEstatesGetValues'] to see the possible values for this operation
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\RealEstate[], HTTP status code, HTTP response headers (array of strings)
     */
    public function realEstatesGetValuesWithHttpInfo(string $contentType = self::contentTypes['realEstatesGetValues'][0])
    {
        $request = $this->realEstatesGetValuesRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\RealEstate[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\RealEstate[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\RealEstate[]', []),
            ...
            $returnType = '\OpenAPI\Client\Model\RealEstate[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\RealEstate[]',
    ...
    /**
     * Operation realEstatesGetValuesAsync
     *
     * /api/v2/RealEstates
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['realEstatesGetValues'] to see the possible values for this operation
     ...
     */
    public function realEstatesGetValuesAsync(string $contentType = self::contentTypes['realEstatesGetValues'][0])
    {
        return $this->realEstatesGetValuesAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation realEstatesGetValuesAsyncWithHttpInfo
     *
     * /api/v2/RealEstates
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['realEstatesGetValues'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function realEstatesGetValuesAsyncWithHttpInfo(string $contentType = self::contentTypes['realEstatesGetValues'][0])
    {
        $returnType = '\OpenAPI\Client\Model\RealEstate[]';
        $request = $this->realEstatesGetValuesRequest($contentType);
    ...
    /**
     * Create request for operation 'realEstatesGetValues'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['realEstatesGetValues'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     ...
     */
    public function realEstatesGetValuesRequest(string $contentType = self::contentTypes['realEstatesGetValues'][0])
    {


        $resourcePath = '/api/v2/RealEstates';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
