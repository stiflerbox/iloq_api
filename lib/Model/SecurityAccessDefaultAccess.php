...
/**
 * SecurityAccessDefaultAccess Class Doc Comment
 *
 * @category Class
 * @description Is security access set for locks as default
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SecurityAccessDefaultAccess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecurityAccess_DefaultAccess';
