 ...
 *
 * @category Class
 * @description Single webhook event payload
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Payload implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'failed_requests' => 'int',
        'response' => 'string',
        'state' => '\OpenAPI\Client\Model\PayloadState',
        'subscription_id' => 'string',
        'webhook_event_payload_id' => 'string'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'webhook_event_payload_id' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'webhook_event_payload_id' => 'WebhookEventPayloadId'
    ];
    ...
    protected static $setters = [
        ...
        'webhook_event_payload_id' => 'setWebhookEventPayloadId'
    ];
    ...
    protected static $getters = [
        ...
        'webhook_event_payload_id' => 'getWebhookEventPayloadId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('failed_requests', $data ?? [], null);
        $this->setIfExists('response', $data ?? [], null);
        $this->setIfExists('state', $data ?? [], null);
        $this->setIfExists('subscription_id', $data ?? [], null);
        $this->setIfExists('webhook_event_payload_id', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets created_utc
     *
     * @param \DateTime|null $created_utc When payload was created
     *
     * @return self
     */
    ...
    /**
     * Sets failed_requests
     *
     * @param int|null $failed_requests Count of how many times sending payload has failed
     *
     * @return self
     */
    public function setFailedRequests($failed_requests)
    {
        ...
        $this->container['failed_requests'] = $failed_requests;
     ...
     * Sets response
     *
     * @param string|null $response Response from listening endpoint
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \OpenAPI\Client\Model\PayloadState|null
     */
     ...
     * Sets state
     *
     * @param \OpenAPI\Client\Model\PayloadState|null $state state
     *
     * @return self
     */
    ...
    /**
     * Gets webhook_event_payload_id
     *
     * @return string|null
     */
    public function getWebhookEventPayloadId()
    {
        return $this->container['webhook_event_payload_id'];
    }

    /**
     * Sets webhook_event_payload_id
     *
     * @param string|null $webhook_event_payload_id Id
     *
     * @return self
     */
    public function setWebhookEventPayloadId($webhook_event_payload_id)
    {
        if (is_null($webhook_event_payload_id)) {
            throw new \InvalidArgumentException('non-nullable webhook_event_payload_id cannot be null');
        }
        $this->container['webhook_event_payload_id'] = $webhook_event_payload_id;
