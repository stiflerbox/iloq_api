...
/**
 * SecurityAccess2Status Class Doc Comment
 *
 * @category Class
 * @description status
 * @package  OpenAPI\Client
 ...
 */
class SecurityAccess2Status implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecurityAccess2_Status';
