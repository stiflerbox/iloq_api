...
/**
 * GetKeysByPersonResult1 Class Doc Comment
 *
 * @category Class
 * @description Result for getting keys for person
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetKeysByPersonResult1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetKeysByPersonResult1';
    ...
    protected static $openAPITypes = [
        'keys' => '\OpenAPI\Client\Model\Key1[]'
    ];
    ...
    */
     ...
     * Gets keys
     *
     * @return \OpenAPI\Client\Model\Key1[]|null
     */
     ...
     * Sets keys
     *
     * @param \OpenAPI\Client\Model\Key1[]|null $keys List of person's keys
     *
     * @return self
     */
