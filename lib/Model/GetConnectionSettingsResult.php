...
/**
 * GetConnectionSettingsResult Class Doc Comment
 *
 * @category Class
 * @description Signal service settings
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetConnectionSettingsResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetConnectionSettingsResult';
    ...
    protected static $openAPITypes = [
        'signal_message_service_address' => 'string',
        'signal_r_service_address' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'signal_message_service_address' => null,
        'signal_r_service_address' => null
    ];
    ...
    protected static array $openAPINullables = [
        'signal_message_service_address' => true,
        'signal_r_service_address' => true
    ];
    ...
    protected static $attributeMap = [
        'signal_message_service_address' => 'SignalMessageServiceAddress',
        'signal_r_service_address' => 'SignalRServiceAddress'
    ];
    ...
    protected static $setters = [
        'signal_message_service_address' => 'setSignalMessageServiceAddress',
        'signal_r_service_address' => 'setSignalRServiceAddress'
    ];
    ...
    protected static $getters = [
        'signal_message_service_address' => 'getSignalMessageServiceAddress',
        'signal_r_service_address' => 'getSignalRServiceAddress'
    ];
    ...
    {
        $this->setIfExists('signal_message_service_address', $data ?? [], null);
        $this->setIfExists('signal_r_service_address', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets signal_message_service_address
     *
     * @return string|null
     */
    public function getSignalMessageServiceAddress()
    {
        return $this->container['signal_message_service_address'];
    }

    /**
     * Sets signal_message_service_address
     *
     * @param string|null $signal_message_service_address Address for old message service.
     *
     * @return self
     */
    public function setSignalMessageServiceAddress($signal_message_service_address)
    {
        if (is_null($signal_message_service_address)) {
            array_push($this->openAPINullablesSetToNull, 'signal_message_service_address');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('signal_message_service_address', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['signal_message_service_address'] = $signal_message_service_address;

        return $this;
    }

    /**
     * Gets signal_r_service_address
     *
     * @return string|null
     */
    public function getSignalRServiceAddress()
    {
        return $this->container['signal_r_service_address'];
    }

    /**
     * Sets signal_r_service_address
     *
     * @param string|null $signal_r_service_address Address for new signalr service
     *
     * @return self
     */
    public function setSignalRServiceAddress($signal_r_service_address)
    {
        if (is_null($signal_r_service_address)) {
            array_push($this->openAPINullablesSetToNull, 'signal_r_service_address');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('signal_r_service_address', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['signal_r_service_address'] = $signal_r_service_address;
