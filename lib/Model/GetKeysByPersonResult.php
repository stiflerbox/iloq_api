...
/**
 * GetKeysByPersonResult Class Doc Comment
 *
 * @category Class
 ...
 */
class GetKeysByPersonResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetKeysByPersonResult';
    ...
    */
     ...
     * Gets keys
     *
     * @return \OpenAPI\Client\Model\Key[]|null
     */
     ...
     * Sets keys
     *
     * @param \OpenAPI\Client\Model\Key[]|null $keys List of person's keys
     *
     * @return self
     */
