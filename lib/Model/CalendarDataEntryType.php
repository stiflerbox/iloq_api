...
/**
 * CalendarDataEntryType Class Doc Comment
 *
 * @category Class
 * @description Type
 * @package  OpenAPI\Client
 ...
 */
class CalendarDataEntryType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarDataEntry_Type';
