...
/**
 * InsertPersonParam Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InsertPersonParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertPersonParam';
    ...
    protected static $openAPITypes = [
        'person' => '\OpenAPI\Client\Model\InsertPersonParamPerson',
        'zone_ids' => 'string[]'
    ];
    ...
    */
     ...
     * Gets person
     *
     * @return \OpenAPI\Client\Model\InsertPersonParamPerson|null
     */
     ...
     * Sets person
     *
     * @param \OpenAPI\Client\Model\InsertPersonParamPerson|null $person person
     *
     * @return self
     */
     ...
     * Sets zone_ids
     *
     * @param string[]|null $zone_ids Zones which user is linked to
     *
     * @return self
     */
