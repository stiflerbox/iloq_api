...
/**
 * GetLockLogsResult Class Doc Comment
 *
 * @category Class
 * @description Result for getting Device logs
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetLockLogsResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetLockLogsResult';
    ...
    protected static $openAPITypes = [
        'lock_logs' => '\OpenAPI\Client\Model\DeviceLogData[]',
        'total_count' => 'int'
    ];
    ...
    */
     ...
     * Gets lock_logs
     *
     * @return \OpenAPI\Client\Model\DeviceLogData[]|null
     */
     ...
     * Sets lock_logs
     *
     * @param \OpenAPI\Client\Model\DeviceLogData[]|null $lock_logs Device logs. Currently maximum of 2000 is returned at once.
     *
     * @return self
     */
     ...
     * Sets total_count
     *
     * @param int|null $total_count Total number of device logs on server with given parameters. Calling application can compare LockLogs.Count to this number and if they don't match, change parameters to narrow it down.
     *
     * @return self
     */
