...
/**
 * UpdateLockSecurityAccessesParamLockOptions Class Doc Comment
 *
 * @category Class
 * @description Lock&#39;s options
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateLockSecurityAccessesParamLockOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateLockSecurityAccessesParam_LockOptions';
    ...
    protected static $openAPITypes = [
        's10_collect_audit_trail' => 'bool',
        's40_accept_soft_group' => 'bool',
        's40_flip_flop' => 'bool',
        's40_logging_on' => 'bool',
        's40_online_required_hard' => 'bool',
        's40_online_required_soft' => 'bool',
        'save_online_lock_audit_trail' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        's10_collect_audit_trail' => null,
        's40_accept_soft_group' => null,
        's40_flip_flop' => null,
        's40_logging_on' => null,
        's40_online_required_hard' => null,
        's40_online_required_soft' => null,
        'save_online_lock_audit_trail' => null
    ];
    ...
    protected static array $openAPINullables = [
        's10_collect_audit_trail' => true,
        's40_accept_soft_group' => true,
        's40_flip_flop' => true,
        's40_logging_on' => true,
        's40_online_required_hard' => true,
        's40_online_required_soft' => true,
        'save_online_lock_audit_trail' => true
    ];
    ...
    protected static $attributeMap = [
        's10_collect_audit_trail' => 'S10CollectAuditTrail',
        's40_accept_soft_group' => 'S40AcceptSoftGroup',
        's40_flip_flop' => 'S40FlipFlop',
        's40_logging_on' => 'S40LoggingOn',
        's40_online_required_hard' => 'S40OnlineRequiredHard',
        's40_online_required_soft' => 'S40OnlineRequiredSoft',
        'save_online_lock_audit_trail' => 'SaveOnlineLockAuditTrail'
    ];
    ...
    protected static $setters = [
        's10_collect_audit_trail' => 'setS10CollectAuditTrail',
        's40_accept_soft_group' => 'setS40AcceptSoftGroup',
        's40_flip_flop' => 'setS40FlipFlop',
        's40_logging_on' => 'setS40LoggingOn',
        's40_online_required_hard' => 'setS40OnlineRequiredHard',
        's40_online_required_soft' => 'setS40OnlineRequiredSoft',
        'save_online_lock_audit_trail' => 'setSaveOnlineLockAuditTrail'
    ];
    ...
    protected static $getters = [
        's10_collect_audit_trail' => 'getS10CollectAuditTrail',
        's40_accept_soft_group' => 'getS40AcceptSoftGroup',
        's40_flip_flop' => 'getS40FlipFlop',
        's40_logging_on' => 'getS40LoggingOn',
        's40_online_required_hard' => 'getS40OnlineRequiredHard',
        's40_online_required_soft' => 'getS40OnlineRequiredSoft',
        'save_online_lock_audit_trail' => 'getSaveOnlineLockAuditTrail'
    ];
    ...
    {
        $this->setIfExists('s10_collect_audit_trail', $data ?? [], null);
        $this->setIfExists('s40_accept_soft_group', $data ?? [], null);
        $this->setIfExists('s40_flip_flop', $data ?? [], null);
        $this->setIfExists('s40_logging_on', $data ?? [], null);
        $this->setIfExists('s40_online_required_hard', $data ?? [], null);
        $this->setIfExists('s40_online_required_soft', $data ?? [], null);
        $this->setIfExists('save_online_lock_audit_trail', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets s10_collect_audit_trail
     *
     * @return bool|null
     */
    public function getS10CollectAuditTrail()
    {
        return $this->container['s10_collect_audit_trail'];
    }

    /**
     * Sets s10_collect_audit_trail
     *
     * @param bool|null $s10_collect_audit_trail sets S10CollectAuditTrail option on/off/leaves old value if null
     *
     * @return self
     */
    public function setS10CollectAuditTrail($s10_collect_audit_trail)
    {
        if (is_null($s10_collect_audit_trail)) {
            array_push($this->openAPINullablesSetToNull, 's10_collect_audit_trail');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('s10_collect_audit_trail', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['s10_collect_audit_trail'] = $s10_collect_audit_trail;

        return $this;
    }

    /**
     * Gets s40_accept_soft_group
     *
     * @return bool|null
     */
    public function getS40AcceptSoftGroup()
    {
        return $this->container['s40_accept_soft_group'];
    }

    /**
     * Sets s40_accept_soft_group
     *
     * @param bool|null $s40_accept_soft_group sets S40AcceptSoftGroup option on/off/leaves old value if null
     *
     * @return self
     */
    public function setS40AcceptSoftGroup($s40_accept_soft_group)
    {
        if (is_null($s40_accept_soft_group)) {
            array_push($this->openAPINullablesSetToNull, 's40_accept_soft_group');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('s40_accept_soft_group', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['s40_accept_soft_group'] = $s40_accept_soft_group;
     ...
     * @return bool|null
     */
    public function getS40FlipFlop()
    {
        return $this->container['s40_flip_flop'];
    }

    /**
     * Sets s40_flip_flop
     *
     * @param bool|null $s40_flip_flop sets S40FlipFlop option on/off/leaves old value if null
     *
     * @return self
     */
    public function setS40FlipFlop($s40_flip_flop)
    {
        if (is_null($s40_flip_flop)) {
            array_push($this->openAPINullablesSetToNull, 's40_flip_flop');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('s40_flip_flop', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['s40_flip_flop'] = $s40_flip_flop;
     ...
     * @return bool|null
     */
    public function getS40LoggingOn()
    {
        return $this->container['s40_logging_on'];
    }

    /**
     * Sets s40_logging_on
     *
     * @param bool|null $s40_logging_on sets S40LoggingOn option on/off/leaves old value if null
     *
     * @return self
     */
    public function setS40LoggingOn($s40_logging_on)
    {
        if (is_null($s40_logging_on)) {
            array_push($this->openAPINullablesSetToNull, 's40_logging_on');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('s40_logging_on', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['s40_logging_on'] = $s40_logging_on;

        return $this;
    }

    /**
     * Gets s40_online_required_hard
     *
     * @return bool|null
     */
    public function getS40OnlineRequiredHard()
    {
        return $this->container['s40_online_required_hard'];
    }

    /**
     * Sets s40_online_required_hard
     *
     * @param bool|null $s40_online_required_hard sets S40OnlineRequiredHard option on/off/leaves old value if null
     *
     * @return self
     */
    public function setS40OnlineRequiredHard($s40_online_required_hard)
    {
        if (is_null($s40_online_required_hard)) {
            array_push($this->openAPINullablesSetToNull, 's40_online_required_hard');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('s40_online_required_hard', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['s40_online_required_hard'] = $s40_online_required_hard;

        return $this;
    }

    /**
     * Gets s40_online_required_soft
     *
     * @return bool|null
     */
    public function getS40OnlineRequiredSoft()
    {
        return $this->container['s40_online_required_soft'];
    }

    /**
     * Sets s40_online_required_soft
     *
     * @param bool|null $s40_online_required_soft sets S40OnlineRequiredSoft option on/off/leaves old value if null
     *
     * @return self
     */
    public function setS40OnlineRequiredSoft($s40_online_required_soft)
    {
        if (is_null($s40_online_required_soft)) {
            array_push($this->openAPINullablesSetToNull, 's40_online_required_soft');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('s40_online_required_soft', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['s40_online_required_soft'] = $s40_online_required_soft;

        return $this;
    }

    /**
     * Gets save_online_lock_audit_trail
     *
     * @return bool|null
     */
    public function getSaveOnlineLockAuditTrail()
    {
        return $this->container['save_online_lock_audit_trail'];
    }

    /**
     * Sets save_online_lock_audit_trail
     *
     * @param bool|null $save_online_lock_audit_trail sets SaveOnlineLockAuditTrail option on/off/leaves old value if null
     *
     * @return self
     */
    public function setSaveOnlineLockAuditTrail($save_online_lock_audit_trail)
    {
        if (is_null($save_online_lock_audit_trail)) {
            array_push($this->openAPINullablesSetToNull, 'save_online_lock_audit_trail');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('save_online_lock_audit_trail', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['save_online_lock_audit_trail'] = $save_online_lock_audit_trail;
