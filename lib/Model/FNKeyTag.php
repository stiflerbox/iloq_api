...
/**
 * FNKeyTag Class Doc Comment
 *
 * @category Class
 * @description FNKey Tag. Key-Value pair.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class FNKeyTag implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FNKeyTag';
    ...
    protected static $attributeMap = [
        'fn_key_id' => 'FNKey_ID',
        'key' => 'Key',
        'save_to_key_audit_trail' => 'SaveToKeyAuditTrail',
        'tag_id' => 'Tag_ID',
        'value' => 'Value'
    ];
    ...
    protected static $setters = [
        ...
        'key' => 'setKey',
        'save_to_key_audit_trail' => 'setSaveToKeyAuditTrail',
        'tag_id' => 'setTagId',
        'value' => 'setValue'
    ];
    ...
    protected static $getters = [
        ...
        'key' => 'getKey',
        'save_to_key_audit_trail' => 'getSaveToKeyAuditTrail',
        'tag_id' => 'getTagId',
        'value' => 'getValue'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('save_to_key_audit_trail', $data ?? [], null);
    ...
    */
     ...
     * Sets fn_key_id
     *
     * @param string|null $fn_key_id FNKey id
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string|null $key Key. It is recommended to use templating like 'companyname_maintenance_ticket' to avoid overlapping keys between applications which use public API.
     *
     * @return self
     */
    ...
    /**
     * Gets save_to_key_audit_trail
     *
     * @return bool|null
     */
    public function getSaveToKeyAuditTrail()
    {
        return $this->container['save_to_key_audit_trail'];
    }

    /**
     * Sets save_to_key_audit_trail
     *
     * @param bool|null $save_to_key_audit_trail True if value is saved on audit trails
     *
     * @return self
     */
    public function setSaveToKeyAuditTrail($save_to_key_audit_trail)
    {
        if (is_null($save_to_key_audit_trail)) {
            throw new \InvalidArgumentException('non-nullable save_to_key_audit_trail cannot be null');
        }
        $this->container['save_to_key_audit_trail'] = $save_to_key_audit_trail;
