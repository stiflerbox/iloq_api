...
/**
 * PersonInsert Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PersonInsert implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonInsert';
    ...
    */
    ...
    public function setPersonCode($person_code)
    {
        ...
        if ((mb_strlen($person_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $person_code when calling PersonInsert., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($person_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $person_code when calling PersonInsert., must be bigger than or equal to 0.');
        }
