...
/**
 * SubscriptionState Class Doc Comment
 *
 * @category Class
 * @description State
 * @package  OpenAPI\Client
 ...
 */
class SubscriptionState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Subscription_State';
