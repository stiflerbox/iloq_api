...
/**
 * InsertKeyParamKey Class Doc Comment
 *
 * @category Class
 ...
 */
class InsertKeyParamKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertKeyParam_Key';
    ...
    protected static $openAPITypes = [
        ...
        'fn_key_id' => 'string',
        'info_text' => 'string',
        'key_type_mask' => '\OpenAPI\Client\Model\KeyInsertKeyTypeMask',
        'manufacturing_info' => 'string',
        'online_access_code' => 'string',
        'person_id' => 'string',
    ...
    protected static $attributeMap = [
        ...
        'online_access_code' => 'OnlineAccessCode',
        'person_id' => 'Person_ID',
    ...
    protected static $setters = [
        ...
        'online_access_code' => 'setOnlineAccessCode',
    ...
    protected static $getters = [
        ...
        'online_access_code' => 'getOnlineAccessCode',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('online_access_code', $data ?? [], null);
    ...
    */
     ...
     * Gets key_type_mask
     *
     * @return \OpenAPI\Client\Model\KeyInsertKeyTypeMask|null
     */
     ...
     * Sets key_type_mask
     *
     * @param \OpenAPI\Client\Model\KeyInsertKeyTypeMask|null $key_type_mask key_type_mask
     *
     * @return self
     */
    ...
    /**
     * Gets online_access_code
     *
     * @return string|null
     */
    public function getOnlineAccessCode()
    {
        return $this->container['online_access_code'];
    }

    /**
     * Sets online_access_code
     *
     * @param string|null $online_access_code PIN code consisting of 5 digits. Network modules may contain calendar controls which require this code for access.
     *
     * @return self
     */
    public function setOnlineAccessCode($online_access_code)
    {
        if (is_null($online_access_code)) {
            array_push($this->openAPINullablesSetToNull, 'online_access_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('online_access_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['online_access_code'] = $online_access_code;
     ...
     * Sets rom_id
     *
     * @param string|null $rom_id ROM ID. Not used in inserting new key.
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets stamp
     *
     * @param string|null $stamp Stamp. Number consisting of 4 digits written to the physical key.
     *
     * @return self
     */
