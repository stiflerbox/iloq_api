...
/**
 * PublicApiGetKeyLocationReportingInAuditTrailQueryResult Class Doc Comment
 *
 * @category Class
 * @description Does phone key record the last known valid location of mobile device to audit trail during lock open event.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PublicApiGetKeyLocationReportingInAuditTrailQueryResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicApiGetKeyLocationReportingInAuditTrailQueryResult';
    ...
    protected static $openAPITypes = [
        'location_reporting_in_audit_trail' => 'bool'
    ];
    ...
    protected static $openAPIFormats = [
        'location_reporting_in_audit_trail' => null
    ];
    ...
    protected static array $openAPINullables = [
        'location_reporting_in_audit_trail' => false
    ];
    ...
    protected static $attributeMap = [
        'location_reporting_in_audit_trail' => 'LocationReportingInAuditTrail'
    ];
    ...
    protected static $setters = [
        'location_reporting_in_audit_trail' => 'setLocationReportingInAuditTrail'
    ];
    ...
    protected static $getters = [
        'location_reporting_in_audit_trail' => 'getLocationReportingInAuditTrail'
    ];
    ...
    {
        $this->setIfExists('location_reporting_in_audit_trail', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets location_reporting_in_audit_trail
     *
     * @return bool|null
     */
    public function getLocationReportingInAuditTrail()
    {
        return $this->container['location_reporting_in_audit_trail'];
    }

    /**
     * Sets location_reporting_in_audit_trail
     *
     * @param bool|null $location_reporting_in_audit_trail Does phone key record the last known valid location of mobile device to audit trail during lock open event.
     *
     * @return self
     */
    public function setLocationReportingInAuditTrail($location_reporting_in_audit_trail)
    {
        if (is_null($location_reporting_in_audit_trail)) {
            throw new \InvalidArgumentException('non-nullable location_reporting_in_audit_trail cannot be null');
        }
        $this->container['location_reporting_in_audit_trail'] = $location_reporting_in_audit_trail;
