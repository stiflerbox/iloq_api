...
/**
 * UpdateLockParamLock Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateLockParamLock implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateLockParam_Lock';
    ...
    protected static $openAPITypes = [
        ...
        'stamp' => 'string',
        'state' => '\OpenAPI\Client\Model\LockUpdateState',
        'zone_id' => 'string'
    ];
    ...
    */
     ...
     * Sets real_estate_id
     *
     * @param string|null $real_estate_id Real estate identifier. If null then is not updated.
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \OpenAPI\Client\Model\LockUpdateState|null
     */
     ...
     * Sets state
     *
     * @param \OpenAPI\Client\Model\LockUpdateState|null $state state
     *
     * @return self
     */
