...
/**
 * SecurityAccessStatus Class Doc Comment
 *
 * @category Class
 * @description Status
 * @package  OpenAPI\Client
 ...
 */
class SecurityAccessStatus implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecurityAccess_Status';
