...
/**
 * InsertTimeLimitTitlesParam Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InsertTimeLimitTitlesParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertTimeLimitTitlesParam';
    ...
    protected static $openAPITypes = [
        'time_limit_data' => '\OpenAPI\Client\Model\TimeLimitData[]',
        'time_limit_title' => '\OpenAPI\Client\Model\InsertTimeLimitTitlesParamTimeLimitTitle'
    ];
    ...
    protected static $setters = [
        ...
        'time_limit_title' => 'setTimeLimitTitle'
    ];
    ...
    protected static $getters = [
        ...
        'time_limit_title' => 'getTimeLimitTitle'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('time_limit_title', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @return \OpenAPI\Client\Model\TimeLimitData[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\TimeLimitData[]|null $time_limit_data Datas which are added for the added time limit title Maximum count is 10
     *
     * @return self
     */
    ...
    /**
     * Gets time_limit_title
     *
     * @return \OpenAPI\Client\Model\InsertTimeLimitTitlesParamTimeLimitTitle|null
     */
    public function getTimeLimitTitle()
    {
        return $this->container['time_limit_title'];
    }

    /**
     * Sets time_limit_title
     *
     * @param \OpenAPI\Client\Model\InsertTimeLimitTitlesParamTimeLimitTitle|null $time_limit_title time_limit_title
     *
     * @return self
     */
    public function setTimeLimitTitle($time_limit_title)
    {
        if (is_null($time_limit_title)) {
            array_push($this->openAPINullablesSetToNull, 'time_limit_title');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('time_limit_title', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['time_limit_title'] = $time_limit_title;
