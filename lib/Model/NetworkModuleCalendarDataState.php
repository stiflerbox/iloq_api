...
/**
 * NetworkModuleCalendarDataState Class Doc Comment
 *
 * @category Class
 * @description Calendar data state
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NetworkModuleCalendarDataState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NetworkModule_CalendarDataState';
