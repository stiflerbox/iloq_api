...
/**
 * DeviceLogDataFNKey Class Doc Comment
 *
 * @category Class
 * @description Key information if log row is linked to a key
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DeviceLogDataFNKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceLogData_FNKey';
    ...
    protected static $openAPITypes = [
        'custom_value_data' => 'string',
        'description' => 'string',
        'fn_key_id' => 'string',
        'going_counter' => 'int',
        'key_id' => 'int',
        'key_type_mask' => '\OpenAPI\Client\Model\DeviceLogFNKeyKeyTypeMask',
        'option_mask' => '\OpenAPI\Client\Model\DeviceLogFNKeyOptionMask',
        'person_name' => 'string',
        'stamp' => 'string'
    ];
    ...
    protected static $attributeMap = [
        'custom_value_data' => 'CustomValueData',
    ...
    protected static $setters = [
        'custom_value_data' => 'setCustomValueData',
    ...
    protected static $getters = [
        'custom_value_data' => 'getCustomValueData',
    ...
    {
        $this->setIfExists('custom_value_data', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets custom_value_data
     *
     * @return string|null
     */
    public function getCustomValueData()
    {
        return $this->container['custom_value_data'];
    }

    /**
     * Sets custom_value_data
     *
     * @param string|null $custom_value_data Custom value data gathered from KeyTags when audit trail was saved.
     *
     * @return self
     */
    public function setCustomValueData($custom_value_data)
    {
        if (is_null($custom_value_data)) {
            array_push($this->openAPINullablesSetToNull, 'custom_value_data');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('custom_value_data', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['custom_value_data'] = $custom_value_data;
     ...
     * Sets description
     *
     * @param string|null $description Key description
     *
     * @return self
     */
     ...
     * Sets fn_key_id
     *
     * @param string|null $fn_key_id Id
     *
     * @return self
     */
     ...
     * Sets going_counter
     *
     * @param int|null $going_counter Key going counter
     *
     * @return self
     */
     ...
     * Sets key_id
     *
     * @param int|null $key_id Numeric Key id
     *
     * @return self
     */
     ...
     * Gets key_type_mask
     *
     * @return \OpenAPI\Client\Model\DeviceLogFNKeyKeyTypeMask|null
     */
     ...
     * Sets key_type_mask
     *
     * @param \OpenAPI\Client\Model\DeviceLogFNKeyKeyTypeMask|null $key_type_mask key_type_mask
     *
     * @return self
     */
     ...
     * Gets option_mask
     *
     * @return \OpenAPI\Client\Model\DeviceLogFNKeyOptionMask|null
     */
     ...
     * Sets option_mask
     *
     * @param \OpenAPI\Client\Model\DeviceLogFNKeyOptionMask|null $option_mask option_mask
     *
     * @return self
     */
     ...
     * Sets person_name
     *
     * @param string|null $person_name Person's name during the time of access.
     *
     * @return self
     */
