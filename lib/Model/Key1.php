 ...
 */
class Key1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Key1';
    ...
    */
    ...
    public function setStamp($stamp)
    {
        ...
        if ((mb_strlen($stamp) > 10)) {
            throw new \InvalidArgumentException('invalid length for $stamp when calling Key1., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($stamp) < 0)) {
            throw new \InvalidArgumentException('invalid length for $stamp when calling Key1., must be bigger than or equal to 0.');
        }
