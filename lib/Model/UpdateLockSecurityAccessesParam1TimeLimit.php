...
/**
 * UpdateLockSecurityAccessesParam1TimeLimit Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateLockSecurityAccessesParam1TimeLimit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateLockSecurityAccessesParam1_TimeLimit';
    ...
    protected static $setters = [
        'high_security' => 'setHighSecurity',
        'time_limit_mask' => 'setTimeLimitMask'
    ];
    ...
    protected static $getters = [
        'high_security' => 'getHighSecurity',
        'time_limit_mask' => 'getTimeLimitMask'
    ];
    ...
    {
        $this->setIfExists('high_security', $data ?? [], null);
        $this->setIfExists('time_limit_mask', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['high_security'];
    }

    /**
     * Sets high_security
     *
     * @param bool|null $high_security high_security
     *
     * @return self
     */
    public function setHighSecurity($high_security)
    {
        if (is_null($high_security)) {
            throw new \InvalidArgumentException('non-nullable high_security cannot be null');
        }
        $this->container['high_security'] = $high_security;

        return $this;
    }

    /**
     * Gets time_limit_mask
     *
     * @return int|null
     */
    public function getTimeLimitMask()
    {
        return $this->container['time_limit_mask'];
    }

    /**
     * Sets time_limit_mask
     *
     * @param int|null $time_limit_mask 0 = Lock doesn't care about key's time limits. Default.    1 = Lock handles both time limits              Obsolete. Use values 2 and 4 instead    2 = Lock handles key's time limit 1    4 = Lock handles key's time limit 2
     *
     * @return self
     */
    public function setTimeLimitMask($time_limit_mask)
    {
        if (is_null($time_limit_mask)) {
            throw new \InvalidArgumentException('non-nullable time_limit_mask cannot be null');
        }
        $this->container['time_limit_mask'] = $time_limit_mask;
