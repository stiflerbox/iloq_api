...
/**
 * GetLockTimeLimitsResult Class Doc Comment
 *
 * @category Class
 ...
 */
class GetLockTimeLimitsResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetLockTimeLimitsResult';
    ...
    protected static $openAPITypes = [
        ...
        'time_limit_titles' => '\OpenAPI\Client\Model\TimeLimitTitle[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'time_limit_titles' => 'TimeLimitTitles'
    ];
    ...
    protected static $setters = [
        ...
        'time_limit_titles' => 'setTimeLimitTitles'
    ];
    ...
    protected static $getters = [
        ...
        'time_limit_titles' => 'getTimeLimitTitles'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('time_limit_titles', $data ?? [], null);
    }
    ...
    */
     ...
     *
     * @param int|null $outside_user_zones_count How many of additional time limit titles are linked to the lock which are invisible to user because they are outside his zones
     *
     * @return self
     */
    ...
    /**
     * Gets time_limit_titles
     *
     * @return \OpenAPI\Client\Model\TimeLimitTitle[]|null
     */
    public function getTimeLimitTitles()
    {
        return $this->container['time_limit_titles'];
    }

    /**
     * Sets time_limit_titles
     *
     * @param \OpenAPI\Client\Model\TimeLimitTitle[]|null $time_limit_titles Time limit titles linked to lock which are visible to user
     *
     * @return self
     */
    public function setTimeLimitTitles($time_limit_titles)
    {
        if (is_null($time_limit_titles)) {
            array_push($this->openAPINullablesSetToNull, 'time_limit_titles');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('time_limit_titles', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['time_limit_titles'] = $time_limit_titles;
