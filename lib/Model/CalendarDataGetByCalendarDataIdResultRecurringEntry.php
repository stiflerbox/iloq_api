...
/**
 * CalendarDataGetByCalendarDataIdResultRecurringEntry Class Doc Comment
 *
 * @category Class
 * @description Recurring entry information
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CalendarDataGetByCalendarDataIdResultRecurringEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarDataGetByCalendarDataIdResult_RecurringEntry';
    ...
    protected static $openAPITypes = [
        'calendar_data_id' => 'string',
        'calendar_data_title_id' => 'string',
        'end_date_time' => '\DateTime',
        'start_date_time' => '\DateTime',
        'subject' => 'string',
        'type' => '\OpenAPI\Client\Model\CalendarDataEntryType',
        're_id' => 'string',
        're_occurrence_duration_ticks' => 'int',
        're_occurrence_start_time' => '\DateTime',
        're_pattern_days_of_week' => 'int',
        're_pattern_frequency' => 'int',
        're_range_end_date' => '\DateTime',
        're_range_limit' => 'int',
        're_range_start_date' => '\DateTime'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'type' => null,
        're_id' => 'guid',
        're_occurrence_duration_ticks' => 'int64',
        're_occurrence_start_time' => 'date-time',
        're_pattern_days_of_week' => 'int32',
        're_pattern_frequency' => 'int32',
        're_range_end_date' => 'date-time',
        're_range_limit' => 'int32',
        're_range_start_date' => 'date-time'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'type' => false,
        're_id' => false,
        're_occurrence_duration_ticks' => false,
        're_occurrence_start_time' => false,
        're_pattern_days_of_week' => false,
        're_pattern_frequency' => false,
        're_range_end_date' => false,
        're_range_limit' => false,
        're_range_start_date' => false
    ];
    ...
    protected static $attributeMap = [
        'calendar_data_id' => 'CalendarData_ID',
        ...
        'type' => 'Type',
        're_id' => 'Re_ID',
        're_occurrence_duration_ticks' => 'Re_OccurrenceDurationTicks',
        're_occurrence_start_time' => 'Re_OccurrenceStartTime',
        're_pattern_days_of_week' => 'Re_PatternDaysOfWeek',
        're_pattern_frequency' => 'Re_PatternFrequency',
        're_range_end_date' => 'Re_RangeEndDate',
        're_range_limit' => 'Re_RangeLimit',
        're_range_start_date' => 'Re_RangeStartDate'
    ];
    ...
    protected static $setters = [
        'calendar_data_id' => 'setCalendarDataId',
        ...
        'type' => 'setType',
        're_id' => 'setReId',
        're_occurrence_duration_ticks' => 'setReOccurrenceDurationTicks',
        're_occurrence_start_time' => 'setReOccurrenceStartTime',
        're_pattern_days_of_week' => 'setRePatternDaysOfWeek',
        're_pattern_frequency' => 'setRePatternFrequency',
        're_range_end_date' => 'setReRangeEndDate',
        're_range_limit' => 'setReRangeLimit',
        're_range_start_date' => 'setReRangeStartDate'
    ];
    ...
    protected static $getters = [
        'calendar_data_id' => 'getCalendarDataId',
        ...
        'type' => 'getType',
        're_id' => 'getReId',
        're_occurrence_duration_ticks' => 'getReOccurrenceDurationTicks',
        're_occurrence_start_time' => 'getReOccurrenceStartTime',
        're_pattern_days_of_week' => 'getRePatternDaysOfWeek',
        're_pattern_frequency' => 'getRePatternFrequency',
        're_range_end_date' => 'getReRangeEndDate',
        're_range_limit' => 'getReRangeLimit',
        're_range_start_date' => 'getReRangeStartDate'
    ];
    ...
    {
        $this->setIfExists('calendar_data_id', $data ?? [], null);
        ...
        $this->setIfExists('re_id', $data ?? [], null);
        $this->setIfExists('re_occurrence_duration_ticks', $data ?? [], null);
        $this->setIfExists('re_occurrence_start_time', $data ?? [], null);
        $this->setIfExists('re_pattern_days_of_week', $data ?? [], null);
        $this->setIfExists('re_pattern_frequency', $data ?? [], null);
        $this->setIfExists('re_range_end_date', $data ?? [], null);
        $this->setIfExists('re_range_limit', $data ?? [], null);
        $this->setIfExists('re_range_start_date', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets calendar_data_id
     *
     * @return string|null
     */
    public function getCalendarDataId()
    {
        return $this->container['calendar_data_id'];
    }

    /**
     * Sets calendar_data_id
     *
     * @param string|null $calendar_data_id Calendar data id
     *
     * @return self
     */
    public function setCalendarDataId($calendar_data_id)
    {
        if (is_null($calendar_data_id)) {
            throw new \InvalidArgumentException('non-nullable calendar_data_id cannot be null');
        }
        $this->container['calendar_data_id'] = $calendar_data_id;
     ...
     *
     * @param string|null $calendar_data_title_id Calendar data title id for which this entry belongs to.
     *
     * @return self
     */
     ...
     * Sets end_date_time
     *
     * @param \DateTime|null $end_date_time End time
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $start_date_time Start time
     *
     * @return self
     */
     ...
     * Sets subject
     *
     * @param string|null $subject Subject text
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\CalendarDataEntryType|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\CalendarDataEntryType|null $type type
     *
     * @return self
     */
    ...
    {
        return $this->container['re_id'];
    }

    /**
     * Sets re_id
     *
     * @param string|null $re_id ID so that exceptions can be linked to correct recurring entry.
     *
     * @return self
     */
    ...
    {
        if (is_null($re_id)) {
            throw new \InvalidArgumentException('non-nullable re_id cannot be null');
        }
        $this->container['re_id'] = $re_id;

        return $this;
    }

    /**
     * Gets re_occurrence_duration_ticks
     *
     * @return int|null
     */
    public function getReOccurrenceDurationTicks()
    {
        return $this->container['re_occurrence_duration_ticks'];
    }

    /**
     * Sets re_occurrence_duration_ticks
     *
     * @param int|null $re_occurrence_duration_ticks Recurring entry's duration in ticks.
     *
     * @return self
     */
    public function setReOccurrenceDurationTicks($re_occurrence_duration_ticks)
    {
        if (is_null($re_occurrence_duration_ticks)) {
            throw new \InvalidArgumentException('non-nullable re_occurrence_duration_ticks cannot be null');
        }
        $this->container['re_occurrence_duration_ticks'] = $re_occurrence_duration_ticks;

        return $this;
    }

    /**
     * Gets re_occurrence_start_time
     *
     * @return \DateTime|null
     */
    public function getReOccurrenceStartTime()
    {
        return $this->container['re_occurrence_start_time'];
    }

    /**
     * Sets re_occurrence_start_time
     *
     * @param \DateTime|null $re_occurrence_start_time Occurence start time. This and Re_OccurrenceDurationTicks are used to calculate the time span of the occurence.
     *
     * @return self
     */
    public function setReOccurrenceStartTime($re_occurrence_start_time)
    {
        if (is_null($re_occurrence_start_time)) {
            throw new \InvalidArgumentException('non-nullable re_occurrence_start_time cannot be null');
        }
        $this->container['re_occurrence_start_time'] = $re_occurrence_start_time;

        return $this;
    }

    /**
     * Gets re_pattern_days_of_week
     *
     * @return int|null
     */
    public function getRePatternDaysOfWeek()
    {
        return $this->container['re_pattern_days_of_week'];
    }

    /**
     * Sets re_pattern_days_of_week
     *
     * @param int|null $re_pattern_days_of_week Days of week mask which tells on which days the recurring entry happens. None = 0 Sunday = 1 Monday = 2 Tuesday = 4 Wednesday = 8 Thursday = 16 Friday = 32 Saturday = 64
     *
     * @return self
     */
    public function setRePatternDaysOfWeek($re_pattern_days_of_week)
    {
        if (is_null($re_pattern_days_of_week)) {
            throw new \InvalidArgumentException('non-nullable re_pattern_days_of_week cannot be null');
        }
        $this->container['re_pattern_days_of_week'] = $re_pattern_days_of_week;

        return $this;
    }

    /**
     * Gets re_pattern_frequency
     *
     * @return int|null
     */
    public function getRePatternFrequency()
    {
        return $this->container['re_pattern_frequency'];
    }

    /**
     * Sets re_pattern_frequency
     *
     * @param int|null $re_pattern_frequency How often entry recurs: Daily DEPRECATED = 0 Weekly = 1 Monthly = 2 Yearly = 3
     *
     * @return self
     */
    public function setRePatternFrequency($re_pattern_frequency)
    {
        if (is_null($re_pattern_frequency)) {
            throw new \InvalidArgumentException('non-nullable re_pattern_frequency cannot be null');
        }
        $this->container['re_pattern_frequency'] = $re_pattern_frequency;

        return $this;
    }

    /**
     * Gets re_range_end_date
     *
     * @return \DateTime|null
     */
    public function getReRangeEndDate()
    {
        return $this->container['re_range_end_date'];
    }

    /**
     * Sets re_range_end_date
     *
     * @param \DateTime|null $re_range_end_date Last date of recurring entry.
     *
     * @return self
     */
    public function setReRangeEndDate($re_range_end_date)
    {
        if (is_null($re_range_end_date)) {
            throw new \InvalidArgumentException('non-nullable re_range_end_date cannot be null');
        }
        $this->container['re_range_end_date'] = $re_range_end_date;
     ...
     * @return int|null
     */
    public function getReRangeLimit()
    {
        return $this->container['re_range_limit'];
    }

    /**
     * Sets re_range_limit
     *
     * @param int|null $re_range_limit 0 = No limit to the number of occurrences in the recurrence. 1 = DEPRECATED The recurrence is limited to a specific number of occurrences. 2 = The recurrence is restricted by an ending date.
     *
     * @return self
     */
    public function setReRangeLimit($re_range_limit)
    {
        if (is_null($re_range_limit)) {
            throw new \InvalidArgumentException('non-nullable re_range_limit cannot be null');
        }
        $this->container['re_range_limit'] = $re_range_limit;

        return $this;
    }

    /**
     * Gets re_range_start_date
     *
     * @return \DateTime|null
     */
    public function getReRangeStartDate()
    {
        return $this->container['re_range_start_date'];
    }

    /**
     * Sets re_range_start_date
     *
     * @param \DateTime|null $re_range_start_date First date of recurring entry.
     *
     * @return self
     */
    public function setReRangeStartDate($re_range_start_date)
    {
        if (is_null($re_range_start_date)) {
            throw new \InvalidArgumentException('non-nullable re_range_start_date cannot be null');
        }
        $this->container['re_range_start_date'] = $re_range_start_date;
