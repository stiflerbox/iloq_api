...
/**
 * NetworkModuleAllowedSocketRequest Class Doc Comment
 *
 * @category Class
 * @description Allowed socket request mask
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NetworkModuleAllowedSocketRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NetworkModule_AllowedSocketRequest';
