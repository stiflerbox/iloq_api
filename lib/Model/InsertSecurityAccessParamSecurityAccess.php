...
/**
 * InsertSecurityAccessParamSecurityAccess Class Doc Comment
 *
 * @category Class
 * @description Security access to insert
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InsertSecurityAccessParamSecurityAccess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertSecurityAccessParam_SecurityAccess';
    ...
    protected static $openAPITypes = [
        ...
        'name' => 'string',
        'parent_security_access_id' => 'string',
        'real_estate_id' => 'string',
        'security_access_id' => 'string',
        'status' => 'int',
        'type' => 'int',
        'version_nr' => 'int',
        'zone_id' => 'string'
    ...
    protected static $openAPIFormats = [
        ...
        'name' => null,
        'parent_security_access_id' => 'guid',
        'real_estate_id' => 'guid',
        'security_access_id' => 'guid',
        'status' => null,
        'type' => null,
        'version_nr' => 'int32',
        'zone_id' => 'guid'
    ...
    protected static array $openAPINullables = [
        ...
        'name' => true,
        'parent_security_access_id' => true,
        'real_estate_id' => false,
        'security_access_id' => true,
        'status' => false,
        'type' => false,
        'version_nr' => true,
        'zone_id' => true
    ...
    protected static $attributeMap = [
        ...
        'name' => 'Name',
        'parent_security_access_id' => 'ParentSecurityAccess_ID',
        'real_estate_id' => 'RealEstate_ID',
        'security_access_id' => 'SecurityAccess_ID',
        'status' => 'Status',
        'type' => 'Type',
    ...
    protected static $setters = [
        ...
        'default_access' => 'setDefaultAccess',
        'description' => 'setDescription',
        'ext' => 'setExt',
        'ext_description' => 'setExtDescription',
        'name' => 'setName',
        'parent_security_access_id' => 'setParentSecurityAccessId',
        'real_estate_id' => 'setRealEstateId',
        'security_access_id' => 'setSecurityAccessId',
        'status' => 'setStatus',
        'type' => 'setType',
    ...
    protected static $getters = [
        ...
        'default_access' => 'getDefaultAccess',
        'description' => 'getDescription',
        'ext' => 'getExt',
        'ext_description' => 'getExtDescription',
        'name' => 'getName',
        'parent_security_access_id' => 'getParentSecurityAccessId',
        'real_estate_id' => 'getRealEstateId',
        'security_access_id' => 'getSecurityAccessId',
        'status' => 'getStatus',
        'type' => 'getType',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('default_access', $data ?? [], null);
        $this->setIfExists('description', $data ?? [], null);
        $this->setIfExists('ext', $data ?? [], null);
        $this->setIfExists('ext_description', $data ?? [], null);
        $this->setIfExists('name', $data ?? [], null);
        $this->setIfExists('parent_security_access_id', $data ?? [], null);
        $this->setIfExists('real_estate_id', $data ?? [], null);
        $this->setIfExists('security_access_id', $data ?? [], null);
    ...
    */
     ...
     * Sets access_mode
     *
     * @param int|null $access_mode Access mode    0 = show as default    1 = hide as default
     *
     * @return self
     */
    ...
    {
        return $this->container['default_access'];
    }

    /**
     * Sets default_access
     *
     * @param int|null $default_access Is security access set for locks as default    0 = Security access is not set for locks as default    1 = Security access is set for locks as default
     *
     * @return self
     */
    public function setDefaultAccess($default_access)
    {
        if (is_null($default_access)) {
            throw new \InvalidArgumentException('non-nullable default_access cannot be null');
        }
        $this->container['default_access'] = $default_access;
     ...
     * Sets ext
     *
     * @param int|null $ext Option if time control/additional conditions are on.    0 = Time control is not in use    1 = Time control is in use
     *
     * @return self
     */
     ...
     *
     * @param string|null $ext_description Description for what the Ext value means (for example, time control is on).
     *
     * @return self
     */
    ...
    /**
     * Gets parent_security_access_id
     *
     * @return string|null
     */
    public function getParentSecurityAccessId()
    {
        return $this->container['parent_security_access_id'];
    }

    /**
     * Sets parent_security_access_id
     *
     * @param string|null $parent_security_access_id Parent security access ID if this security access is nested and linked to parent. Null if not nested.
     *
     * @return self
     */
    public function setParentSecurityAccessId($parent_security_access_id)
    {
        if (is_null($parent_security_access_id)) {
            array_push($this->openAPINullablesSetToNull, 'parent_security_access_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('parent_security_access_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['parent_security_access_id'] = $parent_security_access_id;
    ...
    /**
     * Gets security_access_id
     *
     * @return string|null
     */
    public function getSecurityAccessId()
    {
        return $this->container['security_access_id'];
    }

    /**
     * Sets security_access_id
     *
     * @param string|null $security_access_id ID.
     *
     * @return self
     */
    public function setSecurityAccessId($security_access_id)
    {
        if (is_null($security_access_id)) {
            array_push($this->openAPINullablesSetToNull, 'security_access_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('security_access_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['security_access_id'] = $security_access_id;
     ...
     * Sets status
     *
     * @param int|null $status Status. Only Active access rights can be created.    0 = Active    1 = Security access is no longer in use.    2 = Security access is blocklisted    3 = Security access is lead to blocklist through a key (only possible on lock security accesses)    4 = Blocked
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param int|null $type Type. Only standard access and API access can be added. Key types are created when keys are blocklisted.    0 = Key security access. This is only for keys which are in blocklist and is created automatically when Key is blocklisted.    1 = Standard access    2 = Mask. Not in use.    3 = API Access
     *
     * @return self
     */
     ...
     * Sets version_nr
     *
     * @param int|null $version_nr Version number if versioned security access. Null otherwise.
     *
     * @return self
     */
     ...
     * Sets zone_id
     *
     * @param string|null $zone_id Zone id if linked to a zone.
     *
     * @return self
     */
