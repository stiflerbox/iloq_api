...
/**
 * GetLockLogsParam Class Doc Comment
 *
 * @category Class
 * @description Parameter for getting lock logs.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetLockLogsParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetLockLogsParam';
    ...
    protected static $openAPITypes = [
        'f_lock_ids' => 'string[]',
        'fn_key_ids' => 'string[]',
        'going_end_date_utc' => '\DateTime',
        'going_start_date_utc' => '\DateTime',
        'type_mask' => '\OpenAPI\Client\Model\GetLockLogsParamTypeMask'
    ];
    ...
    protected static $openAPIFormats = [
        'f_lock_ids' => 'guid',
        'fn_key_ids' => 'guid',
        'going_end_date_utc' => 'date-time',
        'going_start_date_utc' => 'date-time',
        'type_mask' => null
    ];
    ...
    protected static array $openAPINullables = [
        'f_lock_ids' => true,
        'fn_key_ids' => true,
        'going_end_date_utc' => true,
        'going_start_date_utc' => true,
        'type_mask' => false
    ];
    ...
    protected static $attributeMap = [
        'f_lock_ids' => 'FLockIds',
        'fn_key_ids' => 'FNKeyIds',
        'going_end_date_utc' => 'GoingEndDateUtc',
        'going_start_date_utc' => 'GoingStartDateUtc',
        'type_mask' => 'TypeMask'
    ];
    ...
    protected static $setters = [
        'f_lock_ids' => 'setFLockIds',
        'fn_key_ids' => 'setFnKeyIds',
        'going_end_date_utc' => 'setGoingEndDateUtc',
        'going_start_date_utc' => 'setGoingStartDateUtc',
    ...
    protected static $getters = [
        'f_lock_ids' => 'getFLockIds',
        'fn_key_ids' => 'getFnKeyIds',
        'going_end_date_utc' => 'getGoingEndDateUtc',
        'going_start_date_utc' => 'getGoingStartDateUtc',
    ...
    {
        $this->setIfExists('f_lock_ids', $data ?? [], null);
        $this->setIfExists('fn_key_ids', $data ?? [], null);
        $this->setIfExists('going_end_date_utc', $data ?? [], null);
        $this->setIfExists('going_start_date_utc', $data ?? [], null);
    ...
    */
     ...
     * @return string[]|null
     */
    public function getFLockIds()
    {
        return $this->container['f_lock_ids'];
    }

    /**
     * Sets f_lock_ids
     *
     * @param string[]|null $f_lock_ids Lock Ids. Either Key ids or Lock ids must be given, or both.
     *
     * @return self
     */
    public function setFLockIds($f_lock_ids)
    {
        if (is_null($f_lock_ids)) {
            array_push($this->openAPINullablesSetToNull, 'f_lock_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('f_lock_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['f_lock_ids'] = $f_lock_ids;
     ...
     * @return string[]|null
     */
    public function getFnKeyIds()
    {
        return $this->container['fn_key_ids'];
    }

    /**
     * Sets fn_key_ids
     *
     * @param string[]|null $fn_key_ids Key Ids. Either Key ids or Lock ids must be given, or both.
     *
     * @return self
     */
    public function setFnKeyIds($fn_key_ids)
    {
        if (is_null($fn_key_ids)) {
            array_push($this->openAPINullablesSetToNull, 'fn_key_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('fn_key_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['fn_key_ids'] = $fn_key_ids;

        return $this;
    }

    /**
     * Gets going_end_date_utc
     *
     * @return \DateTime|null
     */
    public function getGoingEndDateUtc()
    {
        return $this->container['going_end_date_utc'];
    }

    /**
     * Sets going_end_date_utc
     *
     * @param \DateTime|null $going_end_date_utc Return logs where going date is before this end date. If null, then doesn't take it into account.
     *
     * @return self
     */
    public function setGoingEndDateUtc($going_end_date_utc)
    {
        if (is_null($going_end_date_utc)) {
            array_push($this->openAPINullablesSetToNull, 'going_end_date_utc');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('going_end_date_utc', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['going_end_date_utc'] = $going_end_date_utc;

        return $this;
    }

    /**
     * Gets going_start_date_utc
     *
     * @return \DateTime|null
     */
    public function getGoingStartDateUtc()
    {
        return $this->container['going_start_date_utc'];
    }

    /**
     * Sets going_start_date_utc
     *
     * @param \DateTime|null $going_start_date_utc Returns logs where going date is after this start date. If null, then doesn't take it into account.
     *
     * @return self
     */
    public function setGoingStartDateUtc($going_start_date_utc)
    {
        if (is_null($going_start_date_utc)) {
            array_push($this->openAPINullablesSetToNull, 'going_start_date_utc');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('going_start_date_utc', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['going_start_date_utc'] = $going_start_date_utc;
     ...
     * Gets type_mask
     *
     * @return \OpenAPI\Client\Model\GetLockLogsParamTypeMask|null
     */
     ...
     * Sets type_mask
     *
     * @param \OpenAPI\Client\Model\GetLockLogsParamTypeMask|null $type_mask type_mask
     *
     * @return self
     */
