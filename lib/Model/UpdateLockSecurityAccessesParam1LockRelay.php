...
/**
 * UpdateLockSecurityAccessesParam1LockRelay Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateLockSecurityAccessesParam1LockRelay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateLockSecurityAccessesParam1_LockRelay';
    ...
    */
     ...
     * Sets relay_mask
     *
     * @param int|null $relay_mask Relay mask
     *
     * @return self
     */
     ...
     *
     * @param string|null $security_access_id Security access id
     *
     * @return self
     */
