...
/**
 * TimeLimitData Class Doc Comment
 *
 * @category Class
 * @description One time limit data which belongs to a time limit title. Can be used to define times during which the key has access to lock. For example a key could have access only during work days from 8:00 to 16:30 in which case WeekDayMask would be 31, StartTime 8:00 and EndTime 16:30.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class TimeLimitData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TimeLimitData';
    ...
    protected static array $openAPINullables = [
        'end_time' => false,
        'start_time' => false,
        'time_limit_data_id' => false,
        'time_limit_title_id' => false,
        'week_day_mask' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'time_limit_data_id' => 'TimeLimitData_ID',
        'time_limit_title_id' => 'TimeLimitTitle_ID',
        'week_day_mask' => 'WeekDayMask'
    ];
    ...
    protected static $setters = [
        ...
        'time_limit_data_id' => 'setTimeLimitDataId',
        'time_limit_title_id' => 'setTimeLimitTitleId',
        'week_day_mask' => 'setWeekDayMask'
    ];
    ...
    protected static $getters = [
        ...
        'time_limit_data_id' => 'getTimeLimitDataId',
        'time_limit_title_id' => 'getTimeLimitTitleId',
        'week_day_mask' => 'getWeekDayMask'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('time_limit_data_id', $data ?? [], null);
        $this->setIfExists('time_limit_title_id', $data ?? [], null);
        $this->setIfExists('week_day_mask', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets end_time
     *
     * @param string|null $end_time End time. For example 16:30
     *
     * @return self
     */
     ...
     * Sets start_time
     *
     * @param string|null $start_time Start time. For example 8:00
     *
     * @return self
     */
    ...
    /**
     * Gets time_limit_data_id
     *
     * @return string|null
     */
    public function getTimeLimitDataId()
    {
        return $this->container['time_limit_data_id'];
    }

    /**
     * Sets time_limit_data_id
     *
     * @param string|null $time_limit_data_id Id
     *
     * @return self
     */
    public function setTimeLimitDataId($time_limit_data_id)
    {
        if (is_null($time_limit_data_id)) {
            throw new \InvalidArgumentException('non-nullable time_limit_data_id cannot be null');
        }
        $this->container['time_limit_data_id'] = $time_limit_data_id;
     ...
     *
     * @param string|null $time_limit_title_id Time limit title ID
     *
     * @return self
     */
    public function setTimeLimitTitleId($time_limit_title_id)
    {
        if (is_null($time_limit_title_id)) {
            throw new \InvalidArgumentException('non-nullable time_limit_title_id cannot be null');
        }
    ...
    {
        return $this->container['week_day_mask'];
    }

    /**
     * Sets week_day_mask
     *
     * @param int|null $week_day_mask Week days for this time limit data. For example 31 (monday to friday)    0 = None    1 = Monday    2 = Tuesday    4 = Wednesday    8 = Thursday    16 = Friday    32 = Saturday    64 = Sunday
     *
     * @return self
     */
    public function setWeekDayMask($week_day_mask)
    {
        if (is_null($week_day_mask)) {
            throw new \InvalidArgumentException('non-nullable week_day_mask cannot be null');
        }
        $this->container['week_day_mask'] = $week_day_mask;
