...
/**
 * UpdateKeyPhoneParam Class Doc Comment
 *
 * @category Class
 * @description Parameter for updating Key&#39;s phone information
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateKeyPhoneParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateKeyPhoneParam';
    ...
    protected static $openAPITypes = [
        'email' => 'string',
        'fn_key_id' => 'string',
        'option_mask' => '\OpenAPI\Client\Model\UpdateKeyPhoneParamOptionMask',
        'phone_no' => 'string'
    ];
    ...
    */
     ...
     * Sets email
     *
     * @param string|null $email Email address which is used instead of SMS if OptionMask contains 'UseEmail' bit
     *
     * @return self
     */
     ...
     * Gets option_mask
     *
     * @return \OpenAPI\Client\Model\UpdateKeyPhoneParamOptionMask|null
     */
     ...
     * Sets option_mask
     *
     * @param \OpenAPI\Client\Model\UpdateKeyPhoneParamOptionMask|null $option_mask option_mask
     *
     * @return self
     */
     ...
     * Sets phone_no
     *
     * @param string|null $phone_no Phone number. Must be unique within locking system.
     *
     * @return self
     */
