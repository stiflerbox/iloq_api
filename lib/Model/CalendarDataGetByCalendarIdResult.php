...
/**
 * CalendarDataGetByCalendarIdResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CalendarDataGetByCalendarIdResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarDataGetByCalendarIdResult';
    ...
    protected static $openAPITypes = [
        'entries' => '\OpenAPI\Client\Model\CalendarDataEntry[]',
        'recurring_entries' => '\OpenAPI\Client\Model\CalendarDataRecurringEntry[]',
        'recurring_entry_exceptions' => '\OpenAPI\Client\Model\CalendarDataRecurringEntryException[]'
    ];
    ...
    protected static $openAPIFormats = [
        'entries' => null,
        'recurring_entries' => null,
        'recurring_entry_exceptions' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'recurring_entry_exceptions' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'recurring_entry_exceptions' => 'RecurringEntryExceptions'
    ];
    ...
    protected static $setters = [
        'entries' => 'setEntries',
        'recurring_entries' => 'setRecurringEntries',
        'recurring_entry_exceptions' => 'setRecurringEntryExceptions'
    ];
    ...
    protected static $getters = [
        'entries' => 'getEntries',
        'recurring_entries' => 'getRecurringEntries',
        'recurring_entry_exceptions' => 'getRecurringEntryExceptions'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('recurring_entries', $data ?? [], null);
        $this->setIfExists('recurring_entry_exceptions', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets entries
     *
     * @return \OpenAPI\Client\Model\CalendarDataEntry[]|null
     */
     ...
     * Sets entries
     *
     * @param \OpenAPI\Client\Model\CalendarDataEntry[]|null $entries Calendar datas which belong to calendar
     *
     * @return self
     */
    ...
    /**
     * Gets recurring_entries
     *
     * @return \OpenAPI\Client\Model\CalendarDataRecurringEntry[]|null
     */
    public function getRecurringEntries()
    {
        return $this->container['recurring_entries'];
    }

    /**
     * Sets recurring_entries
     *
     * @param \OpenAPI\Client\Model\CalendarDataRecurringEntry[]|null $recurring_entries Recurring entries which belong to calendar
     *
     * @return self
     */
    public function setRecurringEntries($recurring_entries)
    {
        if (is_null($recurring_entries)) {
            array_push($this->openAPINullablesSetToNull, 'recurring_entries');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('recurring_entries', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['recurring_entries'] = $recurring_entries;

        return $this;
    }

    /**
     * Gets recurring_entry_exceptions
     *
     * @return \OpenAPI\Client\Model\CalendarDataRecurringEntryException[]|null
     */
    public function getRecurringEntryExceptions()
    {
        return $this->container['recurring_entry_exceptions'];
    }

    /**
     * Sets recurring_entry_exceptions
     *
     * @param \OpenAPI\Client\Model\CalendarDataRecurringEntryException[]|null $recurring_entry_exceptions Recurring entry exceptions which belong to calendar
     *
     * @return self
     */
    public function setRecurringEntryExceptions($recurring_entry_exceptions)
    {
        if (is_null($recurring_entry_exceptions)) {
            array_push($this->openAPINullablesSetToNull, 'recurring_entry_exceptions');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('recurring_entry_exceptions', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['recurring_entry_exceptions'] = $recurring_entry_exceptions;
