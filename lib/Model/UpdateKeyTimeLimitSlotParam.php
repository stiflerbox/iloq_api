...
/**
 * UpdateKeyTimeLimitSlotParam Class Doc Comment
 *
 * @category Class
 * @description Parameter for updating time slot for the key
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateKeyTimeLimitSlotParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateKeyTimeLimitSlotParam';
    ...
    protected static $openAPITypes = [
        'time_limit_slot' => '\OpenAPI\Client\Model\InsertKeyTimeLimitSlotParamTimeLimitSlot'
    ];
    ...
    protected static $setters = [
        'time_limit_slot' => 'setTimeLimitSlot'
    ];
    ...
    protected static $getters = [
        'time_limit_slot' => 'getTimeLimitSlot'
    ];
    ...
    {
        $this->setIfExists('time_limit_slot', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets time_limit_slot
     *
     * @return \OpenAPI\Client\Model\InsertKeyTimeLimitSlotParamTimeLimitSlot|null
     */
    public function getTimeLimitSlot()
    {
        return $this->container['time_limit_slot'];
    }

    /**
     * Sets time_limit_slot
     *
     * @param \OpenAPI\Client\Model\InsertKeyTimeLimitSlotParamTimeLimitSlot|null $time_limit_slot time_limit_slot
     *
     * @return self
     */
    public function setTimeLimitSlot($time_limit_slot)
    {
        if (is_null($time_limit_slot)) {
            array_push($this->openAPINullablesSetToNull, 'time_limit_slot');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('time_limit_slot', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['time_limit_slot'] = $time_limit_slot;
