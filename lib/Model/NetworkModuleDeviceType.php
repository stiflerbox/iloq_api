...
/**
 * NetworkModuleDeviceType Class Doc Comment
 *
 * @category Class
 * @description Type
 * @package  OpenAPI\Client
 ...
 */
class NetworkModuleDeviceType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NetworkModuleDevice_Type';
