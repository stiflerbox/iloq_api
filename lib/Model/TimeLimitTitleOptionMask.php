...
/**
 * TimeLimitTitleOptionMask Class Doc Comment
 *
 * @category Class
 * @description Options
 * @package  OpenAPI\Client
 ...
 */
class TimeLimitTitleOptionMask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TimeLimitTitle_OptionMask';
