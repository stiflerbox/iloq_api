...
/**
 * CalendarDataGetByCalendarDataIdResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CalendarDataGetByCalendarDataIdResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarDataGetByCalendarDataIdResult';
    ...
    protected static $openAPITypes = [
        'entry' => '\OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResultEntry',
        'recurring_entry' => '\OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResultRecurringEntry',
        'recurring_entry_exception' => '\OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResultRecurringEntryException'
    ];
    ...
    protected static $openAPIFormats = [
        'entry' => null,
        'recurring_entry' => null,
        'recurring_entry_exception' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'recurring_entry_exception' => true
    ];
    ...
    protected static $attributeMap = [
        'entry' => 'Entry',
        'recurring_entry' => 'RecurringEntry',
        'recurring_entry_exception' => 'RecurringEntryException'
    ];
    ...
    protected static $setters = [
        'entry' => 'setEntry',
        'recurring_entry' => 'setRecurringEntry',
        'recurring_entry_exception' => 'setRecurringEntryException'
    ];
    ...
    protected static $getters = [
        'entry' => 'getEntry',
        'recurring_entry' => 'getRecurringEntry',
        'recurring_entry_exception' => 'getRecurringEntryException'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('recurring_entry', $data ?? [], null);
        $this->setIfExists('recurring_entry_exception', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets entry
     *
     * @return \OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResultEntry|null
     */
     ...
     * Sets entry
     *
     * @param \OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResultEntry|null $entry entry
     *
     * @return self
     */
    ...
    /**
     * Gets recurring_entry
     *
     * @return \OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResultRecurringEntry|null
     */
    public function getRecurringEntry()
    {
        return $this->container['recurring_entry'];
    }

    /**
     * Sets recurring_entry
     *
     * @param \OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResultRecurringEntry|null $recurring_entry recurring_entry
     *
     * @return self
     */
    public function setRecurringEntry($recurring_entry)
    {
        if (is_null($recurring_entry)) {
            array_push($this->openAPINullablesSetToNull, 'recurring_entry');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('recurring_entry', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['recurring_entry'] = $recurring_entry;

        return $this;
    }

    /**
     * Gets recurring_entry_exception
     *
     * @return \OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResultRecurringEntryException|null
     */
    public function getRecurringEntryException()
    {
        return $this->container['recurring_entry_exception'];
    }

    /**
     * Sets recurring_entry_exception
     *
     * @param \OpenAPI\Client\Model\CalendarDataGetByCalendarDataIdResultRecurringEntryException|null $recurring_entry_exception recurring_entry_exception
     *
     * @return self
     */
    public function setRecurringEntryException($recurring_entry_exception)
    {
        if (is_null($recurring_entry_exception)) {
            array_push($this->openAPINullablesSetToNull, 'recurring_entry_exception');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('recurring_entry_exception', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['recurring_entry_exception'] = $recurring_entry_exception;
