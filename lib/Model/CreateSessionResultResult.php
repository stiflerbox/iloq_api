...
/**
 * CreateSessionResultResult Class Doc Comment
 *
 * @category Class
 * @description Result
 * @package  OpenAPI\Client
 ...
 */
class CreateSessionResultResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSessionResult_Result';
