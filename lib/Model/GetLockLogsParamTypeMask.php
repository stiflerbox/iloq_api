...
/**
 * GetLockLogsParamTypeMask Class Doc Comment
 *
 * @category Class
 * @description Lock log types which are retrieved. For example 2052 would be a successful 5 series key access.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetLockLogsParamTypeMask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetLockLogsParam_TypeMask';
