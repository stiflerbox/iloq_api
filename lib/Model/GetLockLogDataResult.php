...
/**
 * GetLockLogDataResult Class Doc Comment
 *
 * @category Class
 * @description Result for getting lock logs
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetLockLogDataResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetLockLogDataResult';
    ...
    protected static $openAPITypes = [
        ...
        'lock_logs' => '\OpenAPI\Client\Model\LockLogData[]',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('lock_logs', $data ?? [], null);
    ...
    */
     ...
     * Sets end_date_utc
     *
     * @param \DateTime|null $end_date_utc End date and time the logs are returned for.
     *
     * @return self
     */
    public function setEndDateUtc($end_date_utc)
    {
        if (is_null($end_date_utc)) {
            array_push($this->openAPINullablesSetToNull, 'end_date_utc');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('end_date_utc', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets lock_logs
     *
     * @return \OpenAPI\Client\Model\LockLogData[]|null
     */
    public function getLockLogs()
    {
        return $this->container['lock_logs'];
    }

    /**
     * Sets lock_logs
     *
     * @param \OpenAPI\Client\Model\LockLogData[]|null $lock_logs Lock logs which are between startdate and enddate (or all if neither is given).
     *
     * @return self
     */
    public function setLockLogs($lock_logs)
    {
        if (is_null($lock_logs)) {
            array_push($this->openAPINullablesSetToNull, 'lock_logs');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('lock_logs', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['lock_logs'] = $lock_logs;
     ...
     * Sets start_date_utc
     *
     * @param \DateTime|null $start_date_utc Start date and time the logs are returned for.
     *
     * @return self
     */
    public function setStartDateUtc($start_date_utc)
    {
        if (is_null($start_date_utc)) {
            array_push($this->openAPINullablesSetToNull, 'start_date_utc');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('start_date_utc', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
