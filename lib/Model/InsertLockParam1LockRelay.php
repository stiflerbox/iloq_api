...
/**
 * InsertLockParam1LockRelay Class Doc Comment
 *
 * @category Class
 * @description Lock relay information
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InsertLockParam1LockRelay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertLockParam1_LockRelay';
    ...
    protected static $openAPITypes = [
        ...
        'relay_k2_delay' => 'int',
        'relay_mask' => 'int',
        'relay_mode' => '\OpenAPI\Client\Model\LockRelayRelayMode',
        'relay_name_data' => 'string',
        'relay_packet' => 'bool',
        'relay_quasar_delay' => 'int',
        'relay_quasar_mode' => '\OpenAPI\Client\Model\LockRelayRelayQuasarMode'
    ];
    ...
    protected static $openAPIFormats = [
        'relay_k1_delay' => 'int32',
        'relay_k2_delay' => 'int32',
        'relay_mask' => 'int64',
        'relay_mode' => null,
        'relay_name_data' => null,
        'relay_packet' => null,
        'relay_quasar_delay' => 'int32',
        'relay_quasar_mode' => null
    ];
    ...
    protected static array $openAPINullables = [
        'relay_k1_delay' => false,
        'relay_k2_delay' => false,
        'relay_mask' => false,
        'relay_mode' => false,
        'relay_name_data' => true,
        'relay_packet' => false,
        'relay_quasar_delay' => false,
        'relay_quasar_mode' => false
    ];
    ...
    protected static $attributeMap = [
        'relay_k1_delay' => 'RelayK1Delay',
        'relay_k2_delay' => 'RelayK2Delay',
        'relay_mask' => 'RelayMask',
        'relay_mode' => 'RelayMode',
        'relay_name_data' => 'RelayNameData',
        'relay_packet' => 'RelayPacket',
        'relay_quasar_delay' => 'RelayQuasarDelay',
        'relay_quasar_mode' => 'RelayQuasarMode'
    ];
    ...
    protected static $setters = [
        'relay_k1_delay' => 'setRelayK1Delay',
        'relay_k2_delay' => 'setRelayK2Delay',
        'relay_mask' => 'setRelayMask',
        'relay_mode' => 'setRelayMode',
        'relay_name_data' => 'setRelayNameData',
        'relay_packet' => 'setRelayPacket',
        'relay_quasar_delay' => 'setRelayQuasarDelay',
        'relay_quasar_mode' => 'setRelayQuasarMode'
    ];
    ...
    protected static $getters = [
        'relay_k1_delay' => 'getRelayK1Delay',
        'relay_k2_delay' => 'getRelayK2Delay',
        'relay_mask' => 'getRelayMask',
        'relay_mode' => 'getRelayMode',
        'relay_name_data' => 'getRelayNameData',
        'relay_packet' => 'getRelayPacket',
        'relay_quasar_delay' => 'getRelayQuasarDelay',
        'relay_quasar_mode' => 'getRelayQuasarMode'
    ];
    ...
    {
        $this->setIfExists('relay_k1_delay', $data ?? [], null);
        $this->setIfExists('relay_k2_delay', $data ?? [], null);
        $this->setIfExists('relay_mask', $data ?? [], null);
        $this->setIfExists('relay_mode', $data ?? [], null);
        $this->setIfExists('relay_name_data', $data ?? [], null);
        $this->setIfExists('relay_packet', $data ?? [], null);
        $this->setIfExists('relay_quasar_delay', $data ?? [], null);
        $this->setIfExists('relay_quasar_mode', $data ?? [], null);
    }
    ...
    */
     ...
     * @return int|null
     */
    public function getRelayK1Delay()
    {
        return $this->container['relay_k1_delay'];
    }

    /**
     * Sets relay_k1_delay
     *
     * @param int|null $relay_k1_delay Lock K1 relay work delay in milliseconds
     *
     * @return self
     */
    public function setRelayK1Delay($relay_k1_delay)
    {
        if (is_null($relay_k1_delay)) {
            throw new \InvalidArgumentException('non-nullable relay_k1_delay cannot be null');
        }
        $this->container['relay_k1_delay'] = $relay_k1_delay;
     ...
     * @return int|null
     */
    public function getRelayK2Delay()
    {
        return $this->container['relay_k2_delay'];
    }

    /**
     * Sets relay_k2_delay
     *
     * @param int|null $relay_k2_delay K2 relay work delay in milliseconds
     *
     * @return self
     */
    public function setRelayK2Delay($relay_k2_delay)
    {
        if (is_null($relay_k2_delay)) {
            throw new \InvalidArgumentException('non-nullable relay_k2_delay cannot be null');
        }
        $this->container['relay_k2_delay'] = $relay_k2_delay;
     ...
     * @return int|null
     */
    public function getRelayMask()
    {
        return $this->container['relay_mask'];
    }

    /**
     * Sets relay_mask
     *
     * @param int|null $relay_mask Mask of which relays are in use
     *
     * @return self
     */
    public function setRelayMask($relay_mask)
    {
        if (is_null($relay_mask)) {
            throw new \InvalidArgumentException('non-nullable relay_mask cannot be null');
        }
        $this->container['relay_mask'] = $relay_mask;
     ...
     * Gets relay_mode
     *
     * @return \OpenAPI\Client\Model\LockRelayRelayMode|null
     */
    public function getRelayMode()
    {
        return $this->container['relay_mode'];
    }

    /**
     * Sets relay_mode
     *
     * @param \OpenAPI\Client\Model\LockRelayRelayMode|null $relay_mode relay_mode
     *
     * @return self
     */
    public function setRelayMode($relay_mode)
    {
        if (is_null($relay_mode)) {
            throw new \InvalidArgumentException('non-nullable relay_mode cannot be null');
        }
        $this->container['relay_mode'] = $relay_mode;

        return $this;
    }

    /**
     * Gets relay_name_data
     *
     * @return string|null
     */
    public function getRelayNameData()
    {
        return $this->container['relay_name_data'];
    }

    /**
     * Sets relay_name_data
     *
     * @param string|null $relay_name_data Name data
     *
     * @return self
     */
    public function setRelayNameData($relay_name_data)
    {
        if (is_null($relay_name_data)) {
            array_push($this->openAPINullablesSetToNull, 'relay_name_data');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('relay_name_data', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['relay_name_data'] = $relay_name_data;
     ...
     * @return bool|null
     */
    public function getRelayPacket()
    {
        return $this->container['relay_packet'];
    }

    /**
     * Sets relay_packet
     *
     * @param bool|null $relay_packet  
     *
     * @return self
     */
    public function setRelayPacket($relay_packet)
    {
        if (is_null($relay_packet)) {
            throw new \InvalidArgumentException('non-nullable relay_packet cannot be null');
        }
        $this->container['relay_packet'] = $relay_packet;

        return $this;
    }

    /**
     * Gets relay_quasar_delay
     *
     * @return int|null
     */
    public function getRelayQuasarDelay()
    {
        return $this->container['relay_quasar_delay'];
    }

    /**
     * Sets relay_quasar_delay
     *
     * @param int|null $relay_quasar_delay  
     *
     * @return self
     */
    public function setRelayQuasarDelay($relay_quasar_delay)
    {
        if (is_null($relay_quasar_delay)) {
            throw new \InvalidArgumentException('non-nullable relay_quasar_delay cannot be null');
        }
        $this->container['relay_quasar_delay'] = $relay_quasar_delay;

        return $this;
    }

    /**
     * Gets relay_quasar_mode
     *
     * @return \OpenAPI\Client\Model\LockRelayRelayQuasarMode|null
     */
    public function getRelayQuasarMode()
    {
        return $this->container['relay_quasar_mode'];
    }

    /**
     * Sets relay_quasar_mode
     *
     * @param \OpenAPI\Client\Model\LockRelayRelayQuasarMode|null $relay_quasar_mode relay_quasar_mode
     *
     * @return self
     */
    public function setRelayQuasarMode($relay_quasar_mode)
    {
        if (is_null($relay_quasar_mode)) {
            throw new \InvalidArgumentException('non-nullable relay_quasar_mode cannot be null');
        }
        $this->container['relay_quasar_mode'] = $relay_quasar_mode;
