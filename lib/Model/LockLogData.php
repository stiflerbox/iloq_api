 ...
 */
class LockLogData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LockLogData';
    ...
    protected static $openAPITypes = [
        'access_type_mask' => '\OpenAPI\Client\Model\LockLogDataAccessTypeMask',
        'device_log_id' => 'string',
        'error_code' => 'int',
        'f_lock_id' => 'string',
        'f_lock_log_fn_key_id' => 'string',
        'fn_key_id' => 'string',
        'going_counter' => 'int',
        'going_date' => '\DateTime',
        'key_id' => 'int',
    ...
    protected static $openAPIFormats = [
        'access_type_mask' => null,
        'device_log_id' => 'guid',
        'error_code' => 'int32',
        'f_lock_id' => 'guid',
        'f_lock_log_fn_key_id' => 'guid',
        'fn_key_id' => 'guid',
        'going_counter' => 'int32',
        'going_date' => 'date-time',
        'key_id' => 'int32',
        'location_code' => null,
        'lock_group_id' => 'guid',
        'locking_object' => null,
    ...
    protected static array $openAPINullables = [
        'access_type_mask' => false,
        'device_log_id' => false,
        'error_code' => false,
        'f_lock_id' => false,
        'f_lock_log_fn_key_id' => false,
        'fn_key_id' => true,
        'going_counter' => false,
        'going_date' => true,
        'key_id' => false,
    ...
    protected static $attributeMap = [
        'access_type_mask' => 'AccessTypeMask',
        'device_log_id' => 'DeviceLog_ID',
        'error_code' => 'ErrorCode',
        'f_lock_id' => 'FLock_ID',
        'f_lock_log_fn_key_id' => 'FLockLogFNKey_ID',
        'fn_key_id' => 'FNKey_ID',
        'going_counter' => 'GoingCounter',
    ...
    protected static $setters = [
        'access_type_mask' => 'setAccessTypeMask',
        'device_log_id' => 'setDeviceLogId',
        'error_code' => 'setErrorCode',
        'f_lock_id' => 'setFLockId',
        'f_lock_log_fn_key_id' => 'setFLockLogFnKeyId',
        'fn_key_id' => 'setFnKeyId',
        'going_counter' => 'setGoingCounter',
        'going_date' => 'setGoingDate',
        'key_id' => 'setKeyId',
    ...
    protected static $getters = [
        'access_type_mask' => 'getAccessTypeMask',
        'device_log_id' => 'getDeviceLogId',
        'error_code' => 'getErrorCode',
        'f_lock_id' => 'getFLockId',
        'f_lock_log_fn_key_id' => 'getFLockLogFnKeyId',
        'fn_key_id' => 'getFnKeyId',
        'going_counter' => 'getGoingCounter',
        'going_date' => 'getGoingDate',
        'key_id' => 'getKeyId',
    ...
    {
        $this->setIfExists('access_type_mask', $data ?? [], null);
        $this->setIfExists('device_log_id', $data ?? [], null);
        $this->setIfExists('error_code', $data ?? [], null);
        $this->setIfExists('f_lock_id', $data ?? [], null);
        $this->setIfExists('f_lock_log_fn_key_id', $data ?? [], null);
        $this->setIfExists('fn_key_id', $data ?? [], null);
        $this->setIfExists('going_counter', $data ?? [], null);
        $this->setIfExists('going_date', $data ?? [], null);
        ...
        $this->setIfExists('reading_date', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets access_type_mask
     *
     * @return \OpenAPI\Client\Model\LockLogDataAccessTypeMask|null
     */
    public function getAccessTypeMask()
    {
        return $this->container['access_type_mask'];
    }

    /**
     * Sets access_type_mask
     *
     * @param \OpenAPI\Client\Model\LockLogDataAccessTypeMask|null $access_type_mask access_type_mask
     *
     * @return self
     */
    public function setAccessTypeMask($access_type_mask)
    {
        if (is_null($access_type_mask)) {
            throw new \InvalidArgumentException('non-nullable access_type_mask cannot be null');
        }
        $this->container['access_type_mask'] = $access_type_mask;
     ...
     * Sets device_log_id
     *
     * @param string|null $device_log_id Log ID
     *
     * @return self
     */
     ...
     * Sets error_code
     *
     * @param int|null $error_code Error code. 0 means no error
     *
     * @return self
     */
     ...
     * Sets f_lock_id
     *
     * @param string|null $f_lock_id Lock Id
     *
     * @return self
     */
    ...
    /**
     * Gets f_lock_log_fn_key_id
     *
     * @return string|null
     * @deprecated
     */
    public function getFLockLogFnKeyId()
    {
        return $this->container['f_lock_log_fn_key_id'];
    }

    /**
     * Sets f_lock_log_fn_key_id
     *
     * @param string|null $f_lock_log_fn_key_id Log ID. Deprecated field, use DeviceLog_ID instead.
     *
     * @return self
     * @deprecated
     */
    public function setFLockLogFnKeyId($f_lock_log_fn_key_id)
    {
        if (is_null($f_lock_log_fn_key_id)) {
            throw new \InvalidArgumentException('non-nullable f_lock_log_fn_key_id cannot be null');
        }
        $this->container['f_lock_log_fn_key_id'] = $f_lock_log_fn_key_id;
     ...
     * Sets fn_key_id
     *
     * @param string|null $fn_key_id Key's ID which accessed lock
     *
     * @return self
     */
    public function setFnKeyId($fn_key_id)
    {
        if (is_null($fn_key_id)) {
            array_push($this->openAPINullablesSetToNull, 'fn_key_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('fn_key_id', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * @return int|null
     */
    public function getGoingCounter()
    {
        return $this->container['going_counter'];
    }

    /**
     * Sets going_counter
     *
     * @param int|null $going_counter Counter of how many times lock has been used
     *
     * @return self
     */
    public function setGoingCounter($going_counter)
    {
        if (is_null($going_counter)) {
            throw new \InvalidArgumentException('non-nullable going_counter cannot be null');
        }
        $this->container['going_counter'] = $going_counter;
    ...
    {
        return $this->container['going_date'];
    }

    /**
     * Sets going_date
     *
     * @param \DateTime|null $going_date Date And time when Key accessed lock (UTC time)
     *
     * @return self
     */
    public function setGoingDate($going_date)
    {
        if (is_null($going_date)) {
            array_push($this->openAPINullablesSetToNull, 'going_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('going_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['going_date'] = $going_date;
     ...
     * Sets key_id
     *
     * @param int|null $key_id Key's KeyId info
     *
     * @return self
     */
     ...
     * Sets location_code
     *
     * @param string|null $location_code Lock's location code
     *
     * @return self
     */
     ...
     * Sets lock_group_id
     *
     * @param string|null $lock_group_id Locking system ID
     *
     * @return self
     */
     ...
     * Sets locking_object
     *
     * @param string|null $locking_object Lock's Locking object info
     *
     * @return self
     */
     ...
     * Sets reading_date
     *
     * @param \DateTime|null $reading_date Date And time when log was read
     *
     * @return self
     */
    public function setReadingDate($reading_date)
    {
        if (is_null($reading_date)) {
            array_push($this->openAPINullablesSetToNull, 'reading_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('reading_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets timestamp_utc
     *
     * @param \DateTime|null $timestamp_utc Time when log arrived to the server and was added to the database
     *
     * @return self
     */
