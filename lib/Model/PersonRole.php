 ...
 */
class PersonRole implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonRole';
    ...
    */
     ...
     * Sets person_role_id
     *
     * @param string|null $person_role_id ID
     *
     * @return self
     */
