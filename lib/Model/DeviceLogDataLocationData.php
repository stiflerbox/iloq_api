...
/**
 * DeviceLogDataLocationData Class Doc Comment
 *
 * @category Class
 * @description Optional location data attached to the audit trail
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DeviceLogDataLocationData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceLogData_LocationData';
    ...
    protected static $openAPIFormats = [
        'accuracy_radius_meters' => 'decimal',
        'latitude' => 'decimal',
        'location_time_utc' => 'date-time',
        'longitude' => 'decimal'
    ];
    ...
    protected static array $openAPINullables = [
        'accuracy_radius_meters' => true,
        'latitude' => true,
        'location_time_utc' => true,
        'longitude' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'latitude' => 'Latitude',
        'location_time_utc' => 'LocationTimeUtc',
        'longitude' => 'Longitude'
    ];
    ...
    protected static $setters = [
        'accuracy_radius_meters' => 'setAccuracyRadiusMeters',
        'latitude' => 'setLatitude',
        'location_time_utc' => 'setLocationTimeUtc',
    ...
    protected static $getters = [
        'accuracy_radius_meters' => 'getAccuracyRadiusMeters',
        'latitude' => 'getLatitude',
        'location_time_utc' => 'getLocationTimeUtc',
    ...
    {
        $this->setIfExists('accuracy_radius_meters', $data ?? [], null);
        $this->setIfExists('latitude', $data ?? [], null);
        $this->setIfExists('location_time_utc', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets accuracy_radius_meters
     *
     * @return float|null
     */
    public function getAccuracyRadiusMeters()
    {
        return $this->container['accuracy_radius_meters'];
    }

    /**
     * Sets accuracy_radius_meters
     *
     * @param float|null $accuracy_radius_meters Accuracy radius of the location in meters
     *
     * @return self
     */
    public function setAccuracyRadiusMeters($accuracy_radius_meters)
    {
        if (is_null($accuracy_radius_meters)) {
            array_push($this->openAPINullablesSetToNull, 'accuracy_radius_meters');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('accuracy_radius_meters', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['accuracy_radius_meters'] = $accuracy_radius_meters;
    ...
    /**
     * Gets location_time_utc
     *
     * @return \DateTime|null
     */
    public function getLocationTimeUtc()
    {
        return $this->container['location_time_utc'];
    }

    /**
     * Sets location_time_utc
     *
     * @param \DateTime|null $location_time_utc Point in time when the location data was read. Can be null.
     *
     * @return self
     */
    public function setLocationTimeUtc($location_time_utc)
    {
        if (is_null($location_time_utc)) {
            array_push($this->openAPINullablesSetToNull, 'location_time_utc');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('location_time_utc', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['location_time_utc'] = $location_time_utc;
