...
/**
 * CalendarDataTitleInsertType Class Doc Comment
 *
 * @category Class
 * @description Type
 * @package  OpenAPI\Client
 ...
 */
class CalendarDataTitleInsertType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarDataTitleInsert_Type';
