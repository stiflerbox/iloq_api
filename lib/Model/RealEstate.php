...
/**
 * RealEstate Class Doc Comment
 *
 * @category Class
 * @description Real estate. Each locking system has at least one real estate which ID is equal to empty guid (00000000-0000-0000-0000-000000000000). It acts as a root real estate and can&#39;t be removed.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class RealEstate implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RealEstate';
    ...
    protected static $attributeMap = [
        'name' => 'Name',
        'parent_real_estate_id' => 'ParentRealEstate_ID',
    ...
    protected static $setters = [
        'name' => 'setName',
        'parent_real_estate_id' => 'setParentRealEstateId',
    ...
    protected static $getters = [
        'name' => 'getName',
        'parent_real_estate_id' => 'getParentRealEstateId',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('parent_real_estate_id', $data ?? [], null);
    ...
    */
     ...
     * Sets name
     *
     * @param string|null $name Real estate name
     *
     * @return self
     */
    ...
    /**
     * Gets parent_real_estate_id
     *
     * @return string|null
     */
    public function getParentRealEstateId()
    {
        return $this->container['parent_real_estate_id'];
    }

    /**
     * Sets parent_real_estate_id
     *
     * @param string|null $parent_real_estate_id Parent's ID if real estate is nested and linked to a parent. Null if it isn't nested.
     *
     * @return self
     */
    public function setParentRealEstateId($parent_real_estate_id)
    {
        if (is_null($parent_real_estate_id)) {
            array_push($this->openAPINullablesSetToNull, 'parent_real_estate_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('parent_real_estate_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['parent_real_estate_id'] = $parent_real_estate_id;
     ...
     * Sets real_estate_id
     *
     * @param string|null $real_estate_id ID
     *
     * @return self
     */
