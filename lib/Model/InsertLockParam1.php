...
/**
 * InsertLockParam1 Class Doc Comment
 *
 * @category Class
 ...
 */
class InsertLockParam1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertLockParam1';
    ...
    protected static $openAPITypes = [
        ...
        'time_limit' => '\OpenAPI\Client\Model\InsertLockParam1TimeLimit'
    ];
    ...
    */
     ...
     * Gets time_limit
     *
     * @return \OpenAPI\Client\Model\InsertLockParam1TimeLimit|null
     */
     ...
     * Sets time_limit
     *
     * @param \OpenAPI\Client\Model\InsertLockParam1TimeLimit|null $time_limit time_limit
     *
     * @return self
     */
    public function setTimeLimit($time_limit)
    {
        if (is_null($time_limit)) {
            array_push($this->openAPINullablesSetToNull, 'time_limit');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('time_limit', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
