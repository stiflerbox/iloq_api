...
/**
 * SecurityAccess2Type Class Doc Comment
 *
 * @category Class
 * @description Type (Group, mask, key)
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SecurityAccess2Type implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecurityAccess2_Type';
