...
/**
 * CalendarDataTitle Class Doc Comment
 *
 * @category Class
 * @description calendar data title
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CalendarDataTitle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarDataTitle';
    ...
    protected static $openAPITypes = [
        ...
        'description' => 'string',
        'name' => 'string',
        'option_mask' => '\OpenAPI\Client\Model\CalendarDataTitleOptionMask',
        'real_estate_id' => 'string',
        'reservable_period_length_weeks' => 'int',
        'reservation_target_type' => '\OpenAPI\Client\Model\CalendarDataTitleReservationTargetType',
        'type' => '\OpenAPI\Client\Model\CalendarDataTitleType',
        'zone_id' => 'string'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'reservable_period_length_weeks' => false,
        'reservation_target_type' => false,
        'type' => false,
        'zone_id' => false
    ];
    ...
    */
     ...
     *
     * @param string|null $calendar_data_title_id Id
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Name of calendardata title
     *
     * @return self
     */
     ...
     * Gets option_mask
     *
     * @return \OpenAPI\Client\Model\CalendarDataTitleOptionMask|null
     */
     ...
     * Sets option_mask
     *
     * @param \OpenAPI\Client\Model\CalendarDataTitleOptionMask|null $option_mask option_mask
     *
     * @return self
     */
     ...
     * Sets real_estate_id
     *
     * @param string|null $real_estate_id Id of the realestate calendardata title belongs to
     *
     * @return self
     */
    ...
    public function setReservablePeriodLengthWeeks($reservable_period_length_weeks)
    {
        if (is_null($reservable_period_length_weeks)) {
            throw new \InvalidArgumentException('non-nullable reservable_period_length_weeks cannot be null');
        }
     ...
     *
     * @return \OpenAPI\Client\Model\CalendarDataTitleReservationTargetType|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CalendarDataTitleReservationTargetType|null $reservation_target_type reservation_target_type
     *
     * @return self
     */
    public function setReservationTargetType($reservation_target_type)
    {
        if (is_null($reservation_target_type)) {
            throw new \InvalidArgumentException('non-nullable reservation_target_type cannot be null');
        }
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\CalendarDataTitleType|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\CalendarDataTitleType|null $type type
     *
     * @return self
     */
     ...
     * Sets zone_id
     *
     * @param string|null $zone_id Id of the calendardata titles zone
     *
     * @return self
     */
