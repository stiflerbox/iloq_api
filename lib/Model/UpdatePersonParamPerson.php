...
/**
 * UpdatePersonParamPerson Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdatePersonParamPerson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdatePersonParam_Person';
    ...
    */
     ...
     * Sets person_id
     *
     * @param string|null $person_id Person ID
     *
     * @return self
     */
     ...
     * Sets person_code
     *
     * @param string|null $person_code Code identifying user. For example social security number.
     *
     * @return self
     */
    public function setPersonCode($person_code)
    {
        if (is_null($person_code)) {
            array_push($this->openAPINullablesSetToNull, 'person_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('person_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
