...
/**
 * UpdateKeyParamKey Class Doc Comment
 *
 * @category Class
 * @description Key update information
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateKeyParamKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateKeyParam_Key';
    ...
    protected static $openAPITypes = [
        ...
        'info_text' => 'string',
        'is_programmed' => 'bool',
        'key_type_mask' => '\OpenAPI\Client\Model\KeyKeyTypeMask',
        'person_id' => 'string',
        'programming_state' => '\OpenAPI\Client\Model\KeyProgrammingState',
    ...
    protected static $attributeMap = [
        ...
        'state' => 'State',
        'tag_key' => 'TagKey',
        'tag_key_hex' => 'TagKeyHex',
        'tag_key_source' => 'TagKeySource',
    ...
    protected static $setters = [
        ...
        'fn_key_id' => 'setFnKeyId',
        'info_text' => 'setInfoText',
        'is_programmed' => 'setIsProgrammed',
        'key_type_mask' => 'setKeyTypeMask',
        'person_id' => 'setPersonId',
        'programming_state' => 'setProgrammingState',
        'real_estate_id' => 'setRealEstateId',
        'rom_id' => 'setRomId',
        'stamp' => 'setStamp',
        'stamp_source' => 'setStampSource',
        'state' => 'setState',
        'tag_key' => 'setTagKey',
        'tag_key_hex' => 'setTagKeyHex',
        'tag_key_source' => 'setTagKeySource',
    ...
    protected static $getters = [
        ...
        'fn_key_id' => 'getFnKeyId',
        'info_text' => 'getInfoText',
        'is_programmed' => 'getIsProgrammed',
        'key_type_mask' => 'getKeyTypeMask',
        'person_id' => 'getPersonId',
        'programming_state' => 'getProgrammingState',
        'real_estate_id' => 'getRealEstateId',
        'rom_id' => 'getRomId',
        'stamp' => 'getStamp',
        'stamp_source' => 'getStampSource',
        'state' => 'getState',
        'tag_key' => 'getTagKey',
        'tag_key_hex' => 'getTagKeyHex',
        'tag_key_source' => 'getTagKeySource',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('fn_key_id', $data ?? [], null);
        $this->setIfExists('info_text', $data ?? [], null);
        $this->setIfExists('is_programmed', $data ?? [], null);
        $this->setIfExists('key_type_mask', $data ?? [], null);
        $this->setIfExists('person_id', $data ?? [], null);
        $this->setIfExists('programming_state', $data ?? [], null);
        $this->setIfExists('real_estate_id', $data ?? [], null);
        $this->setIfExists('rom_id', $data ?? [], null);
        $this->setIfExists('stamp', $data ?? [], null);
        $this->setIfExists('stamp_source', $data ?? [], null);
        $this->setIfExists('state', $data ?? [], null);
        $this->setIfExists('tag_key', $data ?? [], null);
        $this->setIfExists('tag_key_hex', $data ?? [], null);
        $this->setIfExists('tag_key_source', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['stamp']) > 10)) {
            $invalidProperties[] = "invalid value for 'stamp', the character length must be smaller than or equal to 10.";
        }
     ...
     * Sets expire_date
     *
     * @param \DateTime|null $expire_date Expiration date. Null if the key doesn't expire.
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getFnKeyId()
    {
        return $this->container['fn_key_id'];
    }

    /**
     * Sets fn_key_id
     *
     * @param string|null $fn_key_id Key Id
     *
     * @return self
     */
    public function setFnKeyId($fn_key_id)
    {
        if (is_null($fn_key_id)) {
            throw new \InvalidArgumentException('non-nullable fn_key_id cannot be null');
        }
        $this->container['fn_key_id'] = $fn_key_id;
     ...
     * Sets info_text
     *
     * @param string|null $info_text Additional info text
     *
     * @return self
     */
    ...
    {
        return $this->container['is_programmed'];
    }

    /**
     * Sets is_programmed
     *
     * @param bool|null $is_programmed Has key ever been programmed yet. Read only. Programming state can be other than Programmed if there has been changes made to the key after it has been programmed the first time.
     *
     * @return self
     */
    public function setIsProgrammed($is_programmed)
    {
        if (is_null($is_programmed)) {
            throw new \InvalidArgumentException('non-nullable is_programmed cannot be null');
        }
        $this->container['is_programmed'] = $is_programmed;
     ...
     * Gets key_type_mask
     *
     * @return \OpenAPI\Client\Model\KeyKeyTypeMask|null
     */
    public function getKeyTypeMask()
    {
        return $this->container['key_type_mask'];
    }

    /**
     * Sets key_type_mask
     *
     * @param \OpenAPI\Client\Model\KeyKeyTypeMask|null $key_type_mask key_type_mask
     *
     * @return self
     */
    public function setKeyTypeMask($key_type_mask)
    {
        if (is_null($key_type_mask)) {
            throw new \InvalidArgumentException('non-nullable key_type_mask cannot be null');
        }
        $this->container['key_type_mask'] = $key_type_mask;
     ...
     * Sets person_id
     *
     * @param string|null $person_id Person to whom the key is linked to. Null if the key isn't linked to anyone. This is **required** field for S50 phone key.
     *
     * @return self
     */
    ...
    /**
     * Gets programming_state
     *
     * @return \OpenAPI\Client\Model\KeyProgrammingState|null
     */
    public function getProgrammingState()
    {
        return $this->container['programming_state'];
    }

    /**
     * Sets programming_state
     *
     * @param \OpenAPI\Client\Model\KeyProgrammingState|null $programming_state programming_state
     *
     * @return self
     */
    public function setProgrammingState($programming_state)
    {
        if (is_null($programming_state)) {
            throw new \InvalidArgumentException('non-nullable programming_state cannot be null');
        }
        $this->container['programming_state'] = $programming_state;
     ...
     * Sets real_estate_id
     *
     * @param string|null $real_estate_id ID of the real estate where this key belongs to.
     *
     * @return self
     */
     ...
     * Sets rom_id
     *
     * @param string|null $rom_id ROM ID
     *
     * @return self
     */
    ...
    {
        if (is_null($rom_id)) {
            array_push($this->openAPINullablesSetToNull, 'rom_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('rom_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets stamp
     *
     * @param string $stamp Stamp. Number consisting of 4 digits written to the physical key.
     *
     * @return self
     */
    public function setStamp($stamp)
    {
        ...
        if ((mb_strlen($stamp) > 10)) {
            throw new \InvalidArgumentException('invalid length for $stamp when calling UpdateKeyParamKey., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($stamp) < 0)) {
            throw new \InvalidArgumentException('invalid length for $stamp when calling UpdateKeyParamKey., must be bigger than or equal to 0.');
        }
     ...
     * @return int|null
     */
    public function getStampSource()
    {
        return $this->container['stamp_source'];
    }

    /**
     * Sets stamp_source
     *
     * @param int|null $stamp_source The source of the key labeling (Stamp). Read only.    0 = User-entered    1 = Read from the key. Key labeling (Stamp) can not be edited.    2 = Retrieved from the database
     *
     * @return self
     */
    public function setStampSource($stamp_source)
    {
        if (is_null($stamp_source)) {
            throw new \InvalidArgumentException('non-nullable stamp_source cannot be null');
        }
        $this->container['stamp_source'] = $stamp_source;
     ...
     * Sets state
     *
     * @param int|null $state Current state    0 = Key is in planning state.    1 = Key is handed over to a person    2 = Key is hidden and shouldn't be displayed by default    3 = Key is deleted but remains in the system for logging purposes    4 = Key is returned
     *
     * @return self
     */
     ...
     * Sets tag_key
     *
     * @param string|null $tag_key RFID Tag. Empty string if not given.
     *
     * @return self
     */
    ...
    {
        if (is_null($tag_key)) {
            array_push($this->openAPINullablesSetToNull, 'tag_key');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tag_key', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * @return string|null
     */
    public function getTagKeyHex()
    {
        return $this->container['tag_key_hex'];
    }

    /**
     * Sets tag_key_hex
     *
     * @param string|null $tag_key_hex RFID Tag presented as HEX. Empty if TagKey is absent. Read only.
     *
     * @return self
     */
    public function setTagKeyHex($tag_key_hex)
    {
        if (is_null($tag_key_hex)) {
            array_push($this->openAPINullablesSetToNull, 'tag_key_hex');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('tag_key_hex', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['tag_key_hex'] = $tag_key_hex;
     ...
     * @return int|null
     */
    public function getTagKeySource()
    {
        return $this->container['tag_key_source'];
    }

    /**
     * Sets tag_key_source
     *
     * @param int|null $tag_key_source The source of the key's tagkey enumeration. Read only.      0 = User-entered    1 = Read from the key. Key's tagkey can not be edited.
     *
     * @return self
     */
    public function setTagKeySource($tag_key_source)
    {
        if (is_null($tag_key_source)) {
            throw new \InvalidArgumentException('non-nullable tag_key_source cannot be null');
        }
        $this->container['tag_key_source'] = $tag_key_source;
     ...
     * Sets version_code
     *
     * @param string|null $version_code Version information
     *
     * @return self
     */
    public function setVersionCode($version_code)
    {
        if (is_null($version_code)) {
            array_push($this->openAPINullablesSetToNull, 'version_code');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('version_code', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
