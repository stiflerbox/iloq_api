...
/**
 * LockLogDataAccessTypeMask Class Doc Comment
 *
 * @category Class
 * @description Type of the access. Bit mask of possible values. For example 12 would be a successful S50 phone access
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LockLogDataAccessTypeMask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LockLogData_AccessTypeMask';
