 ...
 *
 * @category Class
 * @description Zone information for locks, persons, keys and security accesses. Locks and security accesses always belong to one zone. Persons and keys can belong to multiple.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class Zone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets time_zone_id
     *
     * @param string|null $time_zone_id Time zone of the zone.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param int|null $type Type    0 = Not set    1 = Zone the customer has added to their locking system    2 = Default zone for everything but keys and persons              This can be edited from locking system settings in iLOQ Manager    4 = Default zone for keys and persons.              This can be edited from locking system settings in iLOQ Manager    8 = General zone which is added to all customers as default zone.
     *
     * @return self
     */
