...
/**
 * NetworkModuleType Class Doc Comment
 *
 * @category Class
 * @description Type
 * @package  OpenAPI\Client
 ...
 */
class NetworkModuleType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NetworkModule_Type';
