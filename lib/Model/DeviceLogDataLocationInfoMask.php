...
/**
 * DeviceLogDataLocationInfoMask Class Doc Comment
 *
 * @category Class
 * @description Bitmask value related to the optional location attached to the audit trail
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DeviceLogDataLocationInfoMask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceLogData_LocationInfoMask';
