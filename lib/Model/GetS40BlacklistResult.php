...
/**
 * GetS40BlacklistResult Class Doc Comment
 *
 * @category Class
 * @description  
 * @package  OpenAPI\Client
 ...
 */
class GetS40BlacklistResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetS40BlacklistResult';
    ...
    protected static $openAPITypes = [
        'blacklist_items' => '\OpenAPI\Client\Model\BlackList[]',
        'blacklist_packet' => '\OpenAPI\Client\Model\GetS40BlacklistResultBlacklistPacket',
        'outside_user_zone_key_count' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        'blacklist_items' => null,
        'blacklist_packet' => null,
        'outside_user_zone_key_count' => 'int32'
    ];
    ...
    protected static array $openAPINullables = [
        'blacklist_items' => true,
        'blacklist_packet' => true,
        'outside_user_zone_key_count' => false
    ];
    ...
    protected static $attributeMap = [
        'blacklist_items' => 'BlacklistItems',
        'blacklist_packet' => 'BlacklistPacket',
        'outside_user_zone_key_count' => 'OutsideUserZoneKeyCount'
    ];
    ...
    protected static $setters = [
        'blacklist_items' => 'setBlacklistItems',
        'blacklist_packet' => 'setBlacklistPacket',
        'outside_user_zone_key_count' => 'setOutsideUserZoneKeyCount'
    ];
    ...
    protected static $getters = [
        'blacklist_items' => 'getBlacklistItems',
        'blacklist_packet' => 'getBlacklistPacket',
        'outside_user_zone_key_count' => 'getOutsideUserZoneKeyCount'
    ];
    ...
    {
        $this->setIfExists('blacklist_items', $data ?? [], null);
        $this->setIfExists('blacklist_packet', $data ?? [], null);
        $this->setIfExists('outside_user_zone_key_count', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets blacklist_items
     *
     * @return \OpenAPI\Client\Model\BlackList[]|null
     */
    public function getBlacklistItems()
    {
        return $this->container['blacklist_items'];
    }

    /**
     * Sets blacklist_items
     *
     * @param \OpenAPI\Client\Model\BlackList[]|null $blacklist_items List of keys in blocklist
     *
     * @return self
     */
    public function setBlacklistItems($blacklist_items)
    {
        if (is_null($blacklist_items)) {
            array_push($this->openAPINullablesSetToNull, 'blacklist_items');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('blacklist_items', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['blacklist_items'] = $blacklist_items;

        return $this;
    }

    /**
     * Gets blacklist_packet
     *
     * @return \OpenAPI\Client\Model\GetS40BlacklistResultBlacklistPacket|null
     */
    public function getBlacklistPacket()
    {
        return $this->container['blacklist_packet'];
    }

    /**
     * Sets blacklist_packet
     *
     * @param \OpenAPI\Client\Model\GetS40BlacklistResultBlacklistPacket|null $blacklist_packet blacklist_packet
     *
     * @return self
     */
    public function setBlacklistPacket($blacklist_packet)
    {
        if (is_null($blacklist_packet)) {
            array_push($this->openAPINullablesSetToNull, 'blacklist_packet');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('blacklist_packet', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['blacklist_packet'] = $blacklist_packet;

        return $this;
    }

    /**
     * Gets outside_user_zone_key_count
     *
     * @return int|null
     */
    public function getOutsideUserZoneKeyCount()
    {
        return $this->container['outside_user_zone_key_count'];
    }

    /**
     * Sets outside_user_zone_key_count
     *
     * @param int|null $outside_user_zone_key_count Keys outside user zones
     *
     * @return self
     */
    public function setOutsideUserZoneKeyCount($outside_user_zone_key_count)
    {
        if (is_null($outside_user_zone_key_count)) {
            throw new \InvalidArgumentException('non-nullable outside_user_zone_key_count cannot be null');
        }
        $this->container['outside_user_zone_key_count'] = $outside_user_zone_key_count;
