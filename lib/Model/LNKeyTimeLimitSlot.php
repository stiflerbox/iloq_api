...
/**
 * LNKeyTimeLimitSlot Class Doc Comment
 *
 * @category Class
 * @description TimeLimit slot for key. If S50 key:     Slot 0  &#x3D; Start date. Do not fill TimeLimitTitle_ID or TimeLimitData.     Slot 1  &#x3D; End date. Do not fill TimeLimitTitle_ID or TimeLimitData.     Slot 2+ &#x3D; Weekly time limits. Both TimeLimitTitle_ID and TimeLimitData is required. Can also include TimeLimitTitleStartDateLg and/or TimeLimitTitleStartDateLg if TimeLimitTitle has start date or end date If S10 key:     Slot 0 &#x3D; Start date or weekly time limit     Slot 1 &#x3D; End date or weekly time limit
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LNKeyTimeLimitSlot implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LNKeyTimeLimitSlot';
    ...
    protected static $openAPITypes = [
        'limit_date_lg' => '\DateTime',
        'slot_no' => '\OpenAPI\Client\Model\LNKeyTimeLimitSlotSlotNo',
        'source_calendar_data_id' => 'string',
        'time_limit_data' => '\OpenAPI\Client\Model\LNKeyTimeLimitData[]',
        'time_limit_title_id' => 'string',
        'time_limit_title_end_date_lg' => '\DateTime',
        'time_limit_title_start_date_lg' => '\DateTime',
        'time_zone_id' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'limit_date_lg' => 'date-time',
        'slot_no' => null,
        'source_calendar_data_id' => 'guid',
        'time_limit_data' => null,
        'time_limit_title_id' => 'guid',
        'time_limit_title_end_date_lg' => 'date-time',
        'time_limit_title_start_date_lg' => 'date-time',
        'time_zone_id' => null
    ];
    ...
    protected static array $openAPINullables = [
        'limit_date_lg' => true,
        'slot_no' => false,
        'source_calendar_data_id' => true,
        'time_limit_data' => true,
        'time_limit_title_id' => true,
        'time_limit_title_end_date_lg' => true,
        'time_limit_title_start_date_lg' => true,
        'time_zone_id' => true
    ];
    ...
    protected static $attributeMap = [
        'limit_date_lg' => 'LimitDateLg',
        'slot_no' => 'SlotNo',
        'source_calendar_data_id' => 'SourceCalendarData_ID',
        'time_limit_data' => 'TimeLimitData',
        'time_limit_title_id' => 'TimeLimitTitle_ID',
        'time_limit_title_end_date_lg' => 'TimeLimitTitleEndDateLg',
        'time_limit_title_start_date_lg' => 'TimeLimitTitleStartDateLg',
    ...
    protected static $setters = [
        'limit_date_lg' => 'setLimitDateLg',
        'slot_no' => 'setSlotNo',
        'source_calendar_data_id' => 'setSourceCalendarDataId',
        'time_limit_data' => 'setTimeLimitData',
        'time_limit_title_id' => 'setTimeLimitTitleId',
        'time_limit_title_end_date_lg' => 'setTimeLimitTitleEndDateLg',
        'time_limit_title_start_date_lg' => 'setTimeLimitTitleStartDateLg',
    ...
    protected static $getters = [
        'limit_date_lg' => 'getLimitDateLg',
        'slot_no' => 'getSlotNo',
        'source_calendar_data_id' => 'getSourceCalendarDataId',
        'time_limit_data' => 'getTimeLimitData',
        'time_limit_title_id' => 'getTimeLimitTitleId',
        'time_limit_title_end_date_lg' => 'getTimeLimitTitleEndDateLg',
        'time_limit_title_start_date_lg' => 'getTimeLimitTitleStartDateLg',
    ...
    {
        $this->setIfExists('limit_date_lg', $data ?? [], null);
        $this->setIfExists('slot_no', $data ?? [], null);
        $this->setIfExists('source_calendar_data_id', $data ?? [], null);
        $this->setIfExists('time_limit_data', $data ?? [], null);
        $this->setIfExists('time_limit_title_id', $data ?? [], null);
        $this->setIfExists('time_limit_title_end_date_lg', $data ?? [], null);
        $this->setIfExists('time_limit_title_start_date_lg', $data ?? [], null);
    ...
    */
     ...
     */
    public function getLimitDateLg()
    {
        return $this->container['limit_date_lg'];
    }

    /**
     * Sets limit_date_lg
     *
     * @param \DateTime|null $limit_date_lg If slot = 0, this is start date in locking system's time zone. If slot = 1, this is end date in locking system's time zone. If slot = 2, this is null.
     *
     * @return self
     */
    public function setLimitDateLg($limit_date_lg)
    {
        if (is_null($limit_date_lg)) {
            array_push($this->openAPINullablesSetToNull, 'limit_date_lg');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('limit_date_lg', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['limit_date_lg'] = $limit_date_lg;
     ...
     * Gets slot_no
     *
     * @return \OpenAPI\Client\Model\LNKeyTimeLimitSlotSlotNo|null
     */
    public function getSlotNo()
    {
        return $this->container['slot_no'];
    }

    /**
     * Sets slot_no
     *
     * @param \OpenAPI\Client\Model\LNKeyTimeLimitSlotSlotNo|null $slot_no slot_no
     *
     * @return self
     */
    public function setSlotNo($slot_no)
    {
        if (is_null($slot_no)) {
            throw new \InvalidArgumentException('non-nullable slot_no cannot be null');
        }
        $this->container['slot_no'] = $slot_no;

        return $this;
    }

    /**
     * Gets source_calendar_data_id
     *
     * @return string|null
     */
    public function getSourceCalendarDataId()
    {
        return $this->container['source_calendar_data_id'];
    }

    /**
     * Sets source_calendar_data_id
     *
     * @param string|null $source_calendar_data_id Id of a calendar entry if lnkeytimelimitslot is created for the key by key scheduler. Read only.
     *
     * @return self
     */
    public function setSourceCalendarDataId($source_calendar_data_id)
    {
        if (is_null($source_calendar_data_id)) {
            array_push($this->openAPINullablesSetToNull, 'source_calendar_data_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('source_calendar_data_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['source_calendar_data_id'] = $source_calendar_data_id;

        return $this;
    }

    /**
     * Gets time_limit_data
     *
     * @return \OpenAPI\Client\Model\LNKeyTimeLimitData[]|null
     */
    public function getTimeLimitData()
    {
        return $this->container['time_limit_data'];
    }

    /**
     * Sets time_limit_data
     *
     * @param \OpenAPI\Client\Model\LNKeyTimeLimitData[]|null $time_limit_data TimeLimit data in this slot.
     *
     * @return self
     */
    public function setTimeLimitData($time_limit_data)
    {
        if (is_null($time_limit_data)) {
            array_push($this->openAPINullablesSetToNull, 'time_limit_data');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('time_limit_data', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['time_limit_data'] = $time_limit_data;

        return $this;
    }

    /**
     * Gets time_limit_title_id
     *
     * @return string|null
     */
    public function getTimeLimitTitleId()
    {
        return $this->container['time_limit_title_id'];
    }

    /**
     * Sets time_limit_title_id
     *
     * @param string|null $time_limit_title_id TimeLimitTitle ID if any.
     *
     * @return self
     */
    public function setTimeLimitTitleId($time_limit_title_id)
    {
        if (is_null($time_limit_title_id)) {
            array_push($this->openAPINullablesSetToNull, 'time_limit_title_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('time_limit_title_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['time_limit_title_id'] = $time_limit_title_id;

        return $this;
    }

    /**
     * Gets time_limit_title_end_date_lg
     *
     * @return \DateTime|null
     */
    public function getTimeLimitTitleEndDateLg()
    {
        return $this->container['time_limit_title_end_date_lg'];
    }

    /**
     * Sets time_limit_title_end_date_lg
     *
     * @param \DateTime|null $time_limit_title_end_date_lg End date of TimeLimitTitle in locking systems's time zone or null if not defined.
     *
     * @return self
     */
    public function setTimeLimitTitleEndDateLg($time_limit_title_end_date_lg)
    {
        if (is_null($time_limit_title_end_date_lg)) {
            array_push($this->openAPINullablesSetToNull, 'time_limit_title_end_date_lg');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('time_limit_title_end_date_lg', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['time_limit_title_end_date_lg'] = $time_limit_title_end_date_lg;

        return $this;
    }

    /**
     * Gets time_limit_title_start_date_lg
     *
     * @return \DateTime|null
     */
    public function getTimeLimitTitleStartDateLg()
    {
        return $this->container['time_limit_title_start_date_lg'];
    }

    /**
     * Sets time_limit_title_start_date_lg
     *
     * @param \DateTime|null $time_limit_title_start_date_lg Start date of TimeLimitTitle in locking systems's time zone or null if not defined
     *
     * @return self
     */
    public function setTimeLimitTitleStartDateLg($time_limit_title_start_date_lg)
    {
        if (is_null($time_limit_title_start_date_lg)) {
            array_push($this->openAPINullablesSetToNull, 'time_limit_title_start_date_lg');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('time_limit_title_start_date_lg', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['time_limit_title_start_date_lg'] = $time_limit_title_start_date_lg;
     ...
     * Sets time_zone_id
     *
     * @param string|null $time_zone_id Time zone of the datetime information. Either user selected (for start and end dates) or from the zone of the used time profile
     *
     * @return self
     */
