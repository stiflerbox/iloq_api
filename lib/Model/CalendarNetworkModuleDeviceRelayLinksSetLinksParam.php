...
/**
 * CalendarNetworkModuleDeviceRelayLinksSetLinksParam Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CalendarNetworkModuleDeviceRelayLinksSetLinksParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarNetworkModuleDeviceRelayLinksSetLinksParam';
    ...
    protected static $openAPITypes = [
        'network_module_device_relay_ids' => 'string[]'
    ];
    ...
    protected static $openAPIFormats = [
        'network_module_device_relay_ids' => 'guid'
    ];
    ...
    protected static array $openAPINullables = [
        'network_module_device_relay_ids' => true
    ];
    ...
    protected static $attributeMap = [
        'network_module_device_relay_ids' => 'NetworkModuleDeviceRelayIds'
    ];
    ...
    protected static $setters = [
        'network_module_device_relay_ids' => 'setNetworkModuleDeviceRelayIds'
    ];
    ...
    protected static $getters = [
        'network_module_device_relay_ids' => 'getNetworkModuleDeviceRelayIds'
    ];
    ...
    {
        $this->setIfExists('network_module_device_relay_ids', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets network_module_device_relay_ids
     *
     * @return string[]|null
     */
    public function getNetworkModuleDeviceRelayIds()
    {
        return $this->container['network_module_device_relay_ids'];
    }

    /**
     * Sets network_module_device_relay_ids
     *
     * @param string[]|null $network_module_device_relay_ids Links. The whole result set must be given when setting links because this method handles both adding/removing of links. If no links are given, clears all calendar's links.
     *
     * @return self
     */
    public function setNetworkModuleDeviceRelayIds($network_module_device_relay_ids)
    {
        if (is_null($network_module_device_relay_ids)) {
            array_push($this->openAPINullablesSetToNull, 'network_module_device_relay_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('network_module_device_relay_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['network_module_device_relay_ids'] = $network_module_device_relay_ids;
