...
/**
 * GetS40BlacklistResultBlacklistPacket Class Doc Comment
 *
 * @category Class
 ...
 */
class GetS40BlacklistResultBlacklistPacket implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetS40BlacklistResult_BlacklistPacket';
    ...
    protected static $openAPITypes = [
        'blacklist_packet_id' => 'string',
        'hard_data_version' => 'int',
        'soft_data_version' => 'int',
        'state' => '\OpenAPI\Client\Model\BlacklistPacketState'
    ];
    ...
    protected static $openAPIFormats = [
        'blacklist_packet_id' => 'guid',
        'hard_data_version' => 'int32',
        'soft_data_version' => 'int32',
        'state' => null
    ];
    ...
    protected static array $openAPINullables = [
        'blacklist_packet_id' => false,
        'hard_data_version' => false,
        'soft_data_version' => false,
        'state' => false
    ];
    ...
    protected static $attributeMap = [
        'blacklist_packet_id' => 'BlacklistPacket_ID',
        'hard_data_version' => 'HardDataVersion',
        'soft_data_version' => 'SoftDataVersion',
        'state' => 'State'
    ];
    ...
    protected static $setters = [
        'blacklist_packet_id' => 'setBlacklistPacketId',
        'hard_data_version' => 'setHardDataVersion',
        'soft_data_version' => 'setSoftDataVersion',
        'state' => 'setState'
    ];
    ...
    protected static $getters = [
        'blacklist_packet_id' => 'getBlacklistPacketId',
        'hard_data_version' => 'getHardDataVersion',
        'soft_data_version' => 'getSoftDataVersion',
        'state' => 'getState'
    ];
    ...
    {
        $this->setIfExists('blacklist_packet_id', $data ?? [], null);
        $this->setIfExists('hard_data_version', $data ?? [], null);
        $this->setIfExists('soft_data_version', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets blacklist_packet_id
     *
     * @return string|null
     */
    public function getBlacklistPacketId()
    {
        return $this->container['blacklist_packet_id'];
    }

    /**
     * Sets blacklist_packet_id
     *
     * @param string|null $blacklist_packet_id  
     *
     * @return self
     */
    public function setBlacklistPacketId($blacklist_packet_id)
    {
        if (is_null($blacklist_packet_id)) {
            throw new \InvalidArgumentException('non-nullable blacklist_packet_id cannot be null');
        }
        $this->container['blacklist_packet_id'] = $blacklist_packet_id;

        return $this;
    }

    /**
     * Gets hard_data_version
     *
     * @return int|null
     */
    public function getHardDataVersion()
    {
        return $this->container['hard_data_version'];
    }

    /**
     * Sets hard_data_version
     *
     * @param int|null $hard_data_version  
     *
     * @return self
     */
    public function setHardDataVersion($hard_data_version)
    {
        if (is_null($hard_data_version)) {
            throw new \InvalidArgumentException('non-nullable hard_data_version cannot be null');
        }
        $this->container['hard_data_version'] = $hard_data_version;

        return $this;
    }

    /**
     * Gets soft_data_version
     *
     * @return int|null
     */
    public function getSoftDataVersion()
    {
        return $this->container['soft_data_version'];
    }

    /**
     * Sets soft_data_version
     *
     * @param int|null $soft_data_version  
     *
     * @return self
     */
    public function setSoftDataVersion($soft_data_version)
    {
        if (is_null($soft_data_version)) {
            throw new \InvalidArgumentException('non-nullable soft_data_version cannot be null');
        }
        $this->container['soft_data_version'] = $soft_data_version;
     ...
     * Gets state
     *
     * @return \OpenAPI\Client\Model\BlacklistPacketState|null
     */
     ...
     * Sets state
     *
     * @param \OpenAPI\Client\Model\BlacklistPacketState|null $state state
     *
     * @return self
     */
