...
/**
 * CalendarDataTitleInsertOptionMask Class Doc Comment
 *
 * @category Class
 * @description Options
 * @package  OpenAPI\Client
 ...
 */
class CalendarDataTitleInsertOptionMask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarDataTitleInsert_OptionMask';
