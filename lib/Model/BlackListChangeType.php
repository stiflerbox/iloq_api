...
/**
 * BlackListChangeType Class Doc Comment
 *
 * @category Class
 * @description Change to previous ordered blocklist
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BlackListChangeType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BlackList_ChangeType';
