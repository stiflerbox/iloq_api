...
/**
 * GetTimeLimitsResultKeyScheduler Class Doc Comment
 *
 * @category Class
 * @description Key renew information
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetTimeLimitsResultKeyScheduler implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTimeLimitsResult_KeyScheduler';
    ...
    protected static $openAPITypes = [
        ...
        'renew_gap_count' => 'int',
        'renew_gap_type' => '\OpenAPI\Client\Model\KeySchedulerRenewGapType',
        'renew_minute' => 'int'
    ];
    ...
    */
     ...
     * Sets renew_end_date
     *
     * @param \DateTime|null $renew_end_date When renewing ends
     *
     * @return self
     */
     ...
     *
     * @param int|null $renew_gap_count Gap in days/weeks before key is renewed. (depending on RenewGapType)
     *
     * @return self
     */
     ...
     * Gets renew_gap_type
     *
     * @return \OpenAPI\Client\Model\KeySchedulerRenewGapType|null
     */
     ...
     * Sets renew_gap_type
     *
     * @param \OpenAPI\Client\Model\KeySchedulerRenewGapType|null $renew_gap_type renew_gap_type
     *
     * @return self
     */
     ...
     * Sets renew_minute
     *
     * @param int|null $renew_minute How long before key's expiration it is renewed. Time is in minutes. For example if value is 120, new programming packet is made about 2 hours before expiration. Minimum is 70 minutes.
     *
     * @return self
     */
