...
/**
 * SecurityAccessType Class Doc Comment
 *
 * @category Class
 * @description Type
 * @package  OpenAPI\Client
 ...
 */
class SecurityAccessType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecurityAccess_Type';
