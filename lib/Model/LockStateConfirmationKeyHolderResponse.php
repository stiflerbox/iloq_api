...
/**
 * LockStateConfirmationKeyHolderResponse Class Doc Comment
 *
 * @category Class
 * @description Response from the key holder
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LockStateConfirmationKeyHolderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LockStateConfirmation_KeyHolderResponse';
