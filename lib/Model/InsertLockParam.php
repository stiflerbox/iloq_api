...
/**
 * InsertLockParam Class Doc Comment
 *
 * @category Class
 * @description Parameter for inserting a new lock
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InsertLockParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertLockParam';
    ...
    protected static $openAPITypes = [
        'lock' => '\OpenAPI\Client\Model\InsertLockParam1Lock',
        'lock_options' => '\OpenAPI\Client\Model\InsertLockParamLockOptions',
        'lock_relay' => '\OpenAPI\Client\Model\InsertLockParam1LockRelay',
        'lock_respects_all_time_limits' => 'bool',
        'security_accesses' => '\OpenAPI\Client\Model\LockSecurityAccessInsert[]',
        'time_limit_title_ids' => 'string[]'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'lock_options' => null,
        'lock_relay' => null,
        'lock_respects_all_time_limits' => null,
        'security_accesses' => null,
        'time_limit_title_ids' => 'guid'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'lock_options' => true,
        'lock_relay' => true,
        'lock_respects_all_time_limits' => false,
        'security_accesses' => true,
        'time_limit_title_ids' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'lock_respects_all_time_limits' => 'LockRespectsAllTimeLimits',
        'security_accesses' => 'SecurityAccesses',
        'time_limit_title_ids' => 'TimeLimitTitleIds'
    ];
    ...
    protected static $setters = [
        'lock' => 'setLock',
        'lock_options' => 'setLockOptions',
        'lock_relay' => 'setLockRelay',
        'lock_respects_all_time_limits' => 'setLockRespectsAllTimeLimits',
        'security_accesses' => 'setSecurityAccesses',
        'time_limit_title_ids' => 'setTimeLimitTitleIds'
    ];
    ...
    protected static $getters = [
        'lock' => 'getLock',
        'lock_options' => 'getLockOptions',
        'lock_relay' => 'getLockRelay',
        'lock_respects_all_time_limits' => 'getLockRespectsAllTimeLimits',
        'security_accesses' => 'getSecurityAccesses',
        'time_limit_title_ids' => 'getTimeLimitTitleIds'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('lock_options', $data ?? [], null);
        $this->setIfExists('lock_relay', $data ?? [], null);
        $this->setIfExists('lock_respects_all_time_limits', $data ?? [], null);
        $this->setIfExists('security_accesses', $data ?? [], null);
        $this->setIfExists('time_limit_title_ids', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets lock
     *
     * @return \OpenAPI\Client\Model\InsertLockParam1Lock|null
     */
     ...
     * Sets lock
     *
     * @param \OpenAPI\Client\Model\InsertLockParam1Lock|null $lock lock
     *
     * @return self
     */
    ...
    {
        if (is_null($lock)) {
            array_push($this->openAPINullablesSetToNull, 'lock');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('lock', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Gets lock_options
     *
     * @return \OpenAPI\Client\Model\InsertLockParamLockOptions|null
     */
    public function getLockOptions()
    {
        return $this->container['lock_options'];
    }

    /**
     * Sets lock_options
     *
     * @param \OpenAPI\Client\Model\InsertLockParamLockOptions|null $lock_options lock_options
     *
     * @return self
     */
    public function setLockOptions($lock_options)
    {
        if (is_null($lock_options)) {
            array_push($this->openAPINullablesSetToNull, 'lock_options');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('lock_options', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['lock_options'] = $lock_options;
     ...
     * Gets lock_relay
     *
     * @return \OpenAPI\Client\Model\InsertLockParam1LockRelay|null
     */
    public function getLockRelay()
    {
        return $this->container['lock_relay'];
    }

    /**
     * Sets lock_relay
     *
     * @param \OpenAPI\Client\Model\InsertLockParam1LockRelay|null $lock_relay lock_relay
     *
     * @return self
     */
    public function setLockRelay($lock_relay)
    {
        if (is_null($lock_relay)) {
            array_push($this->openAPINullablesSetToNull, 'lock_relay');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('lock_relay', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['lock_relay'] = $lock_relay;

        return $this;
    }

    /**
     * Gets lock_respects_all_time_limits
     *
     * @return bool|null
     */
    public function getLockRespectsAllTimeLimits()
    {
        return $this->container['lock_respects_all_time_limits'];
    }

    /**
     * Sets lock_respects_all_time_limits
     *
     * @param bool|null $lock_respects_all_time_limits If true, then lock respects all timelimits and TimeLimitTitleIds doesn't need to be given. If false, then lock respects given TimeLimitTitleIds. If no timelimittitle ids are given, then lock isn't timelimited. Default is false.
     *
     * @return self
     */
    public function setLockRespectsAllTimeLimits($lock_respects_all_time_limits)
    {
        if (is_null($lock_respects_all_time_limits)) {
            throw new \InvalidArgumentException('non-nullable lock_respects_all_time_limits cannot be null');
        }
        $this->container['lock_respects_all_time_limits'] = $lock_respects_all_time_limits;

        return $this;
    }

    /**
     * Gets security_accesses
     *
     * @return \OpenAPI\Client\Model\LockSecurityAccessInsert[]|null
     */
    public function getSecurityAccesses()
    {
        return $this->container['security_accesses'];
    }

    /**
     * Sets security_accesses
     *
     * @param \OpenAPI\Client\Model\LockSecurityAccessInsert[]|null $security_accesses Security accesses which are set for the new lock
     *
     * @return self
     */
    public function setSecurityAccesses($security_accesses)
    {
        if (is_null($security_accesses)) {
            array_push($this->openAPINullablesSetToNull, 'security_accesses');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('security_accesses', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['security_accesses'] = $security_accesses;

        return $this;
    }

    /**
     * Gets time_limit_title_ids
     *
     * @return string[]|null
     */
    public function getTimeLimitTitleIds()
    {
        return $this->container['time_limit_title_ids'];
    }

    /**
     * Sets time_limit_title_ids
     *
     * @param string[]|null $time_limit_title_ids Time limit titles for the new lock. Null or empty list of lock isn't timelimited.
     *
     * @return self
     */
    public function setTimeLimitTitleIds($time_limit_title_ids)
    {
        if (is_null($time_limit_title_ids)) {
            array_push($this->openAPINullablesSetToNull, 'time_limit_title_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('time_limit_title_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['time_limit_title_ids'] = $time_limit_title_ids;
