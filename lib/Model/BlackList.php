...
/**
 * BlackList Class Doc Comment
 *
 * @category Class
 * @description Blacklist item
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class BlackList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BlackList';
    ...
    protected static $openAPITypes = [
        'black_list_date_utc' => '\DateTime',
        'blacklist_version' => 'string',
        'change_type' => '\OpenAPI\Client\Model\BlackListChangeType',
        'fn_key_id' => 'string',
        'fn_key_blacklist_packet_link_id' => 'string',
        'key_stamp' => 'string',
        'key_type_mask' => '\OpenAPI\Client\Model\BlackListKeyTypeMask',
        'name' => 'string',
        'person_name' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        'black_list_date_utc' => 'date-time',
        'blacklist_version' => null,
        'change_type' => null,
        'fn_key_id' => 'guid',
        'fn_key_blacklist_packet_link_id' => 'guid',
        'key_stamp' => null,
        'key_type_mask' => null,
        'name' => null,
        'person_name' => null
    ...
    protected static array $openAPINullables = [
        'black_list_date_utc' => false,
        'blacklist_version' => true,
        'change_type' => false,
        'fn_key_id' => false,
        'fn_key_blacklist_packet_link_id' => false,
        'key_stamp' => true,
        'key_type_mask' => false,
        'name' => true,
        'person_name' => true
    ...
    protected static $attributeMap = [
        'black_list_date_utc' => 'BlackListDateUtc',
        'blacklist_version' => 'BlacklistVersion',
        'change_type' => 'ChangeType',
        'fn_key_id' => 'FNKey_ID',
        'fn_key_blacklist_packet_link_id' => 'FNKeyBlacklistPacketLink_ID',
        'key_stamp' => 'KeyStamp',
    ...
    protected static $setters = [
        'black_list_date_utc' => 'setBlackListDateUtc',
        'blacklist_version' => 'setBlacklistVersion',
        'change_type' => 'setChangeType',
        'fn_key_id' => 'setFnKeyId',
        'fn_key_blacklist_packet_link_id' => 'setFnKeyBlacklistPacketLinkId',
        'key_stamp' => 'setKeyStamp',
    ...
    protected static $getters = [
        'black_list_date_utc' => 'getBlackListDateUtc',
        'blacklist_version' => 'getBlacklistVersion',
        'change_type' => 'getChangeType',
        'fn_key_id' => 'getFnKeyId',
        'fn_key_blacklist_packet_link_id' => 'getFnKeyBlacklistPacketLinkId',
        'key_stamp' => 'getKeyStamp',
    ...
    {
        $this->setIfExists('black_list_date_utc', $data ?? [], null);
        $this->setIfExists('blacklist_version', $data ?? [], null);
        $this->setIfExists('change_type', $data ?? [], null);
        $this->setIfExists('fn_key_id', $data ?? [], null);
        $this->setIfExists('fn_key_blacklist_packet_link_id', $data ?? [], null);
        $this->setIfExists('key_stamp', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets black_list_date_utc
     *
     * @return \DateTime|null
     */
    public function getBlackListDateUtc()
    {
        return $this->container['black_list_date_utc'];
    }

    /**
     * Sets black_list_date_utc
     *
     * @param \DateTime|null $black_list_date_utc Date and time when item was added to blocklist
     *
     * @return self
     */
    public function setBlackListDateUtc($black_list_date_utc)
    {
        if (is_null($black_list_date_utc)) {
            throw new \InvalidArgumentException('non-nullable black_list_date_utc cannot be null');
        }
        $this->container['black_list_date_utc'] = $black_list_date_utc;

        return $this;
    }

    /**
     * Gets blacklist_version
     *
     * @return string|null
     */
    public function getBlacklistVersion()
    {
        return $this->container['blacklist_version'];
    }

    /**
     * Sets blacklist_version
     *
     * @param string|null $blacklist_version Blocklist's version
     *
     * @return self
     */
    public function setBlacklistVersion($blacklist_version)
    {
        if (is_null($blacklist_version)) {
            array_push($this->openAPINullablesSetToNull, 'blacklist_version');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('blacklist_version', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['blacklist_version'] = $blacklist_version;
     ...
     * Gets change_type
     *
     * @return \OpenAPI\Client\Model\BlackListChangeType|null
     */
     ...
     * Sets change_type
     *
     * @param \OpenAPI\Client\Model\BlackListChangeType|null $change_type change_type
     *
     * @return self
     */
     ...
     * Sets fn_key_id
     *
     * @param string|null $fn_key_id Key's id which is in blocklist
     *
     * @return self
     */
    ...
    /**
     * Gets fn_key_blacklist_packet_link_id
     *
     * @return string|null
     */
    public function getFnKeyBlacklistPacketLinkId()
    {
        return $this->container['fn_key_blacklist_packet_link_id'];
    }

    /**
     * Sets fn_key_blacklist_packet_link_id
     *
     * @param string|null $fn_key_blacklist_packet_link_id Id
     *
     * @return self
     */
    public function setFnKeyBlacklistPacketLinkId($fn_key_blacklist_packet_link_id)
    {
        if (is_null($fn_key_blacklist_packet_link_id)) {
            throw new \InvalidArgumentException('non-nullable fn_key_blacklist_packet_link_id cannot be null');
        }
        $this->container['fn_key_blacklist_packet_link_id'] = $fn_key_blacklist_packet_link_id;
     ...
     * @return string|null
     */
    public function getKeyStamp()
    {
        return $this->container['key_stamp'];
    }

    /**
     * Sets key_stamp
     *
     * @param string|null $key_stamp Key's stamp
     *
     * @return self
     */
    public function setKeyStamp($key_stamp)
    {
        if (is_null($key_stamp)) {
            array_push($this->openAPINullablesSetToNull, 'key_stamp');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('key_stamp', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['key_stamp'] = $key_stamp;
     ...
     * Gets key_type_mask
     *
     * @return \OpenAPI\Client\Model\BlackListKeyTypeMask|null
     */
     ...
     * Sets key_type_mask
     *
     * @param \OpenAPI\Client\Model\BlackListKeyTypeMask|null $key_type_mask key_type_mask
     *
     * @return self
     */
     ...
     * Sets person_name
     *
     * @param string|null $person_name Person's name
     *
     * @return self
     */
