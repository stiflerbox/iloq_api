...
/**
 * PublicApiGetUrlParam Class Doc Comment
 *
 * @category Class
 * @description Returning url for public API endpoints
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PublicApiGetUrlParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PublicApiGetUrlParam';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['customer_code']) < 2)) {
            $invalidProperties[] = "invalid value for 'customer_code', the character length must be bigger than or equal to 2.";
        }
    ...
    public function setCustomerCode($customer_code)
    {
        ...
        if ((mb_strlen($customer_code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $customer_code when calling PublicApiGetUrlParam., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($customer_code) < 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_code when calling PublicApiGetUrlParam., must be bigger than or equal to 2.');
        }
