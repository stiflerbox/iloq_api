...
/**
 * CalendarDataSecurityRoleLinksDeleteLinksParam Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CalendarDataSecurityRoleLinksDeleteLinksParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarDataSecurityRoleLinksDeleteLinksParam';
    ...
    */
     ...
     *
     * @param string[]|null $security_role_ids Code access group Ids which are deleted from calendar data
     *
     * @return self
     */
