...
/**
 * CalendarNetworkModuleRelayLink Class Doc Comment
 *
 * @category Class
 * @description Link between calendar data title and network module device relay
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CalendarNetworkModuleRelayLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarNetworkModuleRelayLink';
    ...
    protected static array $openAPINullables = [
        ...
        'network_module_device_relay_id' => true
    ];
    ...
    */
     ...
     *
     * @param string|null $calendar_data_title_id Calendar data title ID
     *
     * @return self
     */
     ...
     *
     * @param string|null $network_module_device_relay_id Network module device relay ID
     *
     * @return self
     */
    public function setNetworkModuleDeviceRelayId($network_module_device_relay_id)
    {
        if (is_null($network_module_device_relay_id)) {
            array_push($this->openAPINullablesSetToNull, 'network_module_device_relay_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('network_module_device_relay_id', $nullablesSetToNull);
            if ($index !== FALSE) {
