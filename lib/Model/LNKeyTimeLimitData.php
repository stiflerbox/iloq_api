...
/**
 * LNKeyTimeLimitData Class Doc Comment
 *
 * @category Class
 * @description avaimen aikarajoitukset
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LNKeyTimeLimitData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LNKeyTimeLimitData';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('end_time_ms', $data ?? [], null);
        $this->setIfExists('start_time', $data ?? [], null);
        $this->setIfExists('start_time_ms', $data ?? [], null);
    ...
    */
     ...
     * Sets end_time
     *
     * @param string|null $end_time End time (read only)
     *
     * @return self
     */
     ...
     * Sets end_time_ms
     *
     * @param int|null $end_time_ms Start time in milliseconds when this timelimit ends on given weekdays For example 57 600 000 would be 16:00 in the afternoon. Must be divisable by 15 minutes.
     *
     * @return self
     */
    public function setEndTimeMs($end_time_ms)
    {
        if (is_null($end_time_ms)) {
            throw new \InvalidArgumentException('non-nullable end_time_ms cannot be null');
        }
     ...
     * Sets start_time
     *
     * @param string|null $start_time start time (read only)
     *
     * @return self
     */
     ...
     * Sets start_time_ms
     *
     * @param int|null $start_time_ms Start time in milliseconds when this timelimit begins on given weekdays. For example 28 800 000 would be 8:00 in the morning. Must be divisable by 15 minutes.
     *
     * @return self
     */
    public function setStartTimeMs($start_time_ms)
    {
        if (is_null($start_time_ms)) {
            throw new \InvalidArgumentException('non-nullable start_time_ms cannot be null');
        }
     ...
     * Sets week_day_mask
     *
     * @param int|null $week_day_mask Week days mask to inform when this timelimit is in use
     *
     * @return self
     */
