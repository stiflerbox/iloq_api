...
/**
 * AddSecurityAccessParam Class Doc Comment
 *
 * @category Class
 * @description Param for adding security access for key
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AddSecurityAccessParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddSecurityAccessParam';
    ...
    */
     ...
     *
     * @param string|null $security_access_id Security access to be added
     *
     * @return self
     */
