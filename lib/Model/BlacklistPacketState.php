...
/**
 * BlacklistPacketState Class Doc Comment
 *
 * @category Class
 * @description  
 * @package  OpenAPI\Client
 ...
 */
class BlacklistPacketState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BlacklistPacket_State';
