...
/**
 * LockSecurityAccessInsert Class Doc Comment
 *
 * @category Class
 * @description  
 * @package  OpenAPI\Client
 ...
 */
class LockSecurityAccessInsert implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LockSecurityAccessInsert';
    ...
    */
    ...
    public function setRelayMask($relay_mask)
    {
        if (is_null($relay_mask)) {
            array_push($this->openAPINullablesSetToNull, 'relay_mask');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('relay_mask', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param string|null $security_access_id  
     *
     * @return self
     */
