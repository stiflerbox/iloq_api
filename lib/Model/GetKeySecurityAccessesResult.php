...
/**
 * GetKeySecurityAccessesResult Class Doc Comment
 *
 * @category Class
 * @description Result for gettings key&#39;s security accesses
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetKeySecurityAccessesResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetKeySecurityAccessesResult';
    ...
    protected static $openAPITypes = [
        ...
        'security_accesses' => '\OpenAPI\Client\Model\SecurityAccess[]'
    ];
    ...
    */
     ...
     *
     * @param int|null $outside_user_zones_count How many of additional security accesses are linked to the key which are invisible to user because they are outside his zones
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\SecurityAccess[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\SecurityAccess[]|null $security_accesses Security accesses linked to keys which are visible to user
     *
     * @return self
     */
