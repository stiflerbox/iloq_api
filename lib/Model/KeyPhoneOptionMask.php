...
/**
 * KeyPhoneOptionMask Class Doc Comment
 *
 * @category Class
 * @description Phone options/state
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class KeyPhoneOptionMask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeyPhone_OptionMask';
