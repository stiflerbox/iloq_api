...
/**
 * NetworkModuleState Class Doc Comment
 *
 * @category Class
 * @description State
 * @package  OpenAPI\Client
 ...
 */
class NetworkModuleState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NetworkModule_State';
