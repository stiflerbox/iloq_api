...
/**
 * InsertKeyParam Class Doc Comment
 *
 * @category Class
 * @description Parameter for inserting a new key
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InsertKeyParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertKeyParam';
    ...
    protected static $openAPITypes = [
        'key' => '\OpenAPI\Client\Model\InsertKeyParamKey',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('zone_ids', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets key
     *
     * @return \OpenAPI\Client\Model\InsertKeyParamKey|null
     */
     ...
     * Sets key
     *
     * @param \OpenAPI\Client\Model\InsertKeyParamKey|null $key key
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $security_access_ids Security accesses which should be linked to the new key
     *
     * @return self
     */
     ...
     * Sets zone_ids
     *
     * @param string[]|null $zone_ids Zones the new key belongs to
     *
     * @return self
     */
    ...
    {
        if (is_null($zone_ids)) {
            array_push($this->openAPINullablesSetToNull, 'zone_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('zone_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
