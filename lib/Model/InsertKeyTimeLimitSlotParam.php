...
/**
 * InsertKeyTimeLimitSlotParam Class Doc Comment
 *
 * @category Class
 * @description Parameter for inserting a time limit to key
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InsertKeyTimeLimitSlotParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertKeyTimeLimitSlotParam';
