...
/**
 * KeyProgrammingState Class Doc Comment
 *
 * @category Class
 * @description Programming state of the key. Read only.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class KeyProgrammingState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Key_ProgrammingState';
