...
/**
 * UpdateKeyParam1Key Class Doc Comment
 *
 * @category Class
 ...
 */
class UpdateKeyParam1Key implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateKeyParam1_Key';
    ...
    */
     ...
     * Sets person_id
     *
     * @param string|null $person_id Person to whom the key is linked to. Null if the key isn't linked to anyone.
     *
     * @return self
     */
    ...
    public function setStamp($stamp)
    {
        ...
        if ((mb_strlen($stamp) > 10)) {
            throw new \InvalidArgumentException('invalid length for $stamp when calling UpdateKeyParam1Key., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($stamp) < 0)) {
            throw new \InvalidArgumentException('invalid length for $stamp when calling UpdateKeyParam1Key., must be bigger than or equal to 0.');
        }
