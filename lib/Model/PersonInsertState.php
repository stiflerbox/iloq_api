...
/**
 * PersonInsertState Class Doc Comment
 *
 * @category Class
 * @description State. Is person in use or not in use. This property is readonly.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class PersonInsertState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PersonInsert_State';
