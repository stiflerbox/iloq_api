...
/**
 * GenerateAccessTokenResult Class Doc Comment
 *
 * @category Class
 * @description  
 * @package  OpenAPI\Client
 ...
 */
class GenerateAccessTokenResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GenerateAccessTokenResult';
    ...
    */
     ...
     * Sets access_token
     *
     * @param string|null $access_token Access token which was generated.
     *
     * @return self
     */
