...
/**
 * NetworkModuleDevice Class Doc Comment
 *
 * @category Class
 * @description Device which belongs to a network module
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NetworkModuleDevice implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NetworkModuleDevice';
    ...
    protected static $openAPITypes = [
        ...
        'state_mask' => '\OpenAPI\Client\Model\NetworkModuleDeviceStateMask',
        'type' => '\OpenAPI\Client\Model\NetworkModuleDeviceType'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('serial_no', $data ?? [], null);
        $this->setIfExists('software_version', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $network_module_device_id ID
     *
     * @return self
     */
    ...
    {
        if (is_null($serial_no)) {
            array_push($this->openAPINullablesSetToNull, 'serial_no');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('serial_no', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     *
     * @param string|null $software_version Software version
     *
     * @return self
     */
    public function setSoftwareVersion($software_version)
    {
        if (is_null($software_version)) {
            array_push($this->openAPINullablesSetToNull, 'software_version');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('software_version', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets state_mask
     *
     * @return \OpenAPI\Client\Model\NetworkModuleDeviceStateMask|null
     */
     ...
     * Sets state_mask
     *
     * @param \OpenAPI\Client\Model\NetworkModuleDeviceStateMask|null $state_mask state_mask
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\NetworkModuleDeviceType|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\NetworkModuleDeviceType|null $type type
     *
     * @return self
     */
