...
/**
 * CalendarDataGetByCalendarDataIdResultRecurringEntryException Class Doc Comment
 *
 * @category Class
 * @description Recurring entry exception information
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CalendarDataGetByCalendarDataIdResultRecurringEntryException implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarDataGetByCalendarDataIdResult_RecurringEntryException';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('a_is_removed', $data ?? [], null);
    ...
    */
     ...
     * @return bool|null
     */
    public function getAIsRemoved()
    {
        return $this->container['a_is_removed'];
    }

    /**
     * Sets a_is_removed
     *
     * @param bool|null $a_is_removed True if this entry is removed from recurring calendar entry
     *
     * @return self
     */
    public function setAIsRemoved($a_is_removed)
    {
        if (is_null($a_is_removed)) {
            throw new \InvalidArgumentException('non-nullable a_is_removed cannot be null');
        }
        $this->container['a_is_removed'] = $a_is_removed;
     ...
     *
     * @param \DateTime|null $original_start_date_time Contains entry's original start date, when this entry should have happened normally.
     *
     * @return self
     */
    public function setOriginalStartDateTime($original_start_date_time)
    {
        if (is_null($original_start_date_time)) {
            array_push($this->openAPINullablesSetToNull, 'original_start_date_time');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('original_start_date_time', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets recurrence_id
     *
     * @param string|null $recurrence_id Re_ID of the recurring entry.
     *
     * @return self
     */
