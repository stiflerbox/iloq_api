...
/**
 * NetworkModuleDeviceRelay Class Doc Comment
 *
 * @category Class
 * @description Relay belonging to a network module device
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class NetworkModuleDeviceRelay implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NetworkModuleDeviceRelay';
    ...
    protected static $openAPITypes = [
        ...
        'network_module_device_relay_id' => 'string',
        'relay_no' => 'int'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'network_module_device_relay_id' => 'guid',
        'relay_no' => 'int32'
    ];
    ...
    protected static array $openAPINullables = [
        'in_use' => false,
        'name' => true,
        'network_module_device_id' => false,
        'network_module_device_relay_id' => false,
        'relay_no' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'network_module_device_relay_id' => 'NetworkModuleDeviceRelay_ID',
        'relay_no' => 'RelayNo'
    ];
    ...
    protected static $setters = [
        ...
        'network_module_device_relay_id' => 'setNetworkModuleDeviceRelayId',
        'relay_no' => 'setRelayNo'
    ];
    ...
    protected static $getters = [
        ...
        'network_module_device_relay_id' => 'getNetworkModuleDeviceRelayId',
        'relay_no' => 'getRelayNo'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('network_module_device_relay_id', $data ?? [], null);
        $this->setIfExists('relay_no', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets in_use
     *
     * @param int|null $in_use Is relay in use
     *
     * @return self
     */
    ...
    public function setNetworkModuleDeviceId($network_module_device_id)
    {
        if (is_null($network_module_device_id)) {
            throw new \InvalidArgumentException('non-nullable network_module_device_id cannot be null');
        }
    ...
    /**
     * Gets network_module_device_relay_id
     *
     * @return string|null
     */
    public function getNetworkModuleDeviceRelayId()
    {
        return $this->container['network_module_device_relay_id'];
    }

    /**
     * Sets network_module_device_relay_id
     *
     * @param string|null $network_module_device_relay_id Relay ID
     *
     * @return self
     */
    public function setNetworkModuleDeviceRelayId($network_module_device_relay_id)
    {
        if (is_null($network_module_device_relay_id)) {
            throw new \InvalidArgumentException('non-nullable network_module_device_relay_id cannot be null');
        }
        $this->container['network_module_device_relay_id'] = $network_module_device_relay_id;
     ...
     * @return int|null
     */
    public function getRelayNo()
    {
        return $this->container['relay_no'];
    }

    /**
     * Sets relay_no
     *
     * @param int|null $relay_no Relay number
     *
     * @return self
     */
    public function setRelayNo($relay_no)
    {
        if (is_null($relay_no)) {
            throw new \InvalidArgumentException('non-nullable relay_no cannot be null');
        }
        $this->container['relay_no'] = $relay_no;
