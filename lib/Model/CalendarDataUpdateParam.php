...
/**
 * CalendarDataUpdateParam Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CalendarDataUpdateParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarDataUpdateParam';
    ...
    */
     ...
     * Sets entries
     *
     * @param \OpenAPI\Client\Model\CalendarDataEntry[]|null $entries Calendar datas to update
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CalendarDataRecurringEntry[]|null $recurring_entries Recurring entries to update
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\CalendarDataRecurringEntryException[]|null $recurring_entry_exceptions Recurring entry exceptions to update
     *
     * @return self
     */
