...
/**
 * GetTimeLimitsResult Class Doc Comment
 *
 * @category Class
 * @description Result for retrieving Key&#39;s time limit information
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetTimeLimitsResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetTimeLimitsResult';
    ...
    protected static $openAPITypes = [
        ...
        'key_time_limit_slots' => '\OpenAPI\Client\Model\KeyTimeLimitSlot[]',
    ...
    protected static $attributeMap = [
        ...
        'key_time_limit_slots' => 'KeyTimeLimitSlots',
    ...
    protected static $setters = [
        ...
        'key_time_limit_slots' => 'setKeyTimeLimitSlots',
    ...
    protected static $getters = [
        ...
        'key_time_limit_slots' => 'getKeyTimeLimitSlots',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('key_time_limit_slots', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets key_time_limit_slots
     *
     * @return \OpenAPI\Client\Model\KeyTimeLimitSlot[]|null
     */
    public function getKeyTimeLimitSlots()
    {
        return $this->container['key_time_limit_slots'];
    }

    /**
     * Sets key_time_limit_slots
     *
     * @param \OpenAPI\Client\Model\KeyTimeLimitSlot[]|null $key_time_limit_slots Time limit slots
     *
     * @return self
     */
    public function setKeyTimeLimitSlots($key_time_limit_slots)
    {
        if (is_null($key_time_limit_slots)) {
            array_push($this->openAPINullablesSetToNull, 'key_time_limit_slots');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('key_time_limit_slots', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['key_time_limit_slots'] = $key_time_limit_slots;
     ...
     *
     * @param int[]|null $outside_user_zone_time_limit_title_slots Slots which are filled by information not available for current user.
     *
     * @return self
     */
