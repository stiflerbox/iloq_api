...
/**
 * PayloadState Class Doc Comment
 *
 * @category Class
 * @description State
 * @package  OpenAPI\Client
 ...
 */
class PayloadState implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Payload_State';
