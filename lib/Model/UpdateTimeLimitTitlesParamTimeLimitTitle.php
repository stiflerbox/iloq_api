...
/**
 * UpdateTimeLimitTitlesParamTimeLimitTitle Class Doc Comment
 *
 * @category Class
 * @description Time limit title which is updated
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateTimeLimitTitlesParamTimeLimitTitle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateTimeLimitTitlesParam_TimeLimitTitle';
    ...
    protected static $openAPITypes = [
        'description' => 'string',
        'end_date_lg' => '\DateTime',
        'name' => 'string',
        'option_mask' => '\OpenAPI\Client\Model\TimeLimitTitleOptionMask',
        'real_estate_id' => 'string',
        'start_date_lg' => '\DateTime',
    ...
    protected static $openAPIFormats = [
        'description' => null,
        'end_date_lg' => 'date-time',
        'name' => null,
        'option_mask' => null,
        'real_estate_id' => 'guid',
        'start_date_lg' => 'date-time',
    ...
    */
     ...
     */
    public function getEndDateLg()
    {
        return $this->container['end_date_lg'];
    }

    /**
     * Sets end_date_lg
     *
     * @param \DateTime|null $end_date_lg Time limit's end date in locking system's time. Can be null.
     *
     * @return self
     */
    public function setEndDateLg($end_date_lg)
    {
        if (is_null($end_date_lg)) {
            array_push($this->openAPINullablesSetToNull, 'end_date_lg');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('end_date_lg', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['end_date_lg'] = $end_date_lg;
     ...
     * Sets name
     *
     * @param string|null $name Time limit title's name
     *
     * @return self
     */
     ...
     * Gets option_mask
     *
     * @return \OpenAPI\Client\Model\TimeLimitTitleOptionMask|null
     */
     ...
     * Sets option_mask
     *
     * @param \OpenAPI\Client\Model\TimeLimitTitleOptionMask|null $option_mask option_mask
     *
     * @return self
     */
     ...
     * @return \DateTime|null
     */
    public function getStartDateLg()
    {
        return $this->container['start_date_lg'];
    }

    /**
     * Sets start_date_lg
     *
     * @param \DateTime|null $start_date_lg Time limit's start date in locking system's time. Can be null.
     *
     * @return self
     */
    public function setStartDateLg($start_date_lg)
    {
        if (is_null($start_date_lg)) {
            array_push($this->openAPINullablesSetToNull, 'start_date_lg');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('start_date_lg', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['start_date_lg'] = $start_date_lg;
     ...
     *
     * @param string|null $time_limit_title_id ID
     *
     * @return self
     */
