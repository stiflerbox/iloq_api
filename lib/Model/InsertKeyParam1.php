...
/**
 * InsertKeyParam1 Class Doc Comment
 *
 * @category Class
 ...
 */
class InsertKeyParam1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertKeyParam1';
    ...
    protected static $openAPITypes = [
        'key' => '\OpenAPI\Client\Model\InsertKeyParam1Key',
        'security_access_ids' => 'string[]',
        'time_limits' => '\OpenAPI\Client\Model\KeyTimeLimit[]',
        'zone_ids' => 'string[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('time_limits', $data ?? [], null);
    ...
    */
     ...
     * Gets key
     *
     * @return \OpenAPI\Client\Model\InsertKeyParam1Key|null
     */
     ...
     * Sets key
     *
     * @param \OpenAPI\Client\Model\InsertKeyParam1Key|null $key key
     *
     * @return self
     */
     ...
     * Gets time_limits
     *
     * @return \OpenAPI\Client\Model\KeyTimeLimit[]|null
     */
    public function getTimeLimits()
    {
        return $this->container['time_limits'];
    }

    /**
     * Sets time_limits
     *
     * @param \OpenAPI\Client\Model\KeyTimeLimit[]|null $time_limits Time limit information for the new key
     *
     * @return self
     */
    public function setTimeLimits($time_limits)
    {
        if (is_null($time_limits)) {
            array_push($this->openAPINullablesSetToNull, 'time_limits');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('time_limits', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['time_limits'] = $time_limits;
