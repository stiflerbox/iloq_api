...
/**
 * CalendarDataTitleOptionMask Class Doc Comment
 *
 * @category Class
 * @description Options
 * @package  OpenAPI\Client
 ...
 */
class CalendarDataTitleOptionMask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarDataTitle_OptionMask';
