...
/**
 * InsertResult Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class InsertResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertResult';
    ...
    {
        $this->setIfExists('person_ids', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets person_ids
     *
     * @param string[]|null $person_ids person_ids
     *
     * @return self
     */
    public function setPersonIds($person_ids)
    {
        if (is_null($person_ids)) {
            array_push($this->openAPINullablesSetToNull, 'person_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('person_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
