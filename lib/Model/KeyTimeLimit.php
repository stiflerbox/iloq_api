...
/**
 * KeyTimeLimit Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class KeyTimeLimit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeyTimeLimit';
    ...
    protected static $openAPITypes = [
        ...
        'limit_type' => 'int',
        'ln_key_id' => 'string',
        'ln_key_time_limit_id' => 'string',
        'order_no' => 'int',
        'renew_end_date' => '\DateTime',
        'renew_gap_count' => 'int',
        'renew_gap_type' => 'int',
        'renew_minute' => 'int',
        'start_date' => '\DateTime',
    ...
    protected static $openAPIFormats = [
        'daylight_saving' => null,
        'end_date' => 'date-time',
        'limit_type' => null,
        'ln_key_id' => 'guid',
        'ln_key_time_limit_id' => 'guid',
        'order_no' => null,
        'renew_end_date' => 'date-time',
        'renew_gap_count' => 'int32',
        'renew_gap_type' => 'int32',
        'renew_minute' => 'int32',
    ...
    protected static array $openAPINullables = [
        ...
        'limit_type' => false,
        'ln_key_id' => false,
        'ln_key_time_limit_id' => false,
        'order_no' => false,
        'renew_end_date' => false,
        'renew_gap_count' => false,
        'renew_gap_type' => false,
        'renew_minute' => false,
        'start_date' => true,
        'week_day' => false
    ];
    ...
    protected static $attributeMap = [
        ...
        'ln_key_id' => 'LNKey_ID',
        'ln_key_time_limit_id' => 'LNKeyTimeLimit_ID',
        'order_no' => 'OrderNo',
        'renew_end_date' => 'RenewEndDate',
        'renew_gap_count' => 'RenewGapCount',
        'renew_gap_type' => 'RenewGapType',
        'renew_minute' => 'RenewMinute',
    ...
    protected static $setters = [
        'daylight_saving' => 'setDaylightSaving',
        'end_date' => 'setEndDate',
        'limit_type' => 'setLimitType',
        'ln_key_id' => 'setLnKeyId',
        'ln_key_time_limit_id' => 'setLnKeyTimeLimitId',
        'order_no' => 'setOrderNo',
        'renew_end_date' => 'setRenewEndDate',
        'renew_gap_count' => 'setRenewGapCount',
        'renew_gap_type' => 'setRenewGapType',
        'renew_minute' => 'setRenewMinute',
    ...
    protected static $getters = [
        ...
        'ln_key_id' => 'getLnKeyId',
        'ln_key_time_limit_id' => 'getLnKeyTimeLimitId',
        'order_no' => 'getOrderNo',
        'renew_end_date' => 'getRenewEndDate',
        'renew_gap_count' => 'getRenewGapCount',
        'renew_gap_type' => 'getRenewGapType',
        'renew_minute' => 'getRenewMinute',
    ...
    {
        $this->setIfExists('daylight_saving', $data ?? [], null);
        $this->setIfExists('end_date', $data ?? [], null);
        $this->setIfExists('limit_type', $data ?? [], null);
        $this->setIfExists('ln_key_id', $data ?? [], null);
        $this->setIfExists('ln_key_time_limit_id', $data ?? [], null);
        $this->setIfExists('order_no', $data ?? [], null);
        $this->setIfExists('renew_end_date', $data ?? [], null);
        $this->setIfExists('renew_gap_count', $data ?? [], null);
        $this->setIfExists('renew_gap_type', $data ?? [], null);
        $this->setIfExists('renew_minute', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets daylight_saving
     *
     * @return int|null
     */
    public function getDaylightSaving()
    {
        return $this->container['daylight_saving'];
    }

    /**
     * Sets daylight_saving
     *
     * @param int|null $daylight_saving daylight_saving
     *
     * @return self
     */
    public function setDaylightSaving($daylight_saving)
    {
        if (is_null($daylight_saving)) {
            throw new \InvalidArgumentException('non-nullable daylight_saving cannot be null');
        }
        $this->container['daylight_saving'] = $daylight_saving;
     ...
     * Sets limit_type
     *
     * @param int|null $limit_type limit_type
     *
     * @return self
     */
     ...
     * @return string|null
     */
    public function getLnKeyId()
    {
        return $this->container['ln_key_id'];
    }

    /**
     * Sets ln_key_id
     *
     * @param string|null $ln_key_id ln_key_id
     *
     * @return self
     */
    public function setLnKeyId($ln_key_id)
    {
        if (is_null($ln_key_id)) {
            throw new \InvalidArgumentException('non-nullable ln_key_id cannot be null');
        }
        $this->container['ln_key_id'] = $ln_key_id;

        return $this;
    }

    /**
     * Gets ln_key_time_limit_id
     *
     * @return string|null
     */
    public function getLnKeyTimeLimitId()
    {
        return $this->container['ln_key_time_limit_id'];
    }

    /**
     * Sets ln_key_time_limit_id
     *
     * @param string|null $ln_key_time_limit_id ln_key_time_limit_id
     *
     * @return self
     */
    public function setLnKeyTimeLimitId($ln_key_time_limit_id)
    {
        if (is_null($ln_key_time_limit_id)) {
            throw new \InvalidArgumentException('non-nullable ln_key_time_limit_id cannot be null');
        }
        $this->container['ln_key_time_limit_id'] = $ln_key_time_limit_id;
     ...
     * Sets order_no
     *
     * @param int|null $order_no order_no
     *
     * @return self
     */
     ...
     * @return \DateTime|null
     */
    public function getRenewEndDate()
    {
        return $this->container['renew_end_date'];
    }

    /**
     * Sets renew_end_date
     *
     * @param \DateTime|null $renew_end_date renew_end_date
     *
     * @return self
     */
    public function setRenewEndDate($renew_end_date)
    {
        if (is_null($renew_end_date)) {
            throw new \InvalidArgumentException('non-nullable renew_end_date cannot be null');
        }
        $this->container['renew_end_date'] = $renew_end_date;

        return $this;
    }

    /**
     * Gets renew_gap_count
     *
     * @return int|null
     */
    public function getRenewGapCount()
    {
        return $this->container['renew_gap_count'];
    }

    /**
     * Sets renew_gap_count
     *
     * @param int|null $renew_gap_count renew_gap_count
     *
     * @return self
     */
    public function setRenewGapCount($renew_gap_count)
    {
        if (is_null($renew_gap_count)) {
            throw new \InvalidArgumentException('non-nullable renew_gap_count cannot be null');
        }
        $this->container['renew_gap_count'] = $renew_gap_count;
     ...
     * @return int|null
     */
    public function getRenewGapType()
    {
        return $this->container['renew_gap_type'];
    }

    /**
     * Sets renew_gap_type
     *
     * @param int|null $renew_gap_type renew_gap_type
     *
     * @return self
     */
    public function setRenewGapType($renew_gap_type)
    {
        if (is_null($renew_gap_type)) {
            throw new \InvalidArgumentException('non-nullable renew_gap_type cannot be null');
        }
        $this->container['renew_gap_type'] = $renew_gap_type;
     ...
     * @return int|null
     */
    public function getRenewMinute()
    {
        return $this->container['renew_minute'];
    }

    /**
     * Sets renew_minute
     *
     * @param int|null $renew_minute renew_minute
     *
     * @return self
     */
    public function setRenewMinute($renew_minute)
    {
        if (is_null($renew_minute)) {
            throw new \InvalidArgumentException('non-nullable renew_minute cannot be null');
        }
        $this->container['renew_minute'] = $renew_minute;
     ...
     * Sets week_day
     *
     * @param int|null $week_day week_day
     *
     * @return self
     */
