...
/**
 * UpdateSecurityAccessParamSecurityAccess Class Doc Comment
 *
 * @category Class
 * @description Security access to update
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateSecurityAccessParamSecurityAccess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateSecurityAccessParam_SecurityAccess';
    ...
    */
     ...
     * Sets type
     *
     * @param int|null $type Type. Read only, can't be changed.    0 = Key security access. This is only for keys which are in blocklist and is created automatically when Key is blocklisted.    1 = Standard access    2 = Mask. Not in use.    3 = API Access
     *
     * @return self
     */
