...
/**
 * LockStateConfirmation Class Doc Comment
 *
 * @category Class
 * @description Key holder&#39;s confirmation if the lock was opened or closed. Applies to locks that require manual closing (padlocks etc). Used in locking systems that have the closing confirmation turned on.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class LockStateConfirmation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LockStateConfirmation';
