<?php
/**
 * DeviceLogDataLockStateConfirmation
 *
 * PHP version 7.4
 *
 * @category Class
...
/**
 * DeviceLogDataLockStateConfirmation Class Doc Comment
 *
 * @category Class
 * @description Optional confirmation from the key holder if the lock was opened or closed. Applies to locks that require manual closing (padlocks etc). Used in locking systems that have the closing confirmation turned on.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DeviceLogDataLockStateConfirmation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceLogData_LockStateConfirmation';
    ...
    protected static $openAPITypes = [
        'key_holder_response' => '\OpenAPI\Client\Model\LockStateConfirmationKeyHolderResponse',
    ...
    protected static $attributeMap = [
        'key_holder_response' => 'KeyHolderResponse',
    ...
    protected static $setters = [
        'key_holder_response' => 'setKeyHolderResponse',
    ...
    protected static $getters = [
        'key_holder_response' => 'getKeyHolderResponse',
    ...
    {
        $this->setIfExists('key_holder_response', $data ?? [], null);
        $this->setIfExists('time_stamp_utc', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets key_holder_response
     *
     * @return \OpenAPI\Client\Model\LockStateConfirmationKeyHolderResponse|null
     */
    public function getKeyHolderResponse()
    {
        return $this->container['key_holder_response'];
    }

    /**
     * Sets key_holder_response
     *
     * @param \OpenAPI\Client\Model\LockStateConfirmationKeyHolderResponse|null $key_holder_response key_holder_response
     *
     * @return self
     */
    public function setKeyHolderResponse($key_holder_response)
    {
        if (is_null($key_holder_response)) {
            throw new \InvalidArgumentException('non-nullable key_holder_response cannot be null');
        }
        $this->container['key_holder_response'] = $key_holder_response;
     ...
     * Sets time_stamp_utc
     *
     * @param \DateTime|null $time_stamp_utc Time of the repsonse. Null if response is still pending.
     *
     * @return self
     */
    public function setTimeStampUtc($time_stamp_utc)
    {
        if (is_null($time_stamp_utc)) {
            array_push($this->openAPINullablesSetToNull, 'time_stamp_utc');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('time_stamp_utc', $nullablesSetToNull);
            if ($index !== FALSE) {
