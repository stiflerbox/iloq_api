...
/**
 * SecurityRole Class Doc Comment
 *
 * @category Class
 * @description Security role/Code access group. Use TypeMask to find out type.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SecurityRole implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'online_relay_operating_time_ms' => 'int',
        'real_estate_id' => 'string',
        'security_role_id' => 'string',
        'type_mask' => '\OpenAPI\Client\Model\SecurityRoleTypeMask',
        'zone_id' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'online_relay_operating_time_ms' => 'int32',
        'real_estate_id' => 'guid',
        'security_role_id' => 'guid',
        'type_mask' => null,
        'zone_id' => 'guid'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'online_relay_operating_time_ms' => false,
        'real_estate_id' => false,
        'security_role_id' => false,
        'type_mask' => false,
        'zone_id' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'online_relay_operating_time_ms' => 'OnlineRelayOperatingTimeMs',
        'real_estate_id' => 'RealEstate_ID',
        'security_role_id' => 'SecurityRole_ID',
        'type_mask' => 'TypeMask',
        'zone_id' => 'Zone_ID'
    ];
    ...
    protected static $setters = [
        ...
        'online_relay_operating_time_ms' => 'setOnlineRelayOperatingTimeMs',
    ...
    protected static $getters = [
        ...
        'online_relay_operating_time_ms' => 'getOnlineRelayOperatingTimeMs',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('online_relay_operating_time_ms', $data ?? [], null);
        $this->setIfExists('real_estate_id', $data ?? [], null);
        $this->setIfExists('security_role_id', $data ?? [], null);
    ...
    */
     ...
     *
     * @param string|null $online_access_code Online access code. Empty when retrieving security roles and must be retrieved with a different method. If given as empty string during update, uses previous code.
     *
     * @return self
     */
    ...
    /**
     * Gets online_relay_operating_time_ms
     *
     * @return int|null
     */
    public function getOnlineRelayOperatingTimeMs()
    {
        return $this->container['online_relay_operating_time_ms'];
    }

    /**
     * Sets online_relay_operating_time_ms
     *
     * @param int|null $online_relay_operating_time_ms How long the relay is on after access is granted. In milliseconds.
     *
     * @return self
     */
    public function setOnlineRelayOperatingTimeMs($online_relay_operating_time_ms)
    {
        if (is_null($online_relay_operating_time_ms)) {
            throw new \InvalidArgumentException('non-nullable online_relay_operating_time_ms cannot be null');
        }
        $this->container['online_relay_operating_time_ms'] = $online_relay_operating_time_ms;
     ...
     *
     * @param string|null $security_role_id ID
     *
     * @return self
     */
    public function setSecurityRoleId($security_role_id)
    {
        if (is_null($security_role_id)) {
            throw new \InvalidArgumentException('non-nullable security_role_id cannot be null');
        }
     ...
     * Gets type_mask
     *
     * @return \OpenAPI\Client\Model\SecurityRoleTypeMask|null
     */
     ...
     * Sets type_mask
     *
     * @param \OpenAPI\Client\Model\SecurityRoleTypeMask|null $type_mask type_mask
     *
     * @return self
     */
