...
/**
 * CalendarDataSecurityRoleLinksInsertLinksParam Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CalendarDataSecurityRoleLinksInsertLinksParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarDataSecurityRoleLinksInsertLinksParam';
    ...
    */
     ...
     *
     * @param string[]|null $security_role_ids Code access group Ids which are added to calendar data
     *
     * @return self
     */
