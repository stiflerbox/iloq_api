...
/**
 * InsertPersonParamPerson Class Doc Comment
 *
 * @category Class
 * @description Person which is added
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InsertPersonParamPerson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertPersonParam_Person';
    ...
    protected static $openAPITypes = [
        ...
        'phone3' => 'string',
        'post_office' => 'string',
        'state' => '\OpenAPI\Client\Model\PersonInsertState',
        'work_title' => 'string',
        'zip_code' => 'string'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'description' => null,
        'e_mail' => null,
        'employment_end_date' => 'date-time',
        'external_can_edit' => null,
    ...
    protected static $attributeMap = [
        ...
        'external_can_edit' => 'ExternalCanEdit',
    ...
    protected static $setters = [
        ...
        'external_can_edit' => 'setExternalCanEdit',
        'external_person_id' => 'setExternalPersonId',
        'first_name' => 'setFirstName',
        'language_code' => 'setLanguageCode',
        'last_name' => 'setLastName',
        'person_id' => 'setPersonId',
        'person_code' => 'setPersonCode',
        'phone1' => 'setPhone1',
        'phone2' => 'setPhone2',
        'phone3' => 'setPhone3',
        'post_office' => 'setPostOffice',
        'state' => 'setState',
        'work_title' => 'setWorkTitle',
        'zip_code' => 'setZipCode'
    ];
    ...
    protected static $getters = [
        ...
        'external_can_edit' => 'getExternalCanEdit',
        'external_person_id' => 'getExternalPersonId',
        'first_name' => 'getFirstName',
        'language_code' => 'getLanguageCode',
        'last_name' => 'getLastName',
        'person_id' => 'getPersonId',
        'person_code' => 'getPersonCode',
        'phone1' => 'getPhone1',
        'phone2' => 'getPhone2',
        'phone3' => 'getPhone3',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('external_can_edit', $data ?? [], null);
        $this->setIfExists('external_person_id', $data ?? [], null);
        $this->setIfExists('first_name', $data ?? [], null);
        $this->setIfExists('language_code', $data ?? [], null);
        $this->setIfExists('last_name', $data ?? [], null);
        $this->setIfExists('person_id', $data ?? [], null);
        $this->setIfExists('person_code', $data ?? [], null);
        ...
        $this->setIfExists('work_title', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['person_code'] === null) {
            $invalidProperties[] = "'person_code' can't be null";
        }
        if ((mb_strlen($this->container['person_code']) > 20)) {
            $invalidProperties[] = "invalid value for 'person_code', the character length must be smaller than or equal to 20.";
        }

        if ((mb_strlen($this->container['person_code']) < 0)) {
            $invalidProperties[] = "invalid value for 'person_code', the character length must be bigger than or equal to 0.";
        }
     ...
     * Sets company_name
     *
     * @param string|null $company_name Company where person works
     *
     * @return self
     */
     ...
     * Sets contact_info
     *
     * @param string|null $contact_info General contact info field
     *
     * @return self
     */
     ...
     * Sets country
     *
     * @param string|null $country Country where person lives
     *
     * @return self
     */
     ...
     * Sets e_mail
     *
     * @param string|null $e_mail Email address
     *
     * @return self
     */
     ...
     *
     * @param \DateTime|null $employment_end_date Optional date when user's work contract ends.
     *
     * @return self
     */
    public function setEmploymentEndDate($employment_end_date)
    {
        if (is_null($employment_end_date)) {
            array_push($this->openAPINullablesSetToNull, 'employment_end_date');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('employment_end_date', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets external_can_edit
     *
     * @return bool|null
     */
    public function getExternalCanEdit()
    {
        return $this->container['external_can_edit'];
    }

    /**
     * Sets external_can_edit
     *
     * @param bool|null $external_can_edit Is person editable
     *
     * @return self
     */
    public function setExternalCanEdit($external_can_edit)
    {
        if (is_null($external_can_edit)) {
            throw new \InvalidArgumentException('non-nullable external_can_edit cannot be null');
        }
        $this->container['external_can_edit'] = $external_can_edit;

        return $this;
    }

    /**
     * Gets external_person_id
     *
     * @return string|null
     */
    public function getExternalPersonId()
    {
        return $this->container['external_person_id'];
    }

    /**
     * Sets external_person_id
     *
     * @param string|null $external_person_id Person's identifier if person is imported to iLOQ from external system. If given, this value has to be unique.
     *
     * @return self
     */
    public function setExternalPersonId($external_person_id)
    {
        if (is_null($external_person_id)) {
            array_push($this->openAPINullablesSetToNull, 'external_person_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('external_person_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['external_person_id'] = $external_person_id;
     ...
     * Sets first_name
     *
     * @param string|null $first_name First names
     *
     * @return self
     */
     ...
     * Sets language_code
     *
     * @param string|null $language_code Person's language for SMSs and emails
     *
     * @return self
     */
     ...
     * Sets person_id
     *
     * @param string|null $person_id ID
     *
     * @return self
     */
    ...
    {
        return $this->container['person_code'];
    }

    /**
     * Sets person_code
     *
     * @param string $person_code Code identifying user. For example social security number.
     *
     * @return self
     */
    public function setPersonCode($person_code)
    {
        if (is_null($person_code)) {
            throw new \InvalidArgumentException('non-nullable person_code cannot be null');
        }
        if ((mb_strlen($person_code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $person_code when calling InsertPersonParamPerson., must be smaller than or equal to 20.');
        }
        if ((mb_strlen($person_code) < 0)) {
            throw new \InvalidArgumentException('invalid length for $person_code when calling InsertPersonParamPerson., must be bigger than or equal to 0.');
        }

        $this->container['person_code'] = $person_code;
     ...
     * Sets phone1
     *
     * @param string|null $phone1 Phone number 1
     *
     * @return self
     */
     ...
     * Sets phone2
     *
     * @param string|null $phone2 Phone number 2
     *
     * @return self
     */
     ...
     * Sets phone3
     *
     * @param string|null $phone3 Phone number 3
     *
     * @return self
     */
    ...
    {
        if (is_null($phone3)) {
            array_push($this->openAPINullablesSetToNull, 'phone3');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('phone3', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets post_office
     *
     * @param string|null $post_office City or post office info
     *
     * @return self
     */
     ...
     * Gets state
     *
     * @return \OpenAPI\Client\Model\PersonInsertState|null
     */
     ...
     * Sets state
     *
     * @param \OpenAPI\Client\Model\PersonInsertState|null $state state
     *
     * @return self
     */
    ...
    {
        return $this->container['work_title'];
    }

    /**
     * Sets work_title
     *
     * @param string|null $work_title Work title in the company.
     *
     * @return self
     */
    public function setWorkTitle($work_title)
    {
        if (is_null($work_title)) {
            array_push($this->openAPINullablesSetToNull, 'work_title');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('work_title', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['work_title'] = $work_title;
