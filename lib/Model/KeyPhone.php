...
/**
 * KeyPhone Class Doc Comment
 *
 * @category Class
 * @description Key&#39;s phone information
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class KeyPhone implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'KeyPhone';
    ...
    protected static $openAPITypes = [
        'email' => 'string',
        'fn_key_id' => 'string',
        'option_mask' => '\OpenAPI\Client\Model\KeyPhoneOptionMask',
        'phone_no' => 'string',
        'request_type_mask' => '\OpenAPI\Client\Model\KeyPhoneRequestTypeMask'
    ];
    ...
    protected static $attributeMap = [
        ...
        'phone_no' => 'PhoneNo',
        'request_type_mask' => 'RequestTypeMask'
    ];
    ...
    protected static $setters = [
        ...
        'phone_no' => 'setPhoneNo',
        'request_type_mask' => 'setRequestTypeMask'
    ];
    ...
    protected static $getters = [
        ...
        'phone_no' => 'getPhoneNo',
        'request_type_mask' => 'getRequestTypeMask'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('request_type_mask', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets email
     *
     * @param string|null $email Email address which is used instead of sms if OptionMask contains 'UseEmail'
     *
     * @return self
     */
     ...
     * Gets option_mask
     *
     * @return \OpenAPI\Client\Model\KeyPhoneOptionMask|null
     */
     ...
     * Sets option_mask
     *
     * @param \OpenAPI\Client\Model\KeyPhoneOptionMask|null $option_mask option_mask
     *
     * @return self
     */
    ...
    /**
     * Gets request_type_mask
     *
     * @return \OpenAPI\Client\Model\KeyPhoneRequestTypeMask|null
     */
    public function getRequestTypeMask()
    {
        return $this->container['request_type_mask'];
    }

    /**
     * Sets request_type_mask
     *
     * @param \OpenAPI\Client\Model\KeyPhoneRequestTypeMask|null $request_type_mask request_type_mask
     *
     * @return self
     */
    public function setRequestTypeMask($request_type_mask)
    {
        if (is_null($request_type_mask)) {
            throw new \InvalidArgumentException('non-nullable request_type_mask cannot be null');
        }
        $this->container['request_type_mask'] = $request_type_mask;
