...
/**
 * InsertSecurityAccessParam Class Doc Comment
 *
 * @category Class
 * @description Parameter for inserting a new security access
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InsertSecurityAccessParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertSecurityAccessParam';
    ...
    protected static $openAPITypes = [
        'security_access' => '\OpenAPI\Client\Model\InsertSecurityAccessParamSecurityAccess'
    ];
    ...
    protected static $setters = [
        'security_access' => 'setSecurityAccess'
    ];
    ...
    protected static $getters = [
        'security_access' => 'getSecurityAccess'
    ];
    ...
    {
        $this->setIfExists('security_access', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets security_access
     *
     * @return \OpenAPI\Client\Model\InsertSecurityAccessParamSecurityAccess|null
     */
    public function getSecurityAccess()
    {
        return $this->container['security_access'];
    }

    /**
     * Sets security_access
     *
     * @param \OpenAPI\Client\Model\InsertSecurityAccessParamSecurityAccess|null $security_access security_access
     *
     * @return self
     */
    public function setSecurityAccess($security_access)
    {
        if (is_null($security_access)) {
            array_push($this->openAPINullablesSetToNull, 'security_access');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('security_access', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['security_access'] = $security_access;
