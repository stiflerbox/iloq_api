...
/**
 * SecurityAccess Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SecurityAccess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SecurityAccess';
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\OpenAPI\Client\Model\SecurityAccessStatus',
        'type' => '\OpenAPI\Client\Model\SecurityAccessType',
        'version_nr' => 'int',
        'zone_id' => 'string'
    ];
    ...
    */
     ...
     *
     * @param string|null $parent_security_access_id Parent security access ID if this security access is nested and linked to parent. Null if not nested. Reserved for future use.
     *
     * @return self
     */
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\SecurityAccessStatus|null
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\SecurityAccessStatus|null $status status
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\SecurityAccessType|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\SecurityAccessType|null $type type
     *
     * @return self
     */
