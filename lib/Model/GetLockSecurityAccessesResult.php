...
/**
 * GetLockSecurityAccessesResult Class Doc Comment
 *
 * @category Class
 * @description Result for gettings lock&#39;s security accesses
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetLockSecurityAccessesResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetLockSecurityAccessesResult';
    ...
    protected static $openAPITypes = [
        'outside_user_zones_count' => 'int',
        'security_accesses' => '\OpenAPI\Client\Model\SecurityAccess2[]'
    ];
    ...
    protected static $openAPIFormats = [
        'outside_user_zones_count' => 'int32',
    ...
    protected static array $openAPINullables = [
        'outside_user_zones_count' => false,
    ...
    protected static $attributeMap = [
        'outside_user_zones_count' => 'OutsideUserZonesCount',
    ...
    protected static $setters = [
        'outside_user_zones_count' => 'setOutsideUserZonesCount',
    ...
    protected static $getters = [
        'outside_user_zones_count' => 'getOutsideUserZonesCount',
    ...
    {
        $this->setIfExists('outside_user_zones_count', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets outside_user_zones_count
     *
     * @return int|null
     */
    public function getOutsideUserZonesCount()
    {
        return $this->container['outside_user_zones_count'];
    }

    /**
     * Sets outside_user_zones_count
     *
     * @param int|null $outside_user_zones_count How many of additional security accesses are linked to the lock which are invisible to user because they are outside his zones
     *
     * @return self
     */
    public function setOutsideUserZonesCount($outside_user_zones_count)
    {
        if (is_null($outside_user_zones_count)) {
            throw new \InvalidArgumentException('non-nullable outside_user_zones_count cannot be null');
        }
        $this->container['outside_user_zones_count'] = $outside_user_zones_count;
     ...
     *
     * @return \OpenAPI\Client\Model\SecurityAccess2[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\SecurityAccess2[]|null $security_accesses Security accesses linked to lock which are visible to user
     *
     * @return self
     */
