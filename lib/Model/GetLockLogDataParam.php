...
/**
 * GetLockLogDataParam Class Doc Comment
 *
 * @category Class
 ...
 */
class GetLockLogDataParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetLockLogDataParam';
    ...
    */
     ...
     * Sets end_date_utc
     *
     * @param \DateTime|null $end_date_utc End date and time the logs are returned for (exclusive)
     *
     * @return self
     */
     ...
     * Sets start_date_utc
     *
     * @param \DateTime|null $start_date_utc Start date and time the logs are returned for (inclusive)
     *
     * @return self
     */
