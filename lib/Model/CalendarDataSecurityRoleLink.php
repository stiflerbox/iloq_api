...
/**
 * CalendarDataSecurityRoleLink Class Doc Comment
 *
 * @category Class
 * @description Link between calendar data and security role
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CalendarDataSecurityRoleLink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarDataSecurityRoleLink';
    ...
    */
     ...
     *
     * @param string|null $security_role_id Security role ID
     *
     * @return self
     */
    public function setSecurityRoleId($security_role_id)
    {
        if (is_null($security_role_id)) {
            array_push($this->openAPINullablesSetToNull, 'security_role_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('security_role_id', $nullablesSetToNull);
            if ($index !== FALSE) {
