...
/**
 * DeviceLogData Class Doc Comment
 *
 * @category Class
 ...
 */
class DeviceLogData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceLogData';
    ...
    protected static $openAPITypes = [
        ...
        'err_code' => 'int',
        'f_lock' => '\OpenAPI\Client\Model\DeviceLogDataFLock',
        'fn_key' => '\OpenAPI\Client\Model\DeviceLogDataFNKey',
        'going_date_utc' => '\DateTime',
        'location_data' => '\OpenAPI\Client\Model\DeviceLogDataLocationData',
        'location_info_mask' => '\OpenAPI\Client\Model\DeviceLogDataLocationInfoMask',
        'lock_state_confirmation' => '\OpenAPI\Client\Model\DeviceLogDataLockStateConfirmation',
        'programming_info' => 'int',
        'type_mask' => '\OpenAPI\Client\Model\DeviceLogDataTypeMask'
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'f_lock' => null,
        'fn_key' => null,
        'going_date_utc' => 'date-time',
        'location_data' => null,
        'location_info_mask' => null,
        'lock_state_confirmation' => null,
        'programming_info' => 'int32',
        'type_mask' => null
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'going_date_utc' => true,
        'location_data' => true,
        'location_info_mask' => false,
        'lock_state_confirmation' => true,
        'programming_info' => true,
        'type_mask' => false
    ];
    ...
    protected static $attributeMap = [
        'device_log_id' => 'DeviceLog_ID',
        'err_code' => 'ErrCode',
        'f_lock' => 'FLock',
        'fn_key' => 'FNKey',
        'going_date_utc' => 'GoingDateUtc',
        'location_data' => 'LocationData',
        'location_info_mask' => 'LocationInfoMask',
        'lock_state_confirmation' => 'LockStateConfirmation',
        'programming_info' => 'ProgrammingInfo',
        'type_mask' => 'TypeMask'
    ];
    ...
    protected static $setters = [
        'device_log_id' => 'setDeviceLogId',
        'err_code' => 'setErrCode',
        'f_lock' => 'setFLock',
        'fn_key' => 'setFnKey',
        'going_date_utc' => 'setGoingDateUtc',
        'location_data' => 'setLocationData',
        'location_info_mask' => 'setLocationInfoMask',
        'lock_state_confirmation' => 'setLockStateConfirmation',
        'programming_info' => 'setProgrammingInfo',
        'type_mask' => 'setTypeMask'
    ];
    ...
    protected static $getters = [
        'device_log_id' => 'getDeviceLogId',
        'err_code' => 'getErrCode',
        'f_lock' => 'getFLock',
        'fn_key' => 'getFnKey',
        'going_date_utc' => 'getGoingDateUtc',
        'location_data' => 'getLocationData',
        'location_info_mask' => 'getLocationInfoMask',
        'lock_state_confirmation' => 'getLockStateConfirmation',
        'programming_info' => 'getProgrammingInfo',
        'type_mask' => 'getTypeMask'
    ];
    ...
    {
        $this->setIfExists('device_log_id', $data ?? [], null);
        $this->setIfExists('err_code', $data ?? [], null);
        $this->setIfExists('f_lock', $data ?? [], null);
        $this->setIfExists('fn_key', $data ?? [], null);
        $this->setIfExists('going_date_utc', $data ?? [], null);
        $this->setIfExists('location_data', $data ?? [], null);
        $this->setIfExists('location_info_mask', $data ?? [], null);
        $this->setIfExists('lock_state_confirmation', $data ?? [], null);
        $this->setIfExists('programming_info', $data ?? [], null);
        $this->setIfExists('type_mask', $data ?? [], null);
    }
    ...
    */
     ...
     * @return string|null
     */
    public function getDeviceLogId()
    {
        return $this->container['device_log_id'];
    }

    /**
     * Sets device_log_id
     *
     * @param string|null $device_log_id Id
     *
     * @return self
     */
    public function setDeviceLogId($device_log_id)
    {
        if (is_null($device_log_id)) {
            throw new \InvalidArgumentException('non-nullable device_log_id cannot be null');
        }
        $this->container['device_log_id'] = $device_log_id;
     ...
     * Sets err_code
     *
     * @param int|null $err_code Error code from device
     *
     * @return self
     */
     ...
     * Gets f_lock
     *
     * @return \OpenAPI\Client\Model\DeviceLogDataFLock|null
     */
    public function getFLock()
    {
        return $this->container['f_lock'];
    }

    /**
     * Sets f_lock
     *
     * @param \OpenAPI\Client\Model\DeviceLogDataFLock|null $f_lock f_lock
     *
     * @return self
     */
    public function setFLock($f_lock)
    {
        if (is_null($f_lock)) {
            array_push($this->openAPINullablesSetToNull, 'f_lock');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('f_lock', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['f_lock'] = $f_lock;
     ...
     * Gets fn_key
     *
     * @return \OpenAPI\Client\Model\DeviceLogDataFNKey|null
     */
    public function getFnKey()
    {
        return $this->container['fn_key'];
    }

    /**
     * Sets fn_key
     *
     * @param \OpenAPI\Client\Model\DeviceLogDataFNKey|null $fn_key fn_key
     *
     * @return self
     */
    public function setFnKey($fn_key)
    {
        if (is_null($fn_key)) {
            array_push($this->openAPINullablesSetToNull, 'fn_key');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('fn_key', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['fn_key'] = $fn_key;
     ...
     */
    public function getGoingDateUtc()
    {
        return $this->container['going_date_utc'];
    }

    /**
     * Sets going_date_utc
     *
     * @param \DateTime|null $going_date_utc Date and time of log access
     *
     * @return self
     */
    public function setGoingDateUtc($going_date_utc)
    {
        if (is_null($going_date_utc)) {
            array_push($this->openAPINullablesSetToNull, 'going_date_utc');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('going_date_utc', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['going_date_utc'] = $going_date_utc;
     ...
     * Gets location_data
     *
     * @return \OpenAPI\Client\Model\DeviceLogDataLocationData|null
     */
     ...
     * Sets location_data
     *
     * @param \OpenAPI\Client\Model\DeviceLogDataLocationData|null $location_data location_data
     *
     * @return self
     */
    public function setLocationData($location_data)
    {
        if (is_null($location_data)) {
            array_push($this->openAPINullablesSetToNull, 'location_data');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('location_data', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets location_info_mask
     *
     * @return \OpenAPI\Client\Model\DeviceLogDataLocationInfoMask|null
     */
    public function getLocationInfoMask()
    {
        return $this->container['location_info_mask'];
    }

    /**
     * Sets location_info_mask
     *
     * @param \OpenAPI\Client\Model\DeviceLogDataLocationInfoMask|null $location_info_mask location_info_mask
     *
     * @return self
     */
    public function setLocationInfoMask($location_info_mask)
    {
        if (is_null($location_info_mask)) {
            throw new \InvalidArgumentException('non-nullable location_info_mask cannot be null');
        }
        $this->container['location_info_mask'] = $location_info_mask;

        return $this;
    }

    /**
     * Gets lock_state_confirmation
     *
     * @return \OpenAPI\Client\Model\DeviceLogDataLockStateConfirmation|null
     */
    public function getLockStateConfirmation()
    {
        return $this->container['lock_state_confirmation'];
    }

    /**
     * Sets lock_state_confirmation
     *
     * @param \OpenAPI\Client\Model\DeviceLogDataLockStateConfirmation|null $lock_state_confirmation lock_state_confirmation
     *
     * @return self
     */
    public function setLockStateConfirmation($lock_state_confirmation)
    {
        if (is_null($lock_state_confirmation)) {
            array_push($this->openAPINullablesSetToNull, 'lock_state_confirmation');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('lock_state_confirmation', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['lock_state_confirmation'] = $lock_state_confirmation;

        return $this;
    }

    /**
     * Gets programming_info
     *
     * @return int|null
     */
    public function getProgrammingInfo()
    {
        return $this->container['programming_info'];
    }

    /**
     * Sets programming_info
     *
     * @param int|null $programming_info Additional programming information if any.
     *
     * @return self
     */
    public function setProgrammingInfo($programming_info)
    {
        if (is_null($programming_info)) {
            array_push($this->openAPINullablesSetToNull, 'programming_info');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('programming_info', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['programming_info'] = $programming_info;
     ...
     * Gets type_mask
     *
     * @return \OpenAPI\Client\Model\DeviceLogDataTypeMask|null
     */
    public function getTypeMask()
    {
        return $this->container['type_mask'];
    }

    /**
     * Sets type_mask
     *
     * @param \OpenAPI\Client\Model\DeviceLogDataTypeMask|null $type_mask type_mask
     *
     * @return self
     */
    public function setTypeMask($type_mask)
    {
        if (is_null($type_mask)) {
            throw new \InvalidArgumentException('non-nullable type_mask cannot be null');
        }
        $this->container['type_mask'] = $type_mask;
