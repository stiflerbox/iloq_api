...
/**
 * NetworkModuleDeviceStateMask Class Doc Comment
 *
 * @category Class
 * @description State
 * @package  OpenAPI\Client
 ...
 */
class NetworkModuleDeviceStateMask implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NetworkModuleDevice_StateMask';
