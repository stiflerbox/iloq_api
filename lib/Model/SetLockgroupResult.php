...
/**
 * SetLockgroupResult Class Doc Comment
 *
 * @category Class
 * @description Result after setting locking system successfully
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SetLockgroupResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetLockgroupResult';
    ...
    {
        $this->setIfExists('rights_mask', $data ?? [], null);
    }
