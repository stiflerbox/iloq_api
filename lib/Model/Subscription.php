...
class Subscription implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'state' => '\OpenAPI\Client\Model\SubscriptionState',
    ...
    protected static $openAPIFormats = [
        ...
        'json_path_filter' => null,
        'sign_key' => null,
        'start_date_utc' => 'date-time',
        'state' => null,
        'subscription_id' => 'guid',
        'target_endpoint_uri' => null,
        'webhook_event_id' => 'guid'
    ];
    ...
    protected static array $openAPINullables = [
        ...
        'custom_header' => true,
        'end_date_utc' => false,
        'json_path_filter' => true,
        'sign_key' => true,
        'start_date_utc' => false,
        'state' => false,
        'subscription_id' => false,
        'target_endpoint_uri' => true,
        'webhook_event_id' => false
    ];
    ...
    protected static $setters = [
        ...
        'json_path_filter' => 'setJsonPathFilter',
        'sign_key' => 'setSignKey',
        'start_date_utc' => 'setStartDateUtc',
        'state' => 'setState',
        'subscription_id' => 'setSubscriptionId',
        'target_endpoint_uri' => 'setTargetEndpointUri',
        'webhook_event_id' => 'setWebhookEventId'
    ];
    ...
    protected static $getters = [
        ...
        'json_path_filter' => 'getJsonPathFilter',
        'sign_key' => 'getSignKey',
        'start_date_utc' => 'getStartDateUtc',
        'state' => 'getState',
        'subscription_id' => 'getSubscriptionId',
        'target_endpoint_uri' => 'getTargetEndpointUri',
        'webhook_event_id' => 'getWebhookEventId'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('end_date_utc', $data ?? [], null);
        $this->setIfExists('json_path_filter', $data ?? [], null);
        $this->setIfExists('sign_key', $data ?? [], null);
        $this->setIfExists('start_date_utc', $data ?? [], null);
        $this->setIfExists('state', $data ?? [], null);
        $this->setIfExists('subscription_id', $data ?? [], null);
        $this->setIfExists('target_endpoint_uri', $data ?? [], null);
        $this->setIfExists('webhook_event_id', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets custom_header
     *
     * @param string|null $custom_header Custom headers
     *
     * @return self
     */
    public function setCustomHeader($custom_header)
    {
        if (is_null($custom_header)) {
            array_push($this->openAPINullablesSetToNull, 'custom_header');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('custom_header', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets end_date_utc
     *
     * @param \DateTime|null $end_date_utc Subscription end date
     *
     * @return self
     */
    public function setEndDateUtc($end_date_utc)
    {
        if (is_null($end_date_utc)) {
            throw new \InvalidArgumentException('non-nullable end_date_utc cannot be null');
        }
    ...
    /**
     * Gets json_path_filter
     *
     * @return string|null
     */
    public function getJsonPathFilter()
    {
        return $this->container['json_path_filter'];
    }

    /**
     * Sets json_path_filter
     *
     * @param string|null $json_path_filter Json path filter
     *
     * @return self
     */
    public function setJsonPathFilter($json_path_filter)
    {
        if (is_null($json_path_filter)) {
            array_push($this->openAPINullablesSetToNull, 'json_path_filter');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('json_path_filter', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['json_path_filter'] = $json_path_filter;
     ...
     * Sets sign_key
     *
     * @param string|null $sign_key Signing key
     *
     * @return self
     */
    ...
    {
        if (is_null($sign_key)) {
            array_push($this->openAPINullablesSetToNull, 'sign_key');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('sign_key', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Sets start_date_utc
     *
     * @param \DateTime|null $start_date_utc Subscription start date
     *
     * @return self
     */
    public function setStartDateUtc($start_date_utc)
    {
        if (is_null($start_date_utc)) {
            throw new \InvalidArgumentException('non-nullable start_date_utc cannot be null');
        }
     ...
     * Gets state
     *
     * @return \OpenAPI\Client\Model\SubscriptionState|null
     */
     ...
     * Sets state
     *
     * @param \OpenAPI\Client\Model\SubscriptionState|null $state state
     *
     * @return self
     */
     ...
     *
     * @param string|null $subscription_id Id
     *
     * @return self
     */
    ...
    /**
     * Gets target_endpoint_uri
     *
     * @return string|null
     */
    public function getTargetEndpointUri()
    {
        return $this->container['target_endpoint_uri'];
    }

    /**
     * Sets target_endpoint_uri
     *
     * @param string|null $target_endpoint_uri Endpoint
     *
     * @return self
     */
    public function setTargetEndpointUri($target_endpoint_uri)
    {
        if (is_null($target_endpoint_uri)) {
            array_push($this->openAPINullablesSetToNull, 'target_endpoint_uri');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('target_endpoint_uri', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['target_endpoint_uri'] = $target_endpoint_uri;

        return $this;
    }

    /**
     * Gets webhook_event_id
     *
     * @return string|null
     */
    public function getWebhookEventId()
    {
        return $this->container['webhook_event_id'];
    }

    /**
     * Sets webhook_event_id
     *
     * @param string|null $webhook_event_id Webhook event
     *
     * @return self
     */
    public function setWebhookEventId($webhook_event_id)
    {
        if (is_null($webhook_event_id)) {
            throw new \InvalidArgumentException('non-nullable webhook_event_id cannot be null');
        }
        $this->container['webhook_event_id'] = $webhook_event_id;
