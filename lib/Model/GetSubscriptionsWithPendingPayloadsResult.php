...
/**
 * GetSubscriptionsWithPendingPayloadsResult Class Doc Comment
 *
 * @category Class
 * @description Subscriptions which have events which aren&#39;t sent successfully.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetSubscriptionsWithPendingPayloadsResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetSubscriptionsWithPendingPayloadsResult';
    ...
    */
     ...
     *
     * @param string[]|null $subscription_ids Subscription ids
     *
     * @return self
     */
    public function setSubscriptionIds($subscription_ids)
    {
        if (is_null($subscription_ids)) {
            array_push($this->openAPINullablesSetToNull, 'subscription_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('subscription_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
