...
/**
 * InsertSecurityAccessResultSecurityAccess Class Doc Comment
 *
 * @category Class
 * @description Inserted security access
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InsertSecurityAccessResultSecurityAccess implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InsertSecurityAccessResult_SecurityAccess';
    ...
    protected static $openAPITypes = [
        'access_mode' => '\OpenAPI\Client\Model\SecurityAccessAccessMode',
        'default_access' => '\OpenAPI\Client\Model\SecurityAccessDefaultAccess',
        'description' => 'string',
        'ext' => '\OpenAPI\Client\Model\SecurityAccessExt',
        'ext_description' => 'string',
        'name' => 'string',
        'parent_security_access_id' => 'string',
        'real_estate_id' => 'string',
        'security_access_id' => 'string',
        'status' => '\OpenAPI\Client\Model\SecurityAccess2Status',
        'type' => '\OpenAPI\Client\Model\SecurityAccess2Type',
        'version_nr' => 'int',
        'zone_id' => 'string'
    ];
    ...
    */
     ...
     * Gets access_mode
     *
     * @return \OpenAPI\Client\Model\SecurityAccessAccessMode|null
     */
     ...
     * Sets access_mode
     *
     * @param \OpenAPI\Client\Model\SecurityAccessAccessMode|null $access_mode access_mode
     *
     * @return self
     */
     ...
     * Gets default_access
     *
     * @return \OpenAPI\Client\Model\SecurityAccessDefaultAccess|null
     */
     ...
     * Sets default_access
     *
     * @param \OpenAPI\Client\Model\SecurityAccessDefaultAccess|null $default_access default_access
     *
     * @return self
     */
     ...
     * Gets ext
     *
     * @return \OpenAPI\Client\Model\SecurityAccessExt|null
     */
     ...
     * Sets ext
     *
     * @param \OpenAPI\Client\Model\SecurityAccessExt|null $ext ext
     *
     * @return self
     */
    ...
    public function setSecurityAccessId($security_access_id)
    {
        if (is_null($security_access_id)) {
            throw new \InvalidArgumentException('non-nullable security_access_id cannot be null');
        }
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\SecurityAccess2Status|null
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\SecurityAccess2Status|null $status status
     *
     * @return self
     */
     ...
     * Gets type
     *
     * @return \OpenAPI\Client\Model\SecurityAccess2Type|null
     */
     ...
     * Sets type
     *
     * @param \OpenAPI\Client\Model\SecurityAccess2Type|null $type type
     *
     * @return self
     */
