...
/**
 * UpdateKeySecurityAccessesParam Class Doc Comment
 *
 * @category Class
 * @description Parameter for updating key&#39;s security accesses and time limits
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class UpdateKeySecurityAccessesParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateKeySecurityAccessesParam';
    ...
    protected static $openAPITypes = [
        'key_scheduler' => '\OpenAPI\Client\Model\GetTimeLimitsResultKeyScheduler',
        'offline_expiration_seconds' => 'int',
        'outside_user_zone_time_limit_title_slots' => 'int[]',
        'security_access_ids' => 'string[]',
        'time_limit_slots' => '\OpenAPI\Client\Model\KeyTimeLimitSlot[]'
    ];
    ...
    protected static $openAPIFormats = [
        'key_scheduler' => null,
        'offline_expiration_seconds' => 'int32',
        'outside_user_zone_time_limit_title_slots' => 'int32',
        'security_access_ids' => 'guid',
        'time_limit_slots' => null
    ];
    ...
    protected static array $openAPINullables = [
        'key_scheduler' => true,
        'offline_expiration_seconds' => false,
        'outside_user_zone_time_limit_title_slots' => true,
        'security_access_ids' => true,
        'time_limit_slots' => true
    ];
    ...
    protected static $attributeMap = [
        ...
        'offline_expiration_seconds' => 'OfflineExpirationSeconds',
        'outside_user_zone_time_limit_title_slots' => 'OutsideUserZoneTimeLimitTitleSlots',
        'security_access_ids' => 'SecurityAccessIds',
        'time_limit_slots' => 'TimeLimitSlots'
    ];
    ...
    protected static $setters = [
        'key_scheduler' => 'setKeyScheduler',
        'offline_expiration_seconds' => 'setOfflineExpirationSeconds',
        'outside_user_zone_time_limit_title_slots' => 'setOutsideUserZoneTimeLimitTitleSlots',
        'security_access_ids' => 'setSecurityAccessIds',
        'time_limit_slots' => 'setTimeLimitSlots'
    ];
    ...
    protected static $getters = [
        'key_scheduler' => 'getKeyScheduler',
        'offline_expiration_seconds' => 'getOfflineExpirationSeconds',
        'outside_user_zone_time_limit_title_slots' => 'getOutsideUserZoneTimeLimitTitleSlots',
        'security_access_ids' => 'getSecurityAccessIds',
        'time_limit_slots' => 'getTimeLimitSlots'
    ];
    ...
    {
        $this->setIfExists('key_scheduler', $data ?? [], null);
        $this->setIfExists('offline_expiration_seconds', $data ?? [], null);
        $this->setIfExists('outside_user_zone_time_limit_title_slots', $data ?? [], null);
        $this->setIfExists('security_access_ids', $data ?? [], null);
        $this->setIfExists('time_limit_slots', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets key_scheduler
     *
     * @return \OpenAPI\Client\Model\GetTimeLimitsResultKeyScheduler|null
     */
    public function getKeyScheduler()
    {
        return $this->container['key_scheduler'];
    }

    /**
     * Sets key_scheduler
     *
     * @param \OpenAPI\Client\Model\GetTimeLimitsResultKeyScheduler|null $key_scheduler key_scheduler
     *
     * @return self
     */
    public function setKeyScheduler($key_scheduler)
    {
        if (is_null($key_scheduler)) {
            array_push($this->openAPINullablesSetToNull, 'key_scheduler');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('key_scheduler', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['key_scheduler'] = $key_scheduler;

        return $this;
    }

    /**
     * Gets offline_expiration_seconds
     *
     * @return int|null
     */
    public function getOfflineExpirationSeconds()
    {
        return $this->container['offline_expiration_seconds'];
    }

    /**
     * Sets offline_expiration_seconds
     *
     * @param int|null $offline_expiration_seconds S50 Time key works offline in seconds. Zero = unlimited offline access. Maximum is 16761540 seconds for key fob and 8726340 seconds for phone.
     *
     * @return self
     */
    public function setOfflineExpirationSeconds($offline_expiration_seconds)
    {
        if (is_null($offline_expiration_seconds)) {
            throw new \InvalidArgumentException('non-nullable offline_expiration_seconds cannot be null');
        }
        $this->container['offline_expiration_seconds'] = $offline_expiration_seconds;

        return $this;
    }

    /**
     * Gets outside_user_zone_time_limit_title_slots
     *
     * @return int[]|null
     */
    public function getOutsideUserZoneTimeLimitTitleSlots()
    {
        return $this->container['outside_user_zone_time_limit_title_slots'];
    }

    /**
     * Sets outside_user_zone_time_limit_title_slots
     *
     * @param int[]|null $outside_user_zone_time_limit_title_slots Slots which are filled by information not available for current user and aren't overridden.
     *
     * @return self
     */
    public function setOutsideUserZoneTimeLimitTitleSlots($outside_user_zone_time_limit_title_slots)
    {
        if (is_null($outside_user_zone_time_limit_title_slots)) {
            array_push($this->openAPINullablesSetToNull, 'outside_user_zone_time_limit_title_slots');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('outside_user_zone_time_limit_title_slots', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['outside_user_zone_time_limit_title_slots'] = $outside_user_zone_time_limit_title_slots;

        return $this;
    }

    /**
     * Gets security_access_ids
     *
     * @return string[]|null
     */
    public function getSecurityAccessIds()
    {
        return $this->container['security_access_ids'];
    }

    /**
     * Sets security_access_ids
     *
     * @param string[]|null $security_access_ids Security accesses which are set to the key
     *
     * @return self
     */
    public function setSecurityAccessIds($security_access_ids)
    {
        if (is_null($security_access_ids)) {
            array_push($this->openAPINullablesSetToNull, 'security_access_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('security_access_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['security_access_ids'] = $security_access_ids;

        return $this;
    }

    /**
     * Gets time_limit_slots
     *
     * @return \OpenAPI\Client\Model\KeyTimeLimitSlot[]|null
     */
    public function getTimeLimitSlots()
    {
        return $this->container['time_limit_slots'];
    }

    /**
     * Sets time_limit_slots
     *
     * @param \OpenAPI\Client\Model\KeyTimeLimitSlot[]|null $time_limit_slots Time limit slots
     *
     * @return self
     */
    public function setTimeLimitSlots($time_limit_slots)
    {
        if (is_null($time_limit_slots)) {
            array_push($this->openAPINullablesSetToNull, 'time_limit_slots');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('time_limit_slots', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['time_limit_slots'] = $time_limit_slots;
