...
/**
 * CreateSessionParam Class Doc Comment
 *
 * @category Class
 * @description Parameter for creating session
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreateSessionParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSessionParam';
    ...
    */
     ...
     * Sets api_key
     *
     * @param string|null $api_key Not in use at the moment. Leave empty.
     *
     * @return self
     */
     ...
     * Sets api_secret
     *
     * @param string|null $api_secret Not in use at the moment. Leave empty.
     *
     * @return self
     */
