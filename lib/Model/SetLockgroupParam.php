...
/**
 * SetLockgroupParam Class Doc Comment
 *
 * @category Class
 * @description Parameter for settings session&#39;s locking system information
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SetLockgroupParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SetLockgroupParam';
    ...
    */
     ...
     * Sets lock_group_id
     *
     * @param string|null $lock_group_id Locking system's ID user is logging in to.
     *
     * @return self
     */
