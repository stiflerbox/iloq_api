...
/**
 * GetZonesResult Class Doc Comment
 *
 * @category Class
 * @description Result for retrieving Key&#39;s zones
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class GetZonesResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetZonesResult';
    ...
    protected static $attributeMap = [
        'main_zone' => 'MainZone',
        'outside_user_zone_count' => 'OutsideUserZoneCount',
        'zone_ids' => 'ZoneIds'
    ];
    ...
    protected static $setters = [
        'main_zone' => 'setMainZone',
        'outside_user_zone_count' => 'setOutsideUserZoneCount',
        'zone_ids' => 'setZoneIds'
    ];
    ...
    protected static $getters = [
        'main_zone' => 'getMainZone',
        'outside_user_zone_count' => 'getOutsideUserZoneCount',
        'zone_ids' => 'getZoneIds'
    ];
    ...
    {
        $this->setIfExists('main_zone', $data ?? [], null);
        $this->setIfExists('outside_user_zone_count', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['main_zone'];
    }

    /**
     * Sets main_zone
     *
     * @param string|null $main_zone Key's main zone. In use in 5 series systems.
     *
     * @return self
     */
    public function setMainZone($main_zone)
    {
        if (is_null($main_zone)) {
            array_push($this->openAPINullablesSetToNull, 'main_zone');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('main_zone', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['main_zone'] = $main_zone;

        return $this;
    }

    /**
     * Gets outside_user_zone_count
     *
     * @return int|null
     */
    public function getOutsideUserZoneCount()
    {
        return $this->container['outside_user_zone_count'];
    }

    /**
     * Sets outside_user_zone_count
     *
     * @param int|null $outside_user_zone_count How many zones are invisible to current user because of user's zone restrictions
     *
     * @return self
     */
    public function setOutsideUserZoneCount($outside_user_zone_count)
    {
        if (is_null($outside_user_zone_count)) {
            throw new \InvalidArgumentException('non-nullable outside_user_zone_count cannot be null');
        }
        $this->container['outside_user_zone_count'] = $outside_user_zone_count;
     ...
     * Sets zone_ids
     *
     * @param string[]|null $zone_ids Key's zones
     *
     * @return self
     */
