...
/**
 * DeviceLogDataFLock Class Doc Comment
 *
 * @category Class
 * @description Lock information if log row is linked to a lock
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class DeviceLogDataFLock implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeviceLogData_FLock';
    ...
    protected static $openAPITypes = [
        ...
        'lock_type' => '\OpenAPI\Client\Model\DeviceLogFlockLockType'
    ];
    ...
    {
        $this->setIfExists('flock_id', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['flock_id'];
    }

    /**
     * Sets flock_id
     *
     * @param string|null $flock_id Id
     *
     * @return self
     */
    public function setFlockId($flock_id)
    {
        if (is_null($flock_id)) {
            throw new \InvalidArgumentException('non-nullable flock_id cannot be null');
        }
        $this->container['flock_id'] = $flock_id;
     ...
     * Sets going_counter
     *
     * @param int|null $going_counter Lock going counter
     *
     * @return self
     */
     ...
     * Sets key_chamber
     *
     * @param string|null $key_chamber Key chamber
     *
     * @return self
     */
     ...
     * Gets lock_type
     *
     * @return \OpenAPI\Client\Model\DeviceLogFlockLockType|null
     */
     ...
     * Sets lock_type
     *
     * @param \OpenAPI\Client\Model\DeviceLogFlockLockType|null $lock_type lock_type
     *
     * @return self
     */
    public function setLockType($lock_type)
    {
        if (is_null($lock_type)) {
            array_push($this->openAPINullablesSetToNull, 'lock_type');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('lock_type', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
