 ...
 *
 * @category Class
 * @description Basic key. Keys belong to users and real estates.
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
    ...
    */
    ...
    public function setStamp($stamp)
    {
        ...
        if ((mb_strlen($stamp) > 10)) {
            throw new \InvalidArgumentException('invalid length for $stamp when calling Key., must be smaller than or equal to 10.');
        }
        if ((mb_strlen($stamp) < 0)) {
            throw new \InvalidArgumentException('invalid length for $stamp when calling Key., must be bigger than or equal to 0.');
        }
