...
/**
 * CalendarDataSecurityRoleLinksSetLinksParam Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class CalendarDataSecurityRoleLinksSetLinksParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalendarDataSecurityRoleLinksSetLinksParam';
    ...
    protected static $attributeMap = [
        'security_role_ids' => 'SecurityRoleIds'
    ];
    ...
    protected static $setters = [
        'security_role_ids' => 'setSecurityRoleIds'
    ];
    ...
    protected static $getters = [
        'security_role_ids' => 'getSecurityRoleIds'
    ];
    ...
    {
        $this->setIfExists('security_role_ids', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets security_role_ids
     *
     * @return string[]|null
     */
    public function getSecurityRoleIds()
    {
        return $this->container['security_role_ids'];
    }

    /**
     * Sets security_role_ids
     *
     * @param string[]|null $security_role_ids Code access group Ids to link for calendar data The whole result set must be given when setting links because this method handles both adding/removing of links. If no links are given, clears all calendar data's links.
     *
     * @return self
     */
    public function setSecurityRoleIds($security_role_ids)
    {
        if (is_null($security_role_ids)) {
            array_push($this->openAPINullablesSetToNull, 'security_role_ids');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('security_role_ids', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['security_role_ids'] = $security_role_ids;
