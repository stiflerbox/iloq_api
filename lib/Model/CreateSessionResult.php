...
/**
 * CreateSessionResult Class Doc Comment
 *
 * @category Class
 * @description Return value for CreateSession method
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class CreateSessionResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateSessionResult';
    ...
    protected static $openAPITypes = [
        'result' => '\OpenAPI\Client\Model\CreateSessionResultResult',
        'session_id' => 'string'
    ];
    ...
    */
     ...
     * Gets result
     *
     * @return \OpenAPI\Client\Model\CreateSessionResultResult|null
     */
     ...
     * Sets result
     *
     * @param \OpenAPI\Client\Model\CreateSessionResultResult|null $result result
     *
     * @return self
     */
     ...
     * Sets session_id
     *
     * @param string|null $session_id Created session ID.
     *
     * @return self
     */
